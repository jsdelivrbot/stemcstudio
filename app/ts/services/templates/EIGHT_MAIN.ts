...
export function EIGHT_MAIN(tabString: string): string {
    ...
    lines.push(_ + _ + "model.body.position.x += 1 * Δt");
    lines.push(_ + "}");
    lines.push(_ + "if (kbd.pressed['left']) {");
    lines.push(_ + _ + "model.body.position.x -= 1 * Δt");
    lines.push(_ + "}");
    lines.push(_ + "if (kbd.pressed['up']) {");
    lines.push(_ + _ + "model.body.position.y += 1 * Δt");
    lines.push(_ + "}");
    ...
    lines.push("");
    lines.push(_ + "model.body.position.x = 0");
    lines.push(_ + "model.body.position.y = 0");
    lines.push(_ + "model.body.position.z = 0");
    lines.push("");
