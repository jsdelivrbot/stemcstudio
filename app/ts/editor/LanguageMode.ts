 ...
 * 
 */
export type LanguageModeId = 'AsciiDoc' | 'C' | 'C++' | 'Clojure' | 'CSS' | 'CSV' | 'GLSL' | 'Go' | 'Haskell' | 'HTML' | 'JavaScript' | 'JSX' | 'JSON' | 'LaTeX' | 'LESS' | 'LISP' | 'Markdown' | 'MATLAB' | 'PureScript' | 'Python' | 'Scheme' | 'Text' | 'TypeScript' | 'TSX' | 'XML' | 'YAML';
