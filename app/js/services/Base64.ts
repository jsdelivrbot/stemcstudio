...
/// <reference path="./Base64Service.ts" />
'use strict';

const _keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";

const _utf8_decode = function(utftext: string) {
    var c, c1, c2, c3;
    let s = "";
    let i = 0;
    c = c1 = c2 = 0;
...
const _utf8_encode = function(s: string): string {
    ...
    s = s.replace(/\r\n/g, "\n");
    let utftext = "";
    for (n = _i = 0, _ref = s.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; n = 0 <= _ref ? ++_i : --_i) {
        c = s.charCodeAt(n);
        if (c < 128) {
...
angular.module('app').factory('Base64', [
    '$window', function($window): Base64Service {
        return {
