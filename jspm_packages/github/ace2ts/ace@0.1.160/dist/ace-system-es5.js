      ...
      LanguageServiceProxy = (function() {
        function LanguageServiceProxy(workerUrl) {
          ...
          this.worker.on(EVENT_DEFAULT_LIB_CONTENT, function(response) {
            ...
            var callback = _this.releaseCallback(data.callbackId);
            if ('err' in data) {
              callback(data.err);
            } else {
              callback(void 0);
    ...
    execute: function() {
      ...
      Workspace = (function() {
        function Workspace(workerUrl, scriptImports) {
          ...
          this.languageService = new LanguageServiceProxy_1.default(workerUrl);
        ...
        Workspace.prototype.dump = function(where) {
          ...
          console.log("@ " + where);
          console.log('===============================================');
          var captureNames = Object.keys(this.scriptCapturing);
          ...
          var releaseNames = Object.keys(this.scriptReleasing);
        ...
        Workspace.prototype.init = function(callback) {
          ...
          this.languageService.init(this.scriptImports, function(err) {
            if (!err) {
        ...
        Workspace.prototype.setDefaultLibrary = function(url, callback) {
          ...
          net_1.get(url, function(err, sourceCode) {
            if (err) {
              ...
              if (_this.languageService) {
                _this.languageService.setDefaultLibContent(sourceCode, callback);
              } else {
        ...
        Workspace.prototype.attachEditor = function(fileName, editor, callback) {
          ...
          var changeHandler = function(delta, source) {
            ...
            _this.languageService.applyDelta(fileName, delta);
        ...
        Workspace.prototype.ensureScript = function(fileName, content, callback) {
          ...
          this.languageService.ensureScript(fileName, content, function(err) {
            if (!err) {
              delete _this.scriptCapturing[fileName];
              _this.scriptWorking[fileName] = true;
        ...
        Workspace.prototype.semanticDiagnosticsForEditor = function(fileName, editor) {
          var _this = this;
          checkFileName(fileName);
          this.languageService.getSyntaxErrors(fileName, function(err, syntaxErrors) {
            if (err) {
              console.warn("getSyntaxErrors(" + fileName + ") => " + err);
            } else {
              _this.updateEditor(syntaxErrors, editor);
              if (syntaxErrors.length === 0) {
                _this.languageService.getSemanticErrors(fileName, function(err, semanticErrors) {
                  if (err) {
        ...
        Workspace.prototype.outputFilesForEditor = function(fileName, editor) {
          ...
          checkEditor(editor);
          var session = editor.getSession();
          this.languageService.getOutputFiles(fileName).then(function(outputFiles) {
        ...
        Workspace.prototype.removeScript = function(fileName, callback) {
          ...
          this.languageService.removeScript(fileName, function(err) {
            if (!err) {
              delete _this.scriptReleasing[fileName];
              delete _this.scriptWorking[fileName];
