      ...
      LanguageServiceProxy = (function() {
        function LanguageServiceProxy(workerUrl) {
          ...
          this.worker.on(EVENT_DEFAULT_LIB_CONTENT, function(response) {
            ...
            var callback = _this.callbacks[callbackId];
            delete _this.callbacks[callbackId];
            if ('err' in data) {
              callback(data.err);
            } else {
              callback(void 0);
  ...
  return {
    ...
    execute: function() {
      Workspace = (function() {
        ...
        Workspace.prototype.init = function(workerUrl, scriptImports, callback) {
          var _this = this;
          this.workerProxy = new LanguageServiceProxy_1.default(workerUrl);
          this.workerProxy.init(scriptImports, function(err) {
            if (err) {
              _this.workerProxy = void 0;
            }
            callback(err);
          });
        };
          ...
          net_1.get(url, function(err, sourceCode) {
            if (err) {
              ...
              if (_this.workerProxy) {
                _this.workerProxy.setDefaultLibContent(sourceCode, callback);
              } else {
...
System.register("workspace/createWorkspace.js", ["./Workspace"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var Workspace_1;
...
System.register("mode/XmlMode.js", ["./TextMode", "./XmlHighlightRules", "./behaviour/XmlBehaviour", "./folding/XmlFoldMode"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __extends = (this && this.__extends) || function(d, b) {
    for (var p in b)
...
System.register("mode/CssMode.js", ["./TextMode", "./CssHighlightRules", "./MatchingBraceOutdent", "../worker/WorkerClient", "./behaviour/CssBehaviour", "./folding/CstyleFoldMode"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var __extends = (this && this.__extends) || function(d, b) {
    for (var p in b)
    ...
    execute: function() {
      XmlHighlightRules = (function(_super) {
        ...
        XmlHighlightRules.prototype.embedTagRules = function(HighlightRules, prefix, tag) {
          ...
          this.$rules['tag'].unshift(tagRule);
...
System.register("worker/WorkerClient.js", ["../lib/net", "../lib/EventEmitterClass"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  var net_1,
      EventEmitterClass_1;
                ...
                case 'init':
                  {
                    ...
                    var callback_1 = this.callbacks[callbackId];
...
System.register("Tokenizer.js", [], function(exports_1, context_1) {
  ...
  return {
    ...
    execute: function() {
      ...
      Tokenizer = (function() {
        function Tokenizer(states) {
          var _this = this;
          this.states = states;
          this.regExps = {};
          this.matchMappings = {};
          var _loop_1 = function() {
            var state = this_1.states[key];
            var ruleRegExps = [];
            var matchTotal = 0;
            var mapping = this_1.matchMappings[key] = {defaultToken: "text"};
            var flag = "g";
            splitterRules = [];
            for (var i = 0; i < state.length; i++) {
              ...
              if (Array.isArray(rule.token)) {
                if (rule.token.length == 1 || matchcount == 1) {
                  ...
                  rule.token = null;
                  rule.onMatch = this_1.$arrayTokens;
                }
              } else if (typeof rule.token === "function" && !rule.onMatch) {
                if (matchcount > 1) {
                  rule.onMatch = this_1.$applyToken;
                } else {
              ...
              if (matchcount > 1) {
                if (/\\\d/.test(rule.regex)) {
                  ...
                  matchcount = 1;
                  adjustedregex = this_1.removeCapturingGroups(rule.regex);
                }
            ...
            this_1.regExps[key] = new RegExp("(" + ruleRegExps.join(")|(") + ")|($)", flag);
          };
          var this_1 = this;
          var splitterRules;
        ...
        TextHighlightRules.prototype.normalizeRules = function() {
          ...
          var pushState = function(currentState, stack) {
            if (currentState !== "start" || stack.length) {
              stack.unshift(_this.nextState, currentState);
            }
          ...
          function processState(key) {
            ...
            for (var i = 0; i < state.length; i++) {
              ...
              if (!rule.regex && rule['start']) {
                ...
                nextRules.push({defaultToken: rule.token}, {
              ...
              if (rule['rules']) {
                var childRulesByState = rule['rules'];
            ...
            this.$startWorker(function(err) {
              if (!err) {
                ...
                if (tokenizer['addEventListener'] !== undefined) {
                  var onReloadTokenizer = _this.onReloadTokenizer.bind(_this);
                  tokenizer['addEventListener']("update", onReloadTokenizer);
                }
                if (!_this.bgTokenizer) {
                  _this.bgTokenizer = new BackgroundTokenizer_1.default(tokenizer, _this);
                  _this.bgTokenizer.on("update", function(event, bg) {
                    _this.eventBus._signal("tokenizerUpdate", event);
                  });
                } else {
                  _this.bgTokenizer.setTokenizer(tokenizer);
                }
                _this.bgTokenizer.setDocument(_this.getDocument());
                _this.tokenRe = mode.tokenRe;
                _this.nonTokenRe = mode.nonTokenRe;
                if (!isPlaceholder) {
                  _this.$options.wrapMethod.set.call(_this, _this.$wrapMethod);
                  _this.$setFolding(mode.foldingRules);
                  _this.bgTokenizer.start(0);
                  _this.eventBus._emit("changeMode");
                }
                callback(void 0);
              } else {
                callback(err);
...
System.register("ace.js", ["./createAnchor", "./createDocument", "./createEditor", "./createEditSession", "./createFold", "./createFoldLine", "./createRange", "./createRenderer", "./createTokenizer", "./createUndoManager", "./createWorkerClient", "./workspace/createWorkspace", "./mode/createCssMode", "./mode/createHtmlMode", "./mode/createJavaScriptMode", "./mode/createMarkdownMode", "./mode/createTextMode", "./mode/createTypeScriptMode", "./edit"], function(exports_1, context_1) {
  'use strict';
  var __moduleName = context_1 && context_1.id;
  var createAnchor_1,
      createDocument_1,
