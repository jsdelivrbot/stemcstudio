...
export class LanguageServiceWorker {
     ...
     */
    private readonly pyLanguageServiceHost: DefaultLanguageServiceHost;
    /**
     * Contains the file contents and compiler options for TypeScript and JavaScript files.
     */
    private readonly tsLanguageServiceHost: DefaultLanguageServiceHost;
    ...
    constructor(private sender: WorkerCallback) {
        ...
        this.pyLanguageServiceHost = new DefaultLanguageServiceHost();
        this.tsLanguageServiceHost = new DefaultLanguageServiceHost();

        this.dispatcher = new LanguageServiceDispatcher(this.pyLanguageServiceHost, this.tsLanguageServiceHost);
        ...
        sender.on<SetModuleKindRequest>(EVENT_SET_MODULE_KIND, (message) => {
            ...
            try {
                ...
                this.tsLanguageServiceHost.moduleKind = moduleKind;
                this.resolve(EVENT_SET_MODULE_KIND, this.tsLanguageServiceHost.moduleKind, callbackId);
            }
            catch (reason) {
        ...
        sender.on<SetScriptTargetRequest>(EVENT_SET_SCRIPT_TARGET, (message) => {
            ...
            try {
                ...
                this.tsLanguageServiceHost.scriptTarget = scriptTarget;
                this.resolve(EVENT_SET_SCRIPT_TARGET, this.tsLanguageServiceHost.scriptTarget, callbackId);
            }
            catch (reason) {
