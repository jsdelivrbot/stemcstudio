System.register(["./TreeBuilder", "./Characters", "./Comment", "./Document", "./DocumentFragment", "./DTD", "./Element", "./getAttribute"], function (exports_1, context_1) {
    ...
    var TreeBuilder_1, Characters_1, Comment_1, Document_1, DocumentFragment_1, DTD_1, Element_1, getAttribute_1, SAXTreeBuilder;
    return {
        setters: [
        ...
        execute: function () {
            SAXTreeBuilder = (function (_super) {
                ...
                SAXTreeBuilder.prototype.start = function (tokenizer) {
                    this.document = new Document_1.Document(this.tokenizer);
                };
                ...
                SAXTreeBuilder.prototype.getFragment = function () {
                    var fragment = new DocumentFragment_1.DocumentFragment();
                ...
                SAXTreeBuilder.prototype.addAttributesToElement = function (element, attributes) {
                    for (var i = 0; i < attributes.length; i++) {
                        ...
                        if (!getAttribute_1.getAttribute(element, attribute.nodeName))
                            element.attributes.push(attribute);
                    }
                };
                return SAXTreeBuilder;
            }(TreeBuilder_1.TreeBuilder));
            exports_1("SAXTreeBuilder", SAXTreeBuilder);
        }
    };
});
