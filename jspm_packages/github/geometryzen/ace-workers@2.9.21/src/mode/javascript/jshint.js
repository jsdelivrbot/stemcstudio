System.register(["./EventEmitter", "./vars", "./messages", "./lex", "./reg", "./state", "./style", "./options", "./scope-manager", "../../fp/contains", "../../fp/clone", "../../fp/each", "../../fp/extend", "../../fp/has", "../../fp/isEmpty", "../../fp/isNumber", "../../fp/reject", "../../fp/zip"], function (exports_1, context_1) {
    ...
    var EventEmitter_1, vars_1, messages_1, lex_1, reg_1, state_1, style_1, options_1, scope_manager_1, contains_1, clone_1, each_1, extend_1, has_1, isEmpty_1, isNumber_1, reject_1, zip_1, JSHINT;
    return {
        setters: [
        ...
        execute: function () {
            exports_1("JSHINT", JSHINT = (function () {
                ...
                var api, bang = {
                    ...
                    "outer", "unused", "var"
                ], functions, inblock, indent, lookahead, lex, member, membersOnly, predefined, stack, urls, extraModules = [], emitter = new EventEmitter_1.EventEmitter();
