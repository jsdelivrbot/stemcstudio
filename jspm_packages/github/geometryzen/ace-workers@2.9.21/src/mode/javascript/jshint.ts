...
export const JSHINT: any = (function () {
    "use strict";
    ...
    function checkOption(name: string, t) {
        name = name.trim();
    ...
    function quit(code: string, token: IToken, a?, b?) {
    ...
    var itself: any = function (s: string, o: JSHintOptions, g) {
