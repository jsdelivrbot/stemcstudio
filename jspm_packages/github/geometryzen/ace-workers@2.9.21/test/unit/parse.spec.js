        ...
        execute: function () {
            describe("glsl/parse", function () {
                describe("basic", function () {
                    var node = parse_1.parse('void main(void) {gl_Position = vec4(0.0, 0.0, 0.0, 1.0);}');
                    it("(program)", function () {
                ...
                describe("attribute", function () {
                    var node = parse_1.parse('attribute vec3 aVertexPosition; void main(void) {gl_Position = aVertexPosition;}');
                    it("(program)", function () {
                ...
                describe("uniform", function () {
                    var node = parse_1.parse('uniform mat4 projectionMatrix; void main(void) {gl_Position = aVertexPosition;}');
                    it("(program)", function () {
                        expect(node.mode).toBe(2);
                        expect(node.type).toBe('stmtlist');
                        expect(node.children.length).toBe(2);
                ...
                describe("varying", function () {
                    var node = parse_1.parse('varying highp vec4 vColor; void main(void) {gl_Position = aVertexPosition;}');
                    it("(program)", function () {
                        expect(node.mode).toBe(2);
                        expect(node.type).toBe('stmtlist');
                        expect(node.children.length).toBe(2);
                ...
                xdescribe("syntax", function () {
                    it("", function () {
                        try {
                            parse_1.parse('vary ing highp vec4 vColor; void main(void) {gl_Position = aVertexPosition;}');
                        }
                        catch (e) {
