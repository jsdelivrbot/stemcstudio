        ...
        execute: function () {
            SAXParser = (function () {
                function SAXParser() {
                    ...
                    this._treeBuilder = new SAXTreeBuilder_1.SAXTreeBuilder();
                    this._tokenizer = new Tokenizer_1.Tokenizer(this._treeBuilder);
                ...
                SAXParser.prototype.parseFragment = function (source, context) {
                    ...
                    if (fragment) {
                        new TreeParser_1.TreeParser(this.contentHandler).parse(fragment);
                    }
                };
                SAXParser.prototype.parse = function (source) {
                    ...
                    if (document) {
                        new TreeParser_1.TreeParser(this.contentHandler).parse(document);
                    }
                };
