...
import { ScriptTarget } from './typescript/DefaultLanguageServiceHost';
...
export default class LanguageServiceWorker {
    ...
    constructor(private sender: WorkerCallback) {
        ...
        sender.on(EVENT_SET_SCRIPT_TARGET, (message: { data: { scriptTarget: ScriptTarget, callbackId: number } }) => {
