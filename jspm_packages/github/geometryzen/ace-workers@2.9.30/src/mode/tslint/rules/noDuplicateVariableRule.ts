...
import { isBlockScopedBindingElement, isBlockScopedVariable } from '../language/utils';
import { dedent } from '../utils';
import { BlockScopeAwareRuleWalker } from '../language/walker';
...
class NoDuplicateVariableWalker extends BlockScopeAwareRuleWalker<{}, ScopeInfo> {
    ...
    public visitBindingElement(node: ts.BindingElement) {
        ...
        const isBlockScoped = isBlockScopedBindingElement(node);
    ...
    public visitVariableDeclaration(node: ts.VariableDeclaration) {
        ...
        if (isSingleVariable && !isBlockScopedVariable(node)) {
            this.handleSingleVariableIdentifier(node.name as ts.Identifier);
        }
