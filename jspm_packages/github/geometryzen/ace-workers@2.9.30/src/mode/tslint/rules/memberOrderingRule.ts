...
import { IOptions, IRuleMetadata, RuleFailure } from '../language/rule/rule';
import { hasModifier as hasMod } from '../language/utils';
...
const optionsDescription = dedent`
...
export class MemberOrderingWalker extends RuleWalker {
...
function getMemberKind(member: Member): MemberKind | undefined {
    ...
    function hasModifier(kind: ts.SyntaxKind) {
        return hasMod(member.modifiers, kind);
    }
}
