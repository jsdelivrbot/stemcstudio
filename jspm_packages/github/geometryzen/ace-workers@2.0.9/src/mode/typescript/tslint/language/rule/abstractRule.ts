...
export abstract class AbstractRule implements IRule {
    ...
    protected readonly ruleArguments: (string | boolean)[];

    public static isRuleEnabled(ruleConfigValue: boolean | (boolean | string)[]): boolean {
    ...
    constructor(public readonly ruleName: string, private value: boolean | (boolean | string)[], private disabledIntervals: IDisabledInterval[]) {
