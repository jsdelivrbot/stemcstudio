        ...
        execute: function () {
            MockWorkerCallback = (function () {
                ...
                MockWorkerCallback.prototype.on = function (eventName, callback) {
                    switch (eventName) {
                        ...
                        case LanguageServiceEvents_4.EVENT_GET_COMPLETIONS_AT_POSITION:
                        case LanguageServiceEvents_5.EVENT_GET_DEFINITION_AT_POSITION:
                        ...
                        case LanguageServiceEvents_10.EVENT_GET_SCRIPT_CONTENT:
                        case LanguageServiceEvents_11.EVENT_GET_SEMANTIC_ERRORS:
                        case LanguageServiceEvents_12.EVENT_GET_SYNTAX_ERRORS:
                        case LanguageServiceEvents_13.EVENT_REMOVE_MODULE_MAPPING:
                        case LanguageServiceEvents_14.EVENT_REMOVE_SCRIPT:
                        case LanguageServiceEvents_15.EVENT_SET_MODULE_KIND:
                        case LanguageServiceEvents_16.EVENT_SET_OPERATOR_OVERLOADING:
                        case LanguageServiceEvents_17.EVENT_SET_SCRIPT_CONTENT:
                        case LanguageServiceEvents_18.EVENT_SET_SCRIPT_TARGET:
                        case LanguageServiceEvents_19.EVENT_SET_TRACE:
                        case LanguageServiceEvents_20.EVENT_SET_TS_CONFIG: {
            ...
            MockLanguageServiceProxy = (function () {
                ...
                MockLanguageServiceProxy.prototype.removeModuleMapping = function (moduleName, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_13.EVENT_REMOVE_MODULE_MAPPING];
                    var data = { moduleName: moduleName, callbackId: callbackId };
                    callback({ data: data });
                };
                MockLanguageServiceProxy.prototype.getScriptContent = function (fileName, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_10.EVENT_GET_SCRIPT_CONTENT];
                    var data = { fileName: fileName, callbackId: callbackId };
                    callback({ data: data });
                };
                MockLanguageServiceProxy.prototype.setScriptContent = function (fileName, content, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_17.EVENT_SET_SCRIPT_CONTENT];
                ...
                MockLanguageServiceProxy.prototype.removeScript = function (fileName, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_14.EVENT_REMOVE_SCRIPT];
                    var data = { fileName: fileName, callbackId: callbackId };
                    callback({ data: data });
                };
                ...
                MockLanguageServiceProxy.prototype.setOperatorOverloading = function (operatorOverloading, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_16.EVENT_SET_OPERATOR_OVERLOADING];
                ...
                MockLanguageServiceProxy.prototype.setTrace = function (trace, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_19.EVENT_SET_TRACE];
            ...
            describe("LanguageServiceWorker", function () {
                describe("constructor", function () {
                    ...
                    var lsw = new LanguageServiceWorker_1.LanguageServiceWorker(sender);
                ...
                describe("setOperatorOverloading", function () {
                    describe("(true)", function () {
                        ...
                        it("should change the operatorOverloading property from false to true", function () {
                            ...
                            expect(resolution.eventName).toBe(LanguageServiceEvents_16.EVENT_SET_OPERATOR_OVERLOADING);
                ...
                describe("setTrace", function () {
                    describe("(true)", function () {
                        ...
                        it("should change the trace property from false to true", function () {
                            ...
                            var resolution = sender.resolutions[callbackId];
                            expect(resolution).toBeDefined();
                            expect(resolution.eventName).toBe(LanguageServiceEvents_19.EVENT_SET_TRACE);
                ...
                describe("removeModuleMapping", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        var resolution = sender.resolutions[callbackId];
                        expect(resolution).toBeDefined();
                        expect(resolution.eventName).toBe(LanguageServiceEvents_13.EVENT_REMOVE_MODULE_MAPPING);
                    });
                });
                describe("getScriptContent", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        var resolution = sender.resolutions[callbackId];
                        expect(resolution).toBeDefined();
                        expect(resolution.eventName).toBe(LanguageServiceEvents_10.EVENT_GET_SCRIPT_CONTENT);
                    });
                });
                describe("setScriptContent", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        var resolution = sender.resolutions[callbackId];
                        expect(resolution).toBeDefined();
                        expect(resolution.eventName).toBe(LanguageServiceEvents_17.EVENT_SET_SCRIPT_CONTENT);
                    });
                });
                describe("removeScript", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        var resolution = sender.resolutions[callbackId];
                        expect(resolution).toBeDefined();
                        expect(resolution.eventName).toBe(LanguageServiceEvents_14.EVENT_REMOVE_SCRIPT);
                    });
                });
                describe("getOutputFiles", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        expect(resolution1.eventName).toBe(LanguageServiceEvents_17.EVENT_SET_SCRIPT_CONTENT);
                        var two = Math.random();
                        ...
                        var outputFilesResponse = resolution2.value;
                        expect(outputFilesResponse.outputFiles).toBeDefined();
                        expect(Array.isArray(outputFilesResponse.outputFiles)).toBe(true);
                        expect(outputFilesResponse.outputFiles.length).toBe(2);
                        var fileOne = outputFilesResponse.outputFiles[0];
                        expect(fileOne).toBeDefined();
                        expect(fileOne.name).toBe('index.js');
                        expect(fileOne.text).toBe('var x = 0;\nvar y = 1;\n//# sourceMappingURL=index.js.map');
                        var fileTwo = outputFilesResponse.outputFiles[1];
