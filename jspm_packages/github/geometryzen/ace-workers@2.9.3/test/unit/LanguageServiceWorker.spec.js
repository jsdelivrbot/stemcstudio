        ...
        execute: function () {
            MockWorkerCallback = (function () {
                ...
                MockWorkerCallback.prototype.on = function (eventName, callback) {
                    switch (eventName) {
                        ...
                        case LanguageServiceEvents_3.EVENT_ENSURE_SCRIPT:
                        case LanguageServiceEvents_4.EVENT_GET_COMPLETIONS_AT_POSITION:
                        case LanguageServiceEvents_5.EVENT_GET_FORMATTING_EDITS_FOR_DOCUMENT:
                        case LanguageServiceEvents_6.EVENT_GET_LINT_ERRORS:
                        case LanguageServiceEvents_7.EVENT_GET_OUTPUT_FILES:
                        case LanguageServiceEvents_8.EVENT_GET_QUICK_INFO_AT_POSITION:
                        case LanguageServiceEvents_9.EVENT_GET_SEMANTIC_ERRORS:
                        case LanguageServiceEvents_10.EVENT_GET_SYNTAX_ERRORS:
                        case LanguageServiceEvents_11.EVENT_REMOVE_SCRIPT:
                        case LanguageServiceEvents_12.EVENT_SET_MODULE_KIND:
                        case LanguageServiceEvents_13.EVENT_SET_OPERATOR_OVERLOADING:
                        case LanguageServiceEvents_14.EVENT_SET_SCRIPT_TARGET:
                        case LanguageServiceEvents_15.EVENT_SET_TRACE: {
            ...
            MockLanguageServiceProxy = (function () {
                ...
                MockLanguageServiceProxy.prototype.ensureScript = function (fileName, content, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_3.EVENT_ENSURE_SCRIPT];
                ...
                MockLanguageServiceProxy.prototype.getOutputFiles = function (fileName, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_7.EVENT_GET_OUTPUT_FILES];
                ...
                MockLanguageServiceProxy.prototype.setOperatorOverloading = function (operatorOverloading, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_13.EVENT_SET_OPERATOR_OVERLOADING];
                ...
                MockLanguageServiceProxy.prototype.setTrace = function (trace, callbackId) {
                    var callback = this.sender.callbacks[LanguageServiceEvents_15.EVENT_SET_TRACE];
            ...
            describe("LanguageServiceWorker", function () {
                ...
                describe("setOperatorOverloading", function () {
                    describe("(true)", function () {
                        ...
                        var lsw = new LanguageServiceWorker_1.default(sender);
                        lsw.operatorOverloading = false;
                        it("should change the operatorOverloading property from false to true", function () {
                            expect(lsw.operatorOverloading).toBe(false);
                            var callbackId = Math.random();
                            proxy.setOperatorOverloading(true, callbackId);
                            expect(lsw).toBeDefined();
                            var resolution = sender.resolutions[callbackId];
                            expect(resolution).toBeDefined();
                            expect(resolution.eventName).toBe(LanguageServiceEvents_13.EVENT_SET_OPERATOR_OVERLOADING);
                            expect(lsw.operatorOverloading).toBe(true);
                        });
                    });
                ...
                describe("setTrace", function () {
                    describe("(true)", function () {
                        ...
                        it("should change the trace property from false to true", function () {
                            ...
                            var resolution = sender.resolutions[callbackId];
                            expect(resolution).toBeDefined();
                            expect(resolution.eventName).toBe(LanguageServiceEvents_15.EVENT_SET_TRACE);
                ...
                describe("ensureScript", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        var resolution = sender.resolutions[callbackId];
                        expect(resolution).toBeDefined();
                        expect(resolution.eventName).toBe(LanguageServiceEvents_3.EVENT_ENSURE_SCRIPT);
                    });
                });
                describe("getOutputFiles", function () {
                    ...
                    it("should acknowledge", function () {
                        ...
                        expect(resolution1.eventName).toBe(LanguageServiceEvents_3.EVENT_ENSURE_SCRIPT);
                        var two = Math.random();
                        proxy.getOutputFiles('index.ts', two);
                        var resolution2 = sender.resolutions[two];
                        expect(resolution2).toBeDefined();
                        expect(resolution2.eventName).toBe(LanguageServiceEvents_7.EVENT_GET_OUTPUT_FILES);
