...
export type RuleArgumentType = boolean | number | string | object | string[];

export interface IOptions {
    /**
     * First argument must be a boolean and is the enabled flag.
     * In the general case, the remaining arguments can be other than string.
     */
    ruleArguments: RuleArgumentType[];
    ruleName: string;
