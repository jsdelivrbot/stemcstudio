const errorsMap: { [code: string]: string } = {
    // JSHint options
    E001: "Bad option: '{a}'.",
...
const warningsMap: { [code: string]: string } = {
...
const infoMap: { [code: string]: string } = {
...
export const errors: { [code: string]: CodeAndDesc } = {};
export const warnings: { [code: string]: CodeAndDesc } = {};
export const info: { [code: string]: CodeAndDesc } = {};

function each(data: { [code: string]: string }, callback: (desc: string, code: string) => void) {
...
each(errorsMap, function (desc: string, code: string) {
    errors[code] = { code, desc };
});

each(warningsMap, function (desc: string, code: string) {
    warnings[code] = { code, desc };
});

each(infoMap, function (desc: string, code: string) {
    info[code] = { code, desc };
});
