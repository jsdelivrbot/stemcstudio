System.register(["./src/mode/ClojureWorker", "./src/mode/ExampleWorker", "./src/mode/GlslWorker", "./src/mode/HtmlWorker", "./src/mode/JavaScriptWorker", "./src/mode/JsonWorker", "./src/mode/TypeScriptWorker", "./src/mode/LanguageServiceWorker", "./src/lib/Sender"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var ClojureWorker_1, ExampleWorker_1, GlslWorker_1, HtmlWorker_1, JavaScriptWorker_1, JsonWorker_1, TypeScriptWorker_1, LanguageServiceWorker_1, Sender_1, main;
    return {
        setters: [
        ...
        execute: function () {
            main = {
                get ClojureWorker() { return ClojureWorker_1.default; },
