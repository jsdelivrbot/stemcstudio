...
import { IDisabledInterval, IRuleMetadata, RuleFailure } from '../language/rule/rule';
...
class NoConsecutiveBlankLinesWalker extends RuleWalker {
    ...
    private getTemplateIntervals(sourceFile: ts.SourceFile): IDisabledInterval[] {
        const intervals: IDisabledInterval[] = [];
