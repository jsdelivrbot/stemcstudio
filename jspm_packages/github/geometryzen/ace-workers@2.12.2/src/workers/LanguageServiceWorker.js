        ...
        execute: function () {
            LanguageServiceWorker = (function () {
                function LanguageServiceWorker(sender) {
                    ...
                    this.sender = sender;
                    this.trace = false;
                    this.pyLanguageServiceHost = new DefaultLanguageServiceHost_1.DefaultLanguageServiceHost();
                    this.tsLanguageServiceHost = new DefaultLanguageServiceHost_1.DefaultLanguageServiceHost();
                    this.dispatcher = new LanguageServiceDispatcher_1.LanguageServiceDispatcher(this.pyLanguageServiceHost, this.tsLanguageServiceHost);
                    ...
                    sender.on(LanguageServiceEvents_14.EVENT_SET_MODULE_KIND, function (message) {
                        ...
                        try {
                            ...
                            _this.tsLanguageServiceHost.moduleKind = moduleKind;
                            _this.resolve(LanguageServiceEvents_14.EVENT_SET_MODULE_KIND, _this.tsLanguageServiceHost.moduleKind, callbackId);
                        }
                        catch (reason) {
                    ...
                    sender.on(LanguageServiceEvents_16.EVENT_SET_SCRIPT_TARGET, function (message) {
                        ...
                        try {
                            ...
                            _this.tsLanguageServiceHost.scriptTarget = scriptTarget;
                            _this.resolve(LanguageServiceEvents_16.EVENT_SET_SCRIPT_TARGET, _this.tsLanguageServiceHost.scriptTarget, callbackId);
                        }
                        catch (reason) {
