System.register(["./EventEmitter", "./vars", "./messages", "./lex", "./reg", "./state", "./style", "./options", "./scope-manager", "../../fp/contains", "../../fp/clone", "../../fp/each", "../../fp/extend", "../../fp/has", "../../fp/isEmpty", "../../fp/isNumber", "../../fp/reject", "../../fp/zip"], function (exports_1, context_1) {
    "use strict";
    ...
    function combine(dest, src) {
        Object.keys(src).forEach(function (name) {
            if (has_1.has(JSHINT.blacklist, name))
                return;
            dest[name] = src[name];
        });
    }
    ...
    function removeIgnoredMessages() {
        ...
        JSHINT.errors = reject_1.reject(errors, function excluder(err) { return ignored[err.line]; });
    }
    ...
    var EventEmitter_1, vars_1, messages_1, lex_1, reg_1, state_1, style_1, options_1, scope_manager_1, contains_1, clone_1, each_1, extend_1, has_1, isEmpty_1, isNumber_1, reject_1, zip_1, api, bang, declared, functionicity, functions, inblock, indent, lookahead, lex, member, membersOnly, predefined, stack, urls, extraModules, emitter, typeofValues, baseTemplateSyntax, orPrecendence, lookupBlockType, conststatement, letstatement, varstatement, arrayComprehension, escapeRegex, JSHINT;
    return {
        setters: [
        ...
        execute: function () {
            ...
            conststatement = stmt("const", function (context) {
                return blockVariableStatement("const", this, context);
            });
            conststatement.exps = true;
            letstatement = stmt("let", function (context) {
                return blockVariableStatement("let", this, context);
            });
            letstatement.exps = true;
            varstatement = stmt("var", function (context) {
                var prefix = context && context.prefix;
                var inexport = context && context.inexport;
            ...
            exports_1("JSHINT", JSHINT = function lint(s, o, g) {
                o = clone_1.clone(o);
                state_1.state.reset();
                if (o && o.scope) {
            ...
            JSHINT.addModule(style_1.register);
