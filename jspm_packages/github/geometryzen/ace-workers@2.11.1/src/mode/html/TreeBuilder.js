System.register(["./constants", "./CharacterBuffer", "./ElementStack", "./formatMessage", "./getAttribute", "./isWhitespace", "./isAllWhitespace", "./isAllWhitespaceOrReplacementCharacters", "./messages", "./StackItem", "./Tokenizer"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var constants_1, CharacterBuffer_1, ElementStack_1, formatMessage_1, getAttribute_1, isWhitespace_1, isAllWhitespace_1, isAllWhitespaceOrReplacementCharacters_1, messages_1, StackItem_1, Tokenizer_1, Marker, TreeBuilder;
    return {
        setters: [
        ...
        execute: function () {
            ...
            TreeBuilder = (function () {
                function TreeBuilder() {
                    ...
                    this.head = null;
                    this.form = null;
                    this.openElements = new ElementStack_1.ElementStack();
                    ...
                    modes.afterAfterBody.processCharacters = function (data) {
                        if (!isAllWhitespace_1.isAllWhitespace(data.characters)) {
                    ...
                    modes.inHead.startTagScript = function (name, attributes) {
                        tree.insertElement(name, attributes);
                        tree.tokenizer.setState(Tokenizer_1.Tokenizer.SCRIPT_DATA);
                    ...
                    modes.inBody.processCharacters = function (buffer) {
                        ...
                        if (tree.framesetOk && !isAllWhitespaceOrReplacementCharacters_1.isAllWhitespaceOrReplacementCharacters(characters))
                            tree.framesetOk = false;
                    };
                    ...
                    modes.inBody.startTagPlaintext = function (name, attributes) {
                        if (tree.openElements.inButtonScope('p'))
                            this.endTagP('p');
                        tree.insertElement(name, attributes);
                        tree.tokenizer.setState(Tokenizer_1.Tokenizer.PLAINTEXT);
                    };
                    ...
                    modes.inBody.startTagIsindex = function (name, attributes) {
                        ...
                        this.processCharacters(new CharacterBuffer_1.CharacterBuffer(prompt));
                    ...
                    modes.inBody.startTagTextarea = function (name, attributes) {
                        tree.insertElement(name, attributes);
                        tree.tokenizer.setState(Tokenizer_1.Tokenizer.RCDATA);
                        tree.originalInsertionMode = tree.insertionModeName;
                        tree.shouldSkipLeadingNewline = true;
                        tree.framesetOk = false;
                        tree.setInsertionMode('text');
                    ...
                    modes.inTableText.flushCharacters = function () {
                        ...
                        if (!isAllWhitespace_1.isAllWhitespace(characters)) {
                            tree.redirectAttachToFosterParent = true;
                            tree.reconstructActiveFormattingElements();
                            tree.insertText(characters);
                            tree.framesetOk = false;
                ...
                TreeBuilder.prototype.adoptionAgencyEndTag = function (name) {
                    ...
                    while (outerLoopCounter++ < outerIterationLimit) {
                        ...
                        while (innerLoopCounter++ < innerIterationLimit) {
                            ...
                            var clone_1 = this.createElement(node.namespaceURI, node.localName, node.attributes);
                            var newNode = new StackItem_1.StackItem(node.namespaceURI, node.localName, node.attributes, clone_1);
                        ...
                        var formattingClone = new StackItem_1.StackItem(formattingElement.namespaceURI, formattingElement.localName, formattingElement.attributes, clone);
                ...
                TreeBuilder.prototype.startTokenization = function (tokenizer) {
                    ...
                    if (this.context) {
                        switch (this.context) {
                            case 'title':
                            case 'textarea':
                                this.tokenizer.setState(Tokenizer_1.Tokenizer.RCDATA);
                                break;
                            case 'style':
                            case 'xmp':
                            case 'iframe':
                            case 'noembed':
                            case 'noframes':
                                this.tokenizer.setState(Tokenizer_1.Tokenizer.RAWTEXT);
                                break;
                            case 'script':
                                this.tokenizer.setState(Tokenizer_1.Tokenizer.SCRIPT_DATA);
                                break;
                            case 'noscript':
                                ...
                                break;
                            case 'plaintext':
                                this.tokenizer.setState(Tokenizer_1.Tokenizer.PLAINTEXT);
                                break;
                        }
                ...
                TreeBuilder.prototype.processToken = function (token) {
                    ...
                    switch (token.type) {
                        case 'Characters':
                            var buffer = new CharacterBuffer_1.CharacterBuffer(token.data);
                ...
                TreeBuilder.prototype.insertHtmlElement = function (attributes) {
                    ...
                    this.openElements.pushHtmlElement(new StackItem_1.StackItem("http://www.w3.org/1999/xhtml", 'html', attributes, root));
                    return root;
                };
                TreeBuilder.prototype.insertHeadElement = function (attributes) {
                    ...
                    this.head = new StackItem_1.StackItem("http://www.w3.org/1999/xhtml", "head", attributes, element);
                ...
                TreeBuilder.prototype.insertBodyElement = function (attributes) {
                    ...
                    this.attachNode(element, this.openElements.top.node);
                    this.openElements.pushBodyElement(new StackItem_1.StackItem("http://www.w3.org/1999/xhtml", "body", attributes, element));
                    return element;
                };
                ...
                TreeBuilder.prototype.insertElement = function (name, attributes, namespaceURI, selfClosing) {
                    ...
                    if (this.shouldFosterParent())
                        ...
                        this.attachNode(element, this.openElements.top.node);
                    if (!selfClosing)
                        this.openElements.push(new StackItem_1.StackItem(namespaceURI, name, attributes, element));
                };
                ...
                TreeBuilder.prototype.ensureNoahsArkCondition = function (item) {
                    ...
                    for (var i = 0; i < attributes.length; i++) {
                        ...
                        for (var j = 0; j < candidates.length; j++) {
                            ...
                            var candidateAttribute = getAttribute_1.getAttribute(candidate, attribute.nodeName);
                ...
                TreeBuilder.prototype.parseError = function (code, args) {
                    if (!this.errorHandler)
                        return;
                    var message = formatMessage_1.formatMessage(messages_1.messages[code], args);
                ...
                TreeBuilder.prototype.resetInsertionMode = function () {
                    ...
                    for (var i = this.openElements.length - 1; i >= 0; i--) {
                        ...
                        if (i === 0) {
                            last = true;
                            node = new StackItem_1.StackItem("http://www.w3.org/1999/xhtml", this.context, [], null);
                        }
            ...
            exports_1("TreeBuilder", TreeBuilder);
        }
    };
});
