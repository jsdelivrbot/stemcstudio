        ...
        execute: function () {
            ...
            Document = (function () {
                ...
                Document.prototype.setValue = function (text) {
                    ...
                    this.remove(new Range_1.Range(0, 0, len, this.getLine(len).length));
                ...
                Document.prototype.removeFullLines = function (firstRow, lastRow) {
                    ...
                    var range = new Range_1.Range(startRow, startCol, endRow, endCol);
                ...
                Document.prototype.applyDelta = function (delta, doNotValidate) {
                    ...
                    if (isInsert ? delta.lines.length <= 1 && !delta.lines[0]
                        : !Range_1.Range.comparePoints(delta.start, delta.end)) {
                        return;
                    }
