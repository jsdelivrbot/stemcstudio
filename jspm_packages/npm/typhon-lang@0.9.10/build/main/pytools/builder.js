...
function astForUnaryExpr(c, n) {
  ...
  switch (tree_1.CHILD(n, 0).type) {
    case Tokens_1.Tokens.T_PLUS:
      return new types_81.UnaryOp(types_80.UAdd, expression, n.range);
    case Tokens_1.Tokens.T_MINUS:
      return new types_81.UnaryOp(types_82.USub, expression, n.range);
    case Tokens_1.Tokens.T_TILDE:
      return new types_81.UnaryOp(types_46.Invert, expression, n.range);
  }
