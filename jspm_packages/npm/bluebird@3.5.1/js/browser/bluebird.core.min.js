    ...
    return function r(t, e, n) {
        ...
        e.exports = function(e, n) {
          ...
          function o(t, e, n) {
            ...
            try {
              t(e, n, function(t) {
                if ("function" != typeof t)
                  throw new TypeError("onCancel must be a function, got: " + I.toString(t));
          ...
          e.longStackTraces = function() {
            if (B.haveItemsQueued() && !ot.longStackTraces)
      ...
      11: [function(t, e, n) {
        ...
        e.exports = function(e, n, r) {
          ...
          return i.prototype.isFinallyHandler = function() {
            ...
            if (1 === n)
              return this._passThrough(t, 1, void 0, l);
            var r,
                i = new Array(n - 1),
                o = 0;
            for (r = 0; n - 1 > r; ++r) {
              var a = arguments[r];
              if (!u.isObject(a))
                return e.reject(new TypeError("tapCatch statement predicate: expecting an object but got " + u.classString(a)));
              i[o++] = a;
            }
            i.length = o;
            var s = arguments[r];
      ...
      15: [function(t, e, n) {
        ...
        e.exports = function() {
          ...
          return i.prototype.toString = function() {
            ...
            if (e > 1) {
              ...
              for (n = 0; e - 1 > n; ++n) {
                var o = arguments[n];
                if (!h.isObject(o))
                  return p("Catch statement predicate: expecting an object but got " + h.classString(o));
                r[i++] = o;
              }
            ...
            if ("function" != typeof t)
              throw new g("expecting a function but got " + h.classString(t));
            ...
            if (o >= 65531 && (o = 0, this._setLength(0)), 0 === o)
              this._promise0 = n, this._receiver0 = r, "function" == typeof t && (this._fulfillmentHandler0 = null === i ? t : h.domainBind(i, t)), "function" == typeof e && (this._rejectionHandler0 = null === i ? e : h.domainBind(i, e));
            else {
              var a = 4 * o - 4;
            ...
            var e = this._bitField;
            if (!((117506048 & e) >>> 16))
              return this._setRejected(), this._fulfillmentHandler0 = t, this._isFinal() ? v.fatalError(t, h.isNode) : void((65535 & e) > 0 ? v.settlePromises(this) : this._ensurePossibleRejectionHandled());
          ...
          }, h.notEnumerableProp(i, "_makeSelfResolutionError", l), t("./method")(i, b, E, p, F), t("./bind")(i, b, E, F), t("./cancel")(i, k, p, F), t("./direct_resolve")(i), t("./synchronous_inspection")(i), t("./join")(i, k, E, b, v, c), i.Promise = i, i.version = "3.5.1", h.toFastProperties(i), h.toFastProperties(i.prototype), s({a: 1}), s({b: 2}), s({c: 3}), s(1), s(function() {}), s(void 0), s(!1), s(new i(b)), F.setBounds(d.firstLineError, h.lastLineError), i;
        };
      }, {
        "./async": 1,
        "./bind": 2,
        ...
        e.exports = function(e, n, r, i, o) {
          ...
          return c.inherits(s, o), s.prototype.length = function() {
            ...
            if (o instanceof e) {
              o = o._target();
              var s = o._bitField;
              if (this._values = o, 0 === (50397184 & s))
      ...
      21: [function(t, e, n) {
        ...
        if ("undefined" != typeof Symbol && Symbol.iterator) {
          var U = "function" == typeof Array.from ? function(t) {
            ...
            for (var e,
                n = [],
                r = t[Symbol.iterator](); !(e = r.next()).done; )
              n.push(e.value);
            return n;
          };
          B = function(t) {
