...
(function(process) {
  !function(t, e) {
    ...
    return function(t) {
      ...
      t.exports = e = n;
      var h = e.managers = {};
      e.protocol = a.protocol, e.connect = n, e.Manager = r(17), e.Socket = r(45);
    }, function(t, e, r) {
      (function(e) {
        "use strict";
        function n(t, r) {
      ...
      e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = n, e.Decoder = s, n.prototype.encode = function(t, r) {
        if (p("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type)
          i(t, r);
        else {
          var n = o(t);
          r([n]);
        ...
        var r;
        if ("string" == typeof t)
          r = a(t), e.BINARY_EVENT == r.type || e.BINARY_ACK == r.type ? (this.reconstructor = new u(r), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", r)) : this.emit("decoded", r);
        else {
          if (!y(t) && !t.base64)
      ...
      (function(t, r) {
        ...
        (function() {
                    ...
                    D = function(t, e, r, n, o, i, s) {
                      ...
                      if ("object" == typeof a && a)
                        if (c = v.call(a), c != k || d.call(a, "toJSON"))
                          "function" == typeof a.toJSON && (c != A && c != x && c != B || d.call(a, "toJSON")) && (a = a.toJSON(t));
                        else if (a > -1 / 0 && a < 1 / 0) {
                          if (_) {
                            ...
                            u = a.getUTCFullYear(), h = a.getUTCMonth(), f = a.getUTCDate(), m = a.getUTCHours(), b = a.getUTCMinutes(), w = a.getUTCSeconds(), S = a.getUTCMilliseconds();
                          a = (u <= 0 || u >= 1e4 ? (u < 0 ? "-" : "+") + O(6, u < 0 ? -u : u) : O(4, u)) + "-" + O(2, h + 1) + "-" + O(2, f) + "T" + O(2, m) + ":" + O(2, b) + ":" + O(2, w) + "." + O(3, S) + "Z";
                        } else
                          a = null;
                      if (r && (a = r.call(e, t, a)), null === a)
                        return "null";
                      if (c = v.call(a), c == C)
                        return "" + a;
                      if (c == A)
                ...
                e.stringify = function(t, e, r) {
                  ...
                  if (s[typeof e] && e)
                    if ((a = v.call(e)) == w)
                      ...
                      for (var c,
                          u = 0,
                          h = e.length; u < h; c = e[u++], a = v.call(c), (a == x || a == A) && (i[c] = 1))
                        ;
                    }
                  if (r)
                    if ((a = v.call(r)) == A) {
                      ...
                      a == x && (n = r.length <= 10 ? r : r.slice(0, 10));
                ...
                var q,
                            ...
                            for (t = "@", q++; q < s; )
                              if (o = i.charCodeAt(q), o < 32)
                                ...
                                switch (o = i.charCodeAt(++q)) {
                                  ...
                                  case 117:
                                    for (e = ++q, r = q + 4; q < r; q++)
                                      o = i.charCodeAt(q), o >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || I();
                                    t += M("0x" + i.slice(e, q));
                                    break;
                                  default:
                                    I();
                                ...
                                if (34 == o)
                                  break;
                                for (o = i.charCodeAt(q), e = q; o >= 32 && 92 != o && 34 != o; )
                                  o = i.charCodeAt(++q);
                                t += i.slice(e, q);
                              }
                    ...
                    z = function(t) {
                      ...
                      if ("$" == t && I(), "string" == typeof t) {
                        ...
                        if ("{" == t) {
                          for (e = {}; t = H(), "}" != t; r || (r = !0))
                            r && ("," == t ? (t = H(), "}" == t && I()) : I()), "," != t && "string" == typeof t && "@" == (S ? t.charAt(0) : t[0]) && ":" == H() || I(), e[t.slice(1)] = z(H());
                          return e;
                        }
                        I();
                      }
          ...
          if (!u || u.global !== u && u.window !== u && u.self !== u || (c = u), a && !i)
            o(c, a);
          else {
            var h = c.JSON,
                p = c.JSON3,
            ...
            p || (a('probe transport "%s" opened', t), h.send([{
              ...
              if (!p)
                if ("pong" === e.type && "probe" === e.data) {
                  if (a('probe transport "%s" pong', t), f.upgrading = !0, f.emit("upgrading", h), !h)
                    return;
          ...
          try {
            ...
            if ("application/octet-stream" === e)
              ...
              try {
                ...
                for (var r = new Uint8Array(this.xhr.response),
                    n = [],
                    o = 0,
                    i = r.length; o < i; o++)
                  n.push(r[o]);
      ...
      (function(t) {
        ...
        e.encodePacket = function(e, r, i, a) {
          ...
          try {
            ...
            for (var a = new Uint8Array(r.data),
          ...
          for (var i,
            ...
            if (":" != h)
              ...
              if (s = t.substr(c + 1, i), a != s.length)
                return n(w, 0, 1);
              if (s.length) {
                if (o = e.decodePacket(s, r, !0), w.type == o.type && w.data == o.data)
                  return n(w, 0, 1);
                var p = n(o, c + i, u);
                if (!1 === p)
                  return;
          ...
          return t.length ? void c(t, n, function(t, e) {
            ...
            return e.forEach(function(t) {
              ...
              e ? o[i++] = 0 : o[i++] = 1;
              for (var a = r.byteLength.toString(),
                  s = 0; s < a.length; s++)
                o[i++] = parseInt(a[s]);
              o[i++] = 255;
              for (var n = new Uint8Array(r),
                  s = 0; s < n.length; s++)
                o[i++] = n[s];
            }), r(o.buffer);
          }) : r(new ArrayBuffer(0));
          ...
          function n(t, r) {
            e.encodePacket(t, !0, !0, function(t) {
              ...
              for (var i = t instanceof ArrayBuffer ? t.byteLength : t.size,
                  s = i.toString(),
      ...
      (function(e) {
        function n(t) {
          function r(t) {
            if (!t)
              return !1;
            if (e.Buffer && e.Buffer.isBuffer(t) || e.ArrayBuffer && t instanceof ArrayBuffer || e.Blob && t instanceof Blob || e.File && t instanceof File)
              return !0;
            if (o(t)) {
      ...
      t.exports = function(t, e, r) {
        ...
        for (var o = new Uint8Array(t),
            i = new Uint8Array(r - e),
            s = e,
            a = 0; s < r; s++, a++)
          i[a] = o[s];
        return i.buffer;
      ...
      (function(t, o) {
        !function(i) {
          ...
          function f() {
            ...
            if (224 == (240 & t)) {
              if (e = p(), r = p(), o = (15 & t) << 12 | e << 6 | r, o >= 2048)
                return o;
              throw Error("Invalid continuation byte");
            }
            if (240 == (248 & t) && (e = p(), r = p(), n = p(), o = (15 & t) << 18 | e << 12 | r << 6 | n, o >= 65536 && o <= 1114111))
              return o;
