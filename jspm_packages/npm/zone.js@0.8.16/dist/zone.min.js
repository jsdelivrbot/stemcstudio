...
(function(process) {
  !function(e, t) {
    ...
    function u(e, t, n) {
      function r(t, n) {
        ...
        var b,
            ...
            D = m[w(i)] = m[i],
            Z = m[w(c)] = m[c];
        n && n.prependEventListenerFnName && (b = m[w(n.prependEventListenerFnName)] = m[n.prependEventListenerFnName]);
        var O = function(e) {
          if (!_.isExisting)
            return T.apply(_.target, [_.eventName, _.capture ? g : v, _.options]);
        },
            S = function(e) {
              if (!e.isRemoved) {
                var t = I[e.eventName],
              ...
              if (e.allRemoved)
                return E.apply(e.target, [e.eventName, e.capture ? g : v, e.options]);
            },
            z = function(e) {
              return T.apply(_.target, [_.eventName, e.invoke, _.options]);
            },
            P = function(e) {
            ...
            X = function(e, t) {
              var n = typeof t;
              return n === R && e.callback === t || n === x && e.originalDelegate === t;
            },
            W = n && n.compareTaskCallbackVsDelegate ? n.compareTaskCallbackVsDelegate : X,
            U = function(t, n, o, a, i, s) {
              return void 0 === i && (i = !1), void 0 === s && (s = !1), function() {
                ...
                if (!d || d(t, u, c, arguments)) {
                  ...
                  var S,
                      z = c.constructor[F],
                      P = H[z];
                  P && (S = P[f]), S || (S = z + n + f), _.options = h, v && (_.options.once = !1), _.target = c, _.capture = p, _.eventName = f, _.isExisting = Z;
                  var j = r ? M : null,
                      x = k.scheduleEventTask(S, u, j, o, a);
                  return v && (h.once = !0), x.options = h, x.target = c, x.capture = p, x.eventName = f, l && (x.originalDelegate = u), s ? D.unshift(x) : D.push(x), i ? c : void 0;
                }
              };
            };
        return m[o] = U(T, p, N, A, k), b && (m[f] = U(b, h, P, A, k, !0)), m[a] = function() {
          var t,
              n = this || e,
              r = arguments[0],
              o = arguments[2];
          ...
          if (n) {
            ...
            for (var d = Object.keys(t),
              ...
              var v = d[p],
                  g = B.exec(v),
                  y = g && g[1];
              y && "removeListener" !== y && this[c].apply(this, [y]);
            }
            this[c].apply(this, ["removeListener"]);
          }
        }, s(m[o], T), s(m[a], E), Z && s(m[c], Z), D && s(m[i], D), !0;
      }
      for (var o = n && n.addEventListenerFnName || "addEventListener",
          ...
          c = n && n.removeAllFnName || "removeAllListeners",
          u = w(o),
          p = "." + o + ":",
          f = "prependListener",
          h = "." + f + ":",
    ...
    function y(e, t) {
      var n = t.WebSocket;
      t.EventTarget || u(e, t, [n.prototype]), t.WebSocket = function(e, t) {
        var o,
            a,
    ...
    function k(e, t) {
      if (!Z || S) {
        ...
        if (m()) {
          ...
          r(XMLHttpRequest.prototype, oe);
          var i = t.XMLHttpRequestEventTarget;
          i && r(i && i.prototype, oe), "undefined" != typeof IDBIndex && (r(IDBIndex.prototype, ae), r(IDBRequest.prototype, ae), r(IDBOpenDBRequest.prototype, ae), r(IDBDatabase.prototype, ae), r(IDBTransaction.prototype, ae), r(IDBCursor.prototype, ae)), n && r(WebSocket.prototype, ie);
        } else
          b(), o("XMLHttpRequest"), n && y(e, t);
      }
    }
    function m() {
      if ((O || S) && !Object.getOwnPropertyDescriptor(HTMLElement.prototype, "onclick") && "undefined" != typeof Element) {
      ...
      for (var e = function(e) {
        ...
        self.addEventListener(t, function(e) {
          ...
          for (r = o ? o.constructor.name + "." + n : "unknown." + n; o; )
            o[n] && !o[n][ce] && (t = Zone.current.wrap(o[n], r), t[ce] = o[n], o[n] = t), o = o.parentElement;
        }, !0);
      },
          t = 0; t < se.length; t++)
        e(t);
    ...
    function _(e, t) {
      ...
      for (var D = function(e, t, n, r) {
        ...
        return !0;
          ...
          g = 0; g < a.length; g++) {
        var O = e[a[g]];
        Z.push(O && O.prototype);
      }
      return u(e, Z, {validateHandler: D}), t.patchEventTarget = u, !0;
    }
    function T(e) {
      if ((O || S) && "registerElement" in e.document) {
        ...
        document.registerElement = function(e, r) {
          return r && r.prototype && n.forEach(function(e) {
            ...
            if (r.prototype.hasOwnProperty(e)) {
              ...
              n && n.value ? (n.value = Zone.current.wrap(n.value, t), h(r.prototype, e, n)) : r.prototype[e] = Zone.current.wrap(r.prototype[e], t);
            } else
    ...
    (function(e) {
      ...
      function r(t) {
        0 === j && 0 === v.length && (e[h] ? e[h].resolve(0)[d](o) : e[f](o, 0)), t && v.push(t);
      }
      function o() {
        if (!g) {
          for (g = !0; v.length; ) {
      ...
      var c = function() {
        ...
        return r.assertZonePatched = function() {
          ...
          if (!r || e.type !== Z) {
            var o = e.state != _;
            o && e._transitionTo(_, b), e.runCount++;
            var a = P;
            P = e, z = {
              parent: z,
              zone: this
            ...
            try {
              ...
              e.state !== k && e.state !== w && (e.type == Z || e.data && e.data.isPeriodic ? o && e._transitionTo(b, _) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(k, _, k))), z = z.parent, P = a;
            }
          }
          ...
          try {
            ...
            throw e._transitionTo(w, m, k), this._zoneDelegate.handleError(this, r), r;
          }
          ...
          return this.scheduleTask(new p(E, e, t, n, r, null));
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function c(e, r, o) {
        ...
        if (e[y] === b) {
          ...
          if (r !== T && o instanceof D && o.hasOwnProperty(y) && o.hasOwnProperty(k) && o[y] !== b)
            u(o), c(e, o[y], o[k]);
            ...
            e[y] = r;
            var f = e[k];
            e[k] = o, r === T && o instanceof Error && (o[h("currentTask")] = t.currentTask);
          ...
          D = function() {
            ...
            return e.toString = function() {
              ...
              var r = new this.constructor(null),
                  o = t.current;
              return this[y] == b ? this[k].push(o, r, e, n) : l(this, o, r, e, n), r;
    ...
    var w = Zone.__symbol__,
        ...
        O = !Z && !D && !("undefined" == typeof window || !window.HTMLElement),
        S = "undefined" != typeof E.process && "[object process]" === {}.toString.call(E.process) && !D && !("undefined" == typeof window || !window.HTMLElement),
    ...
    var C = "true",
        ...
        N = Object[w("defineProperty")] = Object.defineProperty,
        A = Object[w("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        X = Object.create,
        W = w("unconfigurables"),
    ...
    Zone.__load_patch("timers", function(e, t, n) {
      ...
      r && r.prototype && n.patchEventTarget(e, [r.prototype]), o("MutationObserver"), o("WebKitMutationObserver"), o("FileReader");
      ...
      function r(e) {
        ...
        function r(e) {
          ...
          var u = t.target[o];
          return u || (t.target[o] = e), f.apply(t.target, t.args), XMLHttpRequest[c] = !0, e;
        }
        function u() {}
        function l(e) {
          var t = e.data;
        ...
        var p = a(e.XMLHttpRequest.prototype, "open", function() {
          return function(e, t) {
            ...
            f = a(e.XMLHttpRequest.prototype, "send", function() {
              return function(e, n) {
                var o = t.current;
                if (e[i])
                  return f.apply(e, n);
