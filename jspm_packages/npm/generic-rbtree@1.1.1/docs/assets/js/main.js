...
(function(process) {
  !function(a, b) {
    ...
    function Fb(a, b) {
      if (b in a)
        return b;
      for (var c = b[0].toUpperCase() + b.slice(1),
          d = b,
          e = Eb.length; e--; )
        if ((b = Eb[e] + c) in a)
          return b;
    ...
    (n.fn.init = function(a, b) {
      ...
      if (!a)
        return this;
      if ("string" == typeof a) {
        if (!(c = "<" === a[0] && ">" === a[a.length - 1] && a.length >= 3 ? [null, a, null] : z.exec(a)) || !c[1] && b)
    ...
    n.extend({
      ...
      data: function(a, b) {
        ...
        return "object" == typeof a ? this.each(function() {
          ...
          var c,
              d = n.camelCase(a);
          if (f && void 0 === b) {
            if (void 0 !== (c = M.get(f, a)))
              return c;
            if (void 0 !== (c = M.get(f, d)))
              return c;
            if (void 0 !== (c = P(f, d, void 0)))
              return c;
          } else
            this.each(function() {
              var c = M.get(this, d);
      ...
      promise: function(a, b) {
        ...
        for ("string" != typeof a && (b = a, a = void 0), a = a || "fx"; g--; )
          (c = L.get(f[g], a + "queueHooks")) && c.empty && (d++, c.empty.add(h));
      ...
      trigger: function(b, c, d, e) {
        ...
        if (g = h = d = d || l, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event.triggered) && (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k = q.indexOf(":") < 0 && "on" + q, b = b[n.expando] ? b : new n.Event(q, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = r.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : n.makeArray(c, [b]), o = n.event.special[q] || {}, e || !o.trigger || !1 !== o.trigger.apply(d, c))) {
          ...
          for (f = 0; (g = p[f++]) && !b.isPropagationStopped(); )
            b.type = f > 1 ? i : o.bindType || q, m = (L.get(g, "events") || {})[b.type] && L.get(g, "handle"), m && m.apply(g, c), (m = k && g[k]) && m.apply && n.acceptData(g) && (b.result = m.apply(g, c), !1 === b.result && b.preventDefault());
        ...
        if (i[0] = a, a.delegateTarget = this, !k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
          for (h = n.event.handlers.call(this, a, j), b = 0; (f = h[b++]) && !a.isPropagationStopped(); )
            for (a.currentTarget = f.elem, c = 0; (g = f.handlers[c++]) && !a.isImmediatePropagationStopped(); )
              (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, void 0 !== (e = ((n.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = e) && (a.preventDefault(), a.stopPropagation()));
        ...
        if (l && (c = n.buildFragment(a, this[0].ownerDocument, !1, this), d = c.firstChild, 1 === c.childNodes.length && (c = d), d)) {
          ...
          if (g)
            for (i = f[f.length - 1].ownerDocument, n.map(f, lb), j = 0; g > j; j++)
              h = f[j], fb.test(h.type || "") && !L.access(h, "globalEval") && n.contains(i, h) && (h.src ? n._evalUrl && n._evalUrl(h.src) : n.globalEval(h.textContent.replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, "")));
        }
        return this;
      }
    }), n.each({
    ...
    n.fn.extend({
      ...
      attr: function(a, b, c) {
        var d,
            ...
            f = a.nodeType;
        if (a && 3 !== f && 8 !== f && 2 !== f)
          return typeof a.getAttribute === U ? n.prop(a, b, c) : (1 === f && n.isXMLDoc(a) || (b = b.toLowerCase(), d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Zb : void 0)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = n.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void n.removeAttr(a, b));
      },
      ...
      toggleClass: function(a, b) {
        ...
        return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(n.isFunction(a) ? function(c) {
          ...
          if ("string" === c)
            ...
            (c === U || "boolean" === c) && (this.className && L.set(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : L.get(this, "__className__") || "");
        });
      },
      hasClass: function(a) {
        for (var b = " " + a + " ",
    ...
    n.ajaxSetup({
      ...
      var e,
          f,
          g,
          h = !1 !== b.jsonp && (Hc.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && Hc.test(b.data) && "data");
    ...
    j.flatten = function(n, t) {
      ...
      for (var n = j.max(j.pluck(arguments, "length").concat(0)),
          t = new Array(n),
          r = 0; n > r; r++)
    ...
    j.template = function(n, t, r) {
      ...
      n.replace(u, function(t, r, e, u, o) {
        return a += n.slice(i, o).replace(/\\|'|\r|\n|\t|\u2028|\u2029/g, function(n) {
          return "\\" + B[n];
    ...
    var u = e.Events = {
      on: function(t, e, i) {
        return c(this, "on", t, [e, i]) && e ? (this._events || (this._events = {}), (this._events[t] || (this._events[t] = [])).push({
          callback: e,
          context: i,
          ctx: i || this
        }), this) : this;
          ...
          if (t = o[h], a = this._events[t]) {
            if (this._events[t] = s = [], e || r)
              for (l = 0, f = a.length; l < f; l++)
                n = a[l], (e && e !== n.callback && e !== n.callback._callback || r && r !== n.context) && s.push(n);
      ...
      stopListening: function(t, e, r) {
        ...
        for (var a in s)
          t = s[a], t.off(e, r, this), (n || i.isEmpty(t._events)) && delete this._listeningTo[a];
        return this;
      }
    },
        l = /\s+/,
    ...
    i.each(d, function(t, e) {
      u[e] = function(e, r, s) {
        return (this._listeningTo || (this._listeningTo = {}))[e._listenId || (e._listenId = i.uniqueId("l"))] = e, s || "object" != typeof r || (s = this), e[t](r, s, this), this;
      };
    ...
    i.extend(p.prototype, u, {
      ...
      set: function(t, e, r) {
        ...
        if (null == t)
          return this;
        if ("object" == typeof t ? (n = t, r = e) : (n = {})[t] = e, r || (r = {}), !this._validate(n, r))
          return !1;
        ...
        for (s in n)
          e = n[s], i.isEqual(c[s], e) || o.push(s), i.isEqual(l[s], e) ? delete this.changed[s] : this.changed[s] = e, a ? delete c[s] : c[s] = e;
        if (!h) {
      ...
      save: function(t, e, r) {
        ...
        return r.success = function(t) {
          h.attributes = o;
          var e = h.parse(t, r);
          if (r.wait && (e = i.extend(s || {}, e)), i.isObject(e) && !h.set(e, r))
            return !1;
      ...
      _validate: function(t, e) {
        ...
        return !r || (this.trigger("invalid", this, r, i.extend(e, {validationError: r})), !1);
      }
    });
    ...
    i.extend(g.prototype, u, {
      ...
      remove: function(t, e) {
        ...
        for (s = 0, n = t.length; s < n; s++)
          (o = t[s] = this.get(t[s])) && (delete this._byId[o.id], delete this._byId[o.cid], a = this.indexOf(o), this.models.splice(a, 1), this.length--, e.silent || (e.index = a, o.trigger("remove", o, this, e)), this._removeReference(o, e));
        return r ? t[0] : t;
      },
      set: function(t, e) {
        ...
        var s,
            ...
            E = !(d || !b || !x) && [];
        for (s = 0, n = t.length; s < n; s++) {
          if (h = t[s] || {}, a = h instanceof p ? o = h : h[f.prototype.idAttribute || "id"], u = this.get(a))
            x && (_[u.cid] = !0), w && (h = h === o ? o.attributes : h, e.parse && (h = u.parse(h, e)), u.set(h, e), d && !l && u.hasChanged(v) && (l = !0)), t[s] = u;
          else if (b) {
    ...
    i.extend($.prototype, u, {
      ...
      _bindRoutes: function() {
        if (this.routes) {
          ...
          for (var t,
              e = i.keys(this.routes); null != (t = e.pop()); )
            this.route(t, this.routes[t]);
        }
      },
      _routeToRegExp: function(t) {
        return t = t.replace(/[\-{}\[\]+?.,\\\^$|#\s]/g, "\\$&").replace(/\((.*?)\)/g, "(?:$1)?").replace(/(\(\?)?:\w+/g, function(t, e) {
          return e ? t : "([^/?]+)";
        }).replace(/\*\w+/g, "([^?]*?)"), new RegExp("^" + t + "(?:\\?([\\s\\S]*))?$");
      },
    ...
    N.started = !1, i.extend(N.prototype, u, {
      ...
      start: function(t) {
        ...
        N.started = !0, this.options = i.extend({root: "/"}, this.options, t), this.root = this.options.root, this._wantsHashChange = !1 !== this.options.hashChange, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.options.pushState && this.history && this.history.pushState);
        var r = this.getFragment(),
            s = document.documentMode,
            n = P.exec(navigator.userAgent.toLowerCase()) && (!s || s <= 7);
        if (this.root = ("/" + this.root + "/").replace(/^\/+|\/+$/g, "/"), n && this._wantsHashChange) {
    ...
    t.version = "0.5.3", t.utils = {}, t.utils.warn = function(t) {
      ...
      for (var e = t.toString().replace(/^\s+/, ""),
          n = e.length - 1; n >= 0; n--)
      ...
      for (var e = [],
          ...
          o = 0; n > o; o++) {
        for (var r = t[o],
            s = 0; i > s && void 0 !== (r = this._stack[s](r, o, t)); s++)
          ;
        void 0 !== r && e.push(r);
      }
      return e;
      ...
      var i = this.list;
      if (!i)
        return this.list = new t.Vector.Node(e, n, i), this.length++;
      for (var o = i,
          r = i.next; void 0 != r; ) {
        if (e < r.idx)
      ...
      for (var e = this.list,
          n = t.list,
          i = 0; e && n; )
        e.idx < n.idx ? e = e.next : e.idx > n.idx ? n = n.next : (i += e.val * n.val, e = e.next, n = n.next);
      return i;
      ...
      for (var n = new t.SortedSet,
          i = 0,
          o = 0,
          r = this.length,
          s = e.length,
          a = this.elements,
          h = e.elements; !(i > r - 1 || o > s - 1); )
        a[i] !== h[o] ? a[i] < h[o] ? i++ : a[i] > h[o] && o++ : (n.add(a[i]), i++, o++);
      return n;
      ...
      for (var n = this.documentStore.get(e),
          i = n.length,
          o = new t.Vector,
          r = 0; i > r; r++) {
        var s = n.elements[r],
      ...
      return function(n) {
        ...
        if (c = n.substr(0, 1), "y" == c && (n = c.toUpperCase() + n.substr(1)), p = /^(.+?)(ss|i)es$/, f = /^(.+?)([^s])s$/, p.test(n) ? n = n.replace(p, "$1$2") : f.test(n) && (n = n.replace(f, "$1$2")), p = /^(.+?)eed$/, f = /^(.+?)(ed|ing)$/, p.test(n)) {
          ...
          var m = f.exec(n);
          r = m[1], f = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"), f.test(r) && (n = r, f = /(at|bl|iz)$/, d = new RegExp("([^aeiouylsz])\\1$"), v = new RegExp("^" + o + i + "[^aeiouwxy]$"), f.test(n) ? n += "e" : d.test(n) ? (p = /.$/, n = n.replace(p, "")) : v.test(n) && (n += "e"));
        }
        ...
        if (p = /^(.+?)e$/, p.test(n)) {
          var m = p.exec(n);
          r = m[1], p = new RegExp(h), f = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"), d = new RegExp("^" + o + i + "[^aeiouwxy]$"), (p.test(r) || f.test(r) && !d.test(r)) && (n = r);
        }
  ...
  !function(typedoc) {
    ...
    var Application = function(_super) {
      function Application() {
        ...
        return _this.createServices(), _this.createComponents(typedoc.$body), _this;
      }
  ...
  !function(typedoc) {
    var FilterItem = function() {
      ...
      return FilterItem.prototype.initialize = function() {}, FilterItem.prototype.handleValueChange = function(oldValue, newValue) {}, FilterItem.prototype.fromLocalStorage = function(value) {
        return value;
        ...
        FilterItemSelect = function(_super) {
          ...
          return __extends(FilterItemSelect, _super), FilterItemSelect.prototype.initialize = function() {
            ...
            typedoc.$html.addClass("toggle-" + this.key + this.value), this.$select = $("#tsd-filter-" + this.key), this.$select.on(typedoc.pointerDown + " mouseover", function() {
              ...
              $(e.target).parents().addBack().is(_this.$select) || _this.$select.removeClass("active");
            });
        ...
        Filter = function(_super) {
          function Filter(options) {
            ...
            return _this.optionVisibility = new FilterItemSelect("visibility", "private"), _this.optionInherited = new FilterItemCheckbox("inherited", !0), _this.optionExternals = new FilterItemCheckbox("externals", !0), _this.optionOnlyExported = new FilterItemCheckbox("only-exported", !1), _this;
          }
  ...
  !function(typedoc) {
    var MenuHighlight = function(_super) {
      function MenuHighlight(options) {
        var _this = _super.call(this, options) || this;
        return _this.index = 0, _this.listenTo(typedoc.viewport, "resize", _this.onResize), _this.listenTo(typedoc.viewport, "scroll", _this.onScroll), _this.createAnchors(), _this;
      }
      return __extends(MenuHighlight, _super), MenuHighlight.prototype.createAnchors = function() {
        ...
        -1 != base.indexOf("#") && (base = base.substr(0, base.indexOf("#"))), this.$el.find("a").each(function(index, el) {
          ...
          if (-1 != href.indexOf("#") && href.substr(0, base.length) == base) {
            ...
            0 != $anchor.length && _this.anchors.push({
              $link: $(el.parentNode),
              $anchor: $anchor,
              position: 0
            });
        ...
        for (var anchor,
            index = 1,
            count = this.anchors.length; index < count; index++)
          anchor = this.anchors[index], anchor.position = anchor.$anchor.offset().top;
  ...
  !function(typedoc) {
    ...
    var MenuSticky = function(_super) {
      function MenuSticky(options) {
        var _this = _super.call(this, options) || this;
        return _this.state = "", _this.stickyMode = StickyMode.None, _this.$current = _this.$el.find("> ul.current"), _this.$navigation = _this.$el.parents(".menu-sticky-wrap"), _this.$container = _this.$el.parents(".row"), _this.listenTo(typedoc.viewport, "resize", _this.onResize), hasPositionSticky || _this.listenTo(typedoc.viewport, "scroll", _this.onScroll), _this.onResize(typedoc.viewport.width, typedoc.viewport.height), _this;
      }
      return __extends(MenuSticky, _super), MenuSticky.prototype.setState = function(state) {
        ...
        if (this.$navigation.height() < containerHeight) {
          ...
          if (this.$current.length) {
            ...
            this.$navigation.css("top", containerTop - currentTop + 20), currentHeight < height && (this.stickyMode = StickyMode.Current, this.stickyTop = currentTop, this.stickyBottom = bottom - elHeight + (currentTop - elTop) - 20);
          }
          elHeight < height && (this.$navigation.css("top", containerTop - elTop + 20), this.stickyMode = StickyMode.Secondary, this.stickyTop = elTop, this.stickyBottom = bottom - elHeight - 20);
        }
        hasPositionSticky ? this.stickyMode == StickyMode.Current ? this.setState("sticky-current") : this.stickyMode == StickyMode.Secondary ? this.setState("sticky") : this.setState("") : (this.$navigation.css("left", this.$navigation.offset().left), this.onScroll(typedoc.viewport.scrollTop));
      }, MenuSticky.prototype.onScroll = function(scrollTop) {
        this.stickyMode == StickyMode.Current ? scrollTop > this.stickyBottom ? this.setState("sticky-bottom") : this.setState(scrollTop + 20 > this.stickyTop ? "sticky-current" : "") : this.stickyMode == StickyMode.Secondary && (scrollTop > this.stickyBottom ? this.setState("sticky-bottom") : this.setState(scrollTop + 20 > this.stickyTop ? "sticky" : ""));
      }, MenuSticky;
    }(Backbone.View);
  ...
  !function(typedoc) {
    ...
    !function(search) {
      ...
      function loadIndex() {
        loadingState == SearchLoadingState.Idle && (setTimeout(function() {
          loadingState == SearchLoadingState.Idle && setLoadingState(SearchLoadingState.Loading);
        }, 500), void 0 !== search.data ? createIndex() : $.get($el.attr("data-index")).done(function(source) {
      ...
      function updateResults() {
        if (loadingState == SearchLoadingState.Ready) {
          $results.empty();
          for (var res = index.search(query),
              i = 0,
              c = Math.min(10, res.length); i < c; i++) {
      ...
      function setLoadingState(value) {
        loadingState != value && ($el.removeClass(SearchLoadingState[loadingState].toLowerCase()), loadingState = value, $el.addClass(SearchLoadingState[loadingState].toLowerCase()), value == SearchLoadingState.Ready && updateResults());
      }
      ...
      function setCurrentResult(dir) {
        ...
        if (0 == $current.length)
          $results.find(1 == dir ? "li:first-child" : "li:last-child").addClass("current");
        else {
      ...
      return SignatureGroup.prototype.addClass = function(className) {
        ...
        Signature = function(_super) {
          function Signature(options) {
            var _this = _super.call(this, options) || this;
            return _this.index = -1, _this.createGroups(), _this.groups && (_this.$el.addClass("active").on("touchstart", ".tsd-signature", function(event) {
              return _this.onClick(event);
            }).on("click", ".tsd-signature", function(event) {
              return _this.onClick(event);
            }), _this.$container.addClass("active"), _this.setIndex(0)), _this;
          }
  ...
  !function(typedoc) {
    var Toggle = function(_super) {
      function Toggle(options) {
        var _this = _super.call(this, options) || this;
        return _this.className = _this.$el.attr("data-toggle"), _this.$el.on(typedoc.pointerUp, function(e) {
  ...
  !function(typedoc) {
    var Viewport = function(_super) {
      function Viewport() {
        var _this = _super.call(this) || this;
        return _this.scrollTop = 0, _this.width = 0, _this.height = 0, typedoc.$window.on("scroll", _(function() {
          return _this.onScroll();
        }).throttle(10)), typedoc.$window.on("resize", _(function() {
          return _this.onResize();
        }).throttle(10)), _this.onResize(), _this.onScroll(), _this;
      }
