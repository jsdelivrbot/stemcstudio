...
(function(Buffer, process) {
  (function(global, factory) {
    ...
    var rxSubscriber = (typeof Symbol$2 === 'function' && typeof Symbol$2.for === 'function') ? Symbol$2.for('rxSubscriber') : '@@rxSubscriber';
    ...
    function combineLatest$1() {
      ...
      return function(source) {
        return source.lift.call(new ArrayObservable([source].concat(observables)), new CombineLatestOperator(project));
      };
    }
    ...
    function partition$1(predicate, thisArg) {
      return function(source) {
        return [filter$1(predicate, thisArg)(source), filter$1(not(predicate, thisArg))(source)];
      };
    }
    function partition$$1(predicate, thisArg) {
    ...
    function publish$1(selector) {
      return selector ? multicast$1(function() {
        return new Subject();
      }, selector) : multicast$1(new Subject());
    }
    function publish$$1(selector) {
    ...
    function publishBehavior$1(value) {
      return function(source) {
        return multicast$1(new BehaviorSubject(value))(source);
      };
    }
    function publishBehavior$$1(value) {
    ...
    function publishLast$1() {
      return function(source) {
        return multicast$1(new AsyncSubject())(source);
      };
    }
    function publishLast$$1() {
    ...
    function share$1() {
      return function(source) {
        return refCount()(multicast$1(shareSubjectFactory)(source));
      };
    }
    function share$$1() {
      return share$1()(this);
