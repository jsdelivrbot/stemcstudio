...
(function(process) {
  !function(e, t) {
    ...
    function o(e, t) {
      var n = "boolean" == typeof e ? e : "object" == typeof e && (e && e.capture),
          r = "boolean" == typeof t ? t : "object" == typeof t && (t && t.capture);
      return !!n == !!r;
    }
      ...
      if (i)
        for (var s = 0; s < i.length; s++) {
          var c = i[s],
              u = c.data,
              l = u.handler;
          if ((u.handler === t || l.listener === t) && o(u.options, r) && u.eventName === n)
            return a && i.splice(s, 1), c;
        }
      return null;
    }
    function i(e, t, n) {
      var r = e[M];
      r || (r = e[M] = []), n ? r.unshift(t) : r.push(t);
    }
    function s(e, t, n, r, o, s) {
      ...
      function u(e) {
        var t = e.data;
        return a(t.target, e.invoke, t.eventName, t.options, !0), t.invokeRemoveFunc(p, e);
      }
      void 0 === n && (n = !0), void 0 === r && (r = !1), void 0 === o && (o = !1), void 0 === s && (s = H);
      var l = S(e),
          p = S(t),
          h = !n && void 0;
      return function(t, n) {
        ...
        var p = !1;
        try {
          p = o.handler && "[object FunctionWrapper]" === o.handler.toString();
        } catch (f) {
          return o.crossContext = !0, o.invokeAddFunc(l, o.handler);
        }
        if (!i || p)
          return o.invokeAddFunc(l, o.handler);
        if (!r) {
          var d = a(o.target, o.handler, o.eventName, o.options, !1);
          if (d)
            return o.invokeAddFunc(l, d);
        }
        var v = Zone.current,
            g = o.target.constructor.name + "." + e + ":" + o.eventName;
        v.scheduleEventTask(g, i, o, c, u);
      };
    }
    function c(e, t, n) {
      void 0 === t && (t = !0), void 0 === n && (n = H);
      var r = S(e),
          o = !t && void 0;
      return function(e, t) {
        var i = n(e, t);
        ...
        if (!s || c)
          return i.invokeRemoveFunc(r, i.handler);
        var l = a(i.target, i.handler, i.eventName, i.options, !0);
        l ? l.zone.cancelTask(l) : i.invokeRemoveFunc(r, i.handler);
      };
    }
    function u(e, t, n, r) {
      return void 0 === t && (t = I), void 0 === n && (n = L), void 0 === r && (r = H), !(!e || !e[t]) && (p(e, t, function() {
        ...
        for (r in o)
          "XMLHttpRequest" === t && "responseBlob" === r || !function(e) {
            "function" == typeof o[e] ? z[t].prototype[e] = function() {
              ...
              set: function(n) {
                "function" == typeof n ? (this[F][e] = Zone.current.wrap(n, t + "." + e), d(this[F][e], n)) : this[F][e] = n;
              },
              get: function() {
                return this[F][e];
              }
    ...
    function v(e, t, n, r) {
      function o(t) {
        ...
        var r = t.data;
        return r.args[0] = n, r.handleId = i.apply(e, r.args), "number" == typeof r.handleId && (c[r.handleId] = t), t;
      }
      function a(e) {
        return "number" == typeof e.data.handleId && delete c[e.data.handleId], s(e.data.handleId);
      }
      var i = null,
          s = null;
      t += r, n += r;
    ...
    function g() {
      Object.defineProperty = function(e, t, n) {
        ...
        return "prototype" !== t && (n = m(e, t, n)), b(e, t, n, r);
    ...
    function y(e, t, n) {
      var r = n.configurable;
      return n = m(e, t, n), b(e, t, n, r);
    }
    function k(e, t) {
      return e && e[B] && e[B][t];
    }
    function m(e, t, n) {
      return n.configurable = !0, n.configurable || (e[B] || R(e, B, {
        writable: !0,
        value: {}
      }), e[B][t] = !0), n;
    }
    ...
    function _(e) {
      var t = [],
          n = e.wtf;
      n ? t = A.split(",").map(function(e) {
        return "HTML" + e + "Element";
      }).concat(X) : e[N] ? t.push(N) : t = X;
    ...
    function w(e) {
      if (!P || C) {
        ...
        if (E()) {
          ...
          r(XMLHttpRequest.prototype, re);
          var o = e.XMLHttpRequestEventTarget;
          o && r(o && o.prototype, re), "undefined" != typeof IDBIndex && (r(IDBIndex.prototype, oe), r(IDBRequest.prototype, oe), r(IDBOpenDBRequest.prototype, oe), r(IDBDatabase.prototype, oe), r(IDBTransaction.prototype, oe), r(IDBCursor.prototype, oe)), t && r(WebSocket.prototype, ae);
        } else
          Z(), l("XMLHttpRequest"), t && T(e);
      }
    }
    function E() {
      if ((j || C) && !Object.getOwnPropertyDescriptor(HTMLElement.prototype, "onclick") && "undefined" != typeof Element) {
      ...
      Object.defineProperty(XMLHttpRequest.prototype, "onreadystatechange", {
        ...
        configurable: !0,
        get: function() {
          return this[S("fakeonreadystatechange")];
        },
        set: function(e) {
          this[S("fakeonreadystatechange")] = e;
        }
      });
      var n = new XMLHttpRequest,
          o = function() {};
      n.onreadystatechange = o;
      var r = n[S("fakeonreadystatechange")] === o;
      ...
      for (var e = function(e) {
        ...
        self.addEventListener(t, function(e) {
          ...
          for (r = o ? o.constructor.name + "." + n : "unknown." + n; o; )
            o[n] && !o[n][se] && (t = Zone.current.wrap(o[n], r), t[se] = o[n], o[n] = t), o = o.parentElement;
        }, !0);
      },
          t = 0; t < ie.length; t++)
        e(t);
    ...
    function D(e) {
      if ((j || C) && "registerElement" in e.document) {
    ...
    (function(e) {
      ...
      function r(t) {
        0 === j && 0 === v.length && (e[f] ? e[f].resolve(0)[d](o) : e[h](o, 0)), t && v.push(t);
      }
      function o() {
        if (!g) {
          for (g = !0; v.length; ) {
      ...
      var c = function() {
        ...
        return r.assertZonePatched = function() {
          ...
          void 0 === t && (t = void 0), void 0 === n && (n = null), void 0 === r && (r = null), O = {
            parent: O,
            zone: this
          };
          try {
          ...
          void 0 === t && (t = null), void 0 === n && (n = null), void 0 === r && (r = null), O = {
            parent: O,
            zone: this
          };
          try {
          ...
          if (!r || e.type !== D) {
            ...
            try {
              ...
              e.state !== k && e.state !== w && (e.type == D || e.data && e.data.isPeriodic ? o && e._transitionTo(b, _) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(k, _, k))), O = O.parent, P = a;
            }
          }
        ...
        onCancelTask: function(e, t, n, r) {
          ...
          p = function() {
            function e(e, t, n, r, a, i) {
              this._zone = null, this.runCount = 0, this._zoneDelegates = null, this._state = "notScheduled", this.type = e, this.source = t, this.data = r, this.scheduleFn = a, this.cancelFn = i, this.callback = n;
              var s = this;
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function c(e, r, o) {
        ...
        if (e[y] === b) {
          ...
          if (r !== T && o instanceof Z && o.hasOwnProperty(y) && o.hasOwnProperty(k) && o[y] !== b)
            u(o), c(e, o[y], o[k]);
      ...
      if (D) {
        p(D);
        var z = e.fetch;
        "function" == typeof z && (e.fetch = h(z));
      }
      return Promise[t.__symbol__("uncaughtPromiseErrors")] = d, Z;
    });
    var S = function(e) {
      return "__zone_symbol__" + e;
    },
        ...
        P = !("nw" in z) && "undefined" != typeof z.process && "[object process]" === {}.toString.call(z.process),
        j = !P && !O && !("undefined" == typeof window || !window.HTMLElement),
        C = "undefined" != typeof z.process && "[object process]" === {}.toString.call(z.process) && !O && !("undefined" == typeof window || !window.HTMLElement),
        M = S("eventTasks"),
        I = "addEventListener",
          ...
          return {
            ...
            invokeAddFunc: function(e, t) {
              if (!this.crossContext)
                return t && t.invoke ? this.target[e](this.eventName, t.invoke, this.options) : this.target[e](this.eventName, t, this.options);
              try {
        ...
        F = S("originalInstance");
    Zone.__load_patch("toString", function(e, t, n) {
      var r = Function.prototype.toString;
      Function.prototype.toString = function() {
        if ("function" == typeof this) {
          var t = this[S("OriginalDelegate")];
          if (t)
            return "function" == typeof t ? r.apply(this[S("OriginalDelegate")], arguments) : Object.prototype.toString.call(t);
          if (this === Promise) {
            var n = e[S("Promise")];
            if (n)
    ...
    var R = Object[S("defineProperty")] = Object.defineProperty,
        x = Object[S("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        q = Object.create,
        B = S("unconfigurables"),
        A = "Anchor,Area,Audio,BR,Base,BaseFont,Body,Button,Canvas,Content,DList,Directory,Div,Embed,FieldSet,Font,Form,Frame,FrameSet,HR,Head,Heading,Html,IFrame,Image,Input,Keygen,LI,Label,Legend,Link,Map,Marquee,Media,Menu,Meta,Meter,Mod,OList,Object,OptGroup,Option,Output,Paragraph,Pre,Progress,Quote,Script,Select,Source,Span,Style,TableCaption,TableCell,TableCol,Table,TableRow,TableSection,TextArea,Title,Track,UList,Unknown,Video",
        ...
        U = ["afterscriptexecute", "beforescriptexecute", "DOMContentLoaded", "fullscreenchange", "mozfullscreenchange", "webkitfullscreenchange", "msfullscreenchange", "fullscreenerror", "mozfullscreenerror", "webkitfullscreenerror", "msfullscreenerror", "readystatechange"],
        ...
        $ = ["toggle"],
        ee = ["load"],
        te = ["blur", "error", "focus", "load", "resize", "scroll"],
        ...
        ie = W.concat(Q, Y, $, U, G, V, J),
        se = S("unbound");
    Zone.__load_patch("timers", function(e, t, n) {
      var r = "set",
          o = "clear";
      v(e, r, o, "Timeout"), v(e, r, o, "Interval"), v(e, r, o, "Immediate"), v(e, "request", "cancel", "AnimationFrame"), v(e, "mozRequest", "mozCancel", "AnimationFrame"), v(e, "webkitRequest", "webkitCancel", "AnimationFrame");
    }), Zone.__load_patch("blocking", function(e, t, n) {
      for (var r = ["alert", "prompt", "confirm"],
          o = 0; o < r.length; o++) {
        var a = r[o];
        p(e, a, function(n, r, o) {
          return function(r, a) {
      ...
      r && r.prototype && u(r.prototype), l("MutationObserver"), l("WebKitMutationObserver"), l("FileReader");
    }), Zone.__load_patch("on_property", function(e, t, n) {
      w(e), g(), D(e);
    }), Zone.__load_patch("canvas", function(e, t, n) {
      var r = e.HTMLCanvasElement;
      "undefined" != typeof r && r.prototype && r.prototype.toBlob && h(r.prototype, "toBlob", function(e, t) {
        return {
      ...
      function r(e) {
        ...
        function r(e) {
          ...
          var t = e.data,
              n = t.target[i],
              r = t.target[S("addEventListener")],
              a = t.target[S("removeEventListener")];
          n && a.apply(t.target, ["readystatechange", n]);
          var c = t.target[i] = function() {
            t.target.readyState === t.target.DONE && !t.aborted && XMLHttpRequest[s] && "scheduled" === e.state && e.invoke();
          };
          r.apply(t.target, ["readystatechange", c]);
          var u = t.target[o];
          return u || (t.target[o] = e), h.apply(t.target, t.args), XMLHttpRequest[s] = !0, e;
        }
        function c() {}
        function u(e) {
          var t = e.data;
        ...
        var l = p(e.XMLHttpRequest.prototype, "open", function() {
          return function(e, t) {
            return e[a] = 0 == t[2], l.apply(e, t);
          };
        }),
            h = p(e.XMLHttpRequest.prototype, "send", function() {
              return function(e, n) {
                var o = t.current;
                if (e[a])
                  return h.apply(e, n);
                ...
                return o.scheduleMacroTask("XMLHttpRequest.send", c, i, r, u);
              };
            }),
            f = p(e.XMLHttpRequest.prototype, "abort", function(e) {
              return function(e, t) {
                var r = n(e);
      ...
      e.PromiseRejectionEvent && (t[S("unhandledPromiseRejectionHandler")] = r("unhandledrejection"), t[S("rejectionHandledHandler")] = r("rejectionhandled"));
    }), Zone.__load_patch("util", function(e, t, n) {
      n.patchEventTargetMethods = u, n.patchOnProperties = r, n.patchMethod = p;
    });
  });
})(require('process'));
