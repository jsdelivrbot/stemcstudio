...
(function(process) {
  (function(B) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = B() : "function" === typeof define && define.amd ? define([], B) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).Rx = B();
  })(function() {
    return function a(b, f, h) {
      function k(e, d) {
        if (!f[e]) {
          ...
          c = f[e] = {exports: {}};
          b[e][0].call(c.exports, function(a) {
            var c = b[e][1][a];
            return k(c ? c : a);
          }, c, c.exports, a, b, f, h);
        }
      ...
      2: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          g.prototype._subscribe = function(e) {
            var d = a.prototype._subscribe.call(this, e);
            d && !d.closed && e.next(this._value);
            return d;
          };
      ...
      5: [function(a, b, f) {
        ...
        a = function() {
          ...
          a.prototype.subscribe = function(a, d, c) {
            var m = this.operator;
            a = k.toSubscriber(a, d, c);
          ...
          a.prototype.forEach = function(a, d) {
            var c = this;
            d || (h.root.Rx && h.root.Rx.config && h.root.Rx.config.Promise ? d = h.root.Rx.config.Promise : h.root.Promise && (d = h.root.Promise));
            if (!d)
              throw Error("no Promise impl found");
            return new d(function(d, n) {
              var g = c.subscribe(function(c) {
                if (g)
                  try {
                    a(c);
                  } catch (d) {
      ...
      7: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(b, a);
          b.prototype.notifyNext = function(a, e, d, c, m) {
      ...
      8: [function(a, b, f) {
        ...
        a = function(a) {
          function d(c, d, n) {
            ...
            this._windowTime = 1 > d ? 1 : d;
          }
          h(d, a);
          d.prototype.next = function(c) {
            var d = this._getNow();
            this._events.push(new g(d, c));
            this._trimBufferThenGetEvents();
            a.prototype.next.call(this, c);
          };
          d.prototype._subscribe = function(c) {
            var d = this._trimBufferThenGetEvents(),
                n = this.scheduler;
            n && c.add(c = new l.ObserveOnSubscriber(c, n));
            for (var n = d.length,
                g = 0; g < n && !c.closed; g++)
              c.next(d[g].value);
            return a.prototype._subscribe.call(this, c);
          };
          d.prototype._getNow = function() {
            return (this.scheduler || k.queue).now();
          };
          d.prototype._trimBufferThenGetEvents = function() {
            for (var a = this._getNow(),
                d = this._bufferSize,
                e = this._windowTime,
                g = this._events,
                b = g.length,
                f = 0; f < b && !(a - g[f].time < e); )
              f++;
            b > d && (f = Math.max(f, b - d));
            0 < f && g.splice(0, f);
            return g;
          };
          return d;
      ...
      11: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(b, a);
          b.prototype[d.$$rxSubscriber] = function() {
            return new c(this);
          };
      ...
      13: [function(a, b, f) {
        ...
        a = function(a) {
          function c(m, n, b) {
            ...
            switch (arguments.length) {
              ...
              case 1:
                ...
                if ("object" === typeof m) {
                  m instanceof c ? (this.destination = m, this.destination.add(this)) : (this.syncErrorThrowable = !0, this.destination = new e(this, m));
                  break;
                }
              default:
          ...
          h(c, a);
          c.prototype[g.$$rxSubscriber] = function() {
            return this;
          };
          c.create = function(a, d, e) {
            a = new c(a, d, e);
        ...
        var e = function(a) {
          function c(c, e, b, g) {
            ...
            var f;
            c = this;
            k.isFunction(e) ? f = e : e && (c = e, f = e.next, b = e.error, g = e.complete, k.isFunction(c.unsubscribe) && this.add(c.unsubscribe.bind(c)), c.unsubscribe = this.unsubscribe.bind(this));
            this._context = c;
            this._next = f;
            this._error = b;
            this._complete = g;
          ...
          c.prototype.next = function(a) {
            if (!this.isStopped && this._next) {
              var c = this._parent;
              c.syncErrorThrowable ? this.__tryOrSetError(c, this._next, a) && this.unsubscribe() : this.__tryOrUnsub(this._next, a);
            }
          };
          c.prototype.error = function(a) {
            if (!this.isStopped) {
              var c = this._parent;
              if (this._error)
                c.syncErrorThrowable ? this.__tryOrSetError(c, this._error, a) : this.__tryOrUnsub(this._error, a), this.unsubscribe();
              else if (c.syncErrorThrowable)
                c.syncErrorValue = a, c.syncErrorThrown = !0, this.unsubscribe();
              else
          ...
          c.prototype.__tryOrUnsub = function(a, c) {
            try {
          ...
          c.prototype.__tryOrSetError = function(a, c, d) {
            try {
          ...
          a.prototype.unsubscribe = function() {
            ...
            if (!this.closed) {
              ...
              if (l.isFunction(b)) {
                ...
                p === e.errorObject && (a = !0, (c = c || []).push(e.errorObject.e));
              }
              if (h.isArray(f))
                for (var b = -1,
                    t = f.length; ++b < t; )
                  p = f[b], k.isObject(p) && (p = g.tryCatch(p.unsubscribe).call(p), p === e.errorObject && (a = !0, c = c || [], p = e.errorObject.e, p instanceof d.UnsubscriptionError ? c = c.concat(p.errors) : c.push(p)));
              if (a)
                throw new d.UnsubscriptionError(c);
            }
          };
          a.prototype.add = function(d) {
            ...
            switch (typeof d) {
              case "function":
                e = new a(d);
              case "object":
                e.closed || "function" !== typeof e.unsubscribe || (this.closed ? e.unsubscribe() : (this._subscriptions || (this._subscriptions = [])).push(e));
                break;
              default:
                throw Error("unrecognized teardown " + d + " added to Subscription.");
            }
            return e;
          };
          a.prototype.remove = function(d) {
            if (null != d && d !== this && d !== a.EMPTY) {
              var e = this._subscriptions;
              e && (d = e.indexOf(d), -1 !== d && e.splice(d, 1));
            }
          };
          a.EMPTY = function(a) {
            a.closed = !0;
      ...
      142: [function(a, b, f) {
        var h = this && this.__extends || function(a, e) {
          ...
          a.prototype = null === e ? Object.create(e) : (d.prototype = e.prototype, new d);
        };
        b = a("../Observable");
        ...
        a = function(a) {
          ...
          e.create = function(a, c) {
            var m = a.length;
            return 0 === m ? new l.EmptyObservable : 1 === m ? new k.ScalarObservable(a[0], c) : new e(a, c);
          };
          e.dispatch = function(a) {
            var c = a.arrayLike,
                ...
                n = a.length,
                b = a.subscriber;
            b.closed || (e >= n ? b.complete() : (b.next(c[e]), a.index = e + 1, this.schedule(a)));
          };
          e.prototype._subscribe = function(a) {
            var c = this.arrayLike,
                ...
                n = c.length;
            if (m)
              return m.schedule(e.dispatch, 0, {
                arrayLike: c,
                index: 0,
                length: n,
                subscriber: a
              });
            for (m = 0; m < n && !a.closed; m++)
              a.next(c[m]);
            a.complete();
          };
          return e;
      ...
      143: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          d.of = function() {
            ...
            var n = a.length;
            return 1 < n ? new d(a, e) : 1 === n ? new k.ScalarObservable(a[0], e) : new l.EmptyObservable(e);
          };
          d.dispatch = function(a) {
            var d = a.array,
                e = a.index,
                b = a.subscriber;
            e >= a.count ? b.complete() : (b.next(d[e]), b.closed || (a.index = e + 1, this.schedule(a)));
          };
          d.prototype._subscribe = function(a) {
            var e = this.array,
                ...
                b = this.scheduler;
            if (b)
              return b.schedule(d.dispatch, 0, {
                array: e,
                index: 0,
                count: n,
                subscriber: a
              });
            for (b = 0; b < n && !a.closed; b++)
              a.next(e[b]);
            a.complete();
          };
          return d;
      ...
      144: [function(a, b, f) {
        ...
        var l = this && this.__extends || function(a, d) {
          function e() {
            this.constructor = a;
          }
          for (var b in d)
        ...
        a = function(a) {
          ...
          m.create = function(a, c, d) {
            ...
            return function() {
              for (var e = [],
                ...
                e[b - 0] = arguments[b];
              return new m(a, c, e, d);
            };
          };
          m.prototype._subscribe = function(a) {
            var c = this.callbackFunc,
                b = this.args,
                f = this.scheduler,
                l = this.subject;
            if (f)
              return f.schedule(m.dispatch, 0, {
                source: this,
                subscriber: a
              });
            l || (l = this.subject = new d.AsyncSubject, f = function u() {
              for (var a = [],
              ...
              var d = u.source,
                  c = d.selector,
                  d = d.subject;
              c ? (a = g.tryCatch(c).apply(this, a), a === e.errorObject ? d.error(e.errorObject.e) : (d.next(a), d.complete())) : (d.next(1 === a.length ? a[0] : a), d.complete());
            }, f.source = this, g.tryCatch(c).apply(this, b.concat(f)) === e.errorObject && l.error(e.errorObject.e));
          ...
          m.dispatch = function(a) {
            ...
            var b = m.callbackFunc,
                ...
                u = m.subject;
            if (!u) {
              var u = m.subject = new d.AsyncSubject,
                  A = function x() {
                    for (var a = [],
                    ...
                    var m = x.source,
                        d = m.selector,
                        m = m.subject;
                    d ? (a = g.tryCatch(d).apply(this, a), a === e.errorObject ? c.add(l.schedule(k, 0, {
                      err: e.errorObject.e,
                      subject: m
                    })) : c.add(l.schedule(h, 0, {
                      value: a,
                      subject: m
                    }))) : c.add(l.schedule(h, 0, {
              ...
              A.source = m;
              g.tryCatch(b).apply(this, f.concat(A)) === e.errorObject && u.error(e.errorObject.e);
            }
            c.add(u.subscribe(a));
          };
          return m;
      ...
      145: [function(a, b, f) {
        function h(a) {
          ...
          var f = g.callbackFunc,
              ...
              w = g.subject;
          if (!w) {
            var w = g.subject = new c.AsyncSubject,
                u = function D() {
                  for (var a = [],
                      c = 0; c < arguments.length; c++)
                    a[c - 0] = arguments[c];
                  var m = D.source,
                      ...
                      m = m.subject,
                      g = a.shift();
                  g ? m.error(g) : c ? (a = e.tryCatch(c).apply(this, a), a === d.errorObject ? b.add(t.schedule(l, 0, {
                    err: d.errorObject.e,
                    subject: m
                  })) : b.add(t.schedule(k, 0, {
                    value: a,
                    subject: m
                  }))) : b.add(t.schedule(k, 0, {
                    value: 1 === a.length ? a[0] : a,
            ...
            u.source = g;
            e.tryCatch(f).apply(this, h.concat(u)) === d.errorObject && w.error(d.errorObject.e);
          }
          b.add(w.subscribe(a));
        }
        function k(a) {
        ...
        var g = this && this.__extends || function(a, c) {
          function d() {
            this.constructor = a;
          }
          for (var e in c)
        ...
        a = function(a) {
          ...
          b.create = function(a, c, d) {
            ...
            return function() {
              for (var e = [],
                  m = 0; m < arguments.length; m++)
                e[m - 0] = arguments[m];
              return new b(a, c, e, d);
            };
          };
          b.prototype._subscribe = function(a) {
            ...
            n || (n = this.subject = new c.AsyncSubject, g = function A() {
              for (var a = [],
                  c = 0; c < arguments.length; c++)
                a[c - 0] = arguments[c];
              var m = A.source,
                  ...
                  m = m.subject,
                  b = a.shift();
              b ? m.error(b) : c ? (a = e.tryCatch(c).apply(this, a), a === d.errorObject ? m.error(d.errorObject.e) : (m.next(a), m.complete())) : (m.next(1 === a.length ? a[0] : a), m.complete());
            }, g.source = this, e.tryCatch(m).apply(this, b.concat(g)) === d.errorObject && n.error(d.errorObject.e));
            ...
            c = function(a) {
              ...
              c.prototype._unsubscribe = function() {
                ...
                if (a) {
                  this.connectable = null;
                  var c = a._refCount;
                  0 >= c ? this.connection = null : (a._refCount = c - 1, 1 < c ? this.connection = null : (c = this.connection, a = a._connection, this.connection = null, !a || c && a !== c || a.unsubscribe()));
                } else
      ...
      148: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._subscribe = function(a) {
            ...
            if (e)
              return e.schedule(b.dispatch, 0, {subscriber: a});
            a.complete();
          };
          return b;
      ...
      150: [function(a, b, f) {
        ...
        b = function(a) {
          ...
          c.create = function() {
            ...
            return 0 === a.length ? new k.EmptyObservable : new c(a, d);
          };
          c.prototype._subscribe = function(a) {
        ...
        var e = function(a) {
          ...
          c.prototype.notifyComplete = function(a) {
            var c = this.destination,
                ...
                b = this.values,
                g = b.length;
            a._hasValue ? (this.completed++, this.completed === g && (d === g && (a = e ? e.apply(this, b) : b, c.next(a)), c.complete())) : c.complete();
          };
          return c;
        }(a.OuterSubscriber);
      }, {
      ...
      151: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(c, a);
          c.create = function(a, d, e, b) {
            l.isFunction(e) && (b = e, e = void 0);
            return new c(a, d, b, e);
          };
          c.setupSubscription = function(a, d, b, g, f) {
            var l;
            if (a && "[object NodeList]" === a.toString() || a && "[object HTMLCollection]" === a.toString())
              for (var k = 0,
                  h = a.length; k < h; k++)
                c.setupSubscription(a[k], d, b, g, f);
            else
              a && "function" === typeof a.addEventListener && "function" === typeof a.removeEventListener ? (a.addEventListener(d, b, f), l = function() {
                return a.removeEventListener(d, b);
              }) : a && "function" === typeof a.on && "function" === typeof a.off ? (a.on(d, b), l = function() {
                return a.off(d, b);
              }) : a && "function" === typeof a.addListener && "function" === typeof a.removeListener && (a.addListener(d, b), l = function() {
                return a.removeListener(d, b);
              });
            g.add(new e.Subscription(l));
          };
          c.prototype._subscribe = function(a) {
            var d = this.selector;
            c.setupSubscription(this.sourceObj, this.eventName, d ? function() {
              for (var c = [],
                  e = 0; e < arguments.length; e++)
                c[e - 0] = arguments[e];
              c = k.tryCatch(d).apply(void 0, c);
              c === g.errorObject ? a.error(g.errorObject.e) : a.next(c);
            } : function(c) {
              return a.next(c);
            }, a, this.options);
          };
      ...
      152: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype._callSelector = function(a, d) {
            try {
              var c = this.selector.apply(this, d);
              a.next(c);
            } catch (m) {
              a.error(m);
            }
          };
          b.prototype._callAddHandler = function(a, d) {
            try {
              this.addHandler(a);
            } catch (c) {
              d.error(c);
      ...
      153: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.create = function(a, f) {
            if (null != a) {
              if ("function" === typeof a[r.$$observable])
                return a instanceof n.Observable && !f ? a : new b(a, f);
              if (k.isArray(a))
                return new d.ArrayObservable(a, f);
              if (l.isPromise(a))
              ...
              if (a && "number" === typeof a.length)
                return new c.ArrayLikeObservable(a, f);
            }
          ...
          b.prototype._subscribe = function(a) {
            var c = this.ish,
                d = this.scheduler;
            return null == d ? c[r.$$observable]().subscribe(a) : c[r.$$observable]().subscribe(new q.ObserveOnSubscriber(a, d, 0));
          };
          return b;
        }(n.Observable);
        f.FromObservable = a;
      ...
      154: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(e, a);
          e.create = function(a, c, m, b, g) {
            return 1 == arguments.length ? new e(a.initialState, a.condition, a.iterate, a.resultSelector || l, a.scheduler) : void 0 === b || k.isScheduler(b) ? new e(a, c, m, l, b) : new e(a, c, m, b, g);
          };
          e.prototype._subscribe = function(a) {
        ...
        var l = function(a) {
          ...
          e.prototype.tryIf = function() {
            var a = this.condition,
                ...
                b;
            try {
              (a = (b = a()) ? c : e) ? this.add(k.subscribeToResult(this, a)) : this._complete();
            } catch (g) {
              this._error(g);
            }
          };
      ...
      156: [function(a, b, f) {
        ...
        a = function(a) {
          function e(d, c) {
            ...
            this.period = d;
            this.scheduler = c;
            if (!k.isNumeric(d) || 0 > d)
              this.period = 0;
            c && "function" === typeof c.schedule || (this.scheduler = l.async);
          }
          h(e, a);
          e.create = function(a, c) {
            void 0 === a && (a = 0);
          ...
          e.dispatch = function(a) {
            var c = a.subscriber,
                e = a.period;
            c.next(a.index);
            c.closed || (a.index += 1, this.schedule(a, e));
          };
          e.prototype._subscribe = function(a) {
            var c = this.period;
            a.add(this.scheduler.schedule(e.dispatch, c, {
              index: 0,
              subscriber: a,
              period: c
            }));
      ...
      157: [function(a, b, f) {
        ...
        a = function(a) {
          function d(m, b) {
            ...
            var f;
            if ((f = m[l.$$iterator]) || "string" !== typeof m)
          ...
          d.dispatch = function(a) {
            var c = a.index,
                d = a.iterator,
                e = a.subscriber;
            a.hasError ? e.error(a.error) : (d = d.next(), d.done ? e.complete() : (e.next(d.value), a.index = c + 1, e.closed || this.schedule(a)));
          };
          d.prototype._subscribe = function(a) {
            var c = this.iterator,
                e = this.scheduler;
            if (e)
              return e.schedule(d.dispatch, 0, {
                index: 0,
                iterator: c,
                subscriber: a
              });
          ...
          return a;
            ...
            e = function() {
              function a(c, e, b) {
                void 0 === e && (e = 0);
                if (void 0 === b)
                  if (b = +c.length, isNaN(b))
                    b = 0;
                  else if (0 !== b && "number" === typeof b && k.root.isFinite(b)) {
                    var g;
                    g = +b;
      ...
      158: [function(a, b, f) {
        ...
        b = a("../Observable");
        var k = a("../observable/ConnectableObservable");
        a = function(a) {
          function b(e, d, c) {
            a.call(this);
            this.source = e;
          ...
          b.prototype._subscribe = function(a) {
            var d = this.selector,
                c = new k.ConnectableObservable(this.source, this.subjectFactory);
            a = d(c).subscribe(a);
            a.add(c.connect());
            return a;
          };
      ...
      160: [function(a, b, f) {
        function h(a) {
          var b = a.obj,
              ...
              d = a.index,
              c = a.subscriber;
          d === a.length ? c.complete() : (e = e[d], c.next([e, b[e]]), a.index = d + 1, this.schedule(a));
        }
        ...
        a = function(a) {
          ...
          d.prototype._subscribe = function(a) {
            var d = this,
                ...
                b = this.scheduler;
            if (null == b)
              this._isScalar ? a.closed || (a.next(this.value), a.complete()) : e.then(function(e) {
                d.value = e;
                d._isScalar = !0;
              ...
              e.then(function(e) {
                d.value = e;
                d._isScalar = !0;
                a.closed || a.add(b.schedule(h, 0, {
                  value: e,
                  subscriber: a
                }));
              }, function(d) {
                a.closed || a.add(b.schedule(k, 0, {
                  err: d,
                  subscriber: a
                }));
              }).then(null, function(a) {
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var e = a.start,
                d = a.index,
                c = a.subscriber;
            d >= a.count ? c.complete() : (c.next(e), c.closed || (a.index = d + 1, a.start = e + 1, this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var e = 0,
                d = this.start,
                ...
                m = this.scheduler;
            if (m)
              return m.schedule(b.dispatch, 0, {
                index: e,
                count: c,
                start: d,
                subscriber: a
      ...
      163: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.dispatch = function(a) {
            var e = a.value,
                d = a.subscriber;
            a.done ? d.complete() : (d.next(e), d.closed || (a.done = !0, this.schedule(a)));
          };
          b.prototype._subscribe = function(a) {
            var e = this.value,
                d = this.scheduler;
      ...
      165: [function(a, b, f) {
        ...
        a = function(a) {
          function c(c, b, f) {
            ...
            this.period = -1;
            this.dueTime = 0;
            k.isNumeric(b) ? this.period = 1 > Number(b) && 1 || Number(b) : g.isScheduler(b) && (f = b);
            g.isScheduler(f) || (f = l.async);
            this.scheduler = f;
            this.dueTime = e.isDate(c) ? +c - this.scheduler.now() : c;
          }
          h(c, a);
          c.create = function(a, d, e) {
            void 0 === a && (a = 0);
          ...
          c.prototype._subscribe = function(a) {
            return this.scheduler.schedule(c.dispatch, this.dueTime, {
              index: 0,
              period: this.period,
              subscriber: a
            });
      ...
      169: [function(a, b, f) {
        ...
        f.combineLatest = function() {
          for (var a = [],
            ...
            a[d - 0] = arguments[d];
          var c = d = null;
          h.isScheduler(a[a.length - 1]) && (c = a.pop());
          "function" === typeof a[a.length - 1] && (d = a.pop());
          1 === a.length && k.isArray(a[0]) && (a = a[0]);
          return (new l.ArrayObservable(a, c)).lift(new g.CombineLatestOperator(d));
        };
      }, {
        "../operator/combineLatest": 203,
        "../util/isArray": 327,
      ...
      172: [function(a, b, f) {
        ...
        var d = this && this.__extends || function(a, c) {
          function d() {
            this.constructor = a;
          }
          for (var e in c)
          ...
          function b(d) {
            ...
            var e = {
              ...
              createXHR: function() {
                var a;
                if (this.crossDomain)
                  if (c.root.XMLHttpRequest)
                    a = new c.root.XMLHttpRequest, "withCredentials" in a && (a.withCredentials = !!this.withCredentials);
                  else if (c.root.XDomainRequest)
                    a = new c.root.XDomainRequest;
                  else
                    throw Error("CORS is not supported by your browser");
                else if (c.root.XMLHttpRequest)
                  a = new c.root.XMLHttpRequest;
                else {
                  var d = void 0;
                  try {
                    for (var e = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
                      ...
                      try {
                        d = e[b];
                        new c.root.ActiveXObject(d);
                        break;
                      } catch (m) {}
                    a = new c.root.ActiveXObject(d);
                  } catch (m) {
            ...
            if ("string" === typeof d)
              ...
              for (var m in d)
                d.hasOwnProperty(m) && (e[m] = d[m]);
            this.request = e;
          }
          d(b, a);
          b.prototype._subscribe = function(a) {
            return new r(a, this.request);
          };
          b.create = function() {
            var a = function(a) {
              return new b(a);
        ...
        var r = function(a) {
          function e(d, b) {
            ...
            "Content-Type" in m || c.root.FormData && b.body instanceof c.root.FormData || "undefined" === typeof b.body || (m["Content-Type"] = "application/x-www-form-urlencoded; charset=UTF-8");
          ...
          e.prototype.next = function(a) {
            this.done = !0;
            var c = this.destination;
            a = new p(a, this.xhr, this.request);
            c.next(a);
          };
          e.prototype.send = function() {
            var a = this.request,
                ...
                l = c.headers,
                c = c.body,
                q = m.tryCatch(a.createXHR).call(a);
            if (q === n.errorObject)
              this.error(n.errorObject.e);
            else {
              this.xhr = q;
              if ((d ? m.tryCatch(q.open).call(q, e, b, g, d, f) : m.tryCatch(q.open).call(q, e, b, g)) === n.errorObject)
                return this.error(n.errorObject.e), null;
              q.timeout = a.timeout;
              q.responseType = a.responseType;
              this.setHeaders(q, l);
              this.setupEvents(q, a);
              c ? q.send(c) : q.send();
            }
            return q;
          };
          e.prototype.serializeBody = function(a, d) {
            if (!a || "string" === typeof a || c.root.FormData && a instanceof c.root.FormData)
              return a;
            if (d) {
              var e = d.indexOf(";");
            ...
            switch (d) {
              case "application/x-www-form-urlencoded":
                return Object.keys(a).map(function(c) {
                  return encodeURI(c) + "=" + encodeURI(a[c]);
                }).join("&");
          ...
          e.prototype.setHeaders = function(a, c) {
            for (var d in c)
              c.hasOwnProperty(d) && a.setRequestHeader(d, c[d]);
          };
          e.prototype.setupEvents = function(a, d) {
            var e = d.progressSubscriber;
            a.ontimeout = function y(a) {
              var c = y.subscriber,
                  d = y.progressSubscriber,
                  e = y.request;
              d && d.error(a);
              c.error(new w(this, e));
            };
            a.ontimeout.request = d;
            a.ontimeout.subscriber = this;
            a.ontimeout.progressSubscriber = e;
            a.upload && "withCredentials" in a && c.root.XDomainRequest && (e && (a.onprogress = function v(a) {
              v.progressSubscriber.next(a);
            }, a.onprogress.progressSubscriber = e), a.onerror = function v(a) {
              var c = v.progressSubscriber,
                  d = v.subscriber,
                  e = v.request;
              c && c.error(a);
              d.error(new t("ajax error", this, e));
            }, a.onerror.request = d, a.onerror.subscriber = this, a.onerror.progressSubscriber = e);
            a.onreadystatechange = function v(a) {
              var c = v.subscriber,
                  d = v.progressSubscriber,
                  e = v.request;
              if (4 === this.readyState) {
                var b = 1223 === this.status ? 204 : this.status,
                    m = "text" === this.responseType ? this.response || this.responseText : this.response;
                0 === b && (b = m ? 200 : 0);
                200 <= b && 300 > b ? (d && d.complete(), c.next(a), c.complete()) : (d && d.error(a), c.error(new t("ajax error " + b, this, e)));
              }
            };
            a.onreadystatechange.subscriber = this;
            a.onreadystatechange.progressSubscriber = e;
            a.onreadystatechange.request = d;
          };
          e.prototype.unsubscribe = function() {
            var c = this.xhr;
            !this.done && c && 4 !== c.readyState && c.abort();
        ...
        var p = function() {
          return function(a, c, d) {
            ...
            this.responseType = c.responseType || d.responseType;
            switch (this.responseType) {
              case "json":
                this.response = "response" in c ? c.responseType ? c.response : JSON.parse(c.response || c.responseText || "") : JSON.parse(c.responseText || "");
                break;
              case "xml":
                this.response = c.responseXML;
                break;
              default:
                this.response = "response" in c ? c.response : c.responseText;
            }
          };
        }();
        f.AjaxResponse = p;
        ...
        var w = function(a) {
          function c(d, e) {
            a.call(this, "ajax timeout", d, e);
          }
          d(c, a);
          return c;
        }(t);
        f.AjaxTimeoutError = w;
      }, {
        "../../Observable": 5,
        "../../Subscriber": 13,
        "../../util/errorObject": 326,
        ...
        a = function(a) {
          function b(e, m) {
            if (e instanceof g.Observable)
              ...
              a.call(this);
              this.WebSocketCtor = d.root.WebSocket;
              ...
              this.destination = new c.ReplaySubject;
            }
          }
          h(b, a);
          ...
          b.prototype.lift = function(a) {
            var c = new b(this, this.destination);
            c.operator = a;
            return c;
          };
          b.prototype.multiplex = function(a, c, d) {
            var e = this;
            return new g.Observable(function(b) {
              var g = m.tryCatch(a)();
              g === n.errorObject ? b.error(n.errorObject.e) : e.next(g);
              var f = e.subscribe(function(a) {
                var c = m.tryCatch(d)(a);
                c === n.errorObject ? b.error(n.errorObject.e) : c && b.next(a);
              }, function(a) {
                return b.error(a);
              }, function() {
                return b.complete();
          ...
          b.prototype._connectSocket = function() {
            var a = this,
                d = this.WebSocketCtor,
                b = this.protocol ? new d(this.url, this.protocol) : new d(this.url);
            this.socket = b;
            var g = new e.Subscription(function() {
              a.socket = null;
              b && 1 === b.readyState && b.close();
            }),
                f = this._output;
            b.onopen = function(d) {
              ...
              a.destination = l.Subscriber.create(function(a) {
                return 1 === b.readyState && b.send(a);
              }, function(d) {
                var e = a.closingObserver;
                e && e.next(void 0);
                d && d.code ? b.close(d.code, d.reason) : f.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));
                a.destination = new c.ReplaySubject;
                a.socket = null;
              }, function() {
                var d = a.closingObserver;
                d && d.next(void 0);
                b.close();
                a.destination = new c.ReplaySubject;
                a.socket = null;
              });
              d && d instanceof c.ReplaySubject && g.add(d.subscribe(a.destination));
            };
            b.onerror = function(a) {
              return f.error(a);
            };
            b.onclose = function(c) {
              var d = a.closeObserver;
              d && d.next(c);
              c.wasClean ? f.complete() : f.error(c);
            };
            b.onmessage = function(c) {
              c = m.tryCatch(a.resultSelector)(c);
              c === n.errorObject ? f.error(n.errorObject.e) : f.next(c);
            };
          };
          b.prototype._subscribe = function(a) {
            var c = this,
            ...
            d = new e.Subscription;
            d.add(this._output.subscribe(a));
            d.add(function() {
              var a = c.socket;
              0 === c._output.observers.length && a && 1 === a.readyState && (a.close(), c.socket = null);
            });
            return d;
          };
          b.prototype.unsubscribe = function() {
            ...
            a.prototype.unsubscribe.call(this);
            d || (this.destination = new c.ReplaySubject);
          };
          return b;
        }(k.AnonymousSubject);
      ...
      193: [function(a, b, f) {
        ...
        var e = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.durationSelector));
          };
          return a;
        }(),
            d = function(a) {
              ...
              d.prototype.notifyNext = function(a, c, d, e) {
                this.clearThrottle();
              };
      ...
      194: [function(a, b, f) {
        ...
        var k = this && this.__extends || function(a, c) {
          function e() {
            this.constructor = a;
          }
          for (var b in c)
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.duration, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
      ...
      195: [function(a, b, f) {
        ...
        var l = function() {
          function a(d) {
            this.closingNotifier = d;
          }
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.closingNotifier));
          };
          return a;
        }(),
            g = function(a) {
              function d(c, d) {
                a.call(this, c);
                this.buffer = [];
                this.add(k.subscribeToResult(this, d));
              }
              h(d, a);
              d.prototype._next = function(a) {
                this.buffer.push(a);
              };
              d.prototype.notifyNext = function(a, d, e, b, g) {
                a = this.buffer;
                this.buffer = [];
                this.destination.next(a);
              };
      ...
      196: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.bufferSize, this.startBufferEvery));
          };
          return a;
        }(),
            l = function(a) {
              ...
              e.prototype._next = function(a) {
                var c = this.count += 1,
                    ...
                    f = g.length,
                    l = -1;
                0 === c % (null == this.startBufferEvery ? b : this.startBufferEvery) && g.push([]);
                for (c = 0; c < f; c++) {
                  var k = g[c];
                  k.push(a);
                  k.length === b && (l = c, e.next(k));
                }
                -1 !== l && g.splice(l, 1);
              };
              e.prototype._complete = function() {
                for (var d = this.destination,
                    c = this.buffers; 0 < c.length; ) {
                  var e = c.shift();
                  0 < e.length && d.next(e);
                }
                a.prototype._complete.call(this);
      ...
      197: [function(a, b, f) {
        function h(a) {
          var c = a.subscriber,
              d = a.context;
          d && c.closeContext(d);
          c.closed || (a.context = c.openContext(), a.context.closeAction = this.schedule(a, a.bufferTimeSpan));
        }
        function k(a) {
          var c = a.bufferCreationInterval,
              ...
              b = a.scheduler,
              m = e.openContext();
          e.closed || (e.add(m.closeAction = b.schedule(l, d, {
            subscriber: e,
            context: m
          })), this.schedule(a, c));
        }
        ...
        var g = this && this.__extends || function(a, c) {
          ...
          a.prototype = null === c ? Object.create(c) : (d.prototype = c.prototype, new d);
            ...
            e = a("../scheduler/async");
        b = a("../Subscriber");
        var d = a("../util/isScheduler");
        f.bufferTime = function(a) {
          var b = arguments.length,
              m = e.async;
          d.isScheduler(arguments[arguments.length - 1]) && (m = arguments[arguments.length - 1], b--);
          var g = null;
          2 <= b && (g = arguments[1]);
          var n = Number.POSITIVE_INFINITY;
          3 <= b && (n = arguments[2]);
          return this.lift(new c(a, g, n, m));
        };
        var c = function() {
          function a(c, d, e, b) {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new n(a, this.bufferTimeSpan, this.bufferCreationInterval, this.maxBufferSize, this.scheduler));
          };
          return a;
        }(),
            m = function() {
            ...
            n = function(a) {
              function c(d, e, b, m, g) {
                ...
                this.contexts = [];
                d = this.openContext();
                (this.timespanOnly = null == b || 0 > b) ? this.add(d.closeAction = g.schedule(h, e, {
                  subscriber: this,
                  context: d,
                  bufferTimeSpan: e
                })) : (m = {
                  bufferTimeSpan: e,
                  bufferCreationInterval: b,
                  subscriber: this,
                  scheduler: g
                }, this.add(d.closeAction = g.schedule(l, e, {
                  subscriber: this,
                  context: d
                })), this.add(g.schedule(k, b, m)));
              }
              g(c, a);
              c.prototype._next = function(a) {
              ...
              c.prototype.onBufferFull = function(a) {
                ...
                if (this.timespanOnly) {
                  ...
                  this.add(a.closeAction = this.scheduler.schedule(h, c, {
                    subscriber: this,
                    context: a,
                    bufferTimeSpan: c
                  }));
      ...
      198: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.openings, this.closingSelector));
          };
          return a;
        }(),
            e = function(a) {
              function c(c, e, b) {
                ...
                this.contexts = [];
                this.add(l.subscribeToResult(this, e));
              }
              h(c, a);
              c.prototype._next = function(a) {
                for (var c = this.contexts,
              ...
              c.prototype.notifyNext = function(a, c, d, e, b) {
                a ? this.closeBuffer(a) : this.openBuffer(c);
              };
              c.prototype.notifyComplete = function(a) {
                this.closeBuffer(a.context);
              };
              c.prototype.openBuffer = function(a) {
                try {
              ...
              c.prototype.closeBuffer = function(a) {
                var c = this.contexts;
                if (c && a) {
                  var d = a.subscription;
                  this.destination.next(a.buffer);
              ...
              c.prototype.trySubscribe = function(a) {
                var c = this.contexts,
                    d = new k.Subscription,
                    e = {
                      buffer: [],
                      subscription: d
                    };
                ...
                !a || a.closed ? this.closeBuffer(e) : (a.context = e, this.add(a), d.add(a));
              };
              return c;
            }(a.OuterSubscriber);
      }, {
      ...
      199: [function(a, b, f) {
        ...
        var d = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new c(a, this.closingSelector));
          };
          return a;
        }(),
            c = function(a) {
              ...
              c.prototype.openBuffer = function() {
                ...
                this.buffer = [];
                var c = l.tryCatch(this.closingSelector)();
                c === g.errorObject ? this.error(g.errorObject.e) : (this.closingSubscription = a = new k.Subscription, this.add(a), this.subscribing = !0, a.add(e.subscribeToResult(this, c)), this.subscribing = !1);
              };
              return c;
            }(b.OuterSubscriber);
      }, {
      ...
      200: [function(a, b, f) {
        ...
        f.cache = function(a, b, e) {
          ...
          var d,
              ...
              f,
              q = function() {
                return d = new k.ReplaySubject(a, b, e);
              };
          return new h.Observable(function(a) {
            d || (d = q(), f = c.subscribe(function(a) {
              return d.next(a);
            }, function(a) {
              var c = d;
              d = null;
      ...
      201: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.selector, this.caught));
          };
          return a;
        }(),
            g = function(a) {
      ...
      203: [function(a, b, f) {
        ...
        f.combineLatest = function() {
          ...
          1 === a.length && l.isArray(a[0]) && (a = a[0]);
          a.unshift(this);
          return (new k.ArrayObservable(a)).lift(new d(c));
        };
        var d = function() {
          function a(c) {
            this.project = c;
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new c(a, this.project));
          };
          return a;
        }();
        f.CombineLatestOperator = d;
        var c = function(a) {
          function c(d, e) {
            a.call(this, d);
            this.project = e;
          ...
          c.prototype._complete = function() {
            ...
            if (0 === c)
              ...
              for (var d = 0; d < c; d++) {
                var e = a[d];
                this.add(g.subscribeToResult(this, e, e, d));
              }
            }
          };
          c.prototype.notifyComplete = function(a) {
          ...
          c.prototype.notifyNext = function(a, c, d, b, m) {
            a = this.values;
            b = a[d];
      ...
      204: [function(a, b, f) {
        function h() {
          for (var a = [],
            ...
            a[d - 0] = arguments[d];
          d = null;
          k.isScheduler(a[a.length - 1]) && (d = a.pop());
          return (new l.ArrayObservable(a, d)).lift(new g.MergeAllOperator(1));
        }
        var k = a("../util/isScheduler"),
      ...
      208: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.predicate, this.source));
          };
          return a;
        }(),
            l = function(a) {
      ...
      209: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.durationSelector));
          };
          return a;
        }(),
            g = function(a) {
              ...
              d.prototype._next = function(a) {
                try {
                  var d = this.durationSelector.call(this, a);
                  d && this._tryNext(a, d);
                } catch (e) {
                  this.destination.error(e);
                }
              ...
              d.prototype._tryNext = function(a, d) {
                var e = this.durationSubscription;
                this.value = a;
                this.hasValue = !0;
                e && (e.unsubscribe(), this.remove(e));
                e = k.subscribeToResult(this, d);
              ...
              d.prototype.emitValue = function() {
                if (this.hasValue) {
                  var c = this.value,
                      d = this.durationSubscription;
                  d && (this.durationSubscription = null, d.unsubscribe(), this.remove(d));
                  this.value = null;
                  this.hasValue = !1;
      ...
      210: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.dueTime, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
      ...
      211: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.defaultValue));
          };
          return a;
        }(),
            l = function(a) {
      ...
      212: [function(a, b, f) {
        ...
        f.delay = function(a, c) {
          void 0 === c && (c = k.async);
          var d = l.isDate(a) ? +a - c.now() : Math.abs(a);
          return this.lift(new e(d, c));
        };
        var e = function() {
          function a(c, d) {
            this.delay = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.delay, this.scheduler));
          };
          return a;
        }(),
            d = function(a) {
              ...
              d.dispatch = function(a) {
                for (var c = a.source,
                    d = c.queue,
                    e = a.scheduler,
                    b = a.destination; 0 < d.length && 0 >= d[0].time - e.now(); )
                  d.shift().notification.observe(b);
                0 < d.length ? (c = Math.max(0, d[0].time - e.now()), this.schedule(a, c)) : c.active = !1;
              };
              d.prototype._schedule = function(a) {
                this.active = !0;
                this.add(a.schedule(d.dispatch, this.delay, {
                  source: this,
                  destination: this.destination,
                  scheduler: a
                }));
              };
              d.prototype.scheduleNotification = function(a) {
                if (!0 !== this.errored) {
                  var d = this.scheduler;
                  a = new c(d.now() + this.delay, a);
                  this.queue.push(a);
                  !1 === this.active && this._schedule(d);
                }
              };
              d.prototype._next = function(a) {
      ...
      213: [function(a, b, f) {
        ...
        var k = a("../Observable"),
            l = a("../OuterSubscriber"),
            g = a("../util/subscribeToResult");
        f.delayWhen = function(a, d) {
          return d ? (new c(this, d)).lift(new e(a)) : this.lift(new e(a));
        };
        var e = function() {
          function a(c) {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.delayDurationSelector));
          };
          return a;
        }(),
            d = function(a) {
              ...
              c.prototype.removeSubscription = function(a) {
                ...
                var c = null;
                -1 !== a && (c = this.values[a], this.delayNotifierSubscriptions.splice(a, 1), this.values.splice(a, 1));
                return c;
              };
              c.prototype.tryDelay = function(a, c) {
                var d = g.subscribeToResult(this, a, c);
                this.add(d);
                this.delayNotifierSubscriptions.push(d);
                this.values.push(c);
              };
      ...
      215: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.compare, this.flushes));
          };
          return a;
        }(),
            g = function(a) {
              function d(c, d, b) {
                a.call(this, c);
                this.values = [];
                "function" === typeof d && (this.compare = d);
                b && this.add(k.subscribeToResult(this, b));
              }
              h(d, a);
              d.prototype.notifyNext = function(a, d, e, b, g) {
      ...
      216: [function(a, b, f) {
        ...
        f.distinctKey = function(a, b, g) {
          return h.distinct.call(this, function(e, d) {
            return b ? b(e[a], d[a]) : e[a] === d[a];
          }, g);
        };
      }, {"./distinct": 215}],
      217: [function(a, b, f) {
        ...
        var k = a("../util/tryCatch"),
            l = a("../util/errorObject");
        f.distinctUntilChanged = function(a, c) {
          return this.lift(new g(a, c));
        };
        var g = function() {
          function a(c, d) {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.compare, this.keySelector));
          };
          return a;
        }(),
            e = function(a) {
              ...
              c.prototype._next = function(a) {
                var c = a;
                if (this.keySelector && (c = k.tryCatch(this.keySelector)(a), c === l.errorObject))
                  return this.destination.error(l.errorObject.e);
                var d = !1;
                if (this.hasKey) {
                  if (d = k.tryCatch(this.compare)(this.key, c), d === l.errorObject)
                    return this.destination.error(l.errorObject.e);
                } else
                  this.hasKey = !0;
                !1 === !!d && (this.key = c, this.destination.next(a));
              };
              return c;
            }(b.Subscriber);
      }, {
      ...
      219: [function(a, b, f) {
        var h = this && this.__extends || function(a, d) {
          ...
          a.prototype = null === d ? Object.create(d) : (c.prototype = d.prototype, new c);
            ...
            k = a("../Subscriber");
        f._do = function(a, d, c) {
          return this.lift(new l(a, d, c));
        };
        var l = function() {
          function a(d, c, e) {
            this.nextOrObserver = d;
            this.error = c;
            this.complete = e;
          }
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.nextOrObserver, this.error, this.complete));
          };
          return a;
        }(),
            g = function(a) {
              function d(c, d, b, g) {
                a.call(this, c);
                c = new k.Subscriber(d, b, g);
                c.syncErrorThrowable = !0;
                this.add(c);
                this.safeSubscriber = c;
              }
              h(d, a);
              d.prototype._next = function(a) {
                var d = this.safeSubscriber;
                d.next(a);
                d.syncErrorThrown ? this.destination.error(d.syncErrorValue) : this.destination.next(a);
              };
              d.prototype._error = function(a) {
                var d = this.safeSubscriber;
                d.error(a);
                d.syncErrorThrown ? this.destination.error(d.syncErrorValue) : this.destination.error(a);
              };
              d.prototype._complete = function() {
      ...
      220: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.index, this.defaultValue));
          };
          return a;
        }(),
            g = function(a) {
      ...
      221: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.predicate, this.thisArg, this.source));
          };
          return a;
        }(),
            l = function(a) {
      ...
      223: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.project, this.resultSelector));
          };
          return a;
        }(),
            g = function(a) {
              ...
              d.prototype.tryNext = function(a) {
                var d = this.index++,
                    e = this.destination;
                try {
                  var b = this.project(a, d);
                  this.hasSubscription = !0;
                  this.add(k.subscribeToResult(this, b, a, d));
                } catch (g) {
                  e.error(g);
                }
              };
              ...
              d.prototype.notifyNext = function(a, d, e, b, g) {
                g = this.destination;
                this.resultSelector ? this.trySelectResult(a, d, e, b) : g.next(d);
              };
              d.prototype.trySelectResult = function(a, d, e, b) {
              ...
              d.prototype.notifyError = function(a) {
                this.destination.error(a);
              };
              d.prototype.notifyComplete = function(a) {
                this.remove(a);
      ...
      224: [function(a, b, f) {
        ...
        b = a("../OuterSubscriber");
        var g = a("../util/subscribeToResult");
        f.expand = function(a, d, b) {
          void 0 === d && (d = Number.POSITIVE_INFINITY);
          void 0 === b && (b = void 0);
          d = 1 > (d || 0) ? Number.POSITIVE_INFINITY : d;
          return this.lift(new e(a, d, b));
        };
        var e = function() {
          function a(c, d, e) {
            this.project = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.project, this.concurrent, this.scheduler));
          };
          return a;
        }();
        f.ExpandOperator = e;
        var d = function(a) {
          ...
          d.prototype._next = function(a) {
            ...
            if (c.closed)
              ...
              if (this.active < this.concurrent) {
                c.next(a);
                var b = k.tryCatch(this.project)(a, e);
                b === l.errorObject ? c.error(l.errorObject.e) : this.scheduler ? this.add(this.scheduler.schedule(d.dispatch, 0, {
                  subscriber: this,
                  result: b,
                  value: a,
                  index: e
          ...
          d.prototype.subscribeToProjection = function(a, c, d) {
            this.active++;
            this.add(g.subscribeToResult(this, a, c, d));
          };
          d.prototype._complete = function() {
            (this.hasCompleted = !0, 0 === this.active) && this.destination.complete();
          };
          d.prototype.notifyNext = function(a, c, d, e, b) {
            this._next(c);
          };
          d.prototype.notifyComplete = function(a) {
            var c = this.buffer;
      ...
      225: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.predicate, this.thisArg));
          };
          return a;
        }(),
            l = function(a) {
      ...
      226: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.callback));
          };
          return a;
        }(),
            g = function(a) {
      ...
      227: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.predicate, this.source, this.yieldIndex, this.thisArg));
          };
          return a;
        }();
        ...
        var l = function(a) {
          ...
          e.prototype._next = function(a) {
            var c = this.predicate,
                ...
                b = this.index++;
            try {
              c.call(e || this, a, b, this.source) && this.notifyComplete(this.yieldIndex ? b : a);
            } catch (g) {
              this.destination.error(g);
            }
          };
      ...
      229: [function(a, b, f) {
        ...
        f.first = function(a, d, c) {
          return this.lift(new l(a, d, c, this));
        };
        var l = function() {
          function a(d, c, e, b) {
            this.predicate = d;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
          };
          return a;
        }(),
            g = function(a) {
              function d(c, d, b, g, f) {
                a.call(this, c);
                this.predicate = d;
                this.resultSelector = b;
                this.defaultValue = g;
              ...
              d.prototype._next = function(a) {
                var d = this.index++;
                this.predicate ? this._tryPredicate(a, d) : this._emit(a, d);
              };
              d.prototype._tryPredicate = function(a, d) {
                var e;
                try {
                  e = this.predicate(a, d, this.source);
                } catch (b) {
              ...
              d.prototype._emit = function(a, d) {
                this.resultSelector ? this._tryResultSelector(a, d) : this._emitFinal(a);
              };
              d.prototype._tryResultSelector = function(a, d) {
                var e;
                try {
                  e = this.resultSelector(a, d);
                } catch (b) {
                  this.destination.error(b);
                  return;
                }
              ...
              d.prototype._emitFinal = function(a) {
      ...
      230: [function(a, b, f) {
        ...
        var k = a("../Subscription"),
            ...
            e = a("../util/Map"),
            d = a("../util/FastMap");
        f.groupBy = function(a, d, e) {
          return this.lift(new c(this, a, d, e));
        };
        var c = function() {
          function a(c, d, e, b) {
            this.source = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new m(a, this.keySelector, this.elementSelector, this.durationSelector));
          };
          return a;
        }(),
            m = function(a) {
              ...
              c.prototype._group = function(a, c) {
                var b = this.groups;
                b || (b = this.groups = "string" === typeof c ? new d.FastMap : new e.Map);
                var m = b.get(c),
                    f;
                if (this.elementSelector)
                  ...
                  f = a;
                if (!m && (b.set(c, m = new g.Subject), b = new q(c, m, this), this.destination.next(b), this.durationSelector)) {
                  b = void 0;
                  try {
                    b = this.durationSelector(new q(c, m));
                  } catch (l) {
                    this.error(l);
                    return;
                  }
                  this.add(b.subscribe(new n(c, m, this)));
                }
                m.closed || m.next(f);
              };
              c.prototype._error = function(a) {
              ...
              c.prototype.removeGroup = function(a) {
            ...
            q = function(a) {
              ...
              h(c, a);
              c.prototype._subscribe = function(a) {
                var c = new k.Subscription,
                    d = this.refCountSubscription,
                    e = this.groupSubject;
                d && !d.closed && c.add(new r(d));
                c.add(e.subscribe(a));
                return c;
              };
              return c;
        ...
        var r = function(a) {
          ...
          c.prototype.unsubscribe = function() {
            var c = this.parent;
            c.closed || this.closed || (a.prototype.unsubscribe.call(this), --c.count, 0 === c.count && c.attemptedToUnsubscribe && c.unsubscribe());
          };
          return c;
        }(k.Subscription);
      }, {
        ...
        var l = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              d.prototype._next = function(a) {
                var d = this.index++;
                this.predicate ? this._tryPredicate(a, d) : this.resultSelector ? this._tryResultSelector(a, d) : (this.lastValue = a, this.hasValue = !0);
              };
              d.prototype._tryPredicate = function(a, d) {
                var e;
                try {
                ...
                e && (this.resultSelector ? this._tryResultSelector(a, d) : (this.lastValue = a, this.hasValue = !0));
              };
              d.prototype._tryResultSelector = function(a, d) {
                var e;
                try {
      ...
      235: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.project, this.thisArg));
          };
          return a;
        }(),
            l = function(a) {
      ...
      236: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.value));
          };
          return a;
        }(),
            l = function(a) {
        ...
        var l = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              d.prototype._error = function(a) {
                var d = this.destination;
                d.next(k.Notification.createError(a));
                d.complete();
              };
              d.prototype._complete = function() {
                var a = this.destination;
      ...
      238: [function(a, b, f) {
        var h = a("./reduce");
        f.max = function(a) {
          return this.lift(new h.ReduceOperator("function" === typeof a ? a : function(a, b) {
            return a > b ? a : b;
          }));
        };
      }, {"./reduce": 256}],
      239: [function(a, b, f) {
        function h() {
          ...
          var d = Number.POSITIVE_INFINITY,
              c = null,
              b = a[a.length - 1];
          g.isScheduler(b) ? (c = a.pop(), 1 < a.length && "number" === typeof a[a.length - 1] && (d = a.pop())) : "number" === typeof b && (d = a.pop());
          return 1 === a.length ? a[0] : (new k.ArrayObservable(a, c)).lift(new l.MergeAllOperator(d));
        }
      ...
      240: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.concurrent));
          };
          return a;
        }();
        ...
        var g = function(a) {
          ...
          d.prototype.notifyComplete = function(a) {
            ...
            this.remove(a);
            this.active--;
            0 < d.length ? this._next(d.shift()) : 0 === this.active && this.hasCompleted && this.destination.complete();
          };
          return d;
        }(b.OuterSubscriber);
      ...
      241: [function(a, b, f) {
        ...
        a = a("../OuterSubscriber");
        f.mergeMap = function(a, d, c) {
          void 0 === c && (c = Number.POSITIVE_INFINITY);
          "number" === typeof d && (c = d, d = null);
          return this.lift(new l(a, d, c));
        };
        var l = function() {
          function a(d, c, e) {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.project, this.resultSelector, this.concurrent));
          };
          return a;
        }();
        ...
        var g = function(a) {
          ...
          d.prototype._tryNext = function(a) {
            var d,
                e = this.index++;
            try {
              d = this.project(a, e);
            ...
            this.active++;
            this._innerSub(d, a, e);
          };
          d.prototype._innerSub = function(a, d, e) {
            this.add(k.subscribeToResult(this, a, d, e));
          };
          d.prototype._complete = function() {
            this.hasCompleted = !0;
            0 === this.active && 0 === this.buffer.length && this.destination.complete();
          };
          d.prototype.notifyNext = function(a, d, e, b, f) {
            this.resultSelector ? this._notifyResultSelector(a, d, e, b) : this.destination.next(d);
          };
          d.prototype._notifyResultSelector = function(a, d, e, b) {
            var f;
            try {
              f = this.resultSelector(a, d, e, b);
            } catch (g) {
              this.destination.error(g);
              return;
            }
      ...
      242: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.ish, this.resultSelector, this.concurrent));
          };
          return a;
        }();
        ...
        var g = function(a) {
          ...
          d.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var d = this.resultSelector,
                  ...
                  f = this.destination;
              this.active++;
              this._innerSub(b, f, d, a, e);
            } else
              this.buffer.push(a);
          };
          d.prototype._innerSub = function(a, d, e, b, f) {
            this.add(k.subscribeToResult(this, a, b, f));
          };
          d.prototype._complete = function() {
            this.hasCompleted = !0;
            0 === this.active && 0 === this.buffer.length && this.destination.complete();
          ...
          d.prototype.notifyNext = function(a, d, e, b, f) {
            f = this.destination;
            this.resultSelector ? this.trySelectResult(a, d, e, b) : f.next(d);
          };
          d.prototype.trySelectResult = function(a, d, e, b) {
      ...
      243: [function(a, b, f) {
        ...
        var e = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.project, this.seed, this.concurrent));
          };
          return a;
        }();
        ...
        var d = function(a) {
          ...
          d.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var c = this.index++,
                  d = k.tryCatch(this.project)(this.acc, a),
                  e = this.destination;
              d === l.errorObject ? e.error(l.errorObject.e) : (this.active++, this._innerSub(d, a, c));
            } else
              this.buffer.push(a);
          };
          d.prototype._innerSub = function(a, c, d) {
            this.add(g.subscribeToResult(this, a, c, d));
          };
          d.prototype._complete = function() {
            this.hasCompleted = !0;
          ...
          d.prototype.notifyComplete = function(a) {
            ...
            this.remove(a);
            this.active--;
            0 < c.length ? this._next(c.shift()) : 0 === this.active && this.hasCompleted && (!1 === this.hasValue && this.destination.next(this.acc), this.destination.complete());
          };
          return d;
        }(a.OuterSubscriber);
        f.MergeScanSubscriber = d;
      }, {
        "../OuterSubscriber": 7,
        "../util/errorObject": 326,
        "../util/subscribeToResult": 337,
      ...
      245: [function(a, b, f) {
        var h = a("../observable/MulticastObservable"),
            k = a("../observable/ConnectableObservable");
        f.multicast = function(a, b) {
          var e;
          e = "function" === typeof a ? a : function() {
            return a;
          };
          return b ? new h.MulticastObservable(this, e, b) : new k.ConnectableObservable(this, e);
        };
      }, {
        "../observable/ConnectableObservable": 146,
        "../observable/MulticastObservable": 158
      ...
      246: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new g(a, this.scheduler, this.delay));
          };
          return a;
        }();
        ...
        var g = function(a) {
          ...
          c.prototype.scheduleMessage = function(a) {
            this.add(this.scheduler.schedule(c.dispatch, this.delay, new e(a, this.destination)));
          };
          c.prototype._next = function(a) {
      ...
      247: [function(a, b, f) {
        ...
        f.onErrorResumeNextStatic = function() {
          ...
          1 === a.length && l.isArray(a[0]) && (a = a[0]);
          d = a.shift();
          return (new k.FromObservable(d, null)).lift(new e(a));
        };
        var e = function() {
          function a(c) {
            this.nextSources = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.nextSources));
          };
          return a;
        }(),
            d = function(a) {
              ...
              d.prototype.subscribeToNextSource = function() {
      ...
      249: [function(a, b, f) {
        ...
        f.partition = function(a, b) {
          return [k.filter.call(this, a), k.filter.call(this, h.not(a, b))];
        };
      }, {
        "../util/not": 335,
        "./filter": 225
      ...
      254: [function(a, b, f) {
        ...
        f.publishReplay = function(a, b, e) {
          void 0 === a && (a = Number.POSITIVE_INFINITY);
          void 0 === b && (b = Number.POSITIVE_INFINITY);
          return k.multicast.call(this, new h.ReplaySubject(a, b, e));
        };
      }, {
        "../ReplaySubject": 8,
        "./multicast": 245
        ...
        function h() {
          ...
          if (1 === a.length)
            if (l.isArray(a[0]))
              ...
              return a[0];
          return (new g.ArrayObservable(a)).lift(new d);
        }
        var k = this && this.__extends || function(a, c) {
          function d() {
            this.constructor = a;
        ...
        var c = function(a) {
          ...
          c.prototype._complete = function() {
            ...
            if (0 === c)
              ...
              for (var d = 0; d < c; d++) {
                var b = a[d],
                    b = e.subscribeToResult(this, b, b, d);
          ...
          c.prototype.notifyNext = function(a, c, d, b, e) {
            if (!this.hasFirst) {
              ...
              for (a = 0; a < this.subscriptions.length; a++)
                a !== d && (b = this.subscriptions[a], b.unsubscribe(), this.remove(b));
      ...
      256: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.accumulator, this.seed));
          };
          return a;
        }();
        f.ReduceOperator = k;
      ...
      257: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.count, this.source));
          };
          return a;
        }(),
            g = function(a) {
      ...
      258: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.count, this.source));
          };
          return a;
        }(),
            l = function(a) {
              ...
              b.prototype.error = function(d) {
                if (!this.isStopped) {
                  var c = this.source,
                      b = this.count;
                  if (0 === b)
                    return a.prototype.error.call(this, d);
                  -1 < b && (this.count = b - 1);
                  this.unsubscribe();
                  this.closed = this.isStopped = !1;
                  c.subscribe(this);
      ...
      259: [function(a, b, f) {
        ...
        var d = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new c(a, this.notifier, this.source));
          };
          return a;
        }(),
            c = function(a) {
      ...
      260: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.notifier));
          };
          return a;
        }(),
            g = function(a) {
              ...
              d.prototype.notifyNext = function(a, d, b, e, f) {
                this.emitValue();
              };
              d.prototype.notifyComplete = function() {
                this.emitValue();
      ...
      261: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.period, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
              ...
              c.prototype.notifyNext = function() {
      ...
      264: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.predicate, this.source));
          };
          return a;
        }(),
            g = function(a) {
              ...
              h(d, a);
              d.prototype.applySingleValue = function(a) {
              ...
              d.prototype._next = function(a) {
                ...
                this.index++;
                d ? this.tryNext(a) : this.applySingleValue(a);
              };
              d.prototype.tryNext = function(a) {
                try {
      ...
      265: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.total));
          };
          return a;
        }(),
            l = function(a) {
      ...
      267: [function(a, b, f) {
        ...
        var k = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new l(a, this.predicate));
          };
          return a;
        }(),
            l = function(a) {
      ...
      268: [function(a, b, f) {
        ...
        f.startWith = function() {
          for (var a = [],
            ...
            a[c - 0] = arguments[c];
          c = a[a.length - 1];
          e.isScheduler(c) ? a.pop() : c = null;
          var b = a.length;
          return 1 === b ? g.concatStatic(new k.ScalarObservable(a[0], c), this) : 1 < b ? g.concatStatic(new h.ArrayObservable(a, c), this) : g.concatStatic(new l.EmptyObservable(c), this);
        };
      }, {
        "../observable/ArrayObservable": 143,
        "../observable/EmptyObservable": 148,
        ...
        var l = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              d.prototype.unsubscribeInner = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              d.prototype._next = function(a) {
                ...
                this._innerSub(d, a, b);
              };
              d.prototype._innerSub = function(a, d, b) {
                var e = this.innerSubscription;
                e && e.unsubscribe();
                this.add(this.innerSubscription = k.subscribeToResult(this, a, d, b));
              };
              d.prototype._complete = function() {
              ...
              d.prototype.notifyComplete = function(c) {
                this.remove(c);
                this.innerSubscription = null;
                this.isStopped && a.prototype._complete.call(this);
              };
              d.prototype.notifyNext = function(a, d, b, e, f) {
                this.resultSelector ? this._tryNotifyNext(a, d, b, e) : this.destination.next(d);
              };
              d.prototype._tryNotifyNext = function(a, d, b, e) {
                var f;
                try {
                  f = this.resultSelector(a, d, b, e);
                } catch (g) {
                  this.destination.error(g);
                  return;
                }
      ...
      272: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.observable, this.resultSelector));
          };
          return a;
        }(),
            g = function(a) {
              ...
              d.prototype.notifyNext = function(a, d, b, e, f) {
                f = this.destination;
                this.resultSelector ? this.tryResultSelector(a, d, b, e) : f.next(d);
              };
              d.prototype.tryResultSelector = function(a, d, b, e) {
                var f = this.resultSelector,
                    g = this.destination,
                    l;
                try {
      ...
      273: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.total));
          };
          return a;
        }(),
            e = function(a) {
            ...
            e = function(a) {
              ...
              c.prototype._complete = function() {
                var a = this.destination,
                    c = this.count;
                if (0 < c)
                  for (var d = this.count >= this.total ? this.total : this.count,
                      b = this.ring,
                      e = 0; e < d; e++) {
                    var f = c++ % d;
                    a.next(b[f]);
        ...
        var k = function() {
          ...
          return a;
            ...
            l = function(a) {
              ...
              b.prototype.nextOrComplete = function(a, c) {
        ...
        var l = function() {
          ...
          return a;
            ...
            g = function(a) {
              ...
              d.prototype.tryDurationSelector = function(a) {
                var d = null;
                try {
                  d = this.durationSelector(a);
                } catch (b) {
                  this.destination.error(b);
                  return;
                }
                this.emitAndThrottle(a, d);
              };
              d.prototype.emitAndThrottle = function(a, d) {
                this.add(this.throttled = k.subscribeToResult(this, d));
                this.destination.next(a);
              };
              d.prototype._unsubscribe = function() {
      ...
      279: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
              ...
              c.prototype._next = function(a) {
                var c = this.scheduler.now(),
                    d = c - this.lastTime;
                this.lastTime = c;
                this.destination.next(new l(a, d));
              };
              return c;
            }(b.Subscriber);
      }, {
      ...
      280: [function(a, b, f) {
        var h = this && this.__extends || function(a, c) {
          ...
          a.prototype = null === c ? Object.create(c) : (b.prototype = c.prototype, new b);
            ...
            l = a("../util/isDate");
        a = a("../Subscriber");
        f.timeout = function(a, c, b) {
          void 0 === c && (c = null);
          void 0 === b && (b = k.async);
          var e = l.isDate(a);
          a = e ? +a - b.now() : Math.abs(a);
          return this.lift(new g(a, e, c, b));
        };
        var g = function() {
          function a(c, d, b, e) {
            this.waitFor = c;
          ...
          a.prototype.call = function(a, d) {
            return d._subscribe(new e(a, this.absoluteTimeout, this.waitFor, this.errorToSend, this.scheduler));
          };
          return a;
        }(),
            e = function(a) {
              function c(c, b, e, f, g) {
                a.call(this, c);
              ...
              c.prototype.scheduleTimeout = function() {
                var a = this.index;
                this.scheduler.schedule(c.dispatchTimeout, this.waitFor, {
                  subscriber: this,
                  index: a
                });
                this.index++;
              ...
              c.prototype.notifyTimeout = function() {
      ...
      281: [function(a, b, f) {
        ...
        b = a("../OuterSubscriber");
        var g = a("../util/subscribeToResult");
        f.timeoutWith = function(a, d, b) {
          void 0 === b && (b = k.async);
          var f = l.isDate(a);
          a = f ? +a - b.now() : Math.abs(a);
          return this.lift(new e(a, f, d, b));
        };
        var e = function() {
          function a(c, d, b, e) {
            this.waitFor = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler));
          };
          return a;
        }(),
            d = function(a) {
              function d(b, e, f, g, l) {
                a.call(this);
                this.destination = b;
              ...
              d.prototype.scheduleTimeout = function() {
                var a = this.index;
                this.scheduler.schedule(d.dispatchTimeout, this.waitFor, {
                  subscriber: this,
                  index: a
                });
                this.index++;
              ...
              d.prototype.handleTimeout = function() {
                if (!this.closed) {
      ...
      285: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, d) {
            var b = new e(a),
                f = d._subscribe(b);
            f.closed || b.add(l.subscribeToResult(b, this.windowBoundaries));
            return f;
          };
          return a;
        }(),
            e = function(a) {
              ...
              c.prototype.openWindow = function() {
                var a = this.window;
                a && a.complete();
                var a = this.destination,
                    c = this.window = new k.Subject;
                a.next(c);
              };
              return c;
            }(b.OuterSubscriber);
      ...
      286: [function(a, b, f) {
        ...
        var l = function() {
          function a(d, c) {
            this.windowSize = d;
            this.startWindowEvery = c;
          }
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.windowSize, this.startWindowEvery));
          };
          return a;
        }(),
            g = function(a) {
              ...
              h(d, a);
              d.prototype._next = function(a) {
                for (var d = 0 < this.startWindowEvery ? this.startWindowEvery : this.windowSize,
                    b = this.destination,
                    e = this.windowSize,
                    f = this.windows,
                    g = f.length,
                    l = 0; l < g && !this.closed; l++)
                  f[l].next(a);
                a = this.count - e + 1;
                0 <= a && 0 === a % d && !this.closed && f.shift().complete();
                0 !== ++this.count % d || this.closed || (d = new k.Subject, f.push(d), b.next(d));
              };
              d.prototype._error = function(a) {
                var d = this.windows;
                if (d)
                  for (; 0 < d.length && !this.closed; )
                    d.shift().error(a);
                this.destination.error(a);
              };
              d.prototype._complete = function() {
      ...
      287: [function(a, b, f) {
        function h(a) {
          var c = a.subscriber,
              ...
              b = a.window;
          b && b.complete();
          a.window = c.openWindow();
          this.schedule(a, d);
        }
        function k(a) {
          var c = a.windowTimeSpan,
              d = a.subscriber,
              b = a.scheduler,
        ...
        var c = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new m(a, this.windowTimeSpan, this.windowCreationInterval, this.scheduler));
          };
          return a;
        }(),
            m = function(a) {
              function c(d, b, e, f) {
                ...
                if (null !== e && 0 <= e) {
                  ...
                  this.add(f.schedule(l, b, d));
                  this.add(f.schedule(k, e, g));
                } else
                  e = {
                    subscriber: this,
                    window: this.openWindow(),
                    windowTimeSpan: b
                  }, this.add(f.schedule(h, b, e));
              }
              g(c, a);
              c.prototype._next = function(a) {
                for (var c = this.windows,
                    d = c.length,
                    b = 0; b < d; b++) {
                  var e = c[b];
                  e.closed || e.next(a);
              ...
              c.prototype._error = function(a) {
                for (var c = this.windows; 0 < c.length; )
                  c.shift().error(a);
                this.destination.error(a);
              };
              c.prototype._complete = function() {
              ...
              c.prototype.closeWindow = function(a) {
                a.complete();
                var c = this.windows;
                c.splice(c.indexOf(a), 1);
              };
      ...
      288: [function(a, b, f) {
        var h = this && this.__extends || function(a, c) {
          ...
          a.prototype = null === c ? Object.create(c) : (d.prototype = c.prototype, new d);
            ...
            e = a("../util/errorObject");
        b = a("../OuterSubscriber");
        var d = a("../util/subscribeToResult");
        f.windowToggle = function(a, d) {
          return this.lift(new c(a, d));
        };
        var c = function() {
          function a(c, d) {
            this.openings = c;
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new m(a, this.openings, this.closingSelector));
          };
          return a;
        }(),
            m = function(a) {
              function c(b, e, f) {
                ...
                this.contexts = [];
                this.add(this.openSubscription = d.subscribeToResult(this, e, e));
              }
              h(c, a);
              c.prototype._next = function(a) {
                var c = this.contexts;
              ...
              c.prototype._unsubscribe = function() {
                ...
                if (a)
                  for (var c = a.length,
                      d = -1; ++d < c; ) {
                    var b = a[d];
                    b.window.unsubscribe();
                    b.subscription.unsubscribe();
                  }
              };
              c.prototype.notifyNext = function(a, c, b, f, h) {
                if (a === this.openings) {
                  f = g.tryCatch(this.closingSelector)(c);
                  if (f === e.errorObject)
                  ...
                  f = d.subscribeToResult(this, f, b);
                  f.closed ? this.closeWindow(this.contexts.length - 1) : (f.context = b, c.add(f));
                  this.destination.next(a);
                } else
      ...
      290: [function(a, b, f) {
        ...
        var l = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new g(a, this.observables, this.project));
          };
          return a;
        }(),
            g = function(a) {
              function b(c, d, f) {
                ...
                this.values = Array(c);
                for (f = 0; f < c; f++)
                  this.toRespond.push(f);
                for (f = 0; f < c; f++) {
                  var g = d[f];
                  this.add(k.subscribeToResult(this, g, g, f));
                }
              }
              h(b, a);
              b.prototype.notifyNext = function(a, b, d, e, f) {
                this.values[d] = b;
                a = this.toRespond;
      ...
      291: [function(a, b, f) {
        function h() {
          for (var a = [],
            ...
            a[c - 0] = arguments[c];
          c = a[a.length - 1];
          "function" === typeof c && a.pop();
          return (new l.ArrayObservable(a)).lift(new m(c));
        }
        var k = this && this.__extends || function(a, c) {
          function b() {
            this.constructor = a;
        ...
        var m = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new n(a, this.project));
          };
          return a;
        }();
        f.ZipOperator = m;
        var n = function(a) {
          ...
          b.prototype._next = function(a) {
            var b = this.iterators,
                d = this.index++;
            g.isArray(a) ? b.push(new r(a)) : "function" === typeof a[c.$$iterator] ? b.push(new q(a[c.$$iterator]())) : b.push(new p(this.destination, this, a, d));
          };
          b.prototype._complete = function() {
            ...
            for (var b = 0; b < c; b++) {
              var d = a[b];
              d.stillUnsubscribed ? this.add(d.subscribe(d, b)) : this.active--;
            }
          };
          ...
          b.prototype.checkIterators = function() {
            for (var a = this.iterators,
                ...
                d = 0; d < c; d++) {
              var e = a[d];
              if ("function" === typeof e.hasValue && !e.hasValue())
                return;
            }
            for (var f = !1,
                g = [],
            ...
            this.project ? this._tryProject(g) : b.next(g);
            f && b.complete();
          };
          b.prototype._tryProject = function(a) {
            var c;
        ...
        var q = function() {
          ...
          return a;
            ...
            r = function() {
              ...
              a.prototype[c.$$iterator] = function() {
                return this;
              };
            ...
            p = function(a) {
              ...
              k(b, a);
              b.prototype[c.$$iterator] = function() {
                return this;
              };
              ...
              b.prototype.notifyNext = function(a, c, b, d, e) {
                this.buffer.push(c);
                this.parent.checkIterators();
              };
              b.prototype.subscribe = function(a, c) {
                return d.subscribeToResult(this, this.observable, this, c);
              };
              return b;
            }(e.OuterSubscriber);
      }, {
      ...
      294: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          h(b, a);
          b.prototype.requestAsyncId = function(b, d, c) {
            void 0 === c && (c = 0);
            if (null !== c && 0 < c)
              return a.prototype.requestAsyncId.call(this, b, d, c);
            b.actions.push(this);
            return b.scheduled || (b.scheduled = k.AnimationFrame.requestAnimationFrame(b.flush.bind(b, null)));
          };
          b.prototype.recycleAsyncId = function(b, d, c) {
            void 0 === c && (c = 0);
            if (null !== c && 0 < c)
              return a.prototype.recycleAsyncId.call(this, b, d, c);
            0 === b.actions.length && (k.AnimationFrame.cancelAnimationFrame(d), b.scheduled = void 0);
          };
          return b;
        }(b.AsyncAction);
        ...
        a = function(a) {
          ...
          b.prototype.flush = function() {
            ...
            var a = this.actions,
                ...
                f = a.shift();
            do
              if (b = f.execute(f.state, f.delay))
                break;
 while (++d < c && (f = a.shift()));
            this.active = !1;
            if (b) {
        ...
        a = function(a) {
          ...
          b.prototype.requestAsyncId = function(b, d, c) {
            ...
            if (null !== c && 0 < c)
              return a.prototype.requestAsyncId.call(this, b, d, c);
            b.actions.push(this);
            return b.scheduled || (b.scheduled = k.Immediate.setImmediate(b.flush.bind(b, null)));
          };
          b.prototype.recycleAsyncId = function(b, d, c) {
            void 0 === c && (c = 0);
            if (null !== c && 0 < c)
              return a.prototype.recycleAsyncId.call(this, b, d, c);
            0 === b.actions.length && (k.Immediate.clearImmediate(d), b.scheduled = void 0);
          };
          return b;
      ...
      298: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.schedule = function(a, b) {
            ...
            var c = this.id,
                f = this.scheduler;
            null != c && (this.id = this.recycleAsyncId(f, c, b));
            this.delay = b;
            this.id = this.id || this.requestAsyncId(f, this.id, b);
            return this;
          };
          b.prototype.requestAsyncId = function(a, b, c) {
            void 0 === c && (c = 0);
            return k.root.setInterval(a.flush.bind(a, this), c);
          };
          b.prototype.recycleAsyncId = function(a, b, c) {
            void 0 === c && (c = 0);
            return null !== c && this.delay === c ? b : (k.root.clearInterval(b), void 0);
          };
          b.prototype.execute = function(a, b) {
            if (this.closed)
              return Error("executing a cancelled action");
            this.pending = !1;
            var c = this._execute(a, b);
            if (c)
              return c;
        ...
        a = function(a) {
          ...
          b.prototype.flush = function(a) {
            ...
            if (this.active)
              ...
              this.active = !0;
              do
                if (d = a.execute(a.state, a.delay))
                  break;
 while (a = b.shift());
              this.active = !1;
              if (d) {
      ...
      300: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.schedule = function(b, e) {
            void 0 === e && (e = 0);
            if (0 < e)
              return a.prototype.schedule.call(this, b, e);
            this.delay = e;
            this.state = b;
          ...
          b.prototype.requestAsyncId = function(b, e, d) {
            void 0 === d && (d = 0);
            return null !== d && 0 < d ? a.prototype.requestAsyncId.call(this, b, e, d) : b.flush(this);
          };
          return b;
        }(a("./AsyncAction").AsyncAction);
        f.QueueAction = a;
      ...
      302: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.prototype.flush = function() {
            for (var a = this.actions,
                b = this.maxFrames,
                c,
                f; (f = a.shift()) && (this.frame = f.delay) <= b && !(c = f.execute(f.state, f.delay)); )
              ;
            if (c) {
              for (; f = a.shift(); )
                f.unsubscribe();
        ...
        var k = function(a) {
          function b(e, d, c) {
            void 0 === c && (c = e.index += 1);
            a.call(this, e, d);
            this.scheduler = e;
            this.work = d;
            this.index = c;
            this.index = e.index = c;
          }
          h(b, a);
          b.prototype.schedule = function(e, d) {
            void 0 === d && (d = 0);
            return this.id ? this.add(new b(this.scheduler, this.work)).schedule(e, d) : a.prototype.schedule.call(this, e, d);
          };
          b.prototype.requestAsyncId = function(a, d, c) {
            void 0 === c && (c = 0);
            this.delay = a.frame + c;
            a = a.actions;
            a.push(this);
      ...
      310: [function(a, b, f) {
        ...
        f.ColdObservable = k;
        a.applyMixins(k, [b.SubscriptionLoggable]);
      }, {
        "../Observable": 5,
        "../Subscription": 14,
      ...
      311: [function(a, b, f) {
        ...
        k = function(a) {
          ...
          b.prototype._subscribe = function(b) {
            ...
            b.add(new l.Subscription(function() {
        ...
        a = function(a) {
          ...
          b.prototype.expectObservable = function(a, c) {
            ...
            this.schedule(function() {
              h = a.subscribe(function(a) {
                var b = a;
                a instanceof k.Observable && (b = d.materializeInnerObservable(b, d.frame));
                e.push({
                  frame: d.frame,
            ...
            g !== Number.POSITIVE_INFINITY && this.schedule(function() {
              return h.unsubscribe();
            }, g);
            this.flushTests.push(f);
            return {toBe: function(a, c, d) {
                f.ready = !0;
          ...
          b.prototype.flush = function() {
            ...
            for (b = this.flushTests.filter(function(a) {
              ...
              var d = b.shift();
              this.assertDeepEqual(d.actual, d.expected);
            }
          };
          b.parseMarblesAsSubscriptions = function(a) {
            if ("string" !== typeof a)
              return new d.SubscriptionLog(Number.POSITIVE_INFINITY);
            for (var b = a.length,
                c = -1,
            ...
            return 0 > f ? new d.SubscriptionLog(e) : new d.SubscriptionLog(e, f);
          };
          b.parseMarbles = function(a, b, c, d) {
            ...
            for (var e = a.length,
                ...
                m = -1,
                x = 0; x < e; x++) {
              var C = x * this.frameTimeFactor + h,
                  z = void 0,
                  y = a[x];
              switch (y) {
                case "-":
                ...
                case ")":
                  ...
                  break;
                case "|":
                  z = l.Notification.createComplete();
                  break;
                case "^":
                  break;
                case "#":
                  z = l.Notification.createError(c || "error");
                  break;
                default:
                  z = l.Notification.createNext(k(y));
              }
              z && f.push({
                frame: -1 < m ? m : C,
                notification: z
          ...
          return b;
        }(a("../scheduler/VirtualTimeScheduler").VirtualTimeScheduler);
        f.TestScheduler = a;
      }, {
        "../Notification": 4,
        "../Observable": 5,
        ...
        a = function() {
          ...
          a.prototype.forEach = function(a, b) {
            var f = this.values,
                e;
            for (e in f)
              f.hasOwnProperty(e) && null !== f[e] && a.call(b, f[e], e);
          };
        ...
        b = function() {
          ...
          a.prototype.createPostMessageSetImmediate = function() {
            var a = this.root,
                ...
                f = function d(c) {
                  var f = d.instance;
                  c.source === a && "string" === typeof c.data && 0 === c.data.indexOf(b) && f.runIfPresent(+c.data.slice(b.length));
                };
            f.instance = this;
        ...
        a = function() {
          ...
          a.prototype.forEach = function(a, b) {
            for (var f = 0; f < this.size; f++)
              a.call(b, this._values[f], this._keys[f]);
          };
          return a;
        }();
        f.MapPolyfill = a;
      ...
      323: [function(a, b, f) {
        ...
        a = function(a) {
          function b(f) {
            a.call(this);
            this.errors = f;
            f = Error.call(this, f ? f.length + " errors occurred during unsubscription:\n  " + f.map(function(a, b) {
      ...
      324: [function(a, b, f) {
        f.applyMixins = function(a, b) {
          for (var f = 0,
              g = b.length; f < g; f++)
            for (var e = b[f],
                d = Object.getOwnPropertyNames(e.prototype),
                c = 0,
                m = d.length; c < m; c++) {
              var n = d[c];
      ...
      337: [function(a, b, f) {
        var h = a("./root"),
            ...
            e = a("../symbol/iterator"),
            d = a("../InnerSubscriber"),
            c = a("../symbol/observable");
        f.subscribeToResult = function(a, b, f, r) {
          var p = new d.InnerSubscriber(a, f, r);
          if (p.closed)
            return null;
          if (b instanceof g.Observable)
            return b._isScalar ? (p.next(b.value), p.complete(), null) : b.subscribe(p);
          if (k.isArray(b)) {
            a = 0;
            for (f = b.length; a < f && !p.closed; a++)
              p.next(b[a]);
            p.closed || p.complete();
          } else {
            if (l.isPromise(b))
            ...
            } else if ("function" === typeof b[c.$$observable])
              if (b = b[c.$$observable](), "function" !== typeof b.subscribe)
                p.error(Error("invalid observable"));
              else
                return b.subscribe(new d.InnerSubscriber(a, f, r));
            else
              p.error(new TypeError("unknown type returned"));
          }
          return null;
        };
      }, {
      ...
      339: [function(a, b, f) {
        function h() {
          try {
            ...
            return k.errorObject.e = a, k.errorObject;
          }
        }
        var k = a("./errorObject"),
            l;
