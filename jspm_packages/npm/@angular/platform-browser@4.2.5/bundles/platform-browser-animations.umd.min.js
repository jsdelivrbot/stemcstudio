    ...
    return __extends(BrowserAnimationFactory, _super), BrowserAnimationFactory.prototype.create = function(element, options) {
      ...
      AnimationRendererFactory = function() {
        function AnimationRendererFactory(delegate, engine, _zone) {
          this.delegate = delegate, this.engine = engine, this._zone = _zone, this._currentId = 0, this._microtaskId = 1, this._animationCallbacksBuffer = [], this._rendererCache = new Map, engine.onRemovalComplete = function(element, delegate) {
    ...
    return Object.defineProperty(BaseAnimationRenderer.prototype, "data", {
      ...
      AnimationRenderer = function(_super) {
        ...
        return __extends(AnimationRenderer, _super), AnimationRenderer.prototype.setProperty = function(el, name, value) {
          "@" == name.charAt(0) ? (name = name.substr(1), this.engine.setProperty(this.namespaceId, el, name, value)) : this.delegate.setProperty(el, name, value);
          ...
          if ("@" == eventName.charAt(0)) {
            var element = resolveElementFromTarget(target),
                ...
                phase = "";
            return "@" != name.charAt(0) && (_a = parseTriggerCallbackName(name), name = _a[0], phase = _a[1]), this.engine.listen(this.namespaceId, element, name, phase, function(event) {
