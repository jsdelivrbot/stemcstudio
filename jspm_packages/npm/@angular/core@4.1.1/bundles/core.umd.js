...
(function(process) {
  (function(global, factory) {
    ...
    function checkAndUpdateDirectiveInline(view, def, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) {
      ...
      if ((view.state & 2) && (def.flags & 32768)) {
        directive.ngOnInit();
      }
      if (def.flags & 131072) {
        directive.ngDoCheck();
    ...
    function checkAndUpdateView(view) {
      ...
      callLifecycleHooksChildrenFirst(view, 1048576 | (view.state & 2 ? 524288 : 0));
      Services.updateRenderer(view, 0);
      execComponentViewsAction(view, ViewAction.CheckAndUpdate);
      execQueriesAction(view, 67108864, 268435456, 0);
      callLifecycleHooksChildrenFirst(view, 4194304 | (view.state & 2 ? 2097152 : 0));
      if (view.def.flags & 2) {
        view.state &= ~8;
      }
    }
    ...
    function callViewAction(view, action) {
      ...
      switch (action) {
        case ViewAction.CheckNoChanges:
          if ((viewState & 12) === 12 && (viewState & 16) === 0) {
