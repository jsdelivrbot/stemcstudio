...
(function(process) {
  !function(global, factory) {
    ...
    function _splitAt(input, character, defaultValues) {
      ...
      return characterIndex == -1 ? defaultValues : [input.slice(0, characterIndex).trim(), input.slice(characterIndex + 1).trim()];
    }
    ...
    function findNode(nodes, position) {
      var path = [],
          visitor = new (function(_super) {
            function class_1() {
              return null !== _super && _super.apply(this, arguments) || this;
            }
            return __extends(class_1, _super), class_1.prototype.visit = function(ast, context) {
              var span = spanOf(ast);
              return !(span.start <= position && position < span.end) || void path.push(ast);
            }, class_1;
          }(RecursiveVisitor));
      return visitAll(visitor, nodes), new AstPath(path, position);
    }
    ...
    function sha1(str) {
      var utf8 = utf8Encode(str),
          ...
          d = _a[3],
          e = _a[4];
      words32[len >> 5] |= 128 << 24 - len % 32, words32[(len + 64 >> 9 << 4) + 15] = len;
      for (var i = 0; i < words32.length; i += 16) {
        for (var _b = [a, b, c, d, e],
            ...
            h4 = _b[4],
            j = 0; j < 80; j++) {
          j < 16 ? w[j] = words32[i + j] : w[j] = rol32(w[j - 3] ^ w[j - 8] ^ w[j - 14] ^ w[j - 16], 1);
          var _c = fk(j, b, c, d),
              f = _c[0],
              k = _c[1],
    ...
    function fingerprint(str) {
      var utf8 = utf8Encode(str),
          ...
          hi = _a[0],
          lo = _a[1];
      return 0 != hi || 0 != lo && 1 != lo || (hi = 319790063 ^ hi, lo ^= -1801410264), [hi, lo];
    }
    ...
    function _resolveProvidersFromDirectives(directives, sourceSpan, targetErrors) {
      ...
      directives.forEach(function(directive) {
        ...
        _resolveProviders([dirProvider], directive.isComponent ? ProviderAstType.Component : ProviderAstType.Directive, !0, sourceSpan, targetErrors, providersByToken);
      });
    ...
    function toBase64VLQ(value) {
      ...
      do {
        var digit = 31 & value;
        value >>= 5, value > 0 && (digit = 32 | digit), out += toBase64Digit(digit);
      } while (value > 0);
      return out;
    }
    ...
    function escapeIdentifier(input, escapeDollar, alwaysQuote) {
      ...
      var body = input.replace(_SINGLE_QUOTE_ESCAPE_STRING_RE, function() {
        ...
        return "$" == match[0] ? escapeDollar ? "\\$" : "$" : "\n" == match[0] ? "\\n" : "\r" == match[0] ? "\\r" : "\\" + match[0];
          ...
          requiresQuotes = alwaysQuote || !_LEGAL_IDENTIFIER_RE.test(body);
    ...
    function calcStaticDynamicQueryFlags(queryIds, queryId, isFirst) {
      var flags = 0;
      return flags |= !isFirst || !queryIds.staticQueryIds.has(queryId) && queryIds.dynamicQueryIds.has(queryId) ? 536870912 : 268435456;
    }
    ...
    function createAotCompiler(compilerHost, options) {
      var translations = options.translations || "",
          ...
          config = new CompilerConfig({
            ...
            useJit: !1,
            enableLegacyTemplate: options.enableLegacyTemplate !== !1,
          ...
          viewCompiler = new ViewCompiler(config, staticReflector, elementSchemaRegistry),
    ...
    var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
      ...
      for (var p in b)
        ...
        VERSION = new _angular_core.Version("4.3.6"),
        TextAst = function() {
      ...
      zwnj: "‌"
        ...
        HtmlTagDefinition = function() {
          ...
          return HtmlTagDefinition.prototype.requireExtraParent = function(currentParent) {
            ...
            var lcParent = currentParent.toLowerCase(),
                isParentTemplate = "template" === lcParent || "ng-template" === currentParent;
            return !isParentTemplate && 1 != this.requiredParents[lcParent];
        ...
        CompileAnimationStateDeclarationMetadata = function(_super) {
          function CompileAnimationStateDeclarationMetadata(stateNameExpr, styles) {
            ...
            return _this.stateNameExpr = stateNameExpr, _this.styles = styles, _this;
          }
        ...
        CompileAnimationStateTransitionMetadata = function(_super) {
          function CompileAnimationStateTransitionMetadata(stateChangeExpr, steps) {
            var _this = _super.call(this) || this;
            return _this.stateChangeExpr = stateChangeExpr, _this.steps = steps, _this;
          }
        ...
        CompileAnimationKeyframesSequenceMetadata = function(_super) {
          function CompileAnimationKeyframesSequenceMetadata(steps) {
            void 0 === steps && (steps = []);
            var _this = _super.call(this) || this;
            return _this.steps = steps, _this;
          }
        ...
        CompileAnimationStyleMetadata = function(_super) {
          function CompileAnimationStyleMetadata(offset, styles) {
            ...
            var _this = _super.call(this) || this;
            return _this.offset = offset, _this.styles = styles, _this;
          }
        ...
        CompileAnimationAnimateMetadata = function(_super) {
          function CompileAnimationAnimateMetadata(timings, styles) {
            void 0 === timings && (timings = 0), void 0 === styles && (styles = null);
            var _this = _super.call(this) || this;
            return _this.timings = timings, _this.styles = styles, _this;
          }
      ...
      return CompileStylesheetMetadata;
        ...
        CompileTemplateMetadata = function() {
          function CompileTemplateMetadata(_a) {
            ...
            this.interpolation = interpolation, this.isInline = isInline;
          }
        ...
        CompilerConfig = function() {
          function CompilerConfig(_a) {
            ...
            this.defaultEncapsulation = defaultEncapsulation, this.useJit = !!useJit, this.missingTranslation = missingTranslation || null, this.enableLegacyTemplate = enableLegacyTemplate !== !1;
          }
      ...
      return Token.prototype.isCharacter = function(code) {
        ...
        _Scanner = function() {
          ...
          return _Scanner.prototype.advance = function() {
            ...
            var str = this.input.substring(start, this.index),
                value = simple ? parseIntAutoRadix(str) : parseFloat(str);
            ...
            for (var buffer = "",
              ...
              if (this.peek == $BACKSLASH) {
                ...
                if (this.peek = this.peek, this.peek == $u) {
        ...
        if (this.expectCharacter($LBRACE), !this.optionalCharacter($RBRACE)) {
          ...
          do {
            ...
            keys.push({
              key: key,
              quoted: quoted
            }), this.expectCharacter($COLON), values.push(this.parsePipe());
          } while (this.optionalCharacter($COMMA));
      ...
      return _Visitor.prototype.extract = function(nodes, interpolationConfig) {
          ...
          return __extends(Xliff, _super), Xliff.prototype.write = function(messages, locale) {
            ...
            messages.forEach(function(message) {
              ...
              message.sources.forEach(function(source) {
                ...
                contextGroupTag.children.push(new CR(10), new Tag(_CONTEXT_TAG, {"context-type": "sourcefile"}, [new Text$2(source.filePath)]), new CR(10), new Tag(_CONTEXT_TAG, {"context-type": "linenumber"}, [new Text$2("" + source.startLine)]), new CR(8)), contextTags.push(new CR(8), contextGroupTag);
              });
              var transUnit = new Tag(_UNIT_TAG, {
                id: message.id,
                datatype: "html"
              });
              (_a = transUnit.children).push.apply(_a, [new CR(8), new Tag(_SOURCE_TAG, {}, visitor.serialize(message.nodes))].concat(contextTags)), message.description && transUnit.children.push(new CR(8), new Tag("note", {
                priority: "1",
                from: "description"
        ...
        _WriteVisitor = function() {
          ...
          return _WriteVisitor.prototype.visitText = function(text, context) {
            ...
            var ctype = getCtypeForTag(ph.tag),
                startTagPh = new Tag(_PLACEHOLDER_TAG, {
                  id: ph.startName,
                  ctype: ctype
                });
            if (ph.isVoid)
        ...
        XmlToI18n = function() {
          ...
          return XmlToI18n.prototype.convert = function(message, url) {
            ...
            var i18nNodes = this._errors.length > 0 || 0 == xmlIcu.rootNodes.length ? [] : visitAll(this, xmlIcu.rootNodes);
            return {
              i18nNodes: i18nNodes,
              errors: this._errors
            };
        ...
        Xliff2 = function(_super) {
          ...
          return __extends(Xliff2, _super), Xliff2.prototype.write = function(messages, locale) {
            ...
            messages.forEach(function(message) {
              ...
              segment.children.push(new CR(8), new Tag(_SOURCE_TAG$1, {}, visitor.serialize(message.nodes)), new CR(6)), unit.children.push(new CR(6), segment, new CR(4)), units.push(new CR(4), unit);
            });
            var file = new Tag("file", {
              original: "ng.template",
              id: "ngi18n"
            }, units.concat([new CR(2)])),
                xliff = new Tag(_XLIFF_TAG, {
                  version: _VERSION$1,
                  xmlns: _XMLNS$1,
        ...
        XmlToI18n$1 = function() {
          ...
          return XmlToI18n$1.prototype.convert = function(message, url) {
            var xmlIcu = (new XmlParser).parse(message, url, !0);
            this._errors = xmlIcu.errors;
            var i18nNodes = this._errors.length > 0 || 0 == xmlIcu.rootNodes.length ? [] : [].concat.apply([], visitAll(this, xmlIcu.rootNodes));
            return {
              i18nNodes: i18nNodes,
              errors: this._errors
            };
        ...
        _Visitor$2 = function() {
          ...
          return _Visitor$2.prototype.visitText = function(text, context) {
            ...
            var startEx = new Tag(_EXEMPLE_TAG, {}, [new Text$2("<" + ph.tag + ">")]),
                startTagPh = new Tag(_PLACEHOLDER_TAG$2, {name: ph.startName}, [startEx]);
            if (ph.isVoid)
              return [startTagPh];
            var closeEx = new Tag(_EXEMPLE_TAG, {}, [new Text$2("</" + ph.tag + ">")]),
                closeTagPh = new Tag(_PLACEHOLDER_TAG$2, {name: ph.closeName}, [closeEx]);
            return [startTagPh].concat(this.serialize(ph.children), [closeTagPh]);
          ...
          return XtbParser.prototype.parse = function(xtb, url) {
            ...
            switch (element.name) {
              case _TRANSLATIONS_TAG:
                this._bundleDepth++, this._bundleDepth > 1 && this._addError(element, "<" + _TRANSLATIONS_TAG + "> elements can not be nested");
        ...
        I18nToHtmlVisitor = function() {
          ...
          return I18nToHtmlVisitor.prototype.convert = function(srcMsg) {
            ...
            var _this = this,
                ...
                exp = this._srcMsg.placeholders.hasOwnProperty(icu.expression) ? this._srcMsg.placeholders[icu.expression] : icu.expression;
        ...
        NgModuleProviderAnalyzer = function() {
          function NgModuleProviderAnalyzer(reflector, ngModule, extraProviders, sourceSpan) {
            ...
            this.reflector = reflector, this._transformedProviders = new Map, this._seenProviders = new Map, this._errors = [], this._allProviders = new Map, ngModule.transitiveModule.modules.forEach(function(ngModuleType) {
              ...
              _resolveProviders([ngModuleProvider], ProviderAstType.PublicService, !0, sourceSpan, _this._errors, _this._allProviders);
          ...
          return BindingParser.prototype.getUsedPipes = function() {
            ...
            if (parts.length > 1)
              if (parts[0] == ATTRIBUTE_PREFIX) {
                ...
                parts[0] == CLASS_PREFIX ? (boundPropertyName = parts[1], bindingType = PropertyBindingType.Class, securityContexts = [_angular_core.SecurityContext.NONE]) : parts[0] == STYLE_PREFIX && (unit = parts.length > 2 ? parts[2] : null, boundPropertyName = parts[1], bindingType = PropertyBindingType.Style, securityContexts = [_angular_core.SecurityContext.STYLE]);
    ...
    var TemplateParseVisitor = function() {
      ...
      return TemplateParseVisitor.prototype.visitExpansion = function(expansion, context) {
        ...
        var ngContentIndex = parent.findNgContentIndex(TEXT_CSS_SELECTOR),
            expr = this._bindingParser.parseInterpolation(text.value, text.sourceSpan);
        ...
        var name = this._normalizeAttributeName(attr.name),
            ...
            hasBinding = !1;
        if (null !== bindParts)
          if (hasBinding = !0, null != bindParts[KW_BIND_IDX])
            this._bindingParser.parsePropertyBinding(bindParts[IDENT_KW_IDX], value, !1, srcSpan, targetMatchableAttrs, targetProps);
        ...
        var _this = this,
            ...
            directiveAsts = directives.map(function(directive) {
              ...
              _this._createDirectivePropertyAsts(directive.inputs, props, directiveProperties, targetBoundDirectivePropNames), elementOrDirectiveRefs.forEach(function(elOrDirRef) {
                (0 === elOrDirRef.value.length && directive.isComponent || directive.exportAs == elOrDirRef.value) && (targetReferences.push(new ReferenceAst(elOrDirRef.name, createTokenForReference(directive.type.reference), elOrDirRef.sourceSpan)), matchedReferences.add(elOrDirRef.name));
              });
        ...
        DirectiveResolver = function() {
          ...
          return DirectiveResolver.prototype.isDirective = function(type) {
            ...
            return Object.keys(propertyMetadata).forEach(function(propName) {
              ...
              output && (output.bindingPropertyName ? outputs.push(propName + ": " + output.bindingPropertyName) : outputs.push(propName));
    ...
    var ERROR_COLLECTOR_TOKEN = new _angular_core.InjectionToken("ErrorCollector"),
        CompileMetadataResolver = function() {
          ...
          return CompileMetadataResolver.prototype.getReflector = function() {
            ...
            var _this = this;
            if (directiveType = _angular_core.resolveForwardRef(directiveType), !directiveType)
              return null;
            ...
            meta.imports && flattenAndDedupeArray(meta.imports).forEach(function(importedType) {
              ...
              if (!_this._checkSelfImport(moduleType, importedModuleType)) {
                ...
                return importedModuleSummary ? void importedModules.push(importedModuleSummary) : void _this._reportError(syntaxError("Unexpected " + _this._getTypeDescriptor(importedType) + " '" + stringifyType(importedType) + "' imported by the module '" + stringifyType(moduleType) + "'. Please add a @NgModule annotation."), moduleType);
              }
            ...
            var compileToken;
            return compileToken = "string" == typeof token ? {value: token} : {identifier: {reference: token}};
              ...
              if (Array.isArray(provider))
                ...
                if (provider && "object" == typeof provider && provider.hasOwnProperty("provide"))
                  ...
                  if (!isValidType(provider)) {
                    ...
                    return void _this._reportError(syntaxError("Invalid " + (debugInfo ? debugInfo : "provider") + " - only instances of Provider and Type are allowed, got: [" + providersInfo + "]"), type);
                  }
      ...
      return Statement.prototype.visitStatement = function(visitor, context) {}, Statement.prototype.hasModifier = function(modifier) {
        ...
        _ValueOutputAstTransformer = function() {
          ...
          return _ValueOutputAstTransformer.prototype.visitArray = function(arr, type) {
            ...
            var _this = this,
                entries = [],
                quotedSet = new Set(map && map[QUOTED_KEYS]);
            return Object.keys(map).forEach(function(key) {
    ...
    var VERSION$1 = 3,
        ...
        EmitterVisitorContext = function() {
          ...
          return EmitterVisitorContext.createRoot = function() {
            ...
            if (emittedLine)
              for (var columnsLeft = column - emittedLine.indent,
        ...
        AbstractEmitterVisitor = function() {
          ...
          return AbstractEmitterVisitor.prototype.visitExpressionStmt = function(stmt, ctx) {
            ...
            var name = expr.name;
            return null != expr.builtin && (name = this.getBuiltinMethodName(expr.builtin), null == name) ? null : (ctx.print(expr, "." + name + "("), this.visitAllExpressions(expr.args, ctx, ","), ctx.print(expr, ")"), null);
        ...
        _TsEmitterVisitor = function(_super) {
          ...
          return __extends(_TsEmitterVisitor, _super), _TsEmitterVisitor.prototype.visitType = function(t, ctx, defaultType) {
            ...
            if (ctx.print(null, name), this.typeExpression > 0) {
              ...
              suppliedParameters.length > 0 && (ctx.print(null, "<"), this.visitAllObjects(function(type) {
    ...
    var BOOLEAN = "boolean",
        ...
        DomElementSchemaRegistry = function(_super) {
          ...
          return __extends(DomElementSchemaRegistry, _super), DomElementSchemaRegistry.prototype.hasProperty = function(tagName, propName, schemaMetas) {
            ...
            return ctx ? ctx : (ctx = SECURITY_SCHEMA["*|" + propName], ctx ? ctx : _angular_core.SecurityContext.NONE);
      ...
      return ShadowCss.prototype.shimCssText = function(cssText, selector, hostSelector) {
        ...
        for (var res,
          ...
          var separator = res[1],
              ...
              scopedPart = startIndex >= scopeAfter ? _scopeSelectorPart(part) : part;
          scopedSelector += scopedPart + " " + separator + " ", startIndex = sep.lastIndex;
        }
      ...
      return __extends(_BuiltinAstConverter, _super), _BuiltinAstConverter.prototype.visitPipe = function(ast, context) {
        ...
        _AstToIrVisitor = function() {
          ...
          return _AstToIrVisitor.prototype.visitBinary = function(ast, mode) {
            ...
            return result ? result : (this._nodeMap.get(ast) || ast).visit(this, mode);
        ...
        ViewCompiler = function() {
          function ViewCompiler(_config, _reflector, _schemaRegistry) {
            this._config = _config, this._reflector = _reflector, this._schemaRegistry = _schemaRegistry;
          }
        ...
        ViewBuilder = function() {
          ...
          return Object.defineProperty(ViewBuilder.prototype, "viewName", {
            ...
            var childCount = this.nodes.length - nodeIndex - 1,
                ...
                compView = NULL_EXPR;
            compAst && (compView = this.outputCtx.importExpr(compAst.directive.componentViewType), compRendererType = this.outputCtx.importExpr(compAst.directive.rendererType)), this.nodes[nodeIndex] = function() {
              return {
                sourceSpan: ast.sourceSpan,
                nodeFlags: 1 | flags,
            ...
            var self = this,
                ...
                nodeDefExprs = this.nodes.map(function(factory, nodeIndex) {
                  ...
                  updateRenderer && updateRendererStmts.push.apply(updateRendererStmts, createUpdateStatements(nodeIndex, sourceSpan, updateRenderer, !1)), updateDirectives && updateDirectivesStmts.push.apply(updateDirectivesStmts, createUpdateStatements(nodeIndex, sourceSpan, updateDirectives, (327680 & nodeFlags) > 0));
                  var logWithNodeDef = 3 & nodeFlags ? new CommaExpr([LOG_VAR$1.callFn([]).callFn([]), nodeDef]) : nodeDef;
        ...
        FromJsonDeserializer = function(_super) {
          ...
          return __extends(FromJsonDeserializer, _super), FromJsonDeserializer.prototype.deserialize = function(json) {
            var _this = this,
                ...
                importAs = [];
            this.symbols = [], data.symbols.forEach(function(serializedSymbol) {
        ...
        AotCompiler = function() {
          ...
          return AotCompiler.prototype.clearCache = function() {
            ...
            var _this = this,
                ...
                sourceModules = files.map(function(file) {
            ...
            var _this = this,
                importExpr$$1 = function(symbol, typeParams) {
        ...
        StaticReflector = function() {
          ...
          return StaticReflector.prototype.componentModuleUrl = function(typeOrFunc) {
            ...
            function simplifyInContext(context, value, depth, references) {
              ...
              function simplify(expression) {
                ...
                if (expression instanceof StaticSymbol) {
                  ...
                  return declarationValue ? simplifyInContext(staticSymbol, declarationValue, depth + 1, references) : staticSymbol;
                }
                if (expression) {
                  if (expression.__symbolic) {
                    ...
                    switch (expression.__symbolic) {
                      ...
                      case "if":
                        ...
                        return simplify(condition ? expression.thenExpression : expression.elseExpression);
                      case "pre":
                      ...
                      case "index":
                        var indexTarget = simplify(expression.expression),
                            index = simplify(expression.index);
                      ...
                      case "select":
                        ...
                        if (selectTarget instanceof StaticSymbol) {
                          ...
                          return declarationValue ? simplifyInContext(selectContext, declarationValue, depth + 1, references) : selectContext;
                        }
                      ...
                      case "new":
                      case "call":
                        if (staticSymbol = simplifyInContext(context, expression.expression, depth + 1, 0), staticSymbol instanceof StaticSymbol) {
            ...
            var _this = this,
                ...
                calling = new Map,
                recordedSimplifyInContext = function(context, value) {
                  try {
                ...
                result = this.errorRecorder ? recordedSimplifyInContext(context, value) : simplifyInContext(context, value, 0, 0);
      ...
      return __extends(PopulatedScope, _super), PopulatedScope.prototype.resolve = function(name) {
        ...
        StaticSymbolResolver = function() {
          ...
          return StaticSymbolResolver.prototype.resolveSymbol = function(staticSymbol) {
            ...
            return result ? result : (result = this._resolveSymbolFromSummary(staticSymbol)) ? result : (this._createSymbolsOf(staticSymbol.filePath), result = this.resolvedSymbols.get(staticSymbol));
            ...
            if (!this.resolvedFilePaths.has(filePath)) {
              ...
              if (metadata.exports)
                for (var _loop_1 = function(moduleExport) {
            ...
            if (!moduleMetadata) {
              ...
              if (moduleMetadata || (moduleMetadata = {
                ...
                module: module,
                metadata: {}
              }), moduleMetadata.version != SUPPORTED_SCHEMA_VERSION) {
                var errorMessage = 2 == moduleMetadata.version ? "Unsupported metadata version " + moduleMetadata.version + " for module " + module + ". This module should be compiled with a newer version of ngc" : "Metadata version mismatch for module " + module + ", found version " + moduleMetadata.version + ", expected " + SUPPORTED_SCHEMA_VERSION;
        ...
        StatementInterpreter = function() {
          ...
          return StatementInterpreter.prototype.debugAst = function(ast) {
            ...
            return condition ? this.visitAllStatements(stmt.trueCase, ctx) : null != stmt.falseCase ? this.visitAllStatements(stmt.falseCase, ctx) : null;
        ...
        JitCompiler = function() {
          ...
          return Object.defineProperty(JitCompiler.prototype, "injector", {
            ...
            compiledTemplate && this._compiledTemplateCache.delete(type);
