...
(function(process) {
  (function() {
      ...
      function outletLink(scope, element, attrs, ctrls, $transclude) {
        var Outlet = (function() {
          ...
          Outlet.prototype.routerCanReuse = function(nextInstruction) {
            var result;
            if (!this.currentInstruction || this.currentInstruction.componentType !== nextInstruction.componentType) {
              result = false;
              ...
              result = nextInstruction === this.currentInstruction || angular.equals(nextInstruction.params, this.currentInstruction.params);
            }
    ...
    function routerTriggerDirective($q) {
      return {
        ...
        link: function(scope, element, attr, ngOutletCtrl) {
          ...
          var currentComponent = outlet.currentController = element.controller(ngOutletCtrl.$$componentName);
    ...
    angular.module('ngComponentRouter', []).directive('ngOutlet', ['$animate', '$q', '$rootRouter', ngOutletDirective]).directive('ngOutlet', ['$compile', ngOutletFillContentDirective]).directive('ngLink', ['$rootRouter', '$parse', ngLinkDirective]).directive('$router', ['$q', routerTriggerDirective]);
    angular.module('ng').provider('$$directiveIntrospector', DirectiveIntrospectorProvider).config(['$compileProvider', '$$directiveIntrospectorProvider', compilerProviderDecorator]);
    angular.module('ngComponentRouter').value('$route', null).value('$routerRootComponent', new Object()).factory('$rootRouter', ['$q', '$location', '$$directiveIntrospector', '$browser', '$rootScope', '$injector', '$routerRootComponent', routerFactory]);
    function routerFactory($q, $location, $$directiveIntrospector, $browser, $rootScope, $injector, $routerRootComponent) {
      ...
      var reflector = {annotations: function(fn) {
      ...
      var $__router_47_location__ = {Location: Location};
      function Location() {}
      ...
      function convertUrlParamsToArray(urlParams) {
        ...
        StringMapWrapper.forEach(urlParams, function(value, key) {
      ...
      var RouteLifecycleHook = (function() {
        ...
        RouteLifecycleHook = __decorate([CONST()], RouteLifecycleHook);
      ...
      var CanActivate = (function() {
        ...
        CanActivate = __decorate([CONST()], CanActivate);
        return CanActivate;
      })();
      ...
      var RouteConfig = (function() {
        ...
        RouteConfig = __decorate([CONST()], RouteConfig);
        return RouteConfig;
      })();
      ...
      var AbstractRoute = (function() {
        ...
        AbstractRoute = __decorate([CONST()], AbstractRoute);
      ...
      var AuxRoute = (function(_super) {
        ...
        AuxRoute = __decorate([CONST()], AuxRoute);
        return AuxRoute;
      })(AbstractRoute);
      ...
      var AsyncRoute = (function(_super) {
        ...
        AsyncRoute = __decorate([CONST()], AsyncRoute);
        return AsyncRoute;
      })(AbstractRoute);
      ...
      var Redirect = (function(_super) {
        ...
        Redirect = __decorate([CONST()], Redirect);
        return Redirect;
      })(AbstractRoute);
      ...
      var RouteRegistry = (function() {
        ...
        RouteRegistry.prototype._recognize = function(parsedUrl, ancestorInstructions, _aux) {
          ...
          var parentComponent = isPresent(parentInstruction) ? parentInstruction.component.componentType : this._rootComponent;
          var rules = this._rules.get(parentComponent);
          if (isBlank(rules)) {
        ...
        RouteRegistry.prototype.generate = function(linkParams, ancestorInstructions, _aux) {
          ...
          if (ListWrapper.first(params) == '') {
            ...
            if (ListWrapper.first(params) == '.') {
              ...
              var parentRouteExists = isPresent(grandparentComponentType) && this.hasRoute(routeName, grandparentComponentType);
