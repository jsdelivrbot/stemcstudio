      ...
      for (var p in b)
        ...
        DefaultUrlSerializer = function() {
          ...
          return DefaultUrlSerializer.prototype.parse = function(url) {
            ...
            return "/" + serializeSegment(tree.root, !0) + serializeQueryParams(tree.queryParams) + ("string" == typeof tree.fragment ? "#" + encodeUriQuery(tree.fragment) : "");
        ...
        VERSION = new _angular_core.Version("5.2.8");
