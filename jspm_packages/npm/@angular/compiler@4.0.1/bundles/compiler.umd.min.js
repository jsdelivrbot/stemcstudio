  ...
  !function(global, factory) {
    ...
    function createAotCompiler(compilerHost, options) {
      var translations = options.translations || "",
          ...
          staticReflector = new StaticReflector(symbolResolver);
    ...
    var __extends = function(d, b) {
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        VERSION = new _angular_core.Version("4.0.1"),
        TextAst = function() {
        ...
        CompileMetadataResolver = function() {
          ...
          return CompileMetadataResolver.prototype.clearCacheFor = function(type) {
            ...
            return exportedNonModuleIdentifiers.forEach(function(exportedId) {
              transitiveModule.directivesSet.has(exportedId.reference) ? (exportedDirectives.push(exportedId), transitiveModule.addExportedDirective(exportedId)) : transitiveModule.pipesSet.has(exportedId.reference) ? (exportedPipes.push(exportedId), transitiveModule.addExportedPipe(exportedId)) : _this._reportError(syntaxError("Can't export " + _this._getTypeDescriptor(exportedId.reference) + " " + stringifyType(exportedId.reference) + " from " + stringifyType(moduleType) + " as it was neither declared nor imported!"), moduleType);
            ...
            }) : (q.selector || this._reportError(syntaxError("Can't construct a query for the property \"" + propertyName + '" of "' + stringifyType(typeOrFunc) + "\" since the query selector wasn't defined."), typeOrFunc), selectors = [this._getTokenMetadata(q.selector)]), {
              selectors: selectors,
              first: q.first,
    ...
    var LOG_VAR = variable("l"),
        ...
        Serializer$1 = function(_super) {
          ...
          return __extends(Serializer$1, _super), Serializer$1.prototype.addOrMergeSummary = function(summary) {
            ...
            symbolMeta && "class" === symbolMeta.__symbolic && (symbolMeta = {
              __symbolic: "class",
        ...
        StaticReflector = function() {
          function StaticReflector(symbolResolver, knownMetadataClasses, knownMetadataFunctions, errorRecorder) {
            ...
            var _this = this;
            this.symbolResolver = symbolResolver, this.errorRecorder = errorRecorder, this.annotationCache = new Map, this.propertyCache = new Map, this.parameterCache = new Map, this.methodCache = new Map, this.conversionMap = new Map, this.initializeConversionMap(), knownMetadataClasses.forEach(function(kc) {
          ...
          return StaticReflector.prototype.importUri = function(typeOrFunc) {
            ...
            if (!propMetadata) {
              var classMetadata = this.getTypeMetadata(type);
              if (propMetadata = {}, classMetadata.extends) {
                var parentType = this.trySimplify(type, classMetadata.extends);
            ...
            try {
              ...
              if (!parameters_1) {
                ...
                if (ctorData) {
                  ...
                  var parentType = this.trySimplify(type, classMetadata.extends);
                  parentType instanceof StaticSymbol && (parameters_1 = this.parameters(parentType));
                }
            ...
            if (!methodNames) {
              var classMetadata = this.getTypeMetadata(type);
              if (methodNames = {}, classMetadata.extends) {
                var parentType = this.trySimplify(type, classMetadata.extends);
                if (parentType instanceof StaticSymbol) {
        ...
        Extractor = function() {
          ...
          return Extractor.prototype.extract = function(rootFiles) {
            ...
            var htmlParser = new I18NHtmlParser(new HtmlParser),
                ...
                staticReflector = new StaticReflector(staticSymbolResolver);
            StaticAndDynamicReflectionCapabilities.install(staticReflector);
