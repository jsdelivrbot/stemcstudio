...
!function(global, factory) {
  ...
  function setupTestingRouter(urlSerializer, contexts, location, loader, compiler, injector, routes, opts, urlHandlingStrategy) {
    ...
    return opts && (isUrlHandlingStrategy(opts) ? router.urlHandlingStrategy = opts : opts.paramsInheritanceStrategy && (router.paramsInheritanceStrategy = opts.paramsInheritanceStrategy)), urlHandlingStrategy && (router.urlHandlingStrategy = urlHandlingStrategy), router;
  }
  var SpyNgModuleFactoryLoader = function() {
    ...
    return Object.defineProperty(SpyNgModuleFactoryLoader.prototype, "stubbedModules", {
      ...
      RouterTestingModule = function() {
        function RouterTestingModule() {}
        return RouterTestingModule.withRoutes = function(routes, config) {
          return {
