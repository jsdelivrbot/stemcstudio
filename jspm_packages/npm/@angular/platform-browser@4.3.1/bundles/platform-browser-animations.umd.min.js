    ...
    for (var p in b)
      ...
      BrowserAnimationBuilder = function(_super) {
        function BrowserAnimationBuilder(rootRenderer) {
          ...
          return _this._renderer = rootRenderer.createRenderer(document.body, typeData), _this;
        }
    ...
    return Object.defineProperty(BaseAnimationRenderer.prototype, "data", {
      ...
      AnimationRenderer = function(_super) {
        ...
        return __extends(AnimationRenderer, _super), AnimationRenderer.prototype.setProperty = function(el, name, value) {
          name.charAt(0) == ANIMATION_PREFIX ? "." == name.charAt(1) && name == DISABLE_ANIMATIONS_FLAG ? this.disableAnimations(el, !!value) : this.engine.process(this.namespaceId, el, name.substr(1), value) : this.delegate.setProperty(el, name, value);
