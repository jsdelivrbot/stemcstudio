        ...
        DefaultUrlSerializer = function() {
          ...
          return DefaultUrlSerializer.prototype.parse = function(url) {
            ...
            var segment = "/" + serializeSegment(tree.root, !0),
                ...
                fragment = "string" == typeof tree.fragment ? "#" + encodeURI(tree.fragment) : "";
 ...
 while (this.consumeOptional("&"));
        ...
        ApplyRedirects = function() {
          ...
          return ApplyRedirects.prototype.apply = function() {
            ...
            return forEach(redirectToParams, function(v, k) {
              var copySourceValue = "string" == typeof v && v.startsWith(":");
              if (copySourceValue) {
          ...
          return Object.defineProperty(ActivatedRouteSnapshot.prototype, "routeConfig", {
            ...
            var url = this.url.map(function(segment) {
              return segment.toString();
                ...
                matched = this._routeConfig ? this._routeConfig.path : "";
          ...
          return PreActivation.prototype.traverse = function(parentContexts) {
            ...
            if (curr && future._routeConfig === curr._routeConfig) {
              if (this.shouldRunGuardsAndResolvers(curr, future, future._routeConfig.runGuardsAndResolvers)) {
                ...
                future.data = curr.data, future._resolvedData = curr._resolvedData;
              future.component ? this.traverseChildRoutes(futureNode, currNode, context ? context.children : null, futurePath) : this.traverseChildRoutes(futureNode, currNode, parentContexts, futurePath);
            } else
            ...
            return waitForMap(resolve, function(k, v) {
              ...
              return wrapIntoObservable(resolver.resolve ? resolver.resolve(future, _this.future) : resolver(future, _this.future));
            });
    ...
    var RouterLinkActive = function() {
      ...
      return Object.defineProperty(RouterLinkActive.prototype, "isActive", {
        ...
        if (this.links && this.linksWithHrefs && this.router.navigated) {
          ...
          this.active !== hasActiveLinks && (this.classes.forEach(function(c) {
    ...
    var RouterInitializer = function() {
      ...
      return RouterInitializer.prototype.appInitializer = function() {
        var _this = this,
            p = this.injector.get(_angular_common.LOCATION_INITIALIZED, Promise.resolve(null));
