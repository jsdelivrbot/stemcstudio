      ...
      for (var p in b)
        ...
        DefaultUrlSerializer = function() {
          ...
          return DefaultUrlSerializer.prototype.parse = function(url) {
            ...
            return "/" + serializeSegment(tree.root, !0) + serializeQueryParams(tree.queryParams) + ("string" == typeof tree.fragment ? "#" + encodeUriFragment(tree.fragment) : "");
        ...
        Router = function() {
          ...
          return Router.prototype.resetRootComponentType = function(rootComponentType) {
            ...
            validateConfig(config), this.config = config.map(copyConfig), this.navigated = !1;
        ...
        VERSION = new _angular_core.Version("5.2.11");
