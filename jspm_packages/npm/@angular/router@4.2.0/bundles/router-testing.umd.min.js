...
!function(global, factory) {
  ...
  function setupTestingRouter(urlSerializer, contexts, location, loader, compiler, injector, routes, urlHandlingStrategy) {
    ...
    return urlHandlingStrategy && (router.urlHandlingStrategy = urlHandlingStrategy), router;
  }
  var SpyNgModuleFactoryLoader = function() {
    function SpyNgModuleFactoryLoader(compiler) {
      this.compiler = compiler, this._stubbedModules = {};
    }
    return Object.defineProperty(SpyNgModuleFactoryLoader.prototype, "stubbedModules", {
      get: function() {
      ...
      return this._stubbedModules[path] ? this._stubbedModules[path] : Promise.reject(new Error("Cannot find module " + path));
    }, SpyNgModuleFactoryLoader;
  }();
  SpyNgModuleFactoryLoader.decorators = [{type: _angular_core.Injectable}], SpyNgModuleFactoryLoader.ctorParameters = function() {
    return [{type: _angular_core.Compiler}];
  };
  var RouterTestingModule = function() {
    function RouterTestingModule() {}
    return RouterTestingModule.withRoutes = function(routes) {
      return {
