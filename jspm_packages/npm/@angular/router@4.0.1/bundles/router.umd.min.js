...
(function(process) {
  !function(global, factory) {
    ...
    function defaultUrlMatcher(segments, segmentGroup, route) {
      for (var path = route.path,
        ...
        var current = segments[currentIndex],
            p = parts[i],
            isPosParam = p.startsWith(":");
        if (!isPosParam && p !== current.path)
          return null;
        isPosParam && (posParams[p.substring(1)] = current), consumed.push(current), currentIndex++;
      }
      return "full" === route.pathMatch && (segmentGroup.hasChildren() || currentIndex < segments.length) ? null : {
        consumed: consumed,
        posParams: posParams
      };
    }
    ...
    function waitForMap(obj, fn) {
      var waitFor = [],
          res = {};
      if (forEach(obj, function(a, k) {
        k === PRIMARY_OUTLET && waitFor.push(rxjs_operator_map.map.call(fn(k, a), function(_) {
          return res[k] = _, _;
        }));
        ...
        var concatted$ = rxjs_operator_concatAll.concatAll.call(rxjs_observable_of.of.apply(void 0, waitFor)),
            last$ = rxjs_operator_last.last.call(concatted$);
    ...
    function wrapIntoObservable(value) {
      return _angular_core.ɵisObservable(value) ? value : _angular_core.ɵisPromise(value) ? rxjs_observable_fromPromise.fromPromise(value) : rxjs_observable_of.of(value);
    }
    ...
    function addEmptySegmentsToChildrenIfNeeded(segmentGroup, slicedSegments, routes, children) {
      for (var res = {},
        ...
        var r = routes_1[_i];
        emptyPathRedirect(segmentGroup, slicedSegments, r) && !children[getOutlet$1(r)] && (res[getOutlet$1(r)] = new UrlSegmentGroup([], {}));
      }
    ...
    function createChildrenForEmptySegments(routes, primarySegmentGroup) {
      ...
      for (var _i = 0,
        ...
        var r = routes_2[_i];
        "" === r.path && getOutlet$1(r) !== PRIMARY_OUTLET && (res[getOutlet$1(r)] = new UrlSegmentGroup([], {}));
      }
      return res;
    }
    ...
    function findPath(expected, c, collected) {
      if (collected.push(c), expected === c.value)
        return collected;
      for (var _i = 0,
          _a = c.children; _i < _a.length; _i++) {
        var cc = _a[_i],
            cloned = collected.slice(0),
            r = findPath(expected, cc, cloned);
        if (r.length > 0)
          return r;
      }
      return [];
    ...
    function inheritedParamsDataResolve(route) {
      ...
      return pathToRoot.slice(inhertingStartingFrom).reduce(function(res, curr) {
        var params = __assign$2({}, res.params, curr.params),
            ...
            resolve = __assign$2({}, res.resolve, curr._resolvedData);
        return {
          params: params,
          data: data,
          resolve: resolve
    ...
    function addEmptyPathsToChildrenIfNeeded(segmentGroup, slicedSegments, routes, children) {
      for (var res = {},
        ...
        if (emptyPathMatch(segmentGroup, slicedSegments, r) && !children[getOutlet$2(r)]) {
          ...
          s._sourceSegment = segmentGroup, s._segmentIndexShift = segmentGroup.segments.length, res[getOutlet$2(r)] = s;
        }
      }
    ...
    function createChildrenForEmptyPaths(segmentGroup, consumedSegments, routes, primarySegment) {
      ...
      for (var _i = 0,
        ...
        if ("" === r.path && getOutlet$2(r) !== PRIMARY_OUTLET) {
          var s = new UrlSegmentGroup([], {});
          s._sourceSegment = segmentGroup, s._segmentIndexShift = consumedSegments.length, res[getOutlet$2(r)] = s;
        }
      }
      return res;
    }
    ...
    function getOutlet(outletMap, route) {
      ...
      if (!outlet) {
        ...
        throw route.outlet === PRIMARY_OUTLET ? new Error("Cannot find primary outlet to load '" + componentName + "'") : new Error("Cannot find the outlet " + route.outlet + " to load '" + componentName + "'");
      }
      return outlet;
    }
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        DefaultUrlSerializer = function() {
          ...
          return DefaultUrlSerializer.prototype.parse = function(url) {
            ...
            var segment = "/" + serializeSegment(tree.root, !0),
                ...
                fragment = null !== tree.fragment && void 0 !== tree.fragment ? "#" + encodeURI(tree.fragment) : "";
        ...
        UrlParser = function() {
          ...
          return UrlParser.prototype.peekStartsWith = function(str) {
            ...
            return this.remaining.startsWith("/") && this.capture("/"), "" === this.remaining || this.remaining.startsWith("?") || this.remaining.startsWith("#") ? new UrlSegmentGroup([], {}) : new UrlSegmentGroup([], this.parseChildren());
          }, UrlParser.prototype.parseChildren = function() {
            if (0 == this.remaining.length)
              return {};
            this.peekStartsWith("/") && this.capture("/");
            var paths = [];
            for (this.peekStartsWith("(") || paths.push(this.parseSegments()); this.peekStartsWith("/") && !this.peekStartsWith("//") && !this.peekStartsWith("/("); )
              this.capture("/"), paths.push(this.parseSegments());
            var children = {};
            this.peekStartsWith("/(") && (this.capture("/"), children = this.parseParens(!0));
            var res = {};
            return this.peekStartsWith("(") && (res = this.parseParens(!1)), (paths.length > 0 || Object.keys(children).length > 0) && (res[PRIMARY_OUTLET] = new UrlSegmentGroup(paths, children)), res;
            ...
            this.capture(path);
            var matrixParams = {};
            return this.peekStartsWith(";") && (matrixParams = this.parseMatrixParams()), new UrlSegment(decode(path), matrixParams);
          }, UrlParser.prototype.parseQueryParams = function() {
            var params = {};
            if (this.peekStartsWith("?"))
              for (this.capture("?"), this.parseQueryParam(params); this.remaining.length > 0 && this.peekStartsWith("&"); )
                this.capture("&"), this.parseQueryParam(params);
            return params;
          }, UrlParser.prototype.parseFragment = function() {
            return this.peekStartsWith("#") ? decodeURI(this.remaining.substring(1)) : null;
          }, UrlParser.prototype.parseMatrixParams = function() {
            for (var params = {}; this.remaining.length > 0 && this.peekStartsWith(";"); )
              this.capture(";"), this.parseParam(params);
            return params;
            ...
            var segments = {};
            for (this.capture("("); !this.peekStartsWith(")") && this.remaining.length > 0; ) {
              var path = matchSegments(this.remaining),
              ...
              segments[outletName] = 1 === Object.keys(children).length ? children[PRIMARY_OUTLET] : new UrlSegmentGroup([], children), this.peekStartsWith("//") && this.capture("//");
            }
            return this.capture(")"), segments;
          }, UrlParser;
        }(),
        ...
        NoMatch = function() {
          function NoMatch(segmentGroup) {
            void 0 === segmentGroup && (segmentGroup = null), this.segmentGroup = segmentGroup;
          }
          return NoMatch;
        }(),
        ...
        RouterState = function(_super) {
          function RouterState(root, snapshot) {
            ...
            return _this.snapshot = snapshot, setRouterStateSnapshot(_this, root), _this;
          }
        ...
        RouterStateSnapshot = function(_super) {
          function RouterStateSnapshot(url, root) {
            var _this = _super.call(this, root) || this;
            return _this.url = url, setRouterStateSnapshot(_this, root), _this;
          }
        ...
        Recognizer = function() {
          ...
          return Recognizer.prototype.recognize = function() {
            try {
              ...
              return this.inheriteParamsAndData(routeState._root), rxjs_observable_of.of(routeState);
            } catch (e) {
              return new rxjs_Observable.Observable(function(obs) {
                return obs.error(e);
              });
            ...
            return id !== this.navigationId ? (this.location.go(this.urlSerializer.serialize(this.currentUrlTree)), this.routerEvents.next(new NavigationCancel(id, this.serializeUrl(url), "Navigation ID " + id + " is not equal to the current navigation id " + this.navigationId)), Promise.resolve(!1)) : new Promise(function(resolvePromise, rejectPromise) {
              ...
              var preActivation,
                  ...
                  preactivationTraverse$ = rxjs_operator_map.map.call(beforePreactivationDone$, function(_a) {
                    ...
                    return preActivation = new PreActivation(snapshot, _this.currentRouterState.snapshot, moduleInjector), preActivation.traverse(_this.outletMap), {
                      appliedUrl: appliedUrl,
                      snapshot: snapshot
                    };
                  }),
                  preactivationCheckGuards$ = rxjs_operator_mergeMap.mergeMap.call(preactivationTraverse$, function(_a) {
                    var appliedUrl = _a.appliedUrl,
                        snapshot = _a.snapshot;
                    return _this.navigationId !== id ? rxjs_observable_of.of(!1) : rxjs_operator_map.map.call(preActivation.checkGuards(), function(shouldActivate) {
                      return {
                        appliedUrl: appliedUrl,
                        snapshot: snapshot,
        ...
        PreActivation = function() {
          ...
          return PreActivation.prototype.traverse = function(parentOutletMap) {
            ...
            var _this = this;
            if (0 === this.canDeactivateChecks.length && 0 === this.canActivateChecks.length)
              return rxjs_observable_of.of(!0);
            ...
            var _this = this;
            if (0 === this.canActivateChecks.length)
              return rxjs_observable_of.of(null);
            ...
            var future = futureNode.value,
                ...
                outlet = parentOutletMap ? parentOutletMap._outlets[futureNode.value.outlet] : null;
            curr && future._routeConfig === curr._routeConfig ? (this.shouldRunGuardsAndResolvers(curr, future, future._routeConfig.runGuardsAndResolvers) ? (this.canActivateChecks.push(new CanActivate(futurePath)), this.canDeactivateChecks.push(new CanDeactivate(outlet.component, curr))) : (future.data = curr.data, future._resolvedData = curr._resolvedData), future.component ? this.traverseChildRoutes(futureNode, currNode, outlet ? outlet.outletMap : null, futurePath) : this.traverseChildRoutes(futureNode, currNode, parentOutletMap, futurePath)) : (curr && this.deactiveRouteAndItsChildren(currNode, outlet), this.canActivateChecks.push(new CanActivate(futurePath)), future.component ? this.traverseChildRoutes(futureNode, null, outlet ? outlet.outletMap : null, futurePath) : this.traverseChildRoutes(futureNode, null, parentOutletMap, futurePath));
        ...
        ActivateRoutes = function() {
          ...
          return ActivateRoutes.prototype.activate = function(parentOutletMap) {
            ...
            this.deactivateChildRoutes(futureRoot, currRoot, parentOutletMap), advanceActivatedRoute(this.futureState.root), this.activateChildRoutes(futureRoot, currRoot, parentOutletMap);
            ...
            if (future === curr)
              ...
              curr && this.deactiveRouteAndItsChildren(currNode, parentOutletMap);
            ...
            if (future === curr)
              ...
              if (this.routeReuseStrategy.shouldAttach(future.snapshot)) {
                ...
                this.routeReuseStrategy.store(future.snapshot, null), outlet.attach(stored.componentRef, stored.route.value), advanceActivatedRouteNodeAndItsChildren(stored.route);
              } else {
                var outletMap = new RouterOutletMap;
                this.placeComponentIntoOutlet(outletMap, future, outlet), this.activateChildRoutes(futureNode, null, outletMap);
              }
            } else
              advanceActivatedRoute(future), this.activateChildRoutes(futureNode, null, parentOutletMap);
    ...
    var RouterLinkActive = function() {
      ...
      return Object.defineProperty(RouterLinkActive.prototype, "isActive", {
        ...
        if (this.links && this.linksWithHrefs && this.router.navigated) {
          ...
          this.active !== hasActiveLinks && (this.active = hasActiveLinks, this.classes.forEach(function(c) {
    ...
    var RouterOutlet = function() {
      ...
      return RouterOutlet.prototype.ngOnDestroy = function() {
        ...
        return this.activated = null, this._activatedRoute = null, r;
        ...
        this.outletMap = outletMap, this._activatedRoute = activatedRoute;
        var snapshot = activatedRoute._futureSnapshot,
            component = snapshot._routeConfig.component,
            factory = resolver.resolveComponentFactory(component),
            inj = _angular_core.ReflectiveInjector.fromResolvedProviders(providers, injector);
        ...
        var factory = resolver.resolveComponentFactory(component),
            injector = new OutletInjector(activatedRoute, outletMap, this.location.injector);
        this.activated = this.location.createComponent(factory, this.location.length, injector, []), this.activated.changeDetectorRef.detectChanges(), this.activateEvents.emit(this.activated.instance);
      }, RouterOutlet;
    }();
