...
(function(process) {
  !function(global, factory) {
    ...
    function syntaxError(msg) {
      var error = Error(msg);
      return error[ERROR_SYNTAX_ERROR] = !0, error;
    }
    ...
    var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
      ...
      for (var p in b)
        ...
        VERSION = new _angular_core.Version("4.2.6"),
        TextAst = function() {
    ...
    var ParseError = function() {
      ...
      return ParseError.prototype.toString = function() {
        var ctx = this.span.start.getContext(100, 3),
            ...
            details = this.span.details ? ", " + this.span.details : "";
    ...
    var LOG_VAR$1 = variable("_l"),
        ...
        AotCompiler = function() {
          ...
          return AotCompiler.prototype.clearCache = function() {
            ...
            return ngModules.forEach(function(ngModuleReference) {
            ...
            }), generatedFiles.push(this._codegenSourceModule(srcFileUrl, ngFactoryOutputCtx)), generatedFiles.push(this._codegenSourceModule(srcFileUrl, jitSummaryOutputCtx)), directives.forEach(function(dirType) {
              var compMeta = _this._metadataResolver.getDirectiveMetadata(dirType);
              compMeta.isComponent && compMeta.template.externalStylesheets.forEach(function(stylesheetMeta) {
        ...
        StaticReflector = function() {
          ...
          return StaticReflector.prototype.componentModuleUrl = function(typeOrFunc) {
            ...
            function simplifyInContext(context, value, depth) {
              ...
              function simplify(expression) {
                ...
                if (expression instanceof StaticSymbol) {
                  ...
                  return declarationValue ? simplifyInContext(staticSymbol, declarationValue, depth + 1) : staticSymbol;
                }
                if (expression) {
                    ...
                    switch (expression.__symbolic) {
                      ...
                      case "select":
                        ...
                        if (selectTarget instanceof StaticSymbol) {
                          ...
                          return declarationValue ? simplifyInContext(selectContext, declarationValue, depth + 1) : selectContext;
                        }
                        return selectTarget && isPrimitive(member) ? simplifyInContext(selectContext, selectTarget[member], depth + 1) : null;
                      case "reference":
            ...
            var _this = this,
                ...
                result = this.errorRecorder ? recordedSimplifyInContext(context, value, 0) : simplifyInContext(context, value, 0);
