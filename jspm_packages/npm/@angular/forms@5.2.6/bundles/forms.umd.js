...
(function(process) {
  (function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/observable/forkJoin'), require('rxjs/observable/fromPromise'), require('rxjs/operator/map'), require('@angular/platform-browser')) : typeof define === 'function' && define.amd ? define('@angular/forms', ['exports', '@angular/core', 'rxjs/observable/forkJoin', 'rxjs/observable/fromPromise', 'rxjs/operator/map', '@angular/platform-browser'], factory) : (factory((global.ng = global.ng || {}, global.ng.forms = {}), global.ng.core, global.Rx.Observable, global.Rx.Observable, global.Rx.Observable.prototype, global.ng.platformBrowser));
    ...
    var CheckboxControlValueAccessor = (function() {
      ...
      CheckboxControlValueAccessor.ctorParameters = function() {
        return [{type: _angular_core.Renderer2}, {type: _angular_core.ElementRef}];
      };
      return CheckboxControlValueAccessor;
    }());
    ...
    var RadioControlValueAccessor = (function() {
      ...
      RadioControlValueAccessor.ctorParameters = function() {
        return [{type: _angular_core.Renderer2}, {type: _angular_core.ElementRef}, {type: RadioControlRegistry}, {type: _angular_core.Injector}];
      };
    ...
    var NgSelectOption = (function() {
      ...
      NgSelectOption.ctorParameters = function() {
        return [{type: _angular_core.ElementRef}, {type: _angular_core.Renderer2}, {
    ...
    var AbstractControl = (function() {
      ...
      AbstractControl.prototype.disable = function(opts) {
        ...
        ((this)).errors = null;
        this._forEachChild(function(control) {
          control.disable(__assign({}, opts, {onlySelf: true}));
        });
        this._updateValue();
      ...
      AbstractControl.prototype.enable = function(opts) {
        ...
        ((this)).status = VALID;
        this._forEachChild(function(control) {
          control.enable(__assign({}, opts, {onlySelf: true}));
        });
      ...
      AbstractControl.prototype._initObservables = function() {
        ((this)).valueChanges = new _angular_core.EventEmitter();
        ((this)).statusChanges = new _angular_core.EventEmitter();
      };
    ...
    var VERSION = new _angular_core.Version('5.2.6');
