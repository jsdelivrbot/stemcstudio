...
(function(process) {
  ...
  var ts;
  (function(ts) {
    ts.timestamp = typeof performance !== "undefined" && performance.now ? function() {
  ...
  (function(ts) {
    ...
    (function(performance) {
      var profilerEvent = typeof onProfilerEvent === "function" && onProfilerEvent.profiler === true ? onProfilerEvent : function(_markName) {};
      var enabled = false;
      var profilerStart = 0;
      var counts;
      var marks;
  ...
  (function(ts) {
    ...
    function shimMap() {
      var MapIterator = (function() {
        ...
        MapIterator.prototype.next = function() {
          ...
          if (index < this.keys.length) {
            this.index++;
            return {
              value: this.selector(this.data, this.keys[index]),
              done: false
            };
          }
          return {
      ...
      return (function() {
        ...
        class_1.prototype.keys = function() {
          return new MapIterator(this.data, function(_data, key) {
            return key;
          });
        };
        class_1.prototype.values = function() {
          return new MapIterator(this.data, function(data, key) {
            return data[key];
          });
        };
    ...
    function deduplicate(array, areEqual) {
      ...
      if (array) {
        ...
        loop: for (var _i = 0,
          ...
          var item = array_6[_i];
          for (var _a = 0,
              result_1 = result; _a < result_1.length; _a++) {
            var res = result_1[_a];
    ...
    function sum(array, prop) {
      var result = 0;
      for (var _i = 0,
          array_7 = array; _i < array_7.length; _i++) {
        var v = array_7[_i];
        result += v[prop];
      }
      return result;
    ...
    function binarySearch(array, value, comparer, offset) {
      ...
      comparer = comparer !== undefined ? comparer : function(v1, v2) {
    ...
    function arrayFrom(iterator, map) {
      var result = [];
      for (var _a = iterator.next(),
          value = _a.value,
          done = _a.done; !done; _b = iterator.next(), value = _b.value, done = _b.done, _b) {
    ...
    function forEachEntry(map, callback) {
      ...
      for (var _a = iterator.next(),
          pair = _a.value,
          done = _a.done; !done; _b = iterator.next(), pair = _b.value, done = _b.done, _b) {
        var key = pair[0],
            value = pair[1];
    ...
    function forEachKey(map, callback) {
      ...
      for (var _a = iterator.next(),
          key = _a.value,
          done = _a.done; !done; _b = iterator.next(), key = _b.value, done = _b.done, _b) {
    ...
    function assign(t) {
      ...
      for (var _a = 0,
          args_1 = args; _a < args_1.length; _a++) {
        var arg = args_1[_a];
        for (var p in arg)
    ...
    function arrayToMap(array, makeKey, makeValue) {
      var result = createMap();
      for (var _i = 0,
          array_8 = array; _i < array_8.length; _i++) {
    ...
    function chain(a, b, c, d, e) {
      if (e) {
        ...
        return function(t) {
          return compose.apply(void 0, map(args_2, function(f) {
            return f(t);
          }));
        };
      } else if (d) {
        return function(t) {
          return compose(a(t), b(t), c(t), d(t));
        };
      } else if (c) {
        return function(t) {
          return compose(a(t), b(t), c(t));
        };
      } else if (b) {
        return function(t) {
          return compose(a(t), b(t));
        };
      } else if (a) {
        return function(t) {
          return compose(a(t));
    ...
    function compose(a, b, c, d, e) {
      if (e) {
        ...
        return function(t) {
          return reduceLeft(args_3, function(u, f) {
            return f(u);
          }, t);
        };
      } else if (d) {
    ...
    function compareStrings(a, b, ignoreCase) {
      ...
      if (ignoreCase) {
        if (ts.collator) {
          var result = ts.localeCompareIsCorrect ? ts.collator.compare(a, b) : a.localeCompare(b, undefined, {
            usage: "sort",
            sensitivity: "accent"
          });
    ...
    function getEmitModuleKind(compilerOptions) {
      return typeof compilerOptions.module === "number" ? compilerOptions.module : getEmitScriptTarget(compilerOptions) >= 2 ? ts.ModuleKind.ES2015 : ts.ModuleKind.CommonJS;
    }
    ...
    function fileExtensionIsAny(path, extensions) {
      for (var _i = 0,
          extensions_1 = extensions; _i < extensions_1.length; _i++) {
    ...
    function getRegularExpressionForWildcard(specs, basePath, usage) {
      ...
      var pattern = patterns.map(function(pattern) {
        return "(" + pattern + ")";
      }).join("|");
    ...
    function getSubPatternFromSpec(spec, basePath, usage, singleAsteriskRegexFragment, doubleAsteriskRegexFragment, replaceWildcardCharacter) {
      ...
      var optionalCount = 0;
      for (var _i = 0,
          components_1 = components; _i < components_1.length; _i++) {
    ...
    function getFileMatcherPatterns(path, excludes, includes, useCaseSensitiveFileNames, currentDirectory) {
      ...
      return {
        includeFilePatterns: map(getRegularExpressionsForWildcards(includes, absolutePath, "files"), function(pattern) {
          return "^" + pattern + "$";
        }),
    ...
    function matchFiles(path, extensions, excludes, includes, useCaseSensitiveFileNames, currentDirectory, getFileSystemEntries) {
      ...
      var includeFileRegexes = patterns.includeFilePatterns && patterns.includeFilePatterns.map(function(pattern) {
      ...
      var results = includeFileRegexes ? includeFileRegexes.map(function() {
        return [];
      }) : [[]];
      var comparer = useCaseSensitiveFileNames ? compareStrings : compareStringsCaseInsensitive;
      for (var _i = 0,
          _a = patterns.basePaths; _i < _a.length; _i++) {
        var basePath = _a[_i];
        visitDirectory(basePath, combinePaths(currentDirectory, basePath));
      }
      return flatten(results);
      function visitDirectory(path, absolutePath) {
        var _a = getFileSystemEntries(path),
            files = _a.files,
            directories = _a.directories;
        ...
        var _loop_1 = function(current) {
          ...
          if (!includeFileRegexes) {
            ...
            var includeIndex = findIndex(includeFileRegexes, function(re) {
        ...
        for (var _b = 0,
            directories_1 = directories; _b < directories_1.length; _b++) {
    ...
    function getBasePaths(path, includes, useCaseSensitiveFileNames) {
      ...
      if (includes) {
        ...
        for (var _i = 0,
            includes_1 = includes; _i < includes_1.length; _i++) {
        ...
        var _loop_2 = function(includeBasePath) {
          if (ts.every(basePaths, function(basePath) {
        ...
        for (var _a = 0,
            includeBasePaths_1 = includeBasePaths; _a < includeBasePaths_1.length; _a++) {
    ...
    function getSupportedExtensions(options, extraFileExtensions) {
      ...
      for (var _i = 0,
          extraFileExtensions_1 = extraFileExtensions; _i < extraFileExtensions_1.length; _i++) {
    ...
    function hasJavaScriptFileExtension(fileName) {
      return forEach(ts.supportedJavascriptExtensions, function(extension) {
    ...
    function isSupportedSourceFileName(fileName, compilerOptions, extraFileExtensions) {
      ...
      for (var _i = 0,
          _a = getSupportedExtensions(compilerOptions, extraFileExtensions); _i < _a.length; _i++) {
        var extension = _a[_i];
    ...
    function unorderedRemoveItem(array, item) {
      unorderedRemoveFirstItemWhere(array, function(element) {
        return element === item;
      });
    }
    ...
    function matchPatternOrExact(patternStrings, candidate) {
      var patterns = [];
      for (var _i = 0,
          patternStrings_1 = patternStrings; _i < patternStrings_1.length; _i++) {
  ...
  (function(ts) {
    ...
    ts.sys = (function() {
      function getNodeSystem() {
        ...
        function createWatchedFileSet() {
          ...
          function addDirWatcher(dirPath) {
            ...
            watcher = _fs.watch(dirPath, {persistent: true}, function(eventName, relativeFileName) {
          ...
          function fileEventHandler(eventName, relativeFileName, baseDirPath) {
            var fileName = typeof relativeFileName !== "string" ? undefined : ts.getNormalizedAbsolutePath(relativeFileName, baseDirPath);
            if ((eventName === "change" || eventName === "rename")) {
              var callbacks = fileWatcherCallbacks.get(fileName);
              if (callbacks) {
                for (var _i = 0,
                    callbacks_1 = callbacks; _i < callbacks_1.length; _i++) {
        ...
        function getAccessibleFileSystemEntries(path) {
          try {
            ...
            var directories = [];
            for (var _i = 0,
                entries_1 = entries; _i < entries_1.length; _i++) {
        ...
        function getDirectories(path) {
          return ts.filter(_fs.readdirSync(path), function(dir) {
            return fileSystemEntryExists(ts.combinePaths(path, dir), 1);
          });
        }
          ...
          watchFile: function(fileName, callback, pollingInterval) {
            if (useNonPollingWatchers) {
              ...
              return {close: function() {
                  return watchedFileSet.removeFile(watchedFile_1);
                }};
            } else {
      ...
      function getChakraSystem() {
        var realpath = ChakraHost.realpath && (function(path) {
          return ChakraHost.realpath(path);
        });
        return {
    ...
    if (ts.sys && ts.sys.getEnvironmentVariable) {
      ts.Debug.currentAssertionLevel = /^development$/i.test(ts.sys.getEnvironmentVariable("NODE_ENV")) ? 1 : 0;
    }
  })(ts || (ts = {}));
  var ts;
  (function(ts) {
    ts.Diagnostics = {
      ...
      Import_assignment_cannot_be_used_when_targeting_ECMAScript_2015_modules_Consider_using_import_Asterisk_as_ns_from_mod_import_a_from_mod_import_d_from_mod_or_another_module_format_instead: {
        code: 1202,
        category: ts.DiagnosticCategory.Error,
        key: "Import_assignment_cannot_be_used_when_targeting_ECMAScript_2015_modules_Consider_using_import_Asteri_1202",
        message: "Import assignment cannot be used when targeting ECMAScript 2015 modules. Consider using 'import * as ns from \"mod\"', 'import {a} from \"mod\"', 'import d from \"mod\"', or another module format instead."
      },
      Export_assignment_cannot_be_used_when_targeting_ECMAScript_2015_modules_Consider_using_export_default_or_another_module_format_instead: {
        code: 1203,
        category: ts.DiagnosticCategory.Error,
        key: "Export_assignment_cannot_be_used_when_targeting_ECMAScript_2015_modules_Consider_using_export_defaul_1203",
        message: "Export assignment cannot be used when targeting ECMAScript 2015 modules. Consider using 'export default' or another module format instead."
      },
      ...
      Type_must_have_a_Symbol_asyncIterator_method_that_returns_an_async_iterator: {
        code: 2504,
        category: ts.DiagnosticCategory.Error,
        key: "Type_must_have_a_Symbol_asyncIterator_method_that_returns_an_async_iterator_2504",
        message: "Type must have a '[Symbol.asyncIterator]()' method that returns an async iterator."
      },
      ...
      A_this_parameter_must_be_the_first_parameter: {
        code: 2680,
        category: ts.DiagnosticCategory.Error,
        key: "A_this_parameter_must_be_the_first_parameter_2680",
      ...
      extends_clause_of_exported_class_0_refers_to_a_type_whose_name_cannot_be_referenced: {
        code: 4093,
        category: ts.DiagnosticCategory.Error,
        key: "extends_clause_of_exported_class_0_refers_to_a_type_whose_name_cannot_be_referenced_4093",
      ...
      File_specification_cannot_contain_multiple_recursive_directory_wildcards_Asterisk_Asterisk_Colon_0: {
        code: 5011,
        category: ts.DiagnosticCategory.Error,
        key: "File_specification_cannot_contain_multiple_recursive_directory_wildcards_Asterisk_Asterisk_Colon_0_5011",
      ...
      Specify_ECMAScript_target_version_Colon_ES3_default_ES5_ES2015_ES2016_ES2017_or_ESNEXT: {
        code: 6015,
        category: ts.DiagnosticCategory.Message,
        key: "Specify_ECMAScript_target_version_Colon_ES3_default_ES5_ES2015_ES2016_ES2017_or_ESNEXT_6015",
      ...
      Specify_library_files_to_be_included_in_the_compilation_Colon: {
        code: 6079,
        category: ts.DiagnosticCategory.Message,
        key: "Specify_library_files_to_be_included_in_the_compilation_Colon_6079",
      ...
      The_config_file_0_found_doesn_t_contain_any_source_files: {
        code: 6129,
        category: ts.DiagnosticCategory.Error,
        key: "The_config_file_0_found_doesn_t_contain_any_source_files_6129",
        message: "The config file '{0}' found doesn't contain any source files."
      },
      ...
      _0_is_declared_but_never_used: {
        code: 6133,
        category: ts.DiagnosticCategory.Error,
        key: "_0_is_declared_but_never_used_6133",
      ...
      Property_0_is_declared_but_never_used: {
        code: 6138,
        category: ts.DiagnosticCategory.Error,
        key: "Property_0_is_declared_but_never_used_6138",
        message: "Property '{0}' is declared but never used."
      },
      ...
      Module_0_was_resolved_to_1_but_allowJs_is_not_set: {
        code: 6143,
        category: ts.DiagnosticCategory.Error,
        key: "Module_0_was_resolved_to_1_but_allowJs_is_not_set_6143",
        message: "Module '{0}' was resolved to '{1}', but '--allowJs' is not set."
      },
      ...
      Resolution_for_module_0_was_found_in_cache: {
        code: 6147,
        category: ts.DiagnosticCategory.Message,
        key: "Resolution_for_module_0_was_found_in_cache_6147",
        message: "Resolution for module '{0}' was found in cache."
      },
      ...
      Add_this_to_unresolved_variable: {
        code: 90008,
        category: ts.DiagnosticCategory.Message,
        key: "Add_this_to_unresolved_variable_90008",
        message: "Add 'this.' to unresolved variable."
      },
      Adding_a_tsconfig_json_file_will_help_organize_projects_that_contain_both_TypeScript_and_JavaScript_files_Learn_more_at_https_Colon_Slash_Slashaka_ms_Slashtsconfig: {
        code: 90009,
        category: ts.DiagnosticCategory.Error,
        key: "Adding_a_tsconfig_json_file_will_help_organize_projects_that_contain_both_TypeScript_and_JavaScript__90009",
      ...
      Type_0_is_not_assignable_to_type_1_Two_different_types_with_this_name_exist_but_they_are_unrelated: {
        code: 90010,
        category: ts.DiagnosticCategory.Error,
        key: "Type_0_is_not_assignable_to_type_1_Two_different_types_with_this_name_exist_but_they_are_unrelated_90010",
      ...
      Add_declaration_for_missing_property_0: {
        code: 90016,
        category: ts.DiagnosticCategory.Message,
        key: "Add_declaration_for_missing_property_0_90016",
        message: "Add declaration for missing property '{0}'."
      },
      Add_index_signature_for_missing_property_0: {
        code: 90017,
        category: ts.DiagnosticCategory.Message,
        key: "Add_index_signature_for_missing_property_0_90017",
        message: "Add index signature for missing property '{0}'."
      },
    ...
    function createScanner(languageVersion, skipTrivia, languageVariant, text, onError, start, length) {
      ...
      return {
        ...
        isIdentifier: function() {
          return token === 71 || token > 107;
        },
        isReservedWord: function() {
          return token >= 72 && token <= 107;
        },
  ...
  (function(ts) {
    ...
    function createCompilerDiagnosticForInvalidCustomType(opt) {
      var namesOfType = ts.arrayFrom(opt.type.keys()).map(function(key) {
        return "'" + key + "'";
      }).join(", ");
    ...
    function parseListTypeOption(opt, value, errors) {
      ...
      switch (opt.element.type) {
        ...
        case "string":
          return ts.map(values, function(v) {
            return v || "";
          });
        default:
          return ts.filter(ts.map(values, function(v) {
            return parseCustomTypeOption(opt.element, v, errors);
          }), function(v) {
            return !!v;
          });
      }
    ...
    function generateTSConfig(options, fileNames, newLine) {
      ...
      var configurations = {compilerOptions: serializeCompilerOptions(compilerOptions)};
      ...
      function writeConfigurations() {
        var categorizedOptions = ts.reduceLeft(ts.filter(ts.optionDeclarations, function(o) {
          return o.category !== ts.Diagnostics.Command_line_Options && o.category !== ts.Diagnostics.Advanced_Options;
        }), function(memo, value) {
          if (value.category) {
        ...
        for (var category in categorizedOptions) {
          ...
          descriptionColumn.push("");
          for (var _i = 0,
              _a = categorizedOptions[category]; _i < _a.length; _i++) {
            var option = _a[_i];
    ...
    function parseJsonConfigFileContent(json, host, basePath, existingOptions, configFileName, resolutionStack, extraFileExtensions) {
      ...
      if (resolutionStack === void 0) {
        resolutionStack = [];
      }
      if (extraFileExtensions === void 0) {
        extraFileExtensions = [];
      }
      var errors = [];
      ...
      if (json["extends"]) {
        var _a = [undefined, undefined, undefined, {}],
            include = _a[0],
            exclude = _a[1],
            files = _a[2],
            baseOptions = _a[3];
      ...
      var _c = getFileNames(errors),
          fileNames = _c.fileNames,
          wildcardDirectories = _c.wildcardDirectories;
      ...
      function tryExtendsName(extendedConfig) {
        ...
        var extendedResult = readConfigFile(extendedConfigPath, function(path) {
        ...
        var updatePath = function(path) {
          return ts.isRootedDiskPath(path) ? path : ts.combinePaths(relativeDifference, path);
        };
    ...
    function convertTypeAcquisitionFromJsonWorker(jsonOptions, basePath, errors, configFileName) {
      var options = {
        enable: ts.getBaseFileName(configFileName) === "jsconfig.json",
        include: [],
        exclude: []
      };
    ...
    function convertOptionsFromJson(optionDeclarations, jsonOptions, basePath, defaultOptions, diagnosticMessage, errors) {
      ...
      var optionNameMap = ts.arrayToMap(optionDeclarations, function(opt) {
        return opt.name;
      });
    ...
    function convertJsonOptionOfListType(option, values, basePath, errors) {
      return ts.filter(ts.map(values, function(v) {
        return convertJsonOption(option.element, v, basePath, errors);
      }), function(v) {
        return !!v;
      });
    }
    ...
    function matchFileNames(fileNames, include, exclude, basePath, options, host, errors, extraFileExtensions) {
      ...
      if (fileNames) {
        for (var _i = 0,
            fileNames_1 = fileNames; _i < fileNames_1.length; _i++) {
      ...
      if (include && include.length > 0) {
        for (var _a = 0,
            _b = host.readDirectory(basePath, supportedExtensions, exclude, include); _a < _b.length; _a++) {
          var file = _b[_a];
    ...
    function getWildcardDirectories(include, exclude, path, useCaseSensitiveFileNames) {
      ...
      if (include !== undefined) {
        var recursiveKeys = [];
        for (var _i = 0,
            include_1 = include; _i < include_1.length; _i++) {
        ...
        for (var key in wildcardDirectories)
          if (ts.hasProperty(wildcardDirectories, key)) {
            for (var _a = 0,
                recursiveKeys_1 = recursiveKeys; _a < recursiveKeys_1.length; _a++) {
  ...
  (function(ts) {
    ...
    (function(JsTyping) {
      ...
      JsTyping.nodeCoreModuleList = ["buffer", "querystring", "events", "http", "cluster", "zlib", "os", "https", "punycode", "repl", "readline", "vm", "child_process", "url", "dns", "net", "dgram", "fs", "path", "string_decoder", "tls", "crypto", "stream", "util", "assert", "tty", "domain", "constants", "process", "v8", "timers", "console"];
      var nodeCoreModules = ts.arrayToMap(JsTyping.nodeCoreModuleList, function(x) {
        return x;
      });
      function discoverTypings(host, fileNames, projectRootPath, safeListPath, packageNameToTypingLocation, typeAcquisition, unresolvedImports) {
        ...
        for (var _i = 0,
            searchDirs_1 = searchDirs; _i < searchDirs_1.length; _i++) {
        ...
        if (unresolvedImports) {
          for (var _a = 0,
              unresolvedImports_1 = unresolvedImports; _a < unresolvedImports_1.length; _a++) {
        ...
        for (var _b = 0,
            exclude_1 = exclude; _b < exclude_1.length; _b++) {
        ...
        function mergeTypings(typingNames) {
          ...
          for (var _i = 0,
              typingNames_1 = typingNames; _i < typingNames_1.length; _i++) {
        ...
        function getTypingNamesFromSourceFileNames(fileNames) {
          ...
          if (safeList !== EmptySafeList) {
            mergeTypings(ts.filter(cleanedTypingNames, function(f) {
              return safeList.has(f);
            }));
          }
          var hasJsxFile = ts.forEach(fileNames, function(f) {
            return ts.ensureScriptKind(f, ts.getScriptKindFromFileName(f)) === 2;
          });
          if (hasJsxFile) {
            mergeTypings(["react"]);
          }
        ...
        function getTypingNamesFromPackagesFolder(packagesFolderPath) {
          ...
          for (var _i = 0,
              fileNames_2 = fileNames; _i < fileNames_2.length; _i++) {
            ...
            if (baseFileName === "package.json" && packageJson._requiredBy && ts.filter(packageJson._requiredBy, function(r) {
              return r[0] === "#" || r === "/";
            }).length === 0) {
              continue;
            }
  ...
  (function(ts) {
    ...
    function createResolvedModuleWithFailedLookupLocations(resolved, isExternalLibraryImport, failedLookupLocations) {
      return {
        resolvedModule: resolved && resolvedModuleFromResolved(resolved, isExternalLibraryImport),
    ...
    function getAutomaticTypeDirectiveNames(options, host) {
      ...
      if (host.directoryExists && host.getDirectories) {
        ...
        if (typeRoots) {
          for (var _i = 0,
              typeRoots_1 = typeRoots; _i < typeRoots_1.length; _i++) {
            var root = typeRoots_1[_i];
            if (host.directoryExists(root)) {
              for (var _a = 0,
                  _b = host.getDirectories(root); _a < _b.length; _a++) {
    ...
    function tryLoadModuleUsingRootDirs(extensions, moduleName, containingDirectory, loader, failedLookupLocations, state) {
      ...
      for (var _i = 0,
          _a = state.compilerOptions.rootDirs; _i < _a.length; _i++) {
        var rootDir = _a[_i];
        ...
        var isLongestMatchingPrefix = ts.startsWith(candidate, normalizedRoot) && (matchedNormalizedPrefix === undefined || matchedNormalizedPrefix.length < normalizedRoot.length);
        if (state.traceEnabled) {
      ...
      if (matchedNormalizedPrefix) {
        ...
        for (var _b = 0,
            _c = state.compilerOptions.rootDirs; _b < _c.length; _b++) {
          var rootDir = _c[_b];
    ...
    function nodeModuleNameResolverWorker(moduleName, containingFile, compilerOptions, host, cache, jsOnly) {
      ...
      function tryResolve(extensions) {
        var loader = function(extensions, candidate, failedLookupLocations, onlyRecordFailures, state) {
          return nodeLoadModuleByRelativeName(extensions, candidate, failedLookupLocations, onlyRecordFailures, state, true);
        };
        ...
        if (moduleHasNonRelativeName(moduleName)) {
          ...
          return resolved_1 && {value: resolved_1.value && {
              resolved: {
                path: realpath(resolved_1.value.path, host, traceEnabled),
                extension: resolved_1.value.extension
              },
          ...
          return resolved_2 && toSearchResult({
            resolved: resolved_2,
            isExternalLibraryImport: false
          });
        }
    ...
    function loadModuleFromNodeModulesFolder(extensions, moduleName, nodeModulesFolder, nodeModulesFolderExists, failedLookupLocations, state) {
      ...
      return loadModuleFromFile(extensions, candidate, failedLookupLocations, !nodeModulesFolderExists, state) || loadNodeModuleFromDirectory(extensions, candidate, failedLookupLocations, !nodeModulesFolderExists, state);
    }
    ...
    function tryFindNonRelativeModuleNameInCache(cache, moduleName, containingDirectory, traceEnabled, host) {
      ...
      if (result) {
        ...
        return {value: result.resolvedModule && {
      ...
      (function(typingsInstaller) {
        ...
        var TypingsInstaller = (function() {
          ...
          TypingsInstaller.prototype.closeWatchers = function(projectName) {
            ...
            for (var _i = 0,
                watchers_1 = watchers; _i < watchers_1.length; _i++) {
              var w = watchers_1[_i];
              w.close();
            }
          ...
          TypingsInstaller.prototype.filterTypings = function(typingsToInstall) {
            ...
            var result = [];
            for (var _i = 0,
                typingsToInstall_1 = typingsToInstall; _i < typingsToInstall_1.length; _i++) {
            ...
            this.installTypingsAsync(requestId, scopedTypings, cachePath, function(ok) {
              try {
                if (!ok) {
                  ...
                  for (var _i = 0,
                      filteredTypings_1 = filteredTypings; _i < filteredTypings_1.length; _i++) {
                ...
                for (var _a = 0,
                    filteredTypings_2 = filteredTypings; _a < filteredTypings_2.length; _a++) {
      ...
      (function(typingsInstaller) {
        ...
        var NodeTypingsInstaller = (function(_super) {
          ...
          function NodeTypingsInstaller(globalTypingsCacheLocation, typingSafeListLocation, throttleLimit, log) {
            ...
            (_this.execSync = require('@empty').execSync);
            ...
            try {
              ...
              _this.execSync(_this.npmPath + " install " + TypesRegistryPackageName, {
