...
var exists = require('@node/fs').existsSync || require('@node/path').existsSync;
var glob = require('@empty');
var path = require('@node/path');
var join = path.join;
var readdirSync = require('@node/fs').readdirSync;
var statSync = require('@node/fs').statSync;
var watchFile = require('@node/fs').watchFile;
var lstatSync = require('@node/fs').lstatSync;
...
exports.inherits = require('@node/util').inherits;
