...
(function(process) {
  !function(e) {
    ...
    var i = "a".charCodeAt(0),
        ...
        ie = "!".charCodeAt(0),
        oe = [h, x, d, v, l, y, O, O],
        se = [h, x, d, v, l, y, A, A, c, w, d, v, o, f, s, g, a, b, p, k, O, O],
        ae = {};
    ae[X] = n.SemiColon, ae[Y] = n.Colon, ae[Z] = n.CurlyL, ae[Q] = n.CurlyR, ae[te] = n.BracketR, ae[ee] = n.BracketL, ae[O] = n.ParenthesisL, ae[z] = n.ParenthesisR, ae[ne] = n.Comma;
    var le = {};
    le.em = n.EMS, le.ex = n.EXS, le.px = n.Length, le.cm = n.Length, le.mm = n.Length, le["in"] = n.Length, le.pt = n.Length, le.pc = n.Length, le.deg = n.Angle, le.rad = n.Angle, le.grad = n.Angle, le.ms = n.Time, le.s = n.Time, le.hz = n.Freq, le.khz = n.Freq, le["%"] = n.Percentage, le.dpi = n.Resolution, le.dpcm = n.Resolution;
    var ce = function() {
      function e() {
      ...
      return e.prototype.setSource = function(e) {
        ...
        if (this.stream.eos())
          return this.finishToken(t, n.EOF);
        if (this.stream.advanceIfChars([N, ie, A, A]))
          return this.finishToken(t, n.CDO);
        if (this.stream.advanceIfChars([A, A, U]))
          return this.finishToken(t, n.CDC);
        var r = this._url();
        if (null !== r)
          return this.finishToken(t, r);
        var i = [];
        if (this.ident(i))
          return this.finishToken(t, n.Ident, i.join(""));
        if (this.stream.advanceIfChar(L)) {
          if (i = ["@"], this._name(i)) {
            var o = i.join("");
            return "@charset" === o ? this.finishToken(t, n.Charset, o) : this.finishToken(t, n.AtKeyword, o);
          }
          return this.finishToken(t, n.Delim);
        }
        if (this.stream.advanceIfChar(M))
          return i = ["#"], this._name(i) ? this.finishToken(t, n.Hash, i.join("")) : this.finishToken(t, n.Delim);
        if (this.stream.advanceIfChar(ie))
          return this.finishToken(t, n.Exclamation);
        if (this._number()) {
          var s = this.stream.pos();
          if (i = [this.stream.substring(t, s)], this.stream.advanceIfChar(D))
            return this.finishToken(t, n.Percentage);
          if (this.ident(i)) {
            var a = this.stream.substring(s).toLowerCase();
            return r = le[a], "undefined" != typeof r ? this.finishToken(t, r, i.join("")) : this.finishToken(t, n.Dimension, i.join(""));
          }
          return this.finishToken(t, n.Num);
        }
        return i = [], r = this._string(i), null !== r ? this.finishToken(t, r, i.join("")) : (r = ae[this.stream.peekChar()], "undefined" != typeof r ? (this.stream.advance(1), this.finishToken(t, r)) : this.stream.peekChar(0) === C && this.stream.peekChar(1) === I ? (this.stream.advance(2), this.finishToken(t, n.Includes)) : this.stream.peekChar(0) === P && this.stream.peekChar(1) === I ? (this.stream.advance(2), this.finishToken(t, n.Dashmatch)) : this.stream.peekChar(0) === R && this.stream.peekChar(1) === I ? (this.stream.advance(2), this.finishToken(t, n.SubstringOperator)) : this.stream.peekChar(0) === E && this.stream.peekChar(1) === I ? (this.stream.advance(2), this.finishToken(t, n.PrefixOperator)) : this.stream.peekChar(0) === j && this.stream.peekChar(1) === I ? (this.stream.advance(2), this.finishToken(t, n.SuffixOperator)) : (this.stream.nextChar(), this.finishToken(t, n.Delim)));
        ...
        for (; ; ) {
          ...
          if (this._whitespace()) {
            if (!this.ignoreWhitespace)
              return this.finishToken(e, n.Whitespace);
          } else {
            if (!this.comment())
              return null;
            if (!this.ignoreComment)
              return this.finishToken(e, n.Comment);
          }
        }
      }, e.prototype.comment = function() {
        if (this.stream.advanceIfChars([B, R])) {
          var e = !1,
              t = !1;
          return this.stream.advanceWhileChar(function(n) {
            return t && n === B ? (e = !0, !1) : (t = n === R, !0);
        ...
        var e,
            t = 0;
        return this.stream.peekChar() === re && (t = 1), e = this.stream.peekChar(t), e >= S && e <= F && (this.stream.advance(t + 1), this.stream.advanceWhileChar(function(e) {
          return e >= S && e <= F || 0 === t && e === re;
        }), !0);
        ...
        switch (t) {
          ...
          case $:
          case q:
            return this.stream.advance(1), e.push(String.fromCharCode(t)), t === K && this.stream.advanceIfChar(q) && e.push("\n"), !0;
        }
        return !1;
        ...
        if (n === V) {
          ...
          for (var r = 0; r < 6 && (n >= S && n <= F || n >= i && n <= s || n >= u && n <= g); )
            this.stream.advance(1), n = this.stream.peekChar(), r++;
          if (r > 0) {
            try {
              var o = parseInt(this.stream.substring(this.stream.pos() - r), 16);
              o && e.push(String.fromCharCode(o));
            } catch (a) {}
            return n === H || n === J ? this.stream.advance(1) : this._newline([]), !0;
          }
          if (n !== K && n !== $ && n !== q)
        ...
        var n = this.stream.peekChar();
        return 0 !== n && n !== e && n !== V && n !== K && n !== $ && n !== q && (this.stream.advance(1), t.push(String.fromCharCode(n)), !0);
      }, e.prototype._string = function(e) {
        if (this.stream.peekChar() === W || this.stream.peekChar() === G) {
        ...
        if (this._matchWordAnyCase(oe) || this._matchWordAnyCase(se)) {
          this._whitespace();
          var e = n.URI,
              t = this._string([]);
          if (t === n.BadString)
          ...
          return this._whitespace(), this.stream.advanceIfChar(z) ? e : n.BadUri;
        }
        return null;
      }, e.prototype._whitespace = function() {
        var e = this.stream.advanceWhileChar(function(e) {
          return e === H || e === J || e === q || e === $ || e === K;
        });
        return e > 0;
        ...
        var t = this.stream.pos(),
            n = this._minus(e);
        if (n && this._minus(e)) {
          for (var r = !1; this._identChar(e) || this._escape(e); )
            r = !0;
          if (r)
            return !0;
        ...
        var t = this.stream.peekChar();
        return (t === _ || t >= i && t <= m || t >= u && t <= T || t >= 128 && t <= 65535) && (this.stream.advance(1), e.push(String.fromCharCode(t)), !0);
      }, e.prototype._minus = function(e) {
        var t = this.stream.peekChar();
        return t === A && (this.stream.advance(1), e.push(String.fromCharCode(t)), !0);
      }, e.prototype._identChar = function(e) {
        var t = this.stream.peekChar();
        return (t === _ || t === A || t >= i && t <= m || t >= u && t <= T || t >= S && t <= F || t >= 128 && t <= 65535) && (this.stream.advance(1), e.push(String.fromCharCode(t)), !0);
      }, e;
    }();
    t.Scanner = ce;
  });
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssNodes", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
      var n = null;
      return !e || t < e.offset || t > e.end ? null : (e.accept(function(e) {
        return e.offset === -1 && e.length === -1 || e.offset <= t && e.end >= t && (n ? e.length <= n.length && (n = e) : n = e, !0);
      }), n);
    }
    function r(e, t) {
      for (var r = n(e, t),
    ...
    }(s = t.ReferenceType || (t.ReferenceType = {})), t.getNodeAtOffset = n, t.getNodePath = r, t.getParentDeclaration = i;
    var a = function() {
      function e(e, t, n) {
      ...
      return Object.defineProperty(e.prototype, "end", {
        ...
        "function" != typeof e && (e = e.visitNode.bind(e)), e(this) && this.children && this.children.forEach(function(t) {
          t.accept(e);
        });
        ...
        e.parent = this;
        var r = this.children;
        return r || (r = this.children = []), t !== -1 ? r.splice(t, 0, e) : r.push(e), e;
        ...
        return this.issues && this.issues.some(function(t) {
          return t.getRule() === e;
        });
      }, e.prototype.isErroneous = function(e) {
        return void 0 === e && (e = !1), !!(this.issues && this.issues.length > 0) || e && this.children && this.children.some(function(e) {
        ...
        if (this.children)
          for (var t = null,
              n = this.children.length - 1; n >= 0; n--)
            if (t = this.children[n], t.offset <= e)
              return t;
        return null;
        ...
        for (var e = this.parent; e instanceof l; )
          e = e.parent;
        return e;
    ...
    var v = function(e) {
      ...
      return __extends(t, e), Object.defineProperty(t.prototype, "type", {
        ...
        if (this.parent instanceof h && this.parent.getParent() instanceof O) {
    ...
    var X = function(e) {
      ...
      return __extends(t, e), Object.defineProperty(t.prototype, "type", {
        ...
        for (var e,
            ...
            o = "9".charCodeAt(0),
            s = 0,
            a = t.length; s < a && (e = t.charCodeAt(s), i <= e && e <= o || e === r); s++)
          n += 1;
        return {
    ...
    t.ParseErrorCollector = ae;
  }), function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t);
    } else
      "function" == typeof define && define.amd && define("vscode-nls/vscode-nls", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
      var n;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssErrors", ["require", "exports", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("vscode-nls"),
    ...
    t.CSSIssueType = i, t.ParseError = {
      ...
      RuleOrSelectorExpected: new i("css-ruleorselectorexpected", r("expected.ruleorselector", "at-rule or selector expected")),
      ...
      URIOrStringExpected: new i("css-uriorstringexpected", r("expected.uriorstring", "uri or string expected")),
      ...
      PropertyValueExpected: new i("css-propertyvalueexpected", r("expected.propvalue", "property value expected")),
      ...
      PageDirectiveOrDeclarationExpected: new i("css-pagedirordeclexpected", r("expected.pagedirordecl", "page directive or declaraton expected")),
      ...
      StringLiteralExpected: new i("css-stringliteralexpected", r("expected.stringliteral", "string literal expected"))
    };
  }), function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/data/browsers", ["require", "exports"], e);
  }(function(e, t) {
    t.data = {css: {
        atdirectives: [{
          name: "@charset",
        ...
        properties: [{
          ...
          values: [{name: "block"}, {
            ...
            name: "inline-flexbox",
            browsers: "O12.1"
          }, {name: "inline-table"}, {name: "list-item"}, {
            name: "-moz-box",
            browsers: "FF"
          }, {
            name: "-moz-deck",
          ...
          }, {name: "column-reverse"}, {name: "row"}, {name: "row-reverse"}]
        }, {
          name: "flex-flow",
          ...
          restriction: "enum",
          values: [{name: "auto"}, {name: "geometricPrecision"}, {name: "optimizeLegibility"}, {
            name: "optimizeSpeed",
          ...
          }, {name: "contents"}, {name: "scroll-position"}]
        }, {
          name: "word-break",
          desc: "Specifies line break opportunities for non-CJK scripts.",
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/languageFacts", ["require", "exports", "../parser/cssNodes", "../data/browsers", "vscode-nls"], e);
  }(function(e, t) {
    function n(e) {
      var t = e.getName();
    ...
    function r(e) {
      if (e.type === u.NodeType.HexColorValue)
        return !0;
      if (e.type === u.NodeType.Function)
        return this.isColorConstructor(e);
      if (e.type === u.NodeType.Identifier) {
        if (e.parent && e.parent.type !== u.NodeType.Term)
          return !1;
    ...
    function i(e) {
      return !!e && (e = e.toLowerCase(), d().hasOwnProperty(e));
    }
    function o(e) {
    ...
    function c(e) {
      ...
      }) : (n.all = !0, r = Number.MAX_VALUE), n.count = r, n.onCodeComplete = r > 0, n;
    }
    function d() {
      if (!y) {
        y = {};
    ...
    t.getPseudoClasses = m, t.browserNames = {
      E: "Edge",
      FF: "Firefox",
      S: "Safari",
      C: "Chrome",
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssParser", ["require", "exports", "./cssScanner", "./cssNodes", "./cssErrors", "../services/languageFacts"], e);
  }(function(e, t) {
    var n = e("./cssScanner"),
        r = e("./cssNodes"),
        i = e("./cssErrors"),
        ...
        s = function() {
          function e(e) {
            void 0 === e && (e = new n.Scanner), this.scanner = e, this.token = null, this.prevToken = null;
          }
          return e.prototype.peek = function(e, t, n) {
            return void 0 === n && (n = !0), e === this.token.type && ("undefined" == typeof t || (n ? t.toLowerCase() === this.token.text.toLowerCase() : t === this.token.text));
            ...
            for (var r = 0; r < t.length; r++)
              if (this.peek(e, t[r], n))
                return this.consumeToken(), !0;
            return !1;
          }, e.prototype.accept = function(e, t, n) {
            return void 0 === n && (n = !0), !!this.peek(e, t, n) && (this.consumeToken(), !0);
            ...
            for (; ; ) {
              ...
              if (t && t.indexOf(this.token.type) !== -1)
                return !0;
              if (this.token.type === n.TokenType.EOF)
                return !1;
            ...
            this.token !== this.lastErrorToken && (e.addIssue(new r.Marker(e, t, r.Level.Error, null, this.token.offset, this.token.len)), this.lastErrorToken = this.token), (n || i) && this.resync(n, i);
            ...
            var r = t.bind(this)();
            return r && (n ? r.textProvider = n : r.textProvider = function(t, n) {
              return e.substr(t, n);
            }), r;
            ...
            do {
              ...
              do {
                ...
                for (s && (e.addChild(s), o = !0, t = !1, this.peek(n.TokenType.EOF) || !this._needsSemicolonAfter(s) || this.accept(n.TokenType.SemiColon) || this.markError(e, i.ParseError.SemiColonExpected)); this.accept(n.TokenType.SemiColon) || this.accept(n.TokenType.CDO) || this.accept(n.TokenType.CDC); )
                  o = !0, t = !1;
              } while (o);
              if (this.peek(n.TokenType.EOF))
                break;
              t || (this.peek(n.TokenType.AtKeyword) ? this.markError(e, i.ParseError.UnknownAtRule) : this.markError(e, i.ParseError.RuleOrSelectorExpected), t = !0), this.consumeToken();
            } while (!this.peek(n.TokenType.EOF));
            return this.finish(e);
          }, e.prototype._parseStylesheetStatement = function() {
            return this._parseRuleset(!1) || this._parseImport() || this._parseMedia() || this._parsePage() || this._parseFontFace() || this._parseKeyframe() || this._parseViewPort() || this._parseNamespace() || this._parseDocument();
          }, e.prototype._tryParseRuleset = function(e) {
            var t = this.mark();
            if (this._parseSelector(e)) {
              for (; this.accept(n.TokenType.Comma) && this._parseSelector(e); )
                ;
              if (this.accept(n.TokenType.CurlyL))
            ...
            if (!this.peek(n.TokenType.AtKeyword, "@apply"))
              return null;
            var e = this.create(r.AtApplyRule);
            return this.consumeToken(), e.setIdentifier(this._parseIdent([r.ReferenceType.Variable])) ? this.finish(e) : this.finish(e, i.ParseError.IdentifierExpected);
            ...
            for (var o = e(); t.addChild(o) && !this.peek(n.TokenType.CurlyR); ) {
              if (this._needsSemicolonAfter(o) && !this.accept(n.TokenType.SemiColon))
                return this.finish(t, i.ParseError.SemiColonExpected, [n.TokenType.SemiColon, n.TokenType.CurlyR]);
              for (; this.accept(n.TokenType.SemiColon); )
                ;
              o = e();
            }
            return this.accept(n.TokenType.CurlyR) ? this.finish(t) : this.finish(t, i.ParseError.RightCurlyExpected, [n.TokenType.CurlyR, n.TokenType.SemiColon]);
          }, e.prototype._parseBody = function(e, t) {
            return e.setDeclarations(this._parseDeclarations(t)) ? this.finish(e) : this.finish(e, i.ParseError.LeftCurlyExpected, [n.TokenType.CurlyR, n.TokenType.SemiColon]);
            ...
            if (this.peek(n.TokenType.CurlyL)) {
              var o = this.create(r.CustomPropertySet),
                  s = this._parseDeclarations(this._parseRuleSetDeclaration.bind(this));
              if (o.setDeclarations(s) && !s.isErroneous(!0) && (o.addChild(this._parsePrio()), this.peek(n.TokenType.SemiColon)))
                return this.finish(o), e.setPropertySet(o), e.semicolonPosition = this.token.offset, this.finish(e);
              this.restoreAtMark(t);
            }
            var a = this._parseExpr();
            return a && !a.isErroneous(!0) && (this._parsePrio(), this.peek(n.TokenType.SemiColon)) ? (e.setValue(a), e.semicolonPosition = this.token.offset, this.finish(e)) : (this.restoreAtMark(t), e.addChild(this._parseCustomPropertyValue()), e.addChild(this._parsePrio()), this.token.offset === e.colonPosition + 1 ? this.finish(e, i.ParseError.PropertyValueExpected) : this.finish(e));
            ...
            e: for (; ; ) {
              switch (this.token.type) {
                ...
                case n.TokenType.ParenthesisR:
                  if (s--, s < 0)
                    return this.finish(e, i.ParseError.LeftParenthesisExpected);
                  break;
                ...
                case n.TokenType.BracketR:
                  if (a--, a < 0)
                    return this.finish(e, i.ParseError.LeftSquareBracketExpected);
                  break;
                case n.TokenType.BadString:
                case n.TokenType.BadUri:
                  break e;
                case n.TokenType.EOF:
                  var l = i.ParseError.RightCurlyExpected;
                  return a > 0 ? l = i.ParseError.RightSquareBracketExpected : s > 0 && (l = i.ParseError.RightParenthesisExpected), this.finish(e, l);
              }
              this.consumeToken();
            }
            return this.finish(e);
            ...
            var e = this.mark();
            return this._parseProperty() && this.accept(n.TokenType.Colon) ? (this.restoreAtMark(e), this._parseDeclaration()) : (this.restoreAtMark(e), null);
          }, e.prototype._parseProperty = function() {
            var e = this.create(r.Property),
                t = this.mark();
            return (this.accept(n.TokenType.Delim, "*") || this.accept(n.TokenType.Delim, "_")) && this.hasWhitespace() ? (this.restoreAtMark(t), null) : e.setIdentifier(this._parsePropertyIdentifier()) ? this.finish(e) : null;
          }, e.prototype._parsePropertyIdentifier = function() {
            return this._parseIdent();
          }, e.prototype._parseCharset = function() {
            var e = this.create(r.Node);
            return this.accept(n.TokenType.Charset) ? this.accept(n.TokenType.String) ? this.accept(n.TokenType.SemiColon) ? this.finish(e) : this.finish(e, i.ParseError.SemiColonExpected) : this.finish(e, i.ParseError.IdentifierExpected) : null;
          }, e.prototype._parseImport = function() {
            var e = this.create(r.Import);
            return this.accept(n.TokenType.AtKeyword, "@import") ? this.accept(n.TokenType.URI) || this.accept(n.TokenType.String) ? (e.setMedialist(this._parseMediaList()), this.finish(e)) : this.finish(e, i.ParseError.URIOrStringExpected) : null;
          }, e.prototype._parseNamespace = function() {
            var e = this.create(r.Namespace);
            return this.accept(n.TokenType.AtKeyword, "@namespace") ? (e.addChild(this._parseIdent()), this.accept(n.TokenType.URI) || this.accept(n.TokenType.String) ? this.accept(n.TokenType.SemiColon) ? this.finish(e) : this.finish(e, i.ParseError.SemiColonExpected) : this.finish(e, i.ParseError.URIExpected, [n.TokenType.SemiColon])) : null;
          }, e.prototype._parseFontFace = function() {
            if (!this.peek(n.TokenType.AtKeyword, "@font-face"))
              return null;
            ...
            if (!this.peek(n.TokenType.AtKeyword, "@-ms-viewport") && !this.peek(n.TokenType.AtKeyword, "@-o-viewport") && !this.peek(n.TokenType.AtKeyword, "@viewport"))
              return null;
            ...
            return this.accept(n.TokenType.AtKeyword, "@keyframes") || this.accept(n.TokenType.AtKeyword, "@-webkit-keyframes") || this.accept(n.TokenType.AtKeyword, "@-ms-keyframes") || this.accept(n.TokenType.AtKeyword, "@-moz-keyframes") || this.accept(n.TokenType.AtKeyword, "@-o-keyframes") ? (e.setKeyword(this.finish(t)), "@-ms-keyframes" === t.getText() && this.markError(t, i.ParseError.UnknownKeyword), e.setIdentifier(this._parseIdent([r.ReferenceType.Keyframe])) ? this._parseBody(e, this._parseKeyframeSelector.bind(this)) : this.finish(e, i.ParseError.IdentifierExpected, [n.TokenType.CurlyR])) : null;
          ...
          }, e.prototype._parseMediaDeclaration = function() {
            return this._tryParseRuleset(!1) || this._tryToParseDeclaration() || this._parseStylesheetStatement();
          }, e.prototype._parseMedia = function() {
            var e = this.create(r.Media);
            if (!this.accept(n.TokenType.AtKeyword, "@media"))
              return null;
            if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))
              return this.finish(e, i.ParseError.IdentifierExpected);
            for (; this.accept(n.TokenType.Comma); )
              if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))
                return this.finish(e, i.ParseError.IdentifierExpected);
            return this._parseBody(e, this._parseMediaDeclaration.bind(this));
          }, e.prototype._parseMediaQuery = function(e) {
            var t = this.create(r.MediaQuery),
                o = !0,
                s = !1;
            if (!this.peek(n.TokenType.ParenthesisL)) {
              if (this.accept(n.TokenType.Ident, "only", !0) || this.accept(n.TokenType.Ident, "not", !0), !t.addChild(this._parseIdent()))
                return null;
              s = !0, o = this.accept(n.TokenType.Ident, "and", !0);
            }
            for (; o; ) {
              if (!this.accept(n.TokenType.ParenthesisL))
                return s ? this.finish(t, i.ParseError.LeftParenthesisExpected, [], e) : null;
            ...
            if (!this.accept(n.TokenType.AtKeyword, "@Page"))
              return null;
            ...
            return this.peek(n.TokenType.AtKeyword) ? (this.acceptOne(n.TokenType.AtKeyword, o.getPageBoxDirectives()) || this.markError(e, i.ParseError.UnknownAtRule, [], [n.TokenType.CurlyL]), this._parseBody(e, this._parseRuleSetDeclaration.bind(this))) : null;
          }, e.prototype._parsePageSelector = function() {
            var e = this.create(r.Node);
            return this.peek(n.TokenType.Ident) || this.peek(n.TokenType.Colon) ? (e.addChild(this._parseIdent()), this.accept(n.TokenType.Colon) && !e.addChild(this._parseIdent()) ? this.finish(e, i.ParseError.IdentifierExpected) : this.finish(e)) : null;
          }, e.prototype._parseDocument = function() {
            var e = this.create(r.Document);
            return this.accept(n.TokenType.AtKeyword, "@-moz-document") ? (this.resync([], [n.TokenType.CurlyL]), this._parseBody(e, this._parseStylesheetStatement.bind(this))) : null;
          }, e.prototype._parseOperator = function() {
            var e = this.createNode(r.NodeType.Operator);
            return this.accept(n.TokenType.Delim, "/") || this.accept(n.TokenType.Delim, "*") || this.accept(n.TokenType.Delim, "+") || this.accept(n.TokenType.Delim, "-") || this.accept(n.TokenType.Dashmatch) || this.accept(n.TokenType.Includes) || this.accept(n.TokenType.SubstringOperator) || this.accept(n.TokenType.PrefixOperator) || this.accept(n.TokenType.SuffixOperator) || this.accept(n.TokenType.Delim, "=") ? this.finish(e) : null;
          }, e.prototype._parseUnaryOperator = function() {
            var e = this.create(r.Node);
            return this.accept(n.TokenType.Delim, "+") || this.accept(n.TokenType.Delim, "-") ? this.finish(e) : null;
          }, e.prototype._parseCombinator = function() {
            var e = this.create(r.Node);
            return this.accept(n.TokenType.Delim, ">") ? (e.type = r.NodeType.SelectorCombinatorParent, this.finish(e)) : this.accept(n.TokenType.Delim, "+") ? (e.type = r.NodeType.SelectorCombinatorSibling, this.finish(e)) : this.accept(n.TokenType.Delim, "~") ? (e.type = r.NodeType.SelectorCombinatorAllSiblings, this.finish(e)) : null;
          }, e.prototype._parseSimpleSelector = function() {
            var e = this.create(r.SimpleSelector),
                t = 0;
            for (e.addChild(this._parseElementName()) && t++; (0 === t || !this.hasWhitespace()) && e.addChild(this._parseSimpleSelectorBody()); )
              t++;
            ...
            if (!this.peek(n.TokenType.Hash) && !this.peek(n.TokenType.Delim, "#"))
              return null;
            ...
            if (!this.peek(n.TokenType.Delim, "."))
              return null;
            var e = this.createNode(r.NodeType.ClassSelector);
            return this.consumeToken(), this.hasWhitespace() || !e.addChild(this._parseSelectorIdent()) ? this.finish(e, i.ParseError.IdentifierExpected) : this.finish(e);
          }, e.prototype._parseElementName = function() {
            var e = this.createNode(r.NodeType.ElementNameSelector);
            return e.addChild(this._parseSelectorIdent()) || this.accept(n.TokenType.Delim, "*") ? this.finish(e) : null;
          }, e.prototype._parseAttrib = function() {
            if (!this.peek(n.TokenType.BracketL))
              return null;
            var e = this.createNode(r.NodeType.AttributeSelector);
            return this.consumeToken(), !e.addChild(this._parseBinaryExpr()), this.accept(n.TokenType.BracketR) ? this.finish(e) : this.finish(e, i.ParseError.RightSquareBracketExpected);
          }, e.prototype._parsePseudo = function() {
            if (!this.peek(n.TokenType.Colon))
              return null;
            var e = this.mark(),
                t = this.createNode(r.NodeType.PseudoSelector);
            return this.consumeToken(), this.hasWhitespace() ? (this.restoreAtMark(e), null) : this.accept(n.TokenType.Colon) && this.hasWhitespace() ? this.finish(t, i.ParseError.IdentifierExpected) : t.addChild(this._parseIdent()) ? this.hasWhitespace() || !this.accept(n.TokenType.ParenthesisL) || (t.addChild(this._parseBinaryExpr() || this._parseSimpleSelector()), this.accept(n.TokenType.ParenthesisR)) ? this.finish(t) : this.finish(t, i.ParseError.RightParenthesisExpected) : this.finish(t, i.ParseError.IdentifierExpected);
          }, e.prototype._parsePrio = function() {
            if (!this.peek(n.TokenType.Exclamation))
              return null;
            var e = this.createNode(r.NodeType.Prio);
            return this.accept(n.TokenType.Exclamation) && this.accept(n.TokenType.Ident, "important", !0) ? this.finish(e) : null;
            ...
            if (!n.setRight(this._parseTerm()))
              return this.finish(n, i.ParseError.TermExpected);
            n = this.finish(n);
            ...
            return e.setOperator(this._parseUnaryOperator()), e.setExpression(this._parseFunction()) || e.setExpression(this._parseIdent()) || e.setExpression(this._parseURILiteral()) || e.setExpression(this._parseStringLiteral()) || e.setExpression(this._parseNumeric()) || e.setExpression(this._parseHexColor()) || e.setExpression(this._parseOperation()) ? this.finish(e) : null;
          }, e.prototype._parseOperation = function() {
            var e = this.create(r.Node);
            return this.accept(n.TokenType.ParenthesisL) ? (e.addChild(this._parseExpr()), this.accept(n.TokenType.ParenthesisR) ? this.finish(e) : this.finish(e, i.ParseError.RightParenthesisExpected)) : null;
          }, e.prototype._parseNumeric = function() {
            var e = this.create(r.NumericValue);
            return this.accept(n.TokenType.Num) || this.accept(n.TokenType.Percentage) || this.accept(n.TokenType.Resolution) || this.accept(n.TokenType.Length) || this.accept(n.TokenType.EMS) || this.accept(n.TokenType.EXS) || this.accept(n.TokenType.Angle) || this.accept(n.TokenType.Time) || this.accept(n.TokenType.Dimension) || this.accept(n.TokenType.Freq) ? this.finish(e) : null;
          }, e.prototype._parseStringLiteral = function() {
            var e = this.createNode(r.NodeType.StringLiteral);
            return this.accept(n.TokenType.String) || this.accept(n.TokenType.BadString) ? this.finish(e) : null;
          }, e.prototype._parseURILiteral = function() {
            var e = this.createNode(r.NodeType.URILiteral);
            return this.accept(n.TokenType.URI) || this.accept(n.TokenType.BadUri) ? this.finish(e) : null;
          }, e.prototype._parseIdent = function(e) {
            var t = this.create(r.Identifier);
            return e && (t.referenceTypes = e), t.isCustomProperty = this.peekRegExp(n.TokenType.Ident, /^--/), this.accept(n.TokenType.Ident) ? this.finish(t) : null;
            ...
            if (t.getArguments().addChild(this._parseFunctionArgument()))
              for (; this.accept(n.TokenType.Comma); )
                t.getArguments().addChild(this._parseFunctionArgument()) || this.markError(t, i.ParseError.ExpressionExpected);
            ...
            if (e.referenceTypes = [r.ReferenceType.Function], this.accept(n.TokenType.Ident, "progid")) {
              if (this.accept(n.TokenType.Colon))
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/utils/arrays", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
      var n = 0,
          r = e.length;
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssSymbolScope", ["require", "exports", "./cssNodes", "../utils/arrays"], e);
  }(function(e, t) {
    var n = e("./cssNodes"),
        r = e("../utils/arrays"),
        i = function() {
      ...
      return e.prototype.addSymbol = function(e, t, n, r) {
        ...
        switch (e.type) {
          ...
          case n.NodeType.For:
            var t = e,
                r = t.getDeclarations();
            return r && this.addSymbolToChildScope(r, t.variable, t.variable.getName(), null, n.ReferenceType.Variable), !0;
          case n.NodeType.Each:
            var i = e,
                o = i.getDeclarations();
            if (o)
              for (var s = i.getVariables().getChildren(),
                  a = 0,
                  l = s; a < l.length; a++) {
                var c = l[a];
        ...
        var t = this.scope.findScope(e.offset, e.length);
        return e.getSelectors().getChildren().forEach(function(e) {
          e instanceof n.Selector && 1 === e.getChildren().length && t.addSymbol(new s(e.getChild(0).getText(), null, e, n.ReferenceType.Rule));
        }), !0;
        ...
        for (var r = this.scope.findScope(e.offset, e.length); null !== r.parent; )
          r = r.parent;
        return r;
      }, e;
    }();
    ...
    var l = function() {
      function e(e) {
        this.global = new o, e.accept(new a(this.global));
      }
      return e.prototype.findSymbolsAtOffset = function(e, t) {
        for (var n = this.global.findScope(e, 0),
            r = [],
            i = {}; n; ) {
          for (var o = n.getSymbols(),
              s = 0; s < o.length; s++) {
            var a = o[s];
        ...
        var r = e;
        if (e.parent instanceof n.FunctionParameter && e.parent.getParent() instanceof n.BodyDeclaration && (r = e.parent.getParent().getDeclarations()), e.parent instanceof n.FunctionArgument && e.parent.getParent() instanceof n.Function) {
        ...
        if (!r)
          return null;
        for (var s = e.getText(),
            a = this.global.findScope(r.offset, r.length); a; ) {
        ...
        if (e instanceof n.Identifier) {
          ...
          if (e.isCustomProperty)
            return [n.ReferenceType.Variable];
          var r = n.getParentDeclaration(e);
          if (r) {
            var i = r.getNonPrefixedPropertyName();
            if (("animation" === i || "animation-name" === i) && r.getValue() && r.getValue().offset === e.offset)
              return [n.ReferenceType.Keyframe];
          }
        } else if (e instanceof n.Variable)
          return [n.ReferenceType.Variable];
        var o = e.findParent(n.NodeType.Selector);
        if (o)
          return [n.ReferenceType.Rule];
        var s = e.findParent(n.NodeType.ExtendsReference);
        return s ? [n.ReferenceType.Rule] : null;
      }, e.prototype.findSymbolFromNode = function(e) {
        if (!e)
          return null;
        for (; e.type === n.NodeType.Interpolation; )
          e = e.getParent();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/utils/strings", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
    ...
    function i(e, t, n) {
      ...
      for (i = 1; i < e.length + 1; ++i)
        for (o = 1; o < t.length + 1; ++o)
          e[i - 1] === t[o - 1] ? s[i][o] = s[i - 1][o - 1] + 1 : s[i][o] = Math.max(s[i - 1][o], s[i][o - 1]);
      return s[e.length][t.length] - Math.sqrt(r);
    }
    function o(e, t) {
      return void 0 === t && (t = !0), e ? e.length < 140 ? e : e.slice(0, 140) + (t ? "…" : "") : "";
    }
    t.startsWith = n, t.endsWith = r, t.difference = i, t.getLimitedString = o;
  }), function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t);
    } else
      "function" == typeof define && define.amd && define("vscode-languageserver-types/main", ["require", "exports"], e);
  }(function(e, t) {
    var n;
    !function(e) {
      function t(e, t) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.number(t.line) && _.number(t.character);
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      function t(e, t, r, i) {
        if (_.number(e) && _.number(t) && _.number(r) && _.number(i))
          return {
            start: n.create(e, t),
            end: n.create(r, i)
          };
      ...
      function r(e) {
        var t = e;
        return _.defined(t) && n.is(t.start) && n.is(t.end);
      }
      e.create = t, e.is = r;
    }(r = t.Range || (t.Range = {}));
    var i;
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && r.is(t.range) && (_.string(t.uri) || _.undefined(t.uri));
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      function t(e, t, n, r, i) {
        ...
        return _.defined(n) && (o.severity = n), _.defined(r) && (o.code = r), _.defined(i) && (o.source = i), o;
      }
      function n(e) {
        var t = e;
        return _.defined(t) && r.is(t.range) && _.string(t.message) && (_.number(t.severity) || _.undefined(t.severity)) && (_.number(t.code) || _.string(t.code) || _.undefined(t.code)) && (_.string(t.source) || _.undefined(t.source));
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      function t(e, t) {
        ...
        return _.defined(n) && n.length > 0 && (i.arguments = n), i;
      }
      function n(e) {
        var t = e;
        return _.defined(t) && _.string(t.title) && _.string(t.title);
      }
      e.create = t, e.is = n;
    }(a = t.Command || (t.Command = {}));
    var l;
    !function(e) {
      function t(e, t) {
        return {
          ...
          return Object.defineProperty(e.prototype, "edit", {
            ...
            if (p.is(e)) {
              ...
              if (!n) {
                ...
                this._workspaceEdit.changes.push(i), n = new c(r), this._textEditChanges[t.uri] = n;
              }
              return n;
            }
    ...
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.string(t.uri);
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.string(t.uri) && _.number(t.version);
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.string(t.uri) && _.string(t.languageId) && _.number(t.version) && _.string(t.text);
      }
      e.create = t, e.is = n;
    }(m = t.TextDocumentItem || (t.TextDocumentItem = {}));
    var u;
    !function(e) {
    ...
    }(u = t.CompletionItemKind || (t.CompletionItemKind = {}));
    var f;
    !function(e) {
      e.PlainText = 1, e.Snippet = 2;
    }(f = t.InsertTextFormat || (t.InsertTextFormat = {}));
    var g;
    !function(e) {
      function t(e) {
        return {label: e};
      ...
      e.create = t;
    }(g = t.CompletionItem || (t.CompletionItem = {}));
    var b;
    !function(e) {
      function t(e, t) {
        return {
    ...
    !function(e) {
      function t(e, t) {
        for (var n = [],
          ...
          n[r - 2] = arguments[r];
        var i = {label: e};
        return _.defined(t) && (i.documentation = t), _.defined(n) ? i.parameters = n : i.parameters = [], i;
      }
      e.create = t;
    }(v = t.SignatureInformation || (t.SignatureInformation = {}));
    var x;
    !function(e) {
      e.Text = 1, e.Read = 2, e.Write = 3;
    }(x = t.DocumentHighlightKind || (t.DocumentHighlightKind = {}));
    var k;
    !function(e) {
      function t(e, t) {
        var n = {range: e};
        return _.number(t) && (n.kind = t), n;
      }
      e.create = t;
    ...
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.typedArray(t.diagnostics, s.is);
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      function t(e, t) {
        var n = {range: e};
        return _.defined(t) && (n.data = t), n;
      }
      function n(e) {
        var t = e;
        return _.defined(t) && r.is(t.range) && (_.undefined(t.command) || a.is(t.command));
      }
      e.create = t, e.is = n;
    ...
    !function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && _.number(t.tabSize) && _["boolean"](t.insertSpaces);
      }
      e.create = t, e.is = n;
    ...
    t.DocumentLink = I, function(e) {
      ...
      function n(e) {
        var t = e;
        return _.defined(t) && r.is(t.range) && (_.undefined(t.target) || _.string(t.target));
      }
      e.create = t, e.is = n;
    }(I = t.DocumentLink || (t.DocumentLink = {})), t.DocumentLink = I, t.EOL = ["\n", "\r\n", "\r"];
    var P;
    !function(e) {
      function t(e, t, n, r) {
      ...
      function n(e) {
        var t = e;
        return !!(_.defined(t) && _.string(t.uri) && (_.undefined(t.languageId) || _.string(t.languageId)) && _.number(t.lineCount) && _.func(t.getText) && _.func(t.positionAt) && _.func(t.offsetAt));
      }
      e.create = t, e.is = n;
    }(P = t.TextDocument || (t.TextDocument = {}));
    var A;
    !function(e) {
    ...
    !function(e) {
      ...
      e.defined = t, e.undefined = n, e["boolean"] = r, e.string = i, e.number = o, e.func = s, e.typedArray = a;
    }(_ || (_ = {}));
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssCompletion", ["require", "exports", "../parser/cssNodes", "../parser/cssSymbolScope", "./languageFacts", "../utils/strings", "vscode-languageserver-types", "vscode-nls"], e);
  }(function(e, t) {
    function n(e) {
      return "undefined" != typeof e;
    }
    ...
    var i = e("../parser/cssNodes"),
        ...
        p = function() {
          function e(e) {
            void 0 === e && (e = null), this.valueTypes = [i.NodeType.Identifier, i.NodeType.Value, i.NodeType.StringLiteral, i.NodeType.URILiteral, i.NodeType.NumericValue, i.NodeType.HexColorValue, i.NodeType.VariableName, i.NodeType.Prio], this.variablePrefix = e;
          }
          return e.prototype.getSymbolContext = function() {
            return this.symbolContext || (this.symbolContext = new o.Symbols(this.styleSheet)), this.symbolContext;
          }, e.prototype.doComplete = function(e, t, n) {
            this.offset = e.offsetAt(t), this.position = t, this.currentWord = r(e, this.offset), this.defaultReplaceRange = l.Range.create(l.Position.create(this.position.line, this.position.character - this.currentWord.length), this.position), this.textDocument = e, this.styleSheet = n;
            try {
              var o = {
                isIncomplete: !1,
                items: []
              ...
              for (var s = this.nodePath.length - 1; s >= 0; s--) {
                var a = this.nodePath[s];
                if (a instanceof i.Property)
                  this.getCompletionsForDeclarationProperty(a.getParent(), o);
                else if (a instanceof i.Expression)
                  this.getCompletionsForExpression(a, o);
                else if (a instanceof i.SimpleSelector) {
                  var c = a.findParent(i.NodeType.Ruleset);
                  this.getCompletionsForSelector(c, o);
                } else
                  a instanceof i.FunctionArgument ? this.getCompletionsForFunctionArgument(a, a.getParent(), o) : a instanceof i.Declarations ? this.getCompletionsForDeclarations(a, o) : a instanceof i.VariableDeclaration ? this.getCompletionsForVariableDeclaration(a, o) : a instanceof i.RuleSet ? this.getCompletionsForRuleSet(a, o) : a instanceof i.Interpolation ? this.getCompletionsForInterpolation(a, o) : a instanceof i.FunctionDeclaration ? this.getCompletionsForFunctionDeclaration(a, o) : a instanceof i.MixinReference ? this.getCompletionsForMixinReference(a, o) : a instanceof i.Function && this.getCompletionsForFunctionArgument(null, a, o);
                if (o.items.length > 0)
                  return o;
              }
              return this.getCompletionsForStylesheet(o), o.items.length > 0 ? o : this.variablePrefix && 0 === this.currentWord.indexOf(this.variablePrefix) && (this.getVariableProposals(null, o), o.items.length > 0) ? o : o;
            } finally {
            ...
            for (var i in r)
              if (r.hasOwnProperty(i)) {
                ...
                if (o.browsers.onCodeComplete) {
                  var a = void 0,
                      c = void 0;
                  e ? (a = this.getCompletionRange(e.getProperty()), c = o.name + (n(e.colonPosition) ? "" : ": ")) : (a = this.getCompletionRange(null), c = o.name + ": "), t.items.push({
                    label: o.name,
                    documentation: s.getEntryDescription(o),
                    textEdit: l.TextEdit.replace(a, c),
            ...
            for (var n = this,
                r = e.getFullPropertyName(),
                i = s.getProperties()[r],
                o = e.getValue(); o && o.hasChildren(); )
              o = o.findChildAtOffset(this.offset, !1);
            if (i)
              this.getColorProposals(i, o, t), this.getPositionProposals(i, o, t), this.getRepeatStyleProposals(i, o, t), this.getLineProposals(i, o, t), this.getBoxProposals(i, o, t), this.getImageProposals(i, o, t), this.getTimingFunctionProposals(i, o, t), this.getBasicShapeProposals(i, o, t), this.getValueEnumProposals(i, o, t), this.getCSSWideKeywordProposals(i, o, t), this.getUnitProposals(i, o, t);
            else {
              var a = new m;
              this.styleSheet.accept(new f(r, a)), a.getEntries().forEach(function(e) {
                t.items.push({
                  label: e,
            ...
            return this.getVariableProposals(o, t), this.getTermProposals(o, t), t;
          }, e.prototype.getValueEnumProposals = function(e, t, n) {
            var r = this;
            return e.values && e.values.forEach(function(e) {
              s.isCommonValue(e) && n.items.push({
                label: e.name,
                documentation: s.getEntryDescription(e),
                textEdit: l.TextEdit.replace(r.getCompletionRange(t), e.name),
                kind: l.CompletionItemKind.Value
              });
            }), n;
          }, e.prototype.getCSSWideKeywordProposals = function(e, t, n) {
            for (var r in s.cssWideKeywords)
              n.items.push({
                label: r,
                documentation: s.cssWideKeywords[r],
            ...
            return r.forEach(function(r) {
              var o = a.startsWith(r.name, "--") ? "var(" + r.name + ")" : r.name,
                  s = {
                    label: r.name,
                    documentation: r.value ? a.getLimitedString(r.value) : r.value,
              ...
              if (r.node.type === i.NodeType.FunctionParameter) {
                ...
                c.type === i.NodeType.MixinDeclaration && (s.detail = d("completion.argument", "argument from '{0}'", c.getName()));
              }
              t.items.push(s);
            }), t;
            ...
            return n = n.filter(function(e) {
              return a.startsWith(e.name, "--");
            }), n.forEach(function(n) {
              e.items.push({
                label: n.name,
                documentation: n.value ? a.getLimitedString(n.value) : n.value,
            ...
            if (this.currentWord.length > 0) {
              var o = this.currentWord.match(/^-?\d[\.\d+]*/);
              o && (i = o[0], n.isIncomplete = i.length === this.currentWord.length);
            } else
              0 === this.currentWord.length && (n.isIncomplete = !0);
            return e.restrictions.forEach(function(e) {
              var o = s.units[e];
              o && o.forEach(function(e) {
                var o = i + e;
                n.items.push({
                  label: o,
                  textEdit: l.TextEdit.replace(r.getCompletionRange(t), o),
            ...
            var r = this;
            if (e.restrictions.indexOf("color") !== -1) {
              for (var i in s.colors)
                n.items.push({
                  label: i,
                  documentation: s.colors[i],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                  kind: l.CompletionItemKind.Color
                });
              for (var i in s.colorKeywords)
                n.items.push({
                  label: i,
                  documentation: s.colorKeywords[i],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                  kind: l.CompletionItemKind.Value
                });
              var o = new m;
              this.styleSheet.accept(new g(o)), o.getEntries().forEach(function(e) {
                n.items.push({
                  label: e,
                  textEdit: l.TextEdit.replace(r.getCompletionRange(t), e),
                  kind: l.CompletionItemKind.Color
                });
              }), s.colorFunctions.forEach(function(e) {
                var i = 1,
                    o = function(e, t) {
                      return "${" + i++ + ":" + t + "}";
                    },
                    s = e.func.replace(/\[?\$(\w+)\]?/g, o);
                n.items.push({
                  label: e.func.substr(0, e.func.indexOf("(")),
                  detail: e.func,
                  documentation: e.desc,
                  textEdit: l.TextEdit.replace(r.getCompletionRange(t), s),
                  insertTextFormat: h,
            ...
            if (e.restrictions.indexOf("position") !== -1)
              for (var r in s.positionKeywords)
                n.items.push({
                  label: r,
                  documentation: s.positionKeywords[r],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), r),
                  kind: l.CompletionItemKind.Value
                });
            return n;
          }, e.prototype.getRepeatStyleProposals = function(e, t, n) {
            if (e.restrictions.indexOf("repeat") !== -1)
              for (var r in s.repeatStyleKeywords)
                n.items.push({
                  label: r,
                  documentation: s.repeatStyleKeywords[r],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), r),
                  kind: l.CompletionItemKind.Value
                });
            return n;
          }, e.prototype.getLineProposals = function(e, t, n) {
            var r = this;
            if (e.restrictions.indexOf("line-style") !== -1)
              for (var i in s.lineStyleKeywords)
                n.items.push({
                  label: i,
                  documentation: s.lineStyleKeywords[i],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                  kind: l.CompletionItemKind.Value
                });
            return e.restrictions.indexOf("line-width") !== -1 && s.lineWidthKeywords.forEach(function(e) {
              n.items.push({
                label: e,
                textEdit: l.TextEdit.replace(r.getCompletionRange(t), e),
                kind: l.CompletionItemKind.Value
            ...
            var r = e.restrictions.indexOf("geometry-box");
            if (r !== -1)
              for (var i in s.geometryBoxKeywords)
                n.items.push({
                  label: i,
                  documentation: s.geometryBoxKeywords[i],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                  kind: l.CompletionItemKind.Value
                });
            if (e.restrictions.indexOf("box") !== -1 || r !== -1)
              for (var i in s.boxKeywords)
                n.items.push({
                  label: i,
                  documentation: s.boxKeywords[i],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                  kind: l.CompletionItemKind.Value
                });
            return n;
          }, e.prototype.getImageProposals = function(e, t, n) {
            if (e.restrictions.indexOf("image") !== -1)
              for (var r in s.imageFunctions)
                n.items.push({
                  label: r,
                  documentation: s.imageFunctions[r],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), r),
                  kind: l.CompletionItemKind.Function
                });
            return n;
          }, e.prototype.getTimingFunctionProposals = function(e, t, n) {
            if (e.restrictions.indexOf("timing-function") !== -1)
              for (var r in s.transitionTimingFunctions)
                n.items.push({
                  label: r,
                  documentation: s.transitionTimingFunctions[r],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), r),
                  kind: l.CompletionItemKind.Function
                });
            return n;
          }, e.prototype.getBasicShapeProposals = function(e, t, n) {
            if (e.restrictions.indexOf("shape") !== -1)
              for (var r in s.basicShapeFunctions)
                n.items.push({
                  label: r,
                  documentation: s.basicShapeFunctions[r],
                  textEdit: l.TextEdit.replace(this.getCompletionRange(t), r),
                  kind: l.CompletionItemKind.Function
                });
            return n;
            ...
            return t ? t instanceof i.RuleSet ? this.getCompletionsForRuleSet(t, e) : e : this.getCompletionForTopLevel(e);
          }, e.prototype.getCompletionForTopLevel = function(e) {
            var t = this;
            return s.getAtDirectives().forEach(function(n) {
              n.browsers.count > 0 && e.items.push({
                label: n.name,
                textEdit: l.TextEdit.replace(t.getCompletionRange(null), n.name),
                documentation: s.getEntryDescription(n),
                kind: l.CompletionItemKind.Keyword
              });
            }), this.getCompletionsForSelector(null, e), e;
            ...
            if (o) {
              for (var s = this.textDocument.offsetAt(this.defaultReplaceRange.start); s > 0 && ":" === this.textDocument.getText().charAt(s - 1); )
                s--;
              return this.getCompletionsForSelector(e, t);
            }
            return e.findParent(i.NodeType.Ruleset), this.getCompletionsForDeclarations(e.getDeclarations(), t);
          }, e.prototype.getCompletionsForSelector = function(e, t) {
            var n = this,
                r = this.findInNodePath(i.NodeType.PseudoSelector, i.NodeType.IdentifierSelector, i.NodeType.ClassSelector, i.NodeType.ElementNameSelector);
            !r && 0 === this.currentWord.length && this.offset > 0 && ":" === this.textDocument.getText()[this.offset - 1] && (this.currentWord = ":", this.defaultReplaceRange = l.Range.create(l.Position.create(this.position.line, this.position.character - 1), this.position)), s.getPseudoClasses().forEach(function(e) {
              e.browsers.onCodeComplete && t.items.push({
                label: e.name,
                textEdit: l.TextEdit.replace(n.getCompletionRange(r), e.name),
                documentation: s.getEntryDescription(e),
                kind: l.CompletionItemKind.Function
              });
            }), s.getPseudoElements().forEach(function(e) {
              e.browsers.onCodeComplete && t.items.push({
                label: e.name,
                textEdit: l.TextEdit.replace(n.getCompletionRange(r), e.name),
                documentation: s.getEntryDescription(e),
            ...
            }), s.html5Tags.forEach(function(e) {
              t.items.push({
                label: e,
                textEdit: l.TextEdit.replace(n.getCompletionRange(r), e),
                kind: l.CompletionItemKind.Keyword
              });
            }), s.svgElements.forEach(function(e) {
              t.items.push({
                label: e,
                textEdit: l.TextEdit.replace(n.getCompletionRange(r), e),
                kind: l.CompletionItemKind.Keyword
            ...
            var o = {};
            o[this.currentWord] = !0;
            var a = this.styleSheet.getTextProvider();
            if (this.styleSheet.accept(function(e) {
              if (e.type === i.NodeType.SimpleSelector && e.length > 0) {
                var s = a(e.offset, e.length);
                return "." !== s.charAt(0) || o[s] || (o[s] = !0, t.items.push({
                  label: s,
                  textEdit: l.TextEdit.replace(n.getCompletionRange(r), s),
                  kind: l.CompletionItemKind.Keyword
                })), !1;
              }
              return !0;
            }), e && e.isNested()) {
              var c = e.getSelectors().findFirstChildBeforeOffset(this.offset);
              c && 0 === e.getSelectors().getChildren().indexOf(c) && this.getPropertyProposals(null, t);
            }
            return t;
            ...
            if (r instanceof i.AbstractDeclaration) {
              ...
              if (n(o.semicolonPosition) && o.semicolonPosition < this.offset)
                return this.offset === o.semicolonPosition + 1 ? t : this.getCompletionsForDeclarationProperty(null, t);
              if (o instanceof i.Declaration)
                return this.getCompletionsForDeclarationValue(o, t);
            }
            return t;
            ...
            if (e.getParent() instanceof i.FunctionArgument)
              return this.getCompletionsForFunctionArgument(e.getParent(), e.getParent().getParent(), t), t;
            var n = e.findParent(i.NodeType.Declaration);
            if (!n)
              return this.getTermProposals(null, t), t;
            var r = e.findChildAtOffset(this.offset, !0);
            return r ? r instanceof i.NumericValue || r instanceof i.Identifier ? this.getCompletionsForDeclarationValue(n, t) : t : this.getCompletionsForDeclarationValue(n, t);
            ...
            var n = e.getDeclarations();
            return n && this.offset > n.offset && this.offset < n.end && this.getTermProposals(null, t), t;
            ...
            return r.forEach(function(e) {
              e.node instanceof i.MixinDeclaration && t.items.push(n.makeTermProposal(e, e.node.getParameters(), null));
            }), t;
          }, e.prototype.getTermProposals = function(e, t) {
            var n = this,
                r = this.getSymbolContext().findSymbolsAtOffset(this.offset, i.ReferenceType.Function);
            return r.forEach(function(r) {
              r.node instanceof i.FunctionDeclaration && t.items.push(n.makeTermProposal(r, r.node.getParameters(), e));
            }), t;
          }, e.prototype.makeTermProposal = function(e, t, n) {
            var r = (e.node, t.getChildren().map(function(e) {
              return e instanceof i.FunctionParameter ? e.getName() : e.getText();
            })),
                o = e.name + "(" + r.map(function(e, t) {
                  return "${" + (t + 1) + ":" + e + "}";
                }).join(", ") + ")";
            return {
              label: e.name,
      ...
      return e.prototype.add = function(e) {
        ...
        u = function() {
          ...
          return e.prototype.visitNode = function(e) {
            return (e instanceof i.Identifier || e instanceof i.NumericValue || e instanceof i.HexColorValue) && this.entries.add(e.getText()), !0;
          }, e;
        }(),
        f = function() {
          function e(e, t) {
          ...
          return e.prototype.matchesProperty = function(e) {
        ...
        g = function() {
          ...
          return e.prototype.visitNode = function(e) {
            return (e instanceof i.HexColorValue || e instanceof i.Function && s.isColorConstructor(e)) && this.entries.add(e.getText()), !0;
          }, e;
        }();
  });
  var __extends = this && this.__extends || function(e, t) {
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/selectorPrinting", ["require", "exports", "../parser/cssNodes"], e);
  }(function(e, t) {
    function n(e, t) {
      var n = new l;
      return e.getChildren().forEach(function(e) {
        switch (e.type) {
          case a.NodeType.SelectorCombinator:
            if (t) {
              ...
              for (var o = 1; o < r.length; o++) {
                if (o > 1) {
                  var s = t.cloneWithParent();
                  n.addChild(s.findRoot()), n = s;
                }
                n.append(r[o]);
              }
            }
            break;
          case a.NodeType.SelectorPlaceholder:
            if ("@at-root" === e.getText())
              return n;
          case a.NodeType.ElementNameSelector:
            var l = e.getText();
            n.addAttr("name", "*" === l ? "element" : l);
            break;
          case a.NodeType.ClassSelector:
            n.addAttr("class", e.getText().substring(1));
            break;
          case a.NodeType.IdentifierSelector:
            n.addAttr("id", e.getText().substring(1));
            break;
          case a.NodeType.MixinDeclaration:
            n.addAttr("class", e.getName());
            break;
          case a.NodeType.PseudoSelector:
            n.addAttr(e.getText(), "");
            break;
          case a.NodeType.AttributeSelector:
    ...
    function s(e) {
      ...
      var t = new c,
          n = [];
      if (e.getParent() instanceof a.RuleSet)
        for (var r = e.getParent().getParent(); r && !o(r); ) {
          if (r instanceof a.RuleSet) {
      ...
      for (var i = new m(t),
          s = n.length - 1; s >= 0; s--) {
        var l = n[s].getSelectors().getChild(0);
    ...
    var a = e("../parser/cssNodes"),
        l = function() {
          ...
          return e.prototype.findAttribute = function(e) {
            if (this.attributes)
              for (var t = 0,
                  n = this.attributes; t < n.length; t++) {
                var r = n[t];
                if (r.name === e)
                  return r.value;
              }
            ...
            for (var n = 0,
                r = this.attributes; n < r.length; n++) {
              var i = r[n];
              if (i.name === e)
            ...
            if (this.attributes) {
              n.attributes = [];
              for (var r = 0,
                  i = this.attributes; r < i.length; r++) {
                var o = i[r];
            ...
            if (t && this.children) {
              ...
              for (var s = 0; s < this.children.length; s++)
                n.addChild(this.children[s].clone());
            }
            return n;
    ...
    var h,
        p = function() {
          ...
          return e.prototype.print = function(e) {
            ...
            var n = new Array(e).join("  ");
            this.result.push(n + t);
          }, e.prototype.doPrintElement = function(e, t) {
            var n = this,
                r = e.findAttribute("name");
            if (e instanceof d)
              return void this.writeLine(t, r);
            var i = ["<"];
            r ? i.push(r) : i.push("element"), e.attributes && e.attributes.forEach(function(e) {
              if ("name" !== e.name) {
    ...
    }(h || (h = {})), t.toElement = n, t.selectorToMarkedString = r, t.simpleSelectorToMarkedString = i;
    var m = function() {
      function e(e) {
      ...
      return e.prototype.processSelector = function(e) {
        var t = this,
            r = null;
        if (!(this.element instanceof c) && e.getChildren().some(function(e) {
          return e.hasChildren() && e.getChild(0).type === a.NodeType.SelectorCombinator;
        })) {
          var i = this.element.findRoot();
          i.parent instanceof c && (r = this.element, this.element = i.parent, this.element.removeChild(i), this.prev = null);
        }
        e.getChildren().forEach(function(e) {
          if (e instanceof a.SimpleSelector) {
            if (t.prev instanceof a.SimpleSelector) {
              var i = new d("…");
              t.element.addChild(i), t.element = i;
            } else
              t.prev && (t.prev.matches("+") || t.prev.matches("~")) && (t.element = t.element.parent);
            t.prev && t.prev.matches("~") && (t.element.addChild(n(e)), t.element.addChild(new d("⋮")));
            var o = n(e, r),
                s = o.findRoot();
            t.element.addChild(s), t.element = o;
          }
          (e instanceof a.SimpleSelector || e.type === a.NodeType.SelectorCombinatorParent || e.type === a.NodeType.SelectorCombinatorSibling || e.type === a.NodeType.SelectorCombinatorAllSiblings) && (t.prev = e);
        });
      }, e;
    }();
    t.selectorToElement = s;
  }), function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t);
    } else
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssHover", ["require", "exports", "../parser/cssNodes", "./languageFacts", "vscode-languageserver-types", "./selectorPrinting"], e);
  }(function(e, t) {
    var n = e("../parser/cssNodes"),
        ...
        s = function() {
          function e() {}
          return e.prototype.doHover = function(e, t, s) {
            function a(t) {
              return i.Range.create(e.positionAt(t.offset), e.positionAt(t.end));
            }
            for (var l = e.offsetAt(t),
                c = n.getNodePath(s, l),
                d = 0; d < c.length; d++) {
              var h = c[d];
              if (h instanceof n.Selector)
                return {
                  contents: o.selectorToMarkedString(h),
                  range: a(h)
                };
              if (h instanceof n.SimpleSelector)
                return {
                  contents: o.simpleSelectorToMarkedString(h),
                  range: a(h)
                };
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssNavigation", ["require", "exports", "../parser/cssNodes", "vscode-languageserver-types", "../parser/cssSymbolScope", "../services/languageFacts", "vscode-nls"], e);
  }(function(e, t) {
    function n(e, t) {
      return o.Range.create(t.positionAt(e.offset), t.positionAt(e.end));
    }
    function r(e) {
      if (e.type === i.NodeType.Selector)
    ...
    var i = e("../parser/cssNodes"),
        ...
        s = e("../parser/cssSymbolScope"),
        a = e("../services/languageFacts"),
        l = e("vscode-nls"),
        c = l.loadMessageBundle(),
        d = function() {
          function e() {}
          return e.prototype.findDefinition = function(e, t, r) {
            var a = new s.Symbols(r),
                l = e.offsetAt(t),
                c = i.getNodeAtOffset(r, l);
            if (!c)
              return {
                uri: e.uri,
                range: o.Range.create(t, t)
              };
            var d = a.findSymbolFromNode(c);
            return d ? {
              uri: e.uri,
              range: n(d.node, e)
            } : {
            ...
            if (!c || c.type === i.NodeType.Stylesheet || c.type === i.NodeType.Declarations)
              return a;
            var d = new s.Symbols(o),
                h = d.findSymbolFromNode(c),
                p = c.getText();
            return o.accept(function(t) {
              if (h) {
                if (d.matchesSymbol(t, h))
                  return a.push({
                    kind: r(t),
                    range: n(t, e)
                  }), !1;
              } else
                c.type === t.type && c.length === t.length && p === t.getText() && a.push({
                  kind: r(t),
                  range: n(t, e)
                });
              return !0;
            ...
            return t.accept(function(t) {
              var s = {
                name: null,
                kind: o.SymbolKind.Class,
                location: null
              },
                  a = t;
              return t instanceof i.Selector ? (s.name = t.getText(), a = t.findParent(i.NodeType.Ruleset)) : t instanceof i.VariableDeclaration ? (s.name = t.getName(), s.kind = o.SymbolKind.Variable) : t instanceof i.MixinDeclaration ? (s.name = t.getName(), s.kind = o.SymbolKind.Method) : t instanceof i.FunctionDeclaration ? (s.name = t.getName(), s.kind = o.SymbolKind.Function) : t instanceof i.Keyframe ? s.name = c("literal.keyframes", "@keyframes {0}", t.getName()) : t instanceof i.FontFace && (s.name = c("literal.fontface", "@font-face")), s.name && (s.location = o.Location.create(e.uri, n(a, e)), r.push(s)), !0;
            }), r;
          }, e.prototype.findColorSymbols = function(e, t) {
            var r = [];
            return t.accept(function(t) {
              return a.isColorValue(t) && r.push(n(t, e)), !0;
            }), r;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lintRules", ["require", "exports", "../parser/cssNodes", "vscode-nls"], e);
  }(function(e, t) {
    function n(e) {
      var n = {};
    ...
    t.Rule = d, t.Rules = {
      AllVendorPrefixes: new d("compatibleVendorPrefixes", s("rule.vendorprefixes.all", "When using a vendor-specific prefix make sure to also include all other vendor-specific properties"), c),
      IncludeStandardPropertyWhenUsingVendorPrefix: new d("vendorPrefix", s("rule.standardvendorprefix.all", "When using a vendor-specific prefix also include the standard property"), a),
      DuplicateDeclarations: new d("duplicateProperties", s("rule.duplicateDeclarations", "Do not use duplicate style definitions"), c),
      EmptyRuleSet: new d("emptyRules", s("rule.emptyRuleSets", "Do not use empty rulesets"), a),
      ImportStatemement: new d("importStatement", s("rule.importDirective", "Import statements do not load in parallel"), c),
      BewareOfBoxModelSize: new d("boxModel", s("rule.bewareOfBoxModelSize", "Do not use width or height when using padding or border"), c),
      UniversalSelector: new d("universalSelector", s("rule.universalSelector", "The universal selector (*) is known to be slow"), c),
      ZeroWithUnit: new d("zeroUnits", s("rule.zeroWidthUnit", "No unit for zero needed"), c),
      RequiredPropertiesForFontFace: new d("fontFaceProperties", s("rule.fontFaceProperties", "@font-face rule must define 'src' and 'font-family' properties"), a),
      HexColorLength: new d("hexColorLength", s("rule.hexColor", "Hex colors must consist of three or six hex numbers"), l),
      ArgsInColorFunction: new d("argumentsInColorFunction", s("rule.colorFunction", "Invalid number of parameters"), l),
      UnknownProperty: new d("unknownProperties", s("rule.unknownProperty", "Unknown property."), a),
      IEStarHack: new d("ieHack", s("rule.ieHack", "IE hacks are only necessary when supporting IE7 and older"), c),
      UnknownVendorSpecificProperty: new d("unknownVendorSpecificProperties", s("rule.unknownVendorSpecificProperty", "Unknown vendor specific property."), c),
      PropertyIgnoredDueToDisplay: new d("propertyIgnoredDueToDisplay", s("rule.propertyIgnoredDueToDisplay", "Property is ignored due to the display."), a),
      AvoidImportant: new d("important", s("rule.avoidImportant", "Avoid using !important. It is an indication that the specificity of the entire CSS has gotten out of control and needs to be refactored."), c),
      AvoidFloat: new d("float", s("rule.avoidFloat", "Avoid using 'float'. Floats lead to fragile CSS that is easy to break if one aspect of the layout changes."), c),
      AvoidIdSelector: new d("idSelector", s("rule.avoidIdSelector", "Selectors should not contain IDs because these rules are too tightly coupled with the HTML."), c)
    }, t.sanitize = n, t.toLevel = r;
  }), function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t);
    } else
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssCodeActions", ["require", "exports", "../parser/cssNodes", "./languageFacts", "../utils/strings", "../services/lintRules", "vscode-languageserver-types", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("../parser/cssNodes"),
        r = e("./languageFacts"),
        i = e("../utils/strings"),
          ...
          return e.prototype.doCodeActions = function(e, t, n, r) {
            ...
            for (var p = 3,
              ...
              var f = u[m],
                  ...
                  y = s.TextEdit.replace(n.range, g);
              if (o.push(s.Command.create(b, "_css.applyCodeAction", e.uri, e.version, [y])), --p <= 0)
                return;
            }
          }, e.prototype.appendFixesForMarker = function(e, t, r, i) {
            if (r.code === o.Rules.UnknownProperty.id)
              for (var s = e.offsetAt(r.range.start),
                  a = e.offsetAt(r.range.end),
                  l = n.getNodePath(t, s),
                  c = l.length - 1; c >= 0; c--) {
                var d = l[c];
                if (d instanceof n.Declaration) {
                  var h = d.getProperty();
                  if (h && h.offset === s && h.end === a)
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lint", ["require", "exports", "./languageFacts", "./lintRules", "../parser/cssNodes", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("./languageFacts"),
        ...
        c = function() {
          ...
          return e.entries = function(t, n) {
            var r = new e(n);
            return t.accept(r), r.getEntries();
          }, e.prototype.fetch = function(e, t) {
            for (var n = [],
                r = 0; r < e.length; r++)
              e[r].name.toLowerCase() === t && n.push(e[r]);
            return n;
            ...
            for (var i = null,
                n = 0; n < e.length; n++) {
              var o = e[n];
              o && (i = null === i ? s("namelist.single", "'{0}'", o) : s("namelist.concatenated", "{0}, '{1}'", i, o));
            }
            return i;
          }, e.prototype.visitNode = function(e) {
            switch (e.type) {
            ...
            var o = ["@-webkit-keyframes", "@-moz-keyframes", "@-o-keyframes"],
                a = function(e) {
                  var i = n.data[e].names,
                      a = i.indexOf("@keyframes") === -1;
                  if (!a && 1 === i.length)
                    return "continue";
                  var l = function(e) {
                    if (a) {
                      var n = s("keyframes.standardrule.missing", "Always define standard rule '@keyframes' when defining keyframes.");
                      t.addEntry(e, r.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, n);
                    }
                    if (d) {
                      var n = s("keyframes.vendorspecific.missing", "Always include all vendor specific rules: Missing: {0}", d);
                      t.addEntry(e, r.Rules.AllVendorPrefixes, n);
                    }
                  },
                      d = c.getMissingNames(o, i);
                  (d || a) && n.data[e].nodes.forEach(l);
                },
                c = this;
            for (var d in n.data)
              a(d);
            ...
            var t = e.getText();
            return "*" === t && this.addEntry(e, r.Rules.UniversalSelector), 0 === t.indexOf("#") && this.addEntry(e, r.Rules.AvoidIdSelector), !0;
            ...
            var d = this,
                h = [];
            if (c.getChildren().forEach(function(e) {
              if (e instanceof i.Declaration) {
                var t = e;
                h.push(new a(t.getFullPropertyName(), t));
              }
            }, this), 0 === this.fetchWithin(h, "box-sizing").length) {
              var p = this.fetch(h, "width");
              if (p.length > 0) {
                var m = !1;
                if (["border", "border-left", "border-right", "padding", "padding-left", "padding-right"].forEach(function(e) {
                  for (var t = o.fetch(h, e),
                      n = 0,
                      i = t; n < i.length; n++) {
                    var s = i[n],
                        a = s.node.getValue();
                    a && !a.matches("none") && (o.addEntry(s.node, r.Rules.BewareOfBoxModelSize), m = !0);
                  }
                }), m)
                  for (var u = 0,
                      f = p; u < f.length; u++) {
              ...
              if (b.length > 0) {
                var y = !1;
                if (["border", "border-top", "border-bottom", "padding", "padding-top", "padding-bottom"].forEach(function(e) {
                  for (var t = o.fetch(h, e),
                      n = 0,
                      i = t; n < i.length; n++) {
                    var s = i[n],
                        a = s.node.getValue();
                    a && !a.matches("none") && (o.addEntry(s.node, r.Rules.BewareOfBoxModelSize), y = !0);
                  }
                }), y)
                  for (var w = 0,
                      v = b; w < v.length; w++) {
            ...
            if (k.length > 0 && ["width", "height", "margin-top", "margin-bottom", "float"].forEach(function(e) {
              for (var t = d.fetch(h, e),
                  n = 0; n < t.length; n++)
                d.addEntry(t[n].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayInline", "Property is ignored due to the display. With 'display: inline', the width, height, margin-top, margin-bottom, and float properties have no effect."));
            }), k = this.fetchWithValue(h, "display", "inline-block"), k.length > 0)
              for (var T = this.fetch(h, "float"),
                  S = 0; S < T.length; S++)
                this.addEntry(T[S].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayInlineBlock", "Property is ignored due to the display. With 'display: inline-block', float properties have no effect."));
            if (k = this.fetchWithValue(h, "display", "block"), k.length > 0)
              for (var T = this.fetch(h, "vertical-align"),
                  S = 0; S < T.length; S++)
                this.addEntry(T[S].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayBlock", "Property is ignored due to the display. With 'display: block', vertical-align should not be used."));
            t.accept(function(e) {
              return e.type === i.NodeType.Prio && d.addEntry(e, r.Rules.AvoidImportant), !0;
            });
            for (var F = this.fetch(h, "float"),
                S = 0; S < F.length; S++)
              this.addEntry(F[S].node, r.Rules.AvoidFloat);
            for (var C = 0; C < h.length; C++) {
              var E = h[C];
              if ("background" !== E.name.toLowerCase()) {
                var I = E.node.getValue();
                if (I && "-" !== I.getText()[0]) {
                  var P = this.fetch(h, E.name);
                  if (P.length > 1)
                    for (var A = 0; A < P.length; A++) {
                      var _ = P[A].node.getValue();
                      _ && "-" !== _.getText()[0] && P[A] !== E && this.addEntry(E.node, r.Rules.DuplicateDeclarations);
                    }
                }
              }
            }
            ...
            if (c.getChildren().forEach(function(e) {
              if (o.isCSSDeclaration(e)) {
                ...
                if ("-" === s) {
                  if ("-" !== i.charAt(1)) {
                    n.isKnownProperty(i) || o.addEntry(t.getProperty(), r.Rules.UnknownVendorSpecificProperty);
                    var a = t.getNonPrefixedPropertyName();
                    D.add(a, i, t.getProperty());
                  }
                } else
                  "*" !== s && "_" !== s || (o.addEntry(t.getProperty(), r.Rules.IEStarHack), i = i.substr(1)), n.isKnownProperty(i) || o.addEntry(t.getProperty(), r.Rules.UnknownProperty), D.add(i, i, null);
              } else
                R = !0;
            }), !R) {
              var O = function(t) {
                var i = D.data[t],
                    a = i.names,
                    l = n.isKnownProperty(t) && a.indexOf(t) === -1;
                if (!l && 1 === a.length)
                  return "continue";
                for (var c = [],
                    d = 0,
                    h = e.prefixes.length; d < h; d++) {
                  var p = e.prefixes[d];
                  n.isKnownProperty(p + t) && c.push(p + t);
                }
                var m = function(e) {
                  if (l) {
                    var n = s("property.standard.missing", "Also define the standard property '{0}' for compatibility", t);
                    o.addEntry(e, r.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, n);
                  }
                  if (u) {
                    var n = s("property.vendorspecific.missing", "Always include all vendor specific properties: Missing: {0}", u);
                    o.addEntry(e, r.Rules.AllVendorPrefixes, n);
                  }
                },
                    u = z.getMissingNames(c, a);
            ...
            var t = e.getValue();
            return "%" === t.unit || (0 === parseFloat(t.value) && t.unit && this.addEntry(e, r.Rules.ZeroWithUnit), !0);
            ...
            if (n) {
              var i = !1,
                  o = !1,
                  s = !1;
              return n.getChildren().forEach(function(e) {
                if (t.isCSSDeclaration(e)) {
                  var n = e.getProperty().getName().toLocaleLowerCase();
                  "src" === n && (i = !0), "font-family" === n && (o = !0);
                } else
                  s = !0;
              }), s || i && o || this.addEntry(e, r.Rules.RequiredPropertiesForFontFace), !0;
            }
            ...
            return n !== -1 && (e.getArguments().accept(function(e) {
              return !(e instanceof i.BinaryExpression) || (o += 1, !1);
            }), o !== n && this.addEntry(e, r.Rules.ArgsInColorFunction)), !0;
          }, e;
        }();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssValidation", ["require", "exports", "../parser/cssNodes", "vscode-languageserver-types", "./lintRules", "./lint"], e);
  }(function(e, t) {
    var n = e("../parser/cssNodes"),
        ...
        s = function() {
          ...
          return e.prototype.configure = function(e) {
            e && (this.validationEnabled = e.validate, e.lint ? this.lintSettings = i.sanitize(e.lint) : this.lintSettings = {});
          }, e.prototype.doValidation = function(e, t) {
            function i(t) {
              var i = r.Range.create(e.positionAt(t.getOffset()), e.positionAt(t.getOffset() + t.getLength()));
              return {
                code: t.getRule().id,
                source: e.languageId,
                message: t.getMessage(),
                severity: t.getLevel() === n.Level.Warning ? r.DiagnosticSeverity.Warning : r.DiagnosticSeverity.Error,
                range: i
              };
            }
            if (!this.validationEnabled)
              return [];
            var s = [];
            return s.push.apply(s, n.ParseErrorCollector.entries(t)), s.push.apply(s, o.LintVisitor.entries(t, this.lintSettings)), s.filter(function(e) {
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssScanner", ["require", "exports", "./cssScanner"], e);
  }(function(e, t) {
    var n = e("./cssScanner"),
        r = "/".charCodeAt(0),
        i = "\n".charCodeAt(0),
    ...
    t.VariableName = f++, t.InterpolationFunction = f++, t.Default = f++, t.EqualsOperator = f++, t.NotEqualsOperator = f++, t.GreaterEqualsOperator = f++, t.SmallerEqualsOperator = f++, t.Ellipsis = f++;
    var g = function(e) {
      function f() {
        return null !== e && e.apply(this, arguments) || this;
      }
      return __extends(f, e), f.prototype.scan = function() {
        var r = this.trivia();
        if (null !== r)
          return r;
        ...
        if (this.stream.advanceIfChar(a)) {
          var o = ["$"];
          if (this.ident(o))
            return this.finishToken(i, t.VariableName, o.join(""));
          this.stream.goBackTo(i);
        }
        return this.stream.advanceIfChars([l, c]) ? this.finishToken(i, t.InterpolationFunction) : this.stream.advanceIfChars([d, d]) ? this.finishToken(i, t.EqualsOperator) : this.stream.advanceIfChars([h, d]) ? this.finishToken(i, t.NotEqualsOperator) : this.stream.advanceIfChar(p) ? this.stream.advanceIfChar(d) ? this.finishToken(i, t.SmallerEqualsOperator) : this.finishToken(i, n.TokenType.Delim) : this.stream.advanceIfChar(m) ? this.stream.advanceIfChar(d) ? this.finishToken(i, t.GreaterEqualsOperator) : this.finishToken(i, n.TokenType.Delim) : this.stream.advanceIfChars([u, u, u]) ? this.finishToken(i, t.Ellipsis) : e.prototype.scan.call(this);
      }, f.prototype.comment = function() {
        return !!e.prototype.comment.call(this) || !!this.stream.advanceIfChars([r, r]) && (this.stream.advanceWhileChar(function(e) {
          switch (e) {
            case i:
            case o:
            case s:
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssErrors", ["require", "exports", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("vscode-nls"),
        r = n.loadMessageBundle(),
        i = function() {
    ...
    t.SCSSIssueType = i, t.SCSSParseError = {
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssParser", ["require", "exports", "./scssScanner", "./cssScanner", "./cssParser", "./cssNodes", "./scssErrors", "./cssErrors"], e);
  }(function(e, t) {
    var n = e("./scssScanner"),
        r = e("./cssScanner"),
        i = e("./cssParser"),
        ...
        l = function(e) {
          ...
          return __extends(t, e), t.prototype._parseStylesheetStatement = function() {
            return e.prototype._parseStylesheetStatement.call(this) || this._parseVariableDeclaration() || this._parseWarnAndDebug() || this._parseControlStatement() || this._parseMixinDeclaration() || this._parseMixinContent() || this._parseMixinReference() || this._parseFunctionDeclaration();
          }, t.prototype._parseImport = function() {
            var e = this.create(o.Import);
            if (!this.accept(r.TokenType.AtKeyword, "@import"))
              return null;
            if (!this.accept(r.TokenType.URI) && !this.accept(r.TokenType.String))
              return this.finish(e, a.ParseError.URIOrStringExpected);
            ...
            return t.setVariable(this._parseVariable()) ? this.accept(r.TokenType.Colon, ":") ? (t.colonPosition = this.prevToken.offset, t.setValue(this._parseExpr()) ? this.accept(r.TokenType.Exclamation) && !this.accept(r.TokenType.Ident, "default", !0) ? this.finish(t, a.ParseError.UnknownKeyword) : (this.peek(r.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset), this.finish(t)) : this.finish(t, a.ParseError.VariableValueExpected, [], e)) : this.finish(t, a.ParseError.ColonExpected) : null;
            ...
            t.referenceTypes = e;
            for (var n = !1; (this.accept(r.TokenType.Ident) || t.addChild(this._parseInterpolation())) && (n = !0, !this.hasWhitespace() && this.accept(r.TokenType.Delim, "-"), !this.hasWhitespace()); )
              ;
            return n ? this.finish(t) : null;
          }, t.prototype._parseTerm = function() {
            var t = e.prototype._parseTerm.call(this);
            return t ? t : (t = this.create(o.Term), t.setExpression(this._parseVariable()) || t.setExpression(this._parseSelectorCombinator()) ? this.finish(t) : null);
          }, t.prototype._parseInterpolation = function() {
            var e = this.create(o.Interpolation);
            return this.accept(n.InterpolationFunction) ? e.addChild(this._parseBinaryExpr()) || this._parseSelectorCombinator() ? this.accept(r.TokenType.CurlyR) ? this.finish(e) : this.finish(e, a.ParseError.RightCurlyExpected) : this.finish(e, a.ParseError.ExpressionExpected) : null;
          }, t.prototype._parseOperator = function() {
            if (this.peek(n.EqualsOperator) || this.peek(n.NotEqualsOperator) || this.peek(n.GreaterEqualsOperator) || this.peek(n.SmallerEqualsOperator) || this.peek(r.TokenType.Delim, ">") || this.peek(r.TokenType.Delim, "<") || this.peek(r.TokenType.Ident, "and") || this.peek(r.TokenType.Ident, "or") || this.peek(r.TokenType.Delim, "%")) {
            ...
            return this.peek(r.TokenType.AtKeyword) ? this._parseKeyframe() || this._parseImport() || this._parseMedia() || this._parseFontFace() || this._parseWarnAndDebug() || this._parseControlStatement() || this._parseFunctionDeclaration() || this._parseExtends() || this._parseMixinReference() || this._parseMixinContent() || this._parseMixinDeclaration() || this._parseRuleset(!0) : this._parseVariableDeclaration() || this._tryParseRuleset(!0) || e.prototype._parseRuleSetDeclaration.call(this);
            ...
            if (!this.accept(r.TokenType.Colon, ":"))
              return this.finish(t, a.ParseError.ColonExpected, [r.TokenType.Colon], e);
            t.colonPosition = this.prevToken.offset;
            var n = !1;
            if (t.setValue(this._parseExpr()) && (n = !0, t.addChild(this._parsePrio())), this.peek(r.TokenType.CurlyL))
              t.setNestedProperties(this._parseNestedProperties());
            else if (!n)
              return this.finish(t, a.ParseError.PropertyValueExpected);
            ...
            return this.accept(r.TokenType.AtKeyword, "@extend") ? e.setSelector(this._parseSimpleSelector()) ? this.accept(r.TokenType.Exclamation) && !this.accept(r.TokenType.Ident, "optional", !0) ? this.finish(e, a.ParseError.UnknownKeyword) : this.finish(e) : this.finish(e, a.ParseError.SelectorExpected) : null;
            ...
            if (this.accept(r.TokenType.Delim, "&")) {
              for (; !this.hasWhitespace() && (this.accept(r.TokenType.Delim, "-") || e.addChild(this._parseIdent()) || this.accept(r.TokenType.Delim, "&")); )
                ;
              return this.finish(e);
            }
            return null;
            ...
            return this.accept(r.TokenType.Delim, "%") ? (this._parseIdent(), this.finish(e)) : this.accept(r.TokenType.AtKeyword, "@at-root") ? this.finish(e) : null;
          }, t.prototype._parseWarnAndDebug = function() {
            if (!this.peek(r.TokenType.AtKeyword, "@debug") && !this.peek(r.TokenType.AtKeyword, "@warn"))
              return null;
            ...
            return void 0 === e && (e = this._parseRuleSetDeclaration.bind(this)), this.peek(r.TokenType.AtKeyword) ? this._parseIfStatement(e) || this._parseForStatement(e) || this._parseEachStatement(e) || this._parseWhileStatement(e) : null;
            ...
            if (this._parseBody(t, e), this.accept(r.TokenType.AtKeyword, "@else"))
              if (this.peek(r.TokenType.Ident, "if"))
            ...
            if (!this.peek(r.TokenType.AtKeyword, "@for"))
              return null;
            var t = this.create(o.ForStatement);
            return this.consumeToken(), t.setVariable(this._parseVariable()) ? this.accept(r.TokenType.Ident, "from") ? t.addChild(this._parseBinaryExpr()) ? this.accept(r.TokenType.Ident, "to") || this.accept(r.TokenType.Ident, "through") ? t.addChild(this._parseBinaryExpr()) ? this._parseBody(t, e) : this.finish(t, a.ParseError.ExpressionExpected, [r.TokenType.CurlyR]) : this.finish(t, s.SCSSParseError.ThroughOrToExpected, [r.TokenType.CurlyR]) : this.finish(t, a.ParseError.ExpressionExpected, [r.TokenType.CurlyR]) : this.finish(t, s.SCSSParseError.FromExpected, [r.TokenType.CurlyR]) : this.finish(t, a.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
          }, t.prototype._parseEachStatement = function(e) {
            if (!this.peek(r.TokenType.AtKeyword, "@each"))
              return null;
            var t = this.create(o.EachStatement);
            this.consumeToken();
            var n = t.getVariables();
            if (!n.addChild(this._parseVariable()))
              return this.finish(t, a.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
            for (; this.accept(r.TokenType.Comma); )
              if (!n.addChild(this._parseVariable()))
                return this.finish(t, a.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
            return this.finish(n), this.accept(r.TokenType.Ident, "in") ? t.addChild(this._parseExpr()) ? this._parseBody(t, e) : this.finish(t, a.ParseError.ExpressionExpected, [r.TokenType.CurlyR]) : this.finish(t, s.SCSSParseError.InExpected, [r.TokenType.CurlyR]);
          }, t.prototype._parseWhileStatement = function(e) {
            if (!this.peek(r.TokenType.AtKeyword, "@while"))
              return null;
            var t = this.create(o.WhileStatement);
            return this.consumeToken(), t.addChild(this._parseBinaryExpr()) ? this._parseBody(t, e) : this.finish(t, a.ParseError.ExpressionExpected, [r.TokenType.CurlyR]);
            ...
            if (!this.peek(r.TokenType.AtKeyword, "@function"))
              return null;
            var e = this.create(o.FunctionDeclaration);
            if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Function])))
              return this.finish(e, a.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
            if (!this.accept(r.TokenType.ParenthesisL))
              return this.finish(e, a.ParseError.LeftParenthesisExpected, [r.TokenType.CurlyR]);
            if (e.getParameters().addChild(this._parseParameterDeclaration()))
              for (; this.accept(r.TokenType.Comma); )
                if (!e.getParameters().addChild(this._parseParameterDeclaration()))
                  return this.finish(e, a.ParseError.VariableNameExpected);
            return this.accept(r.TokenType.ParenthesisR) ? this._parseBody(e, this._parseFunctionBodyDeclaration.bind(this)) : this.finish(e, a.ParseError.RightParenthesisExpected, [r.TokenType.CurlyR]);
          }, t.prototype._parseReturnStatement = function() {
            if (!this.peek(r.TokenType.AtKeyword, "@return"))
              return null;
            ...
            if (!this.peek(r.TokenType.AtKeyword, "@mixin"))
              return null;
            ...
            if (this.accept(r.TokenType.ParenthesisL)) {
              ...
              if (!this.accept(r.TokenType.ParenthesisR))
                return this.finish(e, a.ParseError.RightParenthesisExpected, [r.TokenType.CurlyR]);
            }
            return this._parseBody(e, this._parseRuleSetDeclaration.bind(this));
          }, t.prototype._parseParameterDeclaration = function() {
            var e = this.create(o.FunctionParameter);
            return e.setIdentifier(this._parseVariable()) ? (this.accept(n.Ellipsis), this.accept(r.TokenType.Colon) && !e.setDefaultValue(this._parseExpr(!0)) ? this.finish(e, a.ParseError.VariableValueExpected, [], [r.TokenType.Comma, r.TokenType.ParenthesisR]) : this.finish(e)) : null;
          }, t.prototype._parseMixinContent = function() {
            if (!this.peek(r.TokenType.AtKeyword, "@content"))
              return null;
            var e = this.createNode(o.NodeType.MixinContent);
            return this.consumeToken(), this.finish(e);
          }, t.prototype._parseMixinReference = function() {
            if (!this.peek(r.TokenType.AtKeyword, "@include"))
              return null;
            ...
            if (this.accept(r.TokenType.ParenthesisL)) {
              if (e.getArguments().addChild(this._parseFunctionArgument()))
                for (; this.accept(r.TokenType.Comma); )
                  if (!e.getArguments().addChild(this._parseFunctionArgument()))
                    return this.finish(e, a.ParseError.ExpressionExpected);
              if (!this.accept(r.TokenType.ParenthesisR))
            ...
            if (i)
              if (this.accept(r.TokenType.Colon))
                ...
                if (this.accept(n.Ellipsis))
                  return e.setValue(i), this.finish(e);
                this.restoreAtMark(t);
              }
            ...
            if (!this.accept(r.TokenType.ParenthesisL))
              return null;
            for (; e.addChild(this._parseListElement()); )
              this.accept(r.TokenType.Comma);
            ...
            return e.addChild(this._parseBinaryExpr()) ? this.accept(r.TokenType.Colon) && !e.addChild(this._parseBinaryExpr()) ? this.finish(e, a.ParseError.ExpressionExpected) : this.finish(e) : null;
          }, t;
        }(i.Parser);
    t.SCSSParser = l;
  });
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/scssCompletion", ["require", "exports", "./cssCompletion", "vscode-languageserver-types", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("./cssCompletion"),
        ...
        s = function(e) {
          ...
          return __extends(t, e), t.prototype.createReplaceFunction = function() {
            var e = 1;
            return function(n, r) {
              return r + ": ${" + e++ + ":" + (t.variableDefaults[r] || "") + "}";
            };
          }, t.prototype.createFunctionProposals = function(e, t, n) {
            var i = this;
            return e.forEach(function(e) {
              var o = e.func.replace(/\[?(\$\w+)\]?/g, i.createReplaceFunction());
              n.items.push({
                label: e.func.substr(0, e.func.indexOf("(")),
                detail: e.func,
                documentation: e.desc,
                textEdit: r.TextEdit.replace(i.getCompletionRange(t), o),
                insertTextFormat: r.InsertTextFormat.Snippet,
                kind: r.CompletionItemKind.Function
              });
            }), n;
          }, t.prototype.getCompletionsForSelector = function(n, r) {
            return this.createFunctionProposals(t.selectorFuncs, void 0, r), e.prototype.getCompletionsForSelector.call(this, n, r);
          }, t.prototype.getTermProposals = function(n, r) {
            return this.createFunctionProposals(t.builtInFuncs, n, r), e.prototype.getTermProposals.call(this, n, r);
          }, t.prototype.getColorProposals = function(n, r, i) {
            return this.createFunctionProposals(t.colorProposals, r, i), e.prototype.getColorProposals.call(this, n, r, i);
          }, t.prototype.getCompletionsForDeclarationProperty = function(t, n) {
            return this.getCompletionsForSelector(null, n), e.prototype.getCompletionsForDeclarationProperty.call(this, t, n);
          }, t;
        }(n.CSSCompletion);
    s.variableDefaults = {
      $red: "1",
      ...
      func: "transparentize($color, $amount) / fade-out($color, $amount)",
      ...
      desc: o("scss.builtin.selector-nest", "Nests selector beneath one another like they would be nested in the stylesheet.")
    }, {
      ...
      desc: o("scss.builtin.selector-unify", "Unifies two selectors to produce a selector that matches elements matched by both.")
    }, {
      func: "is-superselector($super, $sub)",
      desc: o("scss.builtin.is-superselector", "Returns whether $super matches all the elements $sub does, and possibly more.")
    }, {
      ...
      desc: o("scss.builtin.variable-exists", "Returns whether a variable with the given name exists in the current scope.")
    }, {
      func: "global-variable-exists($name)",
      desc: o("scss.builtin.global-variable-exists", "Returns whether a variable with the given name exists in the global scope.")
    }, {
      ...
      func: "inspect($value)",
      desc: o("scss.builtin.inspect", "Returns the string representation of a value as it would be represented in Sass.")
    }, {
      func: "type-of($value)",
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/lessScanner", ["require", "exports", "./cssScanner"], e);
  }(function(e, t) {
    var n = e("./cssScanner"),
        r = "/".charCodeAt(0),
        i = "\n".charCodeAt(0),
    ...
    var d = function(e) {
      ...
      return __extends(c, e), c.prototype.scan = function() {
        var n = this.trivia();
        if (null !== n)
          return n;
        var r = this.stream.pos(),
            i = this.escapedJavaScript();
        return null !== i ? this.finishToken(r, i) : this.stream.advanceIfChars([l, l, l]) ? this.finishToken(r, t.Ellipsis) : e.prototype.scan.call(this);
        ...
        return e === a ? (this.stream.advance(1), this.stream.advanceWhileChar(function(e) {
          return e !== a;
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/lessParser", ["require", "exports", "./lessScanner", "./cssScanner", "./cssParser", "./cssNodes", "./cssErrors"], e);
  }(function(e, t) {
    var n = e("./lessScanner"),
        r = e("./cssScanner"),
        i = e("./cssParser"),
        ...
        a = function(e) {
          ...
          return __extends(t, e), t.prototype._parseStylesheetStatement = function() {
            return this._tryParseMixinDeclaration() || this._tryParseMixinReference(!0) || e.prototype._parseStylesheetStatement.call(this) || this._parseVariableDeclaration();
          }, t.prototype._parseImport = function() {
            var e = this.create(o.Import);
            if (!this.accept(r.TokenType.AtKeyword, "@import") && !this.accept(r.TokenType.AtKeyword, "@import-once"))
              return null;
            if (this.accept(r.TokenType.ParenthesisL)) {
              if (!this.accept(r.TokenType.Ident))
                return this.finish(e, s.ParseError.IdentifierExpected, [r.TokenType.SemiColon]);
              do
                if (!this.accept(r.TokenType.Comma))
                  break;
 while (this.accept(r.TokenType.Ident));
              if (!this.accept(r.TokenType.ParenthesisR))
                return this.finish(e, s.ParseError.RightParenthesisExpected, [r.TokenType.SemiColon]);
            }
            return this.accept(r.TokenType.URI) || this.accept(r.TokenType.String) ? (e.setMedialist(this._parseMediaList()), this.finish(e)) : this.finish(e, s.ParseError.URIOrStringExpected, [r.TokenType.SemiColon]);
            ...
            return n;
          }, t.prototype._parseMediaDeclaration = function() {
            return this._tryParseRuleset(!1) || this._tryToParseDeclaration() || this._tryParseMixinDeclaration() || this._tryParseMixinReference() || this._parseDetachedRuleSetMixin() || this._parseStylesheetStatement();
          }, t.prototype._parseVariableDeclaration = function(e) {
            void 0 === e && (e = []);
            var t = this.create(o.VariableDeclaration),
                n = this.mark();
            return t.setVariable(this._parseVariable()) ? this.accept(r.TokenType.Colon, ":") ? (t.colonPosition = this.prevToken.offset, t.setValue(this._parseDetachedRuleSet() || this._parseExpr()) ? (t.addChild(this._parsePrio()), this.peek(r.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset), this.finish(t)) : this.finish(t, s.ParseError.VariableValueExpected, [], e)) : (this.restoreAtMark(n), null) : null;
            ...
            for (var e = this.create(o.Variable),
                t = this.mark(); this.accept(r.TokenType.Delim, "@"); )
              if (this.hasWhitespace())
                return this.restoreAtMark(t), null;
            return this.accept(r.TokenType.AtKeyword) ? e : (this.restoreAtMark(t), null);
          }, t.prototype._parseTerm = function() {
            var t = e.prototype._parseTerm.call(this);
            return t ? t : (t = this.create(o.Term), t.setExpression(this._parseVariable()) || t.setExpression(this._parseEscaped()) ? this.finish(t) : null);
          }, t.prototype._parseEscaped = function() {
            var e = this.createNode(o.NodeType.EscapedValue);
            return this.accept(r.TokenType.EscapedJavaScript) || this.accept(r.TokenType.BadEscapedJavaScript) ? this.finish(e) : this.accept(r.TokenType.Delim, "~") ? this.finish(e, this.accept(r.TokenType.String) ? null : s.ParseError.TermExpected) : null;
          }, t.prototype._parseOperator = function() {
            ...
            return this.accept(r.TokenType.Delim, ">") ? (this.accept(r.TokenType.Delim, "="), e) : this.accept(r.TokenType.Delim, "=") ? (this.accept(r.TokenType.Delim, "<"), e) : this.accept(r.TokenType.Delim, "<") ? (this.accept(r.TokenType.Delim, "="), e) : null;
          }, t.prototype._parseRuleSetDeclaration = function() {
            return this.peek(r.TokenType.AtKeyword) ? this._parseKeyframe() || this._parseMedia() || this._parseImport() || this._parseDetachedRuleSetMixin() || this._parseVariableDeclaration() : this._tryParseMixinDeclaration() || this._tryParseRuleset(!0) || this._tryParseMixinReference() || this._parseExtend() || e.prototype._parseRuleSetDeclaration.call(this);
          }, t.prototype._parseSimpleSelectorBody = function() {
            ...
            return r.addChild(this._parseSimpleSelector()) && r.addChild(this._parseGuard()) ? this.finish(r) : (this.restoreAtMark(n), e.prototype._parseSelector.call(this, t));
          }, t.prototype._parseSelectorCombinator = function() {
            var e = this.createNode(o.NodeType.SelectorCombinator);
            if (this.accept(r.TokenType.Delim, "&")) {
              for (; !this.hasWhitespace() && (this.accept(r.TokenType.Delim, "-") || e.addChild(this._parseIdent()) || this.accept(r.TokenType.Delim, "&")); )
            ...
            return this.accept(r.TokenType.Delim, "~") ? this.hasWhitespace() || !this.accept(r.TokenType.String) && !this.accept(r.TokenType.BadString) ? this.finish(e, s.ParseError.StringLiteralExpected) : this.finish(e) : this.accept(r.TokenType.Delim, "@") ? this.hasWhitespace() || !this.accept(r.TokenType.CurlyL) ? this.finish(e, s.ParseError.LeftCurlyExpected) : e.addChild(this._parseIdent()) ? this.accept(r.TokenType.CurlyR) ? this.finish(e) : this.finish(e, s.ParseError.RightCurlyExpected) : this.finish(e, s.ParseError.IdentifierExpected) : null;
          }, t.prototype._tryParseMixinDeclaration = function() {
            var e = this.mark(),
                t = this.create(o.MixinDeclaration);
            if (!t.setIdentifier(this._parseMixinDeclarationIdentifier()) || !this.accept(r.TokenType.ParenthesisL))
              return this.restoreAtMark(e), null;
            if (t.getParameters().addChild(this._parseMixinParameter()))
              for (; (this.accept(r.TokenType.Comma) || this.accept(r.TokenType.SemiColon)) && !this.peek(r.TokenType.ParenthesisR); )
                if (!t.getParameters().addChild(this._parseMixinParameter()))
                  return this.finish(t, s.ParseError.IdentifierExpected);
            return this.accept(r.TokenType.ParenthesisR) ? (t.setGuard(this._parseGuard()), this.peek(r.TokenType.CurlyL) ? this._parseBody(t, this._parseRuleSetDeclaration.bind(this)) : (this.restoreAtMark(e), null)) : (this.restoreAtMark(e), null);
            ...
            if (!this.peek(r.TokenType.Colon))
              return null;
            var t = this.mark(),
                n = this.create(o.ExtendsReference);
            return this.consumeToken(), this.accept(r.TokenType.Ident, "extend") ? this._completeExtends(n) : (this.restoreAtMark(t), e.prototype._parsePseudo.call(this));
          }, t.prototype._parseExtend = function() {
            if (!this.peek(r.TokenType.Delim, "&"))
              return null;
            var e = this.mark(),
                t = this.create(o.ExtendsReference);
            return this.consumeToken(), !this.hasWhitespace() && this.accept(r.TokenType.Colon) && this.accept(r.TokenType.Ident, "extend") ? this._completeExtends(t) : (this.restoreAtMark(e), null);
          }, t.prototype._completeExtends = function(e) {
            return this.accept(r.TokenType.ParenthesisL) ? e.setSelector(this._parseSelector(!0)) ? this.accept(r.TokenType.ParenthesisR) ? this.finish(e) : this.finish(e, s.ParseError.RightParenthesisExpected) : this.finish(e, s.ParseError.SelectorExpected) : this.finish(e, s.ParseError.LeftParenthesisExpected);
          }, t.prototype._parseDetachedRuleSetMixin = function() {
            if (!this.peek(r.TokenType.AtKeyword))
              return null;
            var e = this.mark(),
                t = this.create(o.MixinReference);
            return t.addChild(this._parseVariable()) && this.accept(r.TokenType.ParenthesisL) ? this.accept(r.TokenType.ParenthesisR) ? this.finish(t) : this.finish(t, s.ParseError.RightParenthesisExpected) : (this.restoreAtMark(e), null);
          }, t.prototype._tryParseMixinReference = function(e) {
            void 0 === e && (e = !1);
            for (var t = this.mark(),
                n = this.create(o.MixinReference),
                i = this._parseMixinDeclarationIdentifier(); i; ) {
            ...
            if (!this.hasWhitespace() && this.accept(r.TokenType.ParenthesisL)) {
              if (n.getArguments().addChild(this._parseMixinArgument()))
                for (; (this.accept(r.TokenType.Comma) || this.accept(r.TokenType.SemiColon)) && !this.peek(r.TokenType.ParenthesisR); )
                  if (!n.getArguments().addChild(this._parseMixinArgument()))
                    return this.finish(n, s.ParseError.ExpressionExpected);
              if (!this.accept(r.TokenType.ParenthesisR))
                return this.finish(n, s.ParseError.RightParenthesisExpected);
              i.referenceTypes = [o.ReferenceType.Mixin];
            } else
              i.referenceTypes = [o.ReferenceType.Mixin, o.ReferenceType.Rule];
            return n.addChild(this._parsePrio()), e && !this.peek(r.TokenType.SemiColon) ? (this.restoreAtMark(t), null) : this.finish(n);
          }, t.prototype._parseMixinArgument = function() {
            var e = this.create(o.FunctionArgument),
                t = this.mark(),
                n = this._parseVariable();
            return n && (this.accept(r.TokenType.Colon) ? e.setIdentifier(n) : this.restoreAtMark(t)), e.setValue(this._parseDetachedRuleSet() || this._parseExpr(!0)) ? this.finish(e) : (this.restoreAtMark(t), null);
          }, t.prototype._parseMixinParameter = function() {
            var e = this.create(o.FunctionParameter);
            if (this.peek(r.TokenType.AtKeyword, "@rest")) {
              var t = this.create(o.Node);
              return this.consumeToken(), this.accept(n.Ellipsis) ? (e.setIdentifier(this.finish(t)), this.finish(e)) : this.finish(e, s.ParseError.DotExpected, [], [r.TokenType.Comma, r.TokenType.ParenthesisR]);
            }
            ...
            var a = !1;
            return e.setIdentifier(this._parseVariable()) && (this.accept(r.TokenType.Colon), a = !0), e.setDefaultValue(this._parseExpr(!0)) || a ? this.finish(e) : null;
          }, t.prototype._parseGuard = function() {
            if (!this.peek(r.TokenType.Ident, "when"))
              return null;
            var e = this.create(o.LessGuard);
            if (this.consumeToken(), e.isNegated = this.accept(r.TokenType.Ident, "not"), !e.getConditions().addChild(this._parseGuardCondition()))
            ...
            return this.accept(r.TokenType.ParenthesisL) ? (!e.addChild(this._parseExpr()), this.accept(r.TokenType.ParenthesisR) ? this.finish(e) : this.finish(e, s.ParseError.RightParenthesisExpected)) : null;
            ...
            return e ? (this.hasWhitespace() || (this.accept(r.TokenType.Delim, "+"), this.hasWhitespace() || this.accept(r.TokenType.Ident, "_")), this.finish(e)) : null;
          }, t;
        }(i.Parser);
    t.LESSParser = a;
  });
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lessCompletion", ["require", "exports", "./cssCompletion", "vscode-languageserver-types", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("./cssCompletion"),
        r = e("vscode-languageserver-types"),
        i = e("vscode-nls"),
        ...
        s = function(e) {
          ...
          return __extends(t, e), t.prototype.createFunctionProposals = function(e, t, n) {
            var i = this;
            return e.forEach(function(e) {
              n.items.push({
                label: e.name,
                ...
                textEdit: r.TextEdit.replace(i.getCompletionRange(t), e.name + "($0)"),
                insertTextFormat: r.InsertTextFormat.Snippet,
                kind: r.CompletionItemKind.Function
              });
            }), n;
          }, t.prototype.getTermProposals = function(n, r) {
            return this.createFunctionProposals(t.builtInProposals, n, r), e.prototype.getTermProposals.call(this, n, r);
          }, t.prototype.getColorProposals = function(n, r, i) {
            return this.createFunctionProposals(t.colorProposals, r, i), e.prototype.getColorProposals.call(this, n, r, i);
          }, t;
        }(n.CSSCompletion);
    s.builtInProposals = [{
      ...
      description: o("less.builtin.escape", "URL encodes a string")
    }, {
      name: "e",
      example: "e(@string);",
      description: o("less.builtin.e", "escape string content")
    }, {
      name: "replace",
      ...
      name: "abs",
      description: o("less.builtin.abs", "absolute value of a number"),
      example: "abs(number);"
    }, {
      name: "acos",
      ...
      name: "ceil",
      example: "ceil(@number);",
      description: o("less.builtin.ceil", "rounds up to an integer")
    }, {
      name: "cos",
      description: o("less.builtin.cos", "cosine function"),
      example: "cos(number);"
    }, {
      name: "floor",
      ...
      name: "sin",
      description: o("less.builtin.sin", "sine function"),
      example: "sin(number);"
    }, {
      name: "tan",
      description: o("less.builtin.tan", "tangent function"),
      example: "tan(number);"
    }, {
      name: "atan",
      ...
      name: "pi",
      description: o("less.builtin.pi", "returns pi"),
      example: "pi();"
    }, {
      name: "pow",
      ...
      name: "argb",
      example: "argb(@color);",
      description: o("less.builtin.argb", "creates a #AARRGGBB")
    }, {
      name: "hsl",
      ...
      description: o("less.builtin.saturation", "returns the `saturation` channel of `@color` in the HSL space")
    }, {
      name: "lightness",
      ...
      description: o("less.builtin.hsvsaturation", "returns the `saturation` channel of `@color` in the HSV space")
    }, {
      name: "hsvvalue",
      ...
      description: o("less.builtin.contrast", "return `@darkcolor` if `@color1 is> 43% luma` otherwise return `@lightcolor`, see notes")
    }, {
      name: "multiply",
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-css-languageservice/cssLanguageService", ["require", "exports", "./parser/cssParser", "./services/cssCompletion", "./services/cssHover", "./services/cssNavigation", "./services/cssCodeActions", "./services/cssValidation", "./parser/scssParser", "./services/scssCompletion", "./parser/lessParser", "./services/lessCompletion"], e);
  }(function(e, t) {
    ...
    function r() {
      return n(new s.Parser, new a.CSSCompletion, new l.CSSHover, new c.CSSNavigation, new d.CSSCodeActions, new h.CSSValidation);
    }
    function i() {
      return n(new p.SCSSParser, new m.SCSSCompletion, new l.CSSHover, new c.CSSNavigation, new d.CSSCodeActions, new h.CSSValidation);
    }
    function o() {
      return n(new u.LESSParser, new f.LESSCompletion, new l.CSSHover, new c.CSSNavigation, new d.CSSCodeActions, new h.CSSValidation);
    }
    var s = e("./parser/cssParser"),
        a = e("./services/cssCompletion"),
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vs/language/css/cssWorker", ["require", "exports", "vscode-css-languageservice", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n(e, t) {
      return new s(e, t);
    }
        ...
        s = function() {
          ...
          return e.prototype.doValidation = function(e) {
            ...
            var i = this._getTextDocument(e),
                ...
                s = this._languageService.doCodeActions(i, t, n, o);
            return r.as(s);
            ...
            var i = this._getTextDocument(e),
                o = this._languageService.parseStylesheet(i),
                s = this._languageService.doRename(i, t, n, o);
            return r.as(s);
          }, e.prototype._getTextDocument = function(e) {
            for (var t = this._ctx.getMirrorModels(),
                n = 0,
                r = t; n < r.length; n++) {
              var i = r[n];
              if (i.uri.toString() === e)
