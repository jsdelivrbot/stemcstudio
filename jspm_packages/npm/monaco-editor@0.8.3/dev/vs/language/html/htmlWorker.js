...
(function(process) {
  !function(e) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/parser/htmlScanner", ["require", "exports", "vscode-nls"], e);
  }(function(e, t) {
    function n(e, t, n) {
      function r() {
      ...
      function y() {
        ...
        switch (A) {
          ...
          case o.WithinContent:
            if (C.advanceIfChar(u)) {
              if (!C.eos() && C.peekChar() === l) {
                if (C.advanceIfChars([l, c, c]))
                  return A = o.WithinComment, v(e, i.StartCommentTag);
                if (C.advanceIfRegExp(/^!doctype/i))
                  return A = o.WithinDoctype, v(e, i.StartDoctypeTag);
              }
          ...
          case o.WithinEndTag:
            if (C.skipWhitespace())
              return v(e, i.Whitespace);
            if (C.advanceIfChar(h))
              return A = o.WithinContent, v(e, i.EndTagClose);
          ...
          case o.BeforeAttributeValue:
            ...
            if (s.length > 0)
              return "type" === k && (S = s), A = o.WithinTag, _ = !1, v(e, i.AttributeValue);
            var b = C.peekChar();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/utils/arrays", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
      var n = 0,
          i = e.length;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/utils/strings", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/parser/htmlTags", ["require", "exports", "../utils/strings", "../utils/arrays", "vscode-nls"], e);
  }(function(e, t) {
    function n(e) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/parser/htmlParser", ["require", "exports", "./htmlScanner", "../utils/arrays", "./htmlTags"], e);
  }(function(e, t) {
    function n(e) {
      for (var t = i.createScanner(e),
          n = new o(0, e.length, [], null),
          r = n,
          s = -1,
          l = t.scan(); l !== i.TokenType.EOS; ) {
        switch (l) {
          ...
          case i.TokenType.EndTag:
            for (var u = t.getTokenText().toLowerCase(); !r.isSameTag(u) && r !== n; )
    ...
    !function(e) {
      function t(e, t, i, r) {
        if (L.number(e) && L.number(t) && L.number(i) && L.number(r))
          return {
            start: n.create(e, t),
            end: n.create(i, r)
          };
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/parser/razorTags", ["require", "exports"], e);
  }(function(e, t) {
    function n() {
      var e = {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/tagProviders", ["require", "exports", "../parser/htmlTags", "../parser/razorTags"], e);
  }(function(e, t) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/htmlCompletion", ["require", "exports", "vscode-languageserver-types", "../parser/htmlScanner", "./tagProviders"], e);
  }(function(e, t) {
    function n(e, t, n, u) {
      function h(t, n) {
      ...
      function m(e, t) {
        void 0 === t && (t = w);
        var n = h(e, t),
            i = r(S, t, l.ScannerState.AfterAttributeName, l.TokenType.DelimiterAssign) ? "" : '="$1"',
            a = x.toLowerCase();
        return T.forEach(function(e) {
      ...
      for (var x,
          k,
          S = e.getText(),
          C = l.createScanner(S, _.start),
          A = C.scan(); A !== l.TokenType.EOS && C.getTokenOffset() <= w; ) {
        switch (A) {
          ...
          case l.TokenType.StartTag:
            if (C.getTokenOffset() <= w && w <= C.getTokenEnd())
              return d(C.getTokenOffset(), C.getTokenEnd());
            x = C.getTokenText();
            break;
          case l.TokenType.AttributeName:
            if (C.getTokenOffset() <= w && w <= C.getTokenEnd())
              return m(C.getTokenOffset(), C.getTokenEnd());
            k = C.getTokenText();
            break;
          ...
          case l.TokenType.AttributeValue:
            if (C.getTokenOffset() <= w && w <= C.getTokenEnd())
              return v(C.getTokenOffset(), C.getTokenEnd());
            break;
          case l.TokenType.Whitespace:
            if (w <= C.getTokenEnd())
              switch (C.getScannerState()) {
          ...
          case l.TokenType.EndTagOpen:
            if (w <= C.getTokenEnd()) {
              var L = C.getTokenOffset() + 1,
                  N = b(l.TokenType.EndTag);
              return f(L, !1, N);
            }
            break;
          case l.TokenType.EndTag:
            if (w <= C.getTokenEnd())
              for (var W = C.getTokenOffset() - 1; W >= 0; ) {
                var D = S.charAt(W);
                if ("/" === D)
                  return f(W, !1, C.getTokenEnd());
                if (!i(D))
                  break;
                W--;
              }
    ...
    function r(e, t, n, i) {
      for (var r = l.createScanner(e, t, n),
          a = r.scan(); a === l.TokenType.Whitespace; )
        a = r.scan();
      return a == i;
    }
    function a(e, t, n) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/htmlHover", ["require", "exports", "../parser/htmlScanner", "vscode-languageserver-types", "./tagProviders"], e);
  }(function(e, t) {
    function n(e, t, n) {
      function o(e, t, n) {
        e = e.toLowerCase();
      ...
      function s(t, n) {
        for (var r = i.createScanner(e.getText(), n),
            a = r.scan(); a !== i.TokenType.EOS && (r.getTokenEnd() < l || r.getTokenEnd() == l && a !== t); )
          a = r.scan();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/beautify/beautify", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
      return e;
    }
    ...
    function e(t, n) {
      ...
      n = n || {}, t = t || "", t = t.replace(/\r\n|[\r\u2028\u2029]/g, "\n");
      var f = n.indent_size || 4,
          g = n.indent_char || " ",
          m = void 0 === n.selector_separator_newline || n.selector_separator_newline,
          v = void 0 !== n.end_with_newline && n.end_with_newline,
          b = void 0 === n.newline_between_rules || n.newline_between_rules,
          y = n.eol ? n.eol : "\n";
      ...
      for (var O = [],
        ...
        if ("/" === T && "*" === r()) {
          ...
          q || "{" === D || E.trim(), E.singleSpace(), O.push(c()), E.newLine();
        else if ("@" === T) {
    ...
    function i(i, o, s, l) {
      function c() {
        ...
        return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
          ...
          for (var e = "",
              t = [],
              n = 0; "<" !== this.input.charAt(this.pos) || 2 === n; ) {
          ...
          do {
            if (this.pos >= this.input.length)
              return e && (this.pos = h, this.line_char_count = d), o.length ? o.join("") : ["", "TK_EOF"];
            if (a = this.input.charAt(this.pos), this.pos++, this.Utils.in_array(a, this.Utils.whitespace))
              l = !0;
            else {
              ...
              if (_ && "{" === i && o.length > 2 && "}" === o[o.length - 2] && "}" === o[o.length - 1])
                break;
            }
          } while (">" !== a);
          var O,
          ...
          for (this.pos++; this.pos <= this.input.length && (t += r, t.charAt(t.length - 1) !== n.charAt(n.length - 1) || t.indexOf(n) === -1); )
            !i && t.length < 10 && (0 === t.indexOf("<![if") ? (n = "<![endif]>", i = !0) : 0 === t.indexOf("<![cdata[") ? (n = "]]>", i = !0) : 0 === t.indexOf("<![") ? (n = "]>", i = !0) : 0 === t.indexOf("<!--") ? (n = "-->", i = !0) : 0 === t.indexOf("{{!--") ? (n = "--}}", i = !0) : 0 === t.indexOf("{{!") ? 5 === t.length && t.indexOf("{{!--") === -1 && (n = "}}", i = !0) : 0 === t.indexOf("<?") ? (n = "?>", i = !0) : 0 === t.indexOf("<%") && (n = "%>", i = !0)), r = this.input.charAt(this.pos), this.pos++;
          return t;
        }, this.get_unformatted = function(e, t) {
          if (t && t.toLowerCase().indexOf(e) !== -1)
            return "";
          var i = "",
              r = "",
              a = !0,
          ...
          if ("CONTENT" === this.current_mode)
            return e = this.get_content(), "string" != typeof e ? e : [e, "TK_CONTENT"];
          if ("TAG" === this.current_mode) {
            if (e = this.get_tag(), "string" != typeof e)
              return e;
      ...
      for (o = o || {}, o = n(o, "html"), void 0 !== o.wrap_line_length && 0 !== parseInt(o.wrap_line_length, 10) || void 0 === o.max_char || 0 === parseInt(o.max_char, 10) || (o.wrap_line_length = o.max_char), h = void 0 !== o.indent_inner_html && o.indent_inner_html, d = void 0 === o.indent_body_inner_html || o.indent_body_inner_html, p = void 0 === o.indent_head_inner_html || o.indent_head_inner_html, f = void 0 === o.indent_size ? 4 : parseInt(o.indent_size, 10), g = void 0 === o.indent_char ? " " : o.indent_char, v = void 0 === o.brace_style ? "collapse" : o.brace_style, m = 0 === parseInt(o.wrap_line_length, 10) ? 32786 : parseInt(o.wrap_line_length || 250, 10), b = o.unformatted || ["a", "abbr", "area", "audio", "b", "bdi", "bdo", "br", "button", "canvas", "cite", "code", "data", "datalist", "del", "dfn", "em", "embed", "i", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "map", "mark", "math", "meter", "noscript", "object", "output", "progress", "q", "ruby", "s", "samp", "select", "small", "span", "strong", "sub", "sup", "svg", "template", "textarea", "time", "u", "var", "video", "wbr", "text", "acronym", "address", "big", "dt", "ins", "strike", "tt"], y = o.content_unformatted || ["pre"], T = void 0 === o.preserve_newlines || o.preserve_newlines, w = T ? isNaN(parseInt(o.max_preserve_newlines, 10)) ? 32786 : parseInt(o.max_preserve_newlines, 10) : 0, _ = void 0 !== o.indent_handlebars && o.indent_handlebars, x = void 0 === o.wrap_attributes ? "auto" : o.wrap_attributes, k = isNaN(parseInt(o.wrap_attributes_indent_size, 10)) ? f : parseInt(o.wrap_attributes_indent_size, 10), S = "force" === x.substr(0, "force".length), C = "force-expand-multiline" === x, A = "force-aligned" === x, E = void 0 !== o.end_with_newline && o.end_with_newline, O = "object" == typeof o.extra_liners && o.extra_liners ? o.extra_liners.concat() : "string" == typeof o.extra_liners ? o.extra_liners.split(",") : "head,body,/html".split(","), I = o.eol ? o.eol : "auto", o.indent_with_tabs && (g = "\t", f = 1), "auto" === I && (I = "\n", i && r.test(i || "") && (I = i.match(r)[0])), I = I.replace(/\\r/, "\r").replace(/\\n/, "\n"), i = i.replace(a, "\n"), u = new c, u.printer(i, g, f, m, v); ; ) {
        var L = u.get_token();
        if (u.token_text = L[0], u.token_type = L[1], "TK_EOF" === u.token_type)
          break;
        switch (u.token_type) {
          case "TK_TAG_START":
    ...
    if ("function" == typeof define && define.amd)
      define("vscode-html-languageservice/beautify/beautify-html", ["require", "./beautify", "./beautify-css"], function(e) {
        var t = e("./beautify"),
            n = e("./beautify-css");
        return {html_beautify: function(e, r) {
            return i(e, r, t.js_beautify, n.css_beautify);
          }};
      });
    else if ("undefined" != typeof exports) {
      var o = require('./beautify'),
          s = require('./beautify-css');
      exports.html_beautify = function(e, t) {
        return i(e, t, o.js_beautify, s.css_beautify);
      };
    } else
      "undefined" != typeof window ? window.html_beautify = function(e, t) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/htmlFormatter", ["require", "exports", "vscode-languageserver-types", "../beautify/beautify-html"], e);
  }(function(e, t) {
    function n(e, t, n) {
      var s = e.getText(),
          l = !0;
      if (t) {
        var c = e.offsetAt(t.start),
            u = e.offsetAt(t.end);
        l = u === s.length, s = s.substring(c, u);
      } else
        t = a.Range.create(a.Position.create(0, 0), e.positionAt(s.length));
      var h = {
    ...
    var a = function() {
      ...
      return Object.defineProperty(e.prototype, "scheme", {
        ...
        var n = t.scheme || this.scheme,
            i = t.authority || this.authority,
            r = t.path || this.path,
            a = t.query || this.query,
            o = t.fragment || this.fragment;
        if (n === this.scheme && i === this.authority && r === this.path && a === this.query && o === this.fragment)
          return this;
        var s = new e;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/htmlLinks", ["require", "exports", "../parser/htmlScanner", "vscode-languageserver-types", "vscode-uri"], e);
  }(function(e, t) {
    function n(e) {
    ...
    function r(e, t, r, a, o) {
      ...
      var h = i(c, u, t);
      return h ? {
        range: s.Range.create(e.positionAt(a), e.positionAt(o)),
        target: h
      } : null;
    }
    function a(e, t) {
      for (var n = [],
          i = o.createScanner(e.getText(), 0),
          a = i.scan(),
          s = !1; a !== o.TokenType.EOS; ) {
        switch (a) {
          ...
          case o.TokenType.AttributeValue:
            if (s) {
              var c = i.getTokenText(),
                  u = r(e, t, c, i.getTokenOffset(), i.getTokenEnd());
              u && n.push(u), s = !1;
            }
        }
        a = i.scan();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/services/htmlHighlighting", ["require", "exports", "../parser/htmlScanner", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n(e, t, n) {
      var i = e.offsetAt(t),
          l = n.findNodeAt(i);
    ...
    function a(e, t, n) {
      for (var i = o.createScanner(t.getText(), n),
          r = i.scan(); r !== o.TokenType.EOS && r !== e; )
        r = i.scan();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-html-languageservice/htmlLanguageService", ["require", "exports", "./parser/htmlScanner", "./parser/htmlParser", "./services/htmlCompletion", "./services/htmlHover", "./services/htmlFormatter", "./services/htmlLinks", "./services/htmlHighlighting", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n() {
      return {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vs/language/html/htmlWorker", ["require", "exports", "vscode-html-languageservice", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n(e, t) {
      return new o(e, t);
    }
        ...
        o = function() {
          ...
          return e.prototype.doValidation = function(e) {
            ...
            for (var t = this._ctx.getMirrorModels(),
              ...
              var r = i[n];
              if (r.uri.toString() === e)
                return a.TextDocument.create(e, this._languageId, r.version, r.getValue());
            }
            return null;
          }, e;
        }();
