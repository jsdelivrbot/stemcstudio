...
(function(process) {
  !function(e) {
    ...
    !function(e) {
      function t(e, t, r, i) {
        if (V.number(e) && V.number(t) && V.number(r) && V.number(i))
          return {
            start: n.create(e, t),
            end: n.create(r, i)
          };
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("jsonc-parser/main", ["require", "exports", "vscode-nls"], e);
  }(function(e, t) {
    function n(e, t) {
      function n(t, n) {
        for (var r = 0,
      ...
      function s() {
        var t = p;
        if (48 === e.charCodeAt(p))
          p++;
        else
          for (p++; p < e.length && o(e.charCodeAt(p)); )
            p++;
        if (p < e.length && 46 === e.charCodeAt(p)) {
          if (p++, !(p < e.length && o(e.charCodeAt(p))))
            return x = m.UnexpectedEndOfNumber, e.substring(t, p);
          for (p++; p < e.length && o(e.charCodeAt(p)); )
            p++;
        }
        var n = p;
        if (p < e.length && (69 === e.charCodeAt(p) || 101 === e.charCodeAt(p)))
          if (p++, (p < e.length && 43 === e.charCodeAt(p) || 45 === e.charCodeAt(p)) && p++, p < e.length && o(e.charCodeAt(p))) {
            for (p++; p < e.length && o(e.charCodeAt(p)); )
              p++;
            n = p;
          } else
            x = m.UnexpectedEndOfNumber;
      ...
      function u() {
        if (h = "", x = m.None, g = p, p >= d)
          return g = d, v = y.EOF;
        var t = e.charCodeAt(p);
        if (r(t)) {
          do
            p++, h += String.fromCharCode(t), t = e.charCodeAt(p);
 while (r(t));
          return v = y.Trivia;
        }
        if (i(t))
          return p++, h += String.fromCharCode(t), 13 === t && 10 === e.charCodeAt(p) && (p++, h += "\n"), v = y.LineBreakTrivia;
        switch (t) {
          case 123:
          ...
          case 45:
            if (h += String.fromCharCode(t), p++, p === d || !o(e.charCodeAt(p)))
              return v = y.Unknown;
          case 48:
          case 49:
          case 50:
      ...
      function f() {
        ...
        do
          e = u();
 while (e >= y.LineCommentTrivia && e <= y.Trivia);
        return e;
      }
      void 0 === t && (t = !1);
      var p = 0,
    ...
    function a(e, t) {
      var r,
          ...
          s = 0;
      do
        switch (i = o.getPosition(), r = o.scan()) {
 ...
 while (r !== y.EOF);
      ...
      try {
        h(e, {
          ...
          onObjectProperty: function(e, o, a) {
            if (t < o)
              throw i;
            if (n(e, o, a, "property"), r[r.length - 1] = e, t <= o + a)
              throw i;
          },
          ...
          onLiteralValue: function(e, r, o) {
            if (t < r)
              throw i;
            if (n(e, r, o, c(e)), t <= r + o)
              throw i;
          },
          onSeparator: function(e, n, a) {
            if (t <= n)
              throw i;
            if (":" === e && "property" === o.type)
              o.columnOffset = n, s = !1, o = void 0;
            else if ("," === e) {
              var c = r[r.length - 1];
      ...
      if (e) {
        for (var n = e,
          ...
          if ("string" == typeof o) {
            ...
            var l = o;
            if ("array" !== n.type || l < 0 || l >= n.children.length)
              return;
            n = n.children[l];
          }
        }
    ...
    function h(e, t, r) {
      ...
      function f() {
        m(), a();
        for (var e = !1; h.getToken() !== y.CloseBraceToken && h.getToken() !== y.EOF; )
          h.getToken() === y.CommaToken ? (e || s(x.ValueExpected, [], []), k(","), a()) : e && s(x.CommaExpected, [], []), l() || s(x.ValueExpected, [], [y.CloseBraceToken, y.CommaToken]), e = !0;
        return v(), h.getToken() !== y.CloseBraceToken ? s(x.CloseBraceExpected, [y.CloseBraceToken], []) : a(), !0;
      }
      function p() {
        b(), a();
        for (var e = !1; h.getToken() !== y.CloseBracketToken && h.getToken() !== y.EOF; )
          h.getToken() === y.CommaToken ? (e || s(x.ValueExpected, [], []), k(","), a()) : e && s(x.CommaExpected, [], []), d() || s(x.ValueExpected, [], [y.CloseBracketToken, y.CommaToken]), e = !0;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/utils/json", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t, r) {
      if (null !== e && "object" == typeof e) {
        ...
        if (Array.isArray(e)) {
          ...
          for (var o = "[\n",
              a = 0; a < e.length; a++)
            o += i + n(e[a], i, r), a < e.length - 1 && (o += ","), o += "\n";
          return o += t + "]";
        }
        var s = Object.keys(e);
        if (0 === s.length)
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonCompletion", ["require", "exports", "jsonc-parser", "../utils/json", "vscode-languageserver-types", "vscode-nls"], e);
  }(function(e, t) {
        ...
        s = function() {
          ...
          return e.prototype.doResolve = function(e) {
            ...
            var r = this,
                ...
                a = e.offsetAt(t),
                s = n.getNodeFromOffsetEndInclusive(a);
            if (this.isInComment(e, s ? s.start : 0, a))
            ...
            if (t.parent)
              if ("property" === t.parent.type) {
                ...
                "array" === t.parent.type && t.parent.items.forEach(function(e) {
            ...
            if (t) {
              if ("property" === t.type) {
                ...
                if (n > u.colonOffset) {
                  var l = u.value;
                  if (l && (n > l.end || "object" === l.type || "array" === l.type))
                    return;
                  var f = u.key.value;
                  e.visit(function(e) {
                    var t = e;
            ...
            if (n) {
              ...
              this.addSchemaValueCompletions(e.schema, "", o, a);
            ...
            if (t) {
              ...
              if ("undefined" != typeof a)
                o += this.getInsertTextForGuessedValue(a, "");
              else if (t["enum"] && t["enum"].length > 0)
            ...
            i.setPosition(t);
            for (var o = i.scan(); o !== n.SyntaxKind.EOF && i.getTokenOffset() + i.getTokenLength() < r; )
              o = i.scan();
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonHover", ["require", "exports", "vscode-languageserver-types"], e);
  }(function(e, t) {
    var n = e("vscode-languageserver-types"),
        r = function() {
          ...
          return e.prototype.doHover = function(e, t, r) {
            var i = e.offsetAt(t),
                o = r.getNodeFromOffset(i);
            if (!o || ("object" === o.type || "array" === o.type) && i > o.start + 1 && i < o.end - 1)
            ...
            for (var u = n.Range.create(e.positionAt(a.start), e.positionAt(a.end)),
                l = function(e) {
                  var t = {
                    contents: e,
                    range: u
                ...
                f = o.getPath(),
                p = this.contributions.length - 1; p >= 0; p--) {
              var d = this.contributions[p],
                  h = d.getInfoContribution(e.uri, f);
              if (h)
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonValidation", ["require", "exports", "vscode-languageserver-types"], e);
  }(function(e, t) {
    var n = e("vscode-languageserver-types"),
        r = function() {
          function e(e, t) {
            ...
            return this.validationEnabled ? this.jsonSchemaService.getSchemaForResource(e.uri, t).then(function(r) {
              if (r)
                if (r.errors.length && t.root) {
                  var i = t.root,
                      o = "object" === i.type ? i.getFirstProperty("$schema") : null;
                  if (o) {
                    var a = o.value || o;
                    t.warnings.push({
                      location: {
              ...
              return t.errors.concat(t.warnings).forEach(function(r, i) {
                ...
                if (!c[o]) {
                  c[o] = !0;
                  var a = {
                    start: e.positionAt(r.location.start),
                    end: e.positionAt(r.location.end)
                  };
                  s.push({
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/utils/strings", ["require", "exports"], e);
  }(function(e, t) {
    function n(e, t) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonDocumentSymbols", ["require", "exports", "../utils/strings", "vscode-languageserver-types"], e);
  }(function(e, t) {
            ...
            var c = function(t, n, o) {
              if ("array" === n.type)
                ...
                a.properties.forEach(function(n) {
                  var a = r.Location.create(e.uri, r.Range.create(e.positionAt(n.start), e.positionAt(n.end))),
                      s = n.value;
                  if (s) {
  ...
  !function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/parser/jsonParser", ["require", "exports", "jsonc-parser", "vscode-nls"], e);
  }(function(e, t) {
    function n(e, t) {
      function n() {
        for (; ; ) {
      ...
      function o(e, t, r, o) {
        if (void 0 === t && (t = null), void 0 === r && (r = []), void 0 === o && (o = []), 0 === C.errors.length || C.errors[0].location.start !== O.getTokenOffset()) {
          var a = {
            message: e,
            location: {
              start: O.getTokenOffset(),
              end: O.getTokenOffset() + O.getTokenLength()
            }
          };
          C.errors.push(a);
        }
        if (t && m(t, !1), r.length + o.length > 0)
          for (var s = O.getToken(); s !== i.SyntaxKind.EOF; ) {
            if (r.indexOf(s) !== -1) {
              n();
              break;
            }
      ...
      function v(e, t) {
        if (O.getToken() !== i.SyntaxKind.OpenBracketToken)
          return null;
        var s = new l(e, t, O.getTokenOffset());
        n();
        var c = 0;
        if (s.addItem(k(s, c++)))
          for (; r(i.SyntaxKind.CommaToken); )
            s.addItem(k(s, c++)) || j || o(a("ValueExpected", "Value expected"));
      ...
      var C = new g(t),
          O = i.createScanner(e, !1),
          E = t && t.disallowComments,
          j = t && t.ignoreDanglingComma;
    ...
    var s = function() {
      ...
      return e.prototype.getPath = function() {
        ...
        return null;
      }, e.prototype.getValue = function() {}, e.prototype.contains = function(e, t) {
        ...
        var t = function(n) {
          if (e >= n.start && e < n.end) {
            for (var r = n.getChildNodes(),
                i = 0; i < r.length && r[i].start <= e; i++) {
              var o = t(r[i]);
              if (o)
                return o;
            }
        ...
        if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
          ...
          var u = function(e, r) {
            ...
            return e.forEach(function(e) {
              var t = new m,
                  n = [];
              if (o.validate(e, t, n), t.hasErrors() || i.push(e), s)
                if (r || t.hasErrors() || s.validationResult.hasErrors()) {
                  ...
                  s.matchingSchemas.push.apply(s.matchingSchemas, n), s.validationResult.propertiesMatches += t.propertiesMatches, s.validationResult.propertiesValueMatches += t.propertiesValueMatches;
              else
                s = {
                  schema: e,
                  validationResult: t,
      ...
      return __extends(t, e), t.prototype.getChildNodes = function() {
        ...
        if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
          if (e.prototype.validate.call(this, t, n, r, i), Array.isArray(t.items)) {
            ...
            t.items && this.items.forEach(function(e) {
              var o = new m;
    ...
    var h = function(e) {
      ...
      return __extends(t, e), t.prototype.getChildNodes = function() {
        ...
        for (var t = e(this),
            n = 0; n < this.properties.length && t; n++)
        ...
        if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
          ...
          this.properties.forEach(function(e) {
            ...
            if (!s[e]) {
              var t = o.parent && o.parent && o.parent.key,
                  r = t ? {
                    start: t.start,
                    end: t.end
                  } : {
          ...
          t.properties && Object.keys(t.properties).forEach(function(e) {
            ...
            var c = s[e];
            if (c)
              if (Array.isArray(t.dependencies[e])) {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/configuration", ["require", "exports", "vscode-nls"], e);
  }(function(e, t) {
    var n = e("vscode-nls"),
    ...
    t.schemaContributions = {
      ...
      schemas: {"http://json-schema.org/draft-04/schema#": {
          ...
          properties: {
            ...
            title: {
              type: "string",
              description: r("schema.json.title", "A descriptive title of the element")
            },
            description: {
              type: "string",
            ...
            not: {
              allOf: [{$ref: "#"}],
              description: r("schema.json.not", "A schema which must not match.")
            }
          },
          dependencies: {
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-uri/index", ["require", "exports"], e);
  }(function(e, t) {
    function n(e) {
    ...
    var o = function() {
      ...
      return Object.defineProperty(e.prototype, "scheme", {
        ...
        var n = t.scheme || this.scheme,
            ...
            a = t.fragment || this.fragment;
        if (n === this.scheme && r === this.authority && i === this.path && o === this.query && a === this.fragment)
          return this;
        var s = new e;
        ...
        if (!e.authority && 0 === e.path.indexOf("//"))
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonSchemaService", ["require", "exports", "jsonc-parser", "vscode-uri", "../utils/strings", "vscode-nls"], e);
  }(function(e, t) {
    function n(e) {
      try {
    ...
    var r = e("jsonc-parser"),
        i = e("vscode-uri"),
        o = e("../utils/strings"),
        a = e("vscode-nls"),
        s = a.loadMessageBundle(),
        c = function() {
          function e(e) {
    ...
    var f = function() {
      ...
      return e.prototype.getSection = function(e) {
        ...
        if (!t || 0 === e.length)
          return t;
        var r = e.shift();
        if (t.properties && t.properties[r])
    ...
    var p = function() {
      ...
      return e.prototype.getRegisteredSchemaIds = function(e) {
        ...
        var n = this,
            ...
            c = function(e, t, n) {
              ...
              if (i)
                ...
                r.push(s("json.schema.invalidref", "$ref '{0}' in {1} can not be resolved.", n, t.id));
              delete e.$ref;
            },
            u = function(e, t, i, a) {
        ...
        for (var a = this.filePatternAssociations.length - 1; a >= 0; a--) {
          ...
          if (s.matchesPattern(e))
            return s.getCombinedSchema(this).getResolvedSchema();
        }
        return this.promise.resolve(null);
      }, e.prototype.createCombinedSchema = function(e, t) {
        if (1 === t.length)
          return this.getOrAddSchemaHandle(t[0]);
        var n = {allOf: t.map(function(e) {
            return {$ref: e};
          })};
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonFormatter", ["require", "exports", "jsonc-parser", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n(e, t, n) {
      function u() {
        return T + r(S, p + C);
      ...
      function l() {
        var e = O.scan();
        for (k = !1; e === s.SyntaxKind.Trivia || e === s.SyntaxKind.LineBreakTrivia; )
          k = k || e === s.SyntaxKind.LineBreakTrivia, e = O.scan();
        return e;
      }
      function f(t, n, r) {
      ...
      if (t) {
        ...
        h = e.offsetAt(y);
        for (var x = e.offsetAt(c.Position.create(t.end.line + 1, 0)),
            b = e.offsetAt(c.Position.create(t.end.line, 0)); x > b && a(v, x - 1); )
          x--;
        t = c.Range.create(y, e.positionAt(x)), d = v.substring(h, x), p = i(d, 0, n);
      } else
        d = v, t = c.Range.create(c.Position.create(0, 0), e.positionAt(d.length)), p = 0, h = 0, m = 0, g = v.length;
      var S,
          T = o(e),
          k = !1,
          C = 0;
      S = n.insertSpaces ? r(" ", n.tabSize) : "\t";
      var O = s.createScanner(d, !1),
          E = [],
          j = l();
      if (j !== s.SyntaxKind.EOF) {
        var I = O.getTokenOffset() + h,
            w = r(S, p);
        f(w, h, I);
      }
      for (; j !== s.SyntaxKind.EOF; ) {
        for (var A = O.getTokenOffset() + O.getTokenLength() + h,
            P = l(),
            V = ""; !k && (P === s.SyntaxKind.LineCommentTrivia || P === s.SyntaxKind.BlockCommentTrivia); ) {
          var F = O.getTokenOffset() + h;
          f(" ", A, F), A = O.getTokenOffset() + O.getTokenLength() + h, V = P === s.SyntaxKind.LineCommentTrivia ? u() : "", P = l();
        }
        if (P === s.SyntaxKind.CloseBraceToken)
          j !== s.SyntaxKind.OpenBraceToken && (C--, V = u());
        else if (P === s.SyntaxKind.CloseBracketToken)
          j !== s.SyntaxKind.OpenBracketToken && (C--, V = u());
        else {
          switch (j) {
    ...
    function o(e) {
      var t = e.getText();
      if (e.lineCount > 1) {
        for (var n = e.offsetAt(c.Position.create(1, 0)),
            r = n; r > 0 && a(t, r - 1); )
          r--;
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vscode-json-languageservice/jsonLanguageService", ["require", "exports", "vscode-languageserver-types", "./services/jsonCompletion", "./services/jsonHover", "./services/jsonValidation", "./services/jsonDocumentSymbols", "./parser/jsonParser", "./services/configuration", "./services/jsonSchemaService", "./services/jsonFormatter"], e);
  }(function(e, t) {
    function n(e) {
      var t = e.promiseConstructor || Promise,
          n = new l.JSONSchemaService(e.schemaRequestService, e.workspaceContext, t);
      n.setSchemaContributions(u.schemaContributions);
      var r = new i.JSONCompletion(n, e.contributions, t),
          p = new o.JSONHover(n, e.contributions, t),
          d = new s.JSONDocumentSymbols,
          h = new a.JSONValidation(n, t),
          m = !1;
      return {
    ...
    var i = e("./services/jsonCompletion"),
        o = e("./services/jsonHover"),
        a = e("./services/jsonValidation"),
        s = e("./services/jsonDocumentSymbols"),
        c = e("./parser/jsonParser"),
        u = e("./services/configuration"),
        l = e("./services/jsonSchemaService"),
        f = e("./services/jsonFormatter");
    ...
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define && define.amd && define("vs/language/json/jsonWorker", ["require", "exports", "vscode-json-languageservice", "vscode-languageserver-types"], e);
  }(function(e, t) {
    function n(e, t) {
      return new s(e, t);
    }
    var r = monaco.Promise,
        i = e("vscode-json-languageservice"),
        ...
        s = function() {
          ...
          return e.prototype.doValidation = function(e) {
            ...
            var i = this._getTextDocument(e),
                o = this._languageService.format(i, t, n);
            return r.as(o);
