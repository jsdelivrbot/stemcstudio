...
var MutablePosition_1 = require('./MutablePosition');
var MutableRange_1 = require('./MutableRange');
...
var StackElement = (function() {
  function StackElement(bMark, eMark, targetBeginLine, targetBeginColumn, trace) {
    ...
    this.texts = [];
    this.trees = [];
    this.cursor = new MutablePosition_1.MutablePosition(targetBeginLine, targetBeginColumn);
  }
  ...
  StackElement.prototype.snapshot = function() {
    ...
    if (N === 0) {
      ...
      if (children.length > 1) {
        ...
        var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(tBL, tBC), new MutablePosition_1.MutablePosition(tEL, tEC));
...
var CodeWriter = (function() {
  ...
  CodeWriter.prototype.assign = function(text, source) {
    var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(-3, -3), new MutablePosition_1.MutablePosition(-3, -3));
  ...
  CodeWriter.prototype.name = function(id, source) {
    if (source) {
      var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(-2, -2), new MutablePosition_1.MutablePosition(-2, -2));
      var tree = new MappingTree_1.MappingTree(source, target, null);
  ...
  CodeWriter.prototype.str = function(text, source) {
    if (source) {
      var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(-23, -23), new MutablePosition_1.MutablePosition(-23, -23));
      var tree = new MappingTree_1.MappingTree(source, target, null);
      this.stack.write(text, tree);
    } else {
      this.stack.write(text, null);
  ...
  CodeWriter.prototype.binOp = function(binOp, source) {
    var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(-5, -5), new MutablePosition_1.MutablePosition(-5, -5));
    var tree = new MappingTree_1.MappingTree(source, target, null);
  ...
  CodeWriter.prototype.comma = function(begin, end) {
    if (begin && end) {
      ...
      var target = new MutableRange_1.MutableRange(new MutablePosition_1.MutablePosition(-4, -4), new MutablePosition_1.MutablePosition(-4, -4));
      var tree = new MappingTree_1.MappingTree(source, target, null);
