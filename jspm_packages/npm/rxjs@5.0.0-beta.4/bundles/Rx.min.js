...
(function(process) {
  ...
  System.register("rxjs/util/root", [], !0, function(require, e, t) {
  ...
  }), System.register("rxjs/symbol/observable", ["rxjs/util/root"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/root'),
        o = i.root.Symbol;
    return "function" == typeof o ? o.observable ? e.$$observable = o.observable : ("function" == typeof o["for"] ? e.$$observable = o["for"]("observable") : e.$$observable = o("observable"), o.observable = e.$$observable) : e.$$observable = "@@observable", r.define = s, t.exports;
  ...
  }), System.register("rxjs/symbol/rxSubscriber", ["rxjs/util/root"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/root'),
        o = i.root.Symbol;
    return e.$$rxSubscriber = "function" == typeof o && "function" == typeof o["for"] ? o["for"]("rxSubscriber") : "@@rxSubscriber", r.define = s, t.exports;
    ...
    function r(e) {
      var t = this,
          ...
          p = r.subject;
      if (!p) {
        p = r.subject = new b.AsyncSubject;
        var h = function d() {
          for (var e = [],
        ...
        f === l.errorObject && p.error(l.errorObject.e);
      }
      t.add(p.subscribe(o));
    }
    function s(e) {
    ...
    var a = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        b = require('../subject/AsyncSubject'),
        p = function(e) {
          function t(t, r, s, i) {
          ...
          return a(t, e), t.create = function(e, r, s) {
            ...
            if (!o) {
              o = this.subject = new b.AsyncSubject;
              var n = function u() {
                for (var e = [],
    ...
    return e.BoundNodeCallbackObservable = p, o.define = n, t.exports;
  ...
  }), System.register("rxjs/symbol/iterator", ["rxjs/util/root"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/root'),
    ...
    if ("function" == typeof o)
      o.iterator ? e.$$iterator = o.iterator : "function" == typeof o["for"] && (e.$$iterator = o["for"]("iterator"));
    else if (i.root.Set && "function" == typeof(new i.root.Set)["@@iterator"])
      e.$$iterator = "@@iterator";
    else if (i.root.Map)
      for (var n = Object.getOwnPropertyNames(i.root.Map.prototype),
          a = 0; a < n.length; ++a) {
        var u = n[a];
        if ("entries" !== u && "size" !== u && i.root.Map.prototype[u] === i.root.Map.prototype.entries) {
          e.$$iterator = u;
          break;
        }
      }
  ...
  }), System.register("rxjs/observable/DeferObservable", ["rxjs/Observable", "rxjs/util/subscribeToResult", "rxjs/OuterSubscriber"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        u = function(e) {
          ...
          return i(t, e), t.create = function(e) {
            ...
            return new c(e, this.observableFactory);
          }, t;
        }(o.Observable);
    e.DeferObservable = u;
    var c = function(e) {
      ...
      return i(t, e), t.prototype.tryDefer = function() {
        try {
          var e = this.factory.call(this);
          e && this.add(n.subscribeToResult(this, e));
        } catch (t) {
          this._error(t);
        }
      }, t;
  ...
  }), System.register("rxjs/observable/ForkJoinObservable", ["rxjs/Observable", "rxjs/observable/EmptyObservable", "rxjs/util/isArray", "rxjs/util/subscribeToResult", "rxjs/OuterSubscriber"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        o = require('../Observable'),
        n = require('../observable/EmptyObservable'),
        ...
        l = function(e) {
          ...
          return i(t, e), t.create = function() {
            ...
            if (null === e || 0 === arguments.length)
              return new n.EmptyObservable;
            var s = null;
            return "function" == typeof e[e.length - 1] && (s = e.pop()), 1 === e.length && a.isArray(e[0]) && (e = e[0]), 0 === e.length ? new n.EmptyObservable : new t(e, s);
          }, t.prototype._subscribe = function(e) {
            return new b(e, this.sources, this.resultSelector);
          }, t;
        }(o.Observable);
    e.ForkJoinObservable = l;
    var b = function(e) {
      function t(t, r, s) {
        e.call(this, t), this.sources = r, this.resultSelector = s, this.completed = 0, this.haveValues = 0;
        var i = r.length;
        this.total = i, this.values = new Array(i);
        for (var o = 0; i > o; o++) {
          var n = r[o],
              a = u.subscribeToResult(this, n, null, o);
          a && (a.outerIndex = o, this.add(a));
        }
      }
      return i(t, e), t.prototype.notifyNext = function(e, t, r, s, i) {
        this.values[r] = t, i._hasValue || (i._hasValue = !0, this.haveValues++);
      }, t.prototype.notifyComplete = function(e) {
        ...
        if (this.completed++, this.completed === n) {
          if (s === n) {
            var a = i ? i.apply(this, o) : o;
            t.next(a);
          }
          t.complete();
        }
  ...
  }), System.register("rxjs/observable/IteratorObservable", ["rxjs/util/root", "rxjs/util/isObject", "rxjs/util/tryCatch", "rxjs/Observable", "rxjs/util/isFunction", "rxjs/symbol/iterator", "rxjs/util/errorObject"], !0, function(require, e, t) {
    function r(e) {
      var t = e[f.$$iterator];
    ...
    var u = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        b = require('../util/tryCatch'),
        p = require('../Observable'),
        h = require('../util/isFunction'),
        f = require('../symbol/iterator'),
        ...
        v = function(e) {
          ...
          return u(t, e), t.create = function(e, r, s, i) {
            ...
            var a = o.next();
            return a.done ? void n.complete() : (i ? (a = b.tryCatch(i).call(s, a.value, t), a === d.errorObject ? (e.error = d.errorObject.e, e.hasError = !0) : (n.next(a), e.index = t + 1)) : (n.next(a.value), e.index = t + 1), void(n.isUnsubscribed || this.schedule(e)));
          }, t.prototype._subscribe = function(e) {
            var r = 0,
                s = this,
                i = s.iterator,
            ...
            for (; ; ) {
              ...
              if (o) {
                if (u = b.tryCatch(o).call(n, u.value, r++), u === d.errorObject) {
    ...
    var x = function() {
      ...
      return e.prototype[f.$$iterator] = function() {
        return this;
            ...
            var r = this.sourceObj,
                ...
                o = i ? function() {
                  for (var t = [],
                      r = 0; r < arguments.length; r++)
                    t[r - 0] = arguments[r];
                  var s = b.tryCatch(i).apply(void 0, t);
                  s === p.errorObject ? e.error(p.errorObject.e) : e.next(s);
                } : function(t) {
                  return e.next(t);
                };
    ...
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        a = function(e) {
          function t(t, r) {
            e.call(this), this.scheduler = t, this.work = r, this.pending = !1;
          }
          return i(t, e), t.prototype.execute = function() {
            ...
            var s = this.id;
            return null != s && this.delay === t ? this : (this.delay = t, null != s && (this.id = null, o.root.clearInterval(s)), this.id = o.root.setInterval(function() {
              r.pending = !1;
              var e = r,
                  t = e.id,
                  s = e.scheduler;
              s.actions.push(r), s.flush(), r.pending === !1 && null != t && (r.id = null, o.root.clearInterval(t));
            }, t), this);
            ...
            var e = this,
                ...
                s = r.actions,
                i = s.indexOf(this);
            null != t && (this.id = null, o.root.clearInterval(t)), -1 !== i && s.splice(i, 1), this.work = null, this.state = null, this.scheduler = null;
          }, t;
        }(n.Subscription);
    ...
    function s() {
      ...
      return new u.ArrayObservable(e).lift(new b);
    }
    var i = System.global,
        o = i.define;
    i.define = void 0;
    ...
    return e.RaceSubscriber = p, i.define = o, t.exports;
  }), System.register("rxjs/util/noop", [], !0, function(require, e, t) {
    function r() {}
    var s = System.global,
        i = s.define;
    return s.define = void 0, e.noop = r, s.define = i, t.exports;
  }), System.register("rxjs/add/observable/of", ["rxjs/Observable", "rxjs/observable/ArrayObservable"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../Observable'),
        o = require('../observable/ArrayObservable');
    return i.Observable.of = o.ArrayObservable.of, r.define = s, t.exports;
  ...
  }), System.register("rxjs/operator/zip", ["rxjs/observable/ArrayObservable", "rxjs/util/isArray", "rxjs/Subscriber", "rxjs/OuterSubscriber", "rxjs/util/subscribeToResult", "rxjs/symbol/iterator"], !0, function(require, e, t) {
    function r() {
      for (var e = [],
          t = 0; t < arguments.length; t++)
        e[t - 0] = arguments[t];
    ...
    var n = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        b = require('../util/subscribeToResult'),
        p = require('../symbol/iterator');
    ...
    var f = function(e) {
      ...
      return n(t, e), t.prototype._next = function(e) {
        var t = this.iterators,
            r = this.index++;
        u.isArray(e) ? t.push(new v(e)) : "function" == typeof e[p.$$iterator] ? t.push(new d(e[p.$$iterator]())) : t.push(new x(this.destination, this, e, r));
      }, t.prototype._complete = function() {
    ...
    var d = function() {
      ...
      return e.prototype.hasValue = function() {
        ...
        v = function() {
          ...
          return e.prototype[p.$$iterator] = function() {
            return this;
        ...
        x = function(e) {
          ...
          return n(t, e), t.prototype[p.$$iterator] = function() {
            return this;
            ...
            return b.subscribeToResult(this, this.observable, this, t);
          }, t;
        }(l.OuterSubscriber);
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/bufferTime", ["rxjs/Subscriber", "rxjs/scheduler/async"], !0, function(require, e, t) {
    function r(e, t, r) {
      return void 0 === t && (t = null), void 0 === r && (r = l.async), this.lift(new b(e, t, r));
    }
    function s(e) {
      var t = e.subscriber,
          r = e.buffer;
    ...
    var b = function() {
      ...
      return e.prototype.call = function(e) {
        return new p(e, this.bufferTimeSpan, this.bufferCreationInterval, this.scheduler);
      }, e;
    }(),
        p = function(e) {
          function t(t, r, n, a) {
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.openings, this.closingSelector);
      }, e;
    }(),
        b = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.openings = r, this.closingSelector = s, this.contexts = [], this.add(this.openings.subscribe(new p(this)));
          }
          return o(t, e), t.prototype._next = function(e) {
    ...
    var b = function() {
      ...
      return e.prototype.call = function(e) {
        return new p(e, this.closingSelector);
      }, e;
    }(),
        p = function(e) {
          function t(t, r) {
    ...
    function r(e, t, r) {
      return void 0 === r && (r = Number.POSITIVE_INFINITY), "number" == typeof t && (r = t, t = null), this.lift(new u(e, t, r));
    }
    var s = System.global,
        i = s.define;
    s.define = void 0;
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/debounceTime", ["rxjs/Subscriber", "rxjs/scheduler/async"], !0, function(require, e, t) {
    function r(e, t) {
      return void 0 === t && (t = u.async), this.lift(new c(e, t));
    }
    function s(e) {
      e.debouncedNext();
    }
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/delay", ["rxjs/scheduler/async", "rxjs/util/isDate", "rxjs/Subscriber", "rxjs/Notification"], !0, function(require, e, t) {
    function r(e, t) {
      void 0 === t && (t = n.async);
      var r = a.isDate(e),
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.delay, this.scheduler);
      }, e;
    }(),
        b = function(e) {
          function t(t, r, s) {
    ...
    function r(e, t) {
      return t ? new p(this, t).lift(new l(e)) : this.lift(new l(e));
    }
    var s = System.global,
        i = s.define;
    s.define = void 0;
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.delayDurationSelector);
      }, e;
    }(),
        b = function(e) {
          function t(t, r) {
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/do", ["rxjs/Subscriber"], !0, function(require, e, t) {
    function r(e, t, r) {
      return this.lift(new a(e, t, r));
    }
    var s = System.global,
        i = s.define;
    s.define = void 0;
    ...
    var a = function() {
      ...
      return e.prototype.call = function(e) {
        return new u(e, this.nextOrObserver, this.error, this.complete);
      }, e;
    }(),
        u = function(e) {
          function t(t, r, s, i) {
            e.call(this, t);
            var o = new n.Subscriber(r, s, i);
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.project, this.concurrent, this.scheduler);
      }, e;
    }();
    e.ExpandOperator = l;
    var b = function(e) {
    ...
    return e.ExpandSubscriber = b, s.define = i, t.exports;
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/audit", ["rxjs/util/tryCatch", "rxjs/util/errorObject", "rxjs/OuterSubscriber", "rxjs/util/subscribeToResult"], !0, function(require, e, t) {
    function r(e) {
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.durationSelector);
      }, e;
    }(),
        b = function(e) {
          function t(t, r) {
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/auditTime", ["rxjs/scheduler/async", "rxjs/Subscriber"], !0, function(require, e, t) {
    function r(e, t) {
      return void 0 === t && (t = a.async), this.lift(new c(e, t));
    }
    function s(e) {
      e.clearThrottle();
    }
    ...
    return i.Observable.prototype.flatMapTo = o.mergeMapTo, i.Observable.prototype.mergeMapTo = o.mergeMapTo, r.define = s, t.exports;
    ...
    var b = function() {
      ...
      return e.prototype.call = function(e) {
        return new p(e, this.notifier, this.source);
      }, e;
    }(),
        p = function(e) {
          function t(t, r, s) {
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/sampleTime", ["rxjs/Subscriber", "rxjs/scheduler/async"], !0, function(require, e, t) {
    function r(e, t) {
      return void 0 === t && (t = u.async), this.lift(new c(e, t));
    }
    function s(e) {
    ...
    var c = function() {
      ...
      return e.prototype.call = function(e) {
        ...
        l = function(e) {
          function t(t, r) {
            e.call(this, t), this.total = r, this.ring = new Array, this.count = 0;
          }
          return o(t, e), t.prototype._next = function(e) {
            var t = this.ring,
                r = this.total,
            ...
            var e = this.destination,
                t = this.count;
            if (t > 0)
              for (var r = this.count >= this.total ? this.total : this.count,
                  s = this.ring,
                  i = 0; r > i; i++) {
                var o = t++ % r;
                e.next(s[o]);
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/throttleTime", ["rxjs/Subscriber", "rxjs/scheduler/async"], !0, function(require, e, t) {
    function r(e, t) {
      return void 0 === t && (t = u.async), this.lift(new c(e, t));
    }
    function s(e) {
    ...
    return i.define = o, t.exports;
  }), System.register("rxjs/operator/timeout", ["rxjs/scheduler/async", "rxjs/util/isDate", "rxjs/Subscriber"], !0, function(require, e, t) {
    function r(e, t, r) {
      void 0 === t && (t = null), void 0 === r && (r = n.async);
      var s = a.isDate(e),
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/timeoutWith", ["rxjs/scheduler/async", "rxjs/util/isDate", "rxjs/OuterSubscriber", "rxjs/util/subscribeToResult"], !0, function(require, e, t) {
    function r(e, t, r) {
      void 0 === r && (r = n.async);
      var s = a.isDate(e),
          i = s ? +e - r.now() : Math.abs(e);
    ...
    var l = function() {
      ...
      return e.prototype.call = function(e) {
        return new b(e, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler);
      }, e;
    }(),
        b = function(e) {
          function t(t, r, s, i, o) {
    ...
    return s.define = i, t.exports;
  }), System.register("rxjs/operator/windowTime", ["rxjs/Subscriber", "rxjs/Subject", "rxjs/scheduler/async"], !0, function(require, e, t) {
    function r(e, t, r) {
      return void 0 === t && (t = null), void 0 === r && (r = b.async), this.lift(new p(e, t, r));
    }
    function s(e) {
      var t = e.subscriber,
          r = e.windowTimeSpan,
    ...
    var p = function() {
      ...
      return e.prototype.call = function(e) {
        ...
        h = function(e) {
          function t(t, r, s) {
            e.call(this, t), this.openings = r, this.closingSelector = s, this.contexts = [], this.add(this.openSubscription = b.subscribeToResult(this, r, r));
          }
          return o(t, e), t.prototype._next = function(e) {
            var t = this.contexts;
            if (t)
            ...
            if (e === this.openings) {
              ...
              var d = b.subscribeToResult(this, l, f);
              d.isUnsubscribed ? this.closeWindow(this.contexts.length - 1) : (d.context = f, h.add(d)), this.destination.next(p);
            } else
    ...
    return e.BoundCallbackObservable = p, o.define = n, t.exports;
  ...
  }), System.register("rxjs/util/subscribeToResult", ["rxjs/util/root", "rxjs/util/isArray", "rxjs/util/isPromise", "rxjs/Observable", "rxjs/symbol/iterator", "rxjs/symbol/observable", "rxjs/InnerSubscriber"], !0, function(require, e, t) {
    function r(e, t, r, s) {
      var i = new b.InnerSubscriber(e, r, s);
      if (!i.isUnsubscribed) {
        if (t instanceof u.Observable)
          return t._isScalar ? (i.next(t.value), void i.complete()) : t.subscribe(i);
        if (n.isArray(t)) {
          for (var p = 0,
              h = t.length; h > p && !i.isUnsubscribed; p++)
            i.next(t[p]);
          ...
          if ("function" == typeof t[c.$$iterator]) {
            for (var f = 0,
                d = t; f < d.length; f++) {
              var v = d[f];
              if (i.next(v), i.isUnsubscribed)
                break;
            }
            i.isUnsubscribed || i.complete();
          } else if ("function" == typeof t[l.$$observable]) {
            var x = t[l.$$observable]();
            if ("function" == typeof x.subscribe)
              return x.subscribe(new b.InnerSubscriber(e, r, s));
    ...
    var o = require('../util/root'),
        ...
        u = require('../Observable'),
        c = require('../symbol/iterator'),
        l = require('../symbol/observable'),
        b = require('../InnerSubscriber');
          ...
          return e.prototype.now = function() {
            ...
            if (!this.active && !this.scheduledId) {
              ...
              for (var e = this.actions,
                  t = void 0; t = e.shift(); )
                if (t.execute(), t.error)
                  throw this.active = !1, t.error;
              this.active = !1;
            }
  ...
  }), System.register("rxjs/observable/TimerObservable", ["rxjs/util/isNumeric", "rxjs/Observable", "rxjs/scheduler/async", "rxjs/util/isScheduler", "rxjs/util/isDate"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        l = function(e) {
          function t(t, r, s) {
            void 0 === t && (t = 0), e.call(this), this.period = -1, this.dueTime = 0, o.isNumeric(r) ? this.period = Number(r) < 1 && 1 || Number(r) : u.isScheduler(r) && (s = r), u.isScheduler(s) || (s = a.async), this.scheduler = s, this.dueTime = c.isDate(t) ? +t - this.scheduler.now() : t;
          }
          return i(t, e), t.create = function(e, r, s) {
  ...
  }), System.register("rxjs/add/operator/audit", ["rxjs/Observable", "rxjs/operator/audit"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../Observable'),
        o = require('../operator/audit');
    return i.Observable.prototype.audit = o.audit, r.define = s, t.exports;
  }), System.register("rxjs/add/operator/auditTime", ["rxjs/Observable", "rxjs/operator/auditTime"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../Observable'),
        o = require('../operator/auditTime');
    return i.Observable.prototype.auditTime = o.auditTime, r.define = s, t.exports;
                ...
                for (var p = -1,
                  ...
                  if (n.isObject(f)) {
                    ...
                    if (l === c.errorObject) {
                      ...
                      d instanceof b ? e = e.concat(d.errors) : e.push(d);
                    }
                  }
                }
              if (t)
    ...
    return e.UnsubscriptionError = b, r.define = s, t.exports;
    ...
    function r() {
      for (var e = [],
        ...
        e[t - 0] = arguments[t];
      var r = null;
      return "function" == typeof e[e.length - 1] && (r = e.pop()), 1 === e.length && u.isArray(e[0]) && (e = e[0]), e.unshift(this), new a.ArrayObservable(e).lift(new p(r));
    }
    function s() {
      for (var e = [],
          t = 0; t < arguments.length; t++)
      ...
      var r = null,
          s = null;
      return c.isScheduler(e[e.length - 1]) && (s = e.pop()), "function" == typeof e[e.length - 1] && (r = e.pop()), 1 === e.length && u.isArray(e[0]) && (e = e[0]), new a.ArrayObservable(e, s).lift(new p(r));
    }
    var i = System.global,
        o = i.define;
    i.define = void 0;
    ...
    var h = function(e) {
      ...
      return n(t, e), t.prototype._next = function(e) {
        ...
        if (0 === t)
          ...
          for (var r = 0; t > r; r++) {
            var s = e[r];
            this.add(b.subscribeToResult(this, s, s, r));
          }
        }
      }, t.prototype.notifyComplete = function(e) {
    ...
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        b = require('../observable/ArrayObservable'),
        p = require('../observable/ArrayLikeObservable'),
        h = require('../symbol/observable'),
        f = require('../symbol/iterator'),
        d = require('../Observable'),
        v = require('../operator/observeOn'),
        x = function(e) {
          return e && "number" == typeof e.length;
        },
        y = function(e) {
          ...
          return i(t, e), t.create = function(e, r, s, i) {
            var v = null,
                y = null;
            if (n.isFunction(r) ? (v = i || null, y = r) : u.isScheduler(v) && (v = r), null != e) {
              if ("function" == typeof e[h.$$observable])
                return e instanceof d.Observable && !v ? e : new t(e, v);
              if (o.isArray(e))
                return new b.ArrayObservable(e, v);
              if (a.isPromise(e))
                return new c.PromiseObservable(e, v);
              if ("function" == typeof e[f.$$iterator] || "string" == typeof e)
                return new l.IteratorObservable(e, null, null, v);
              if (x(e))
                return new p.ArrayLikeObservable(e, y, s, v);
            }
            throw new TypeError((null !== e && typeof e || e) + " is not observable");
          }, t.prototype._subscribe = function(e) {
            var t = this.ish,
                r = this.scheduler;
            return null == r ? t[h.$$observable]().subscribe(e) : t[h.$$observable]().subscribe(new v.ObserveOnSubscriber(e, r, 0));
          }, t;
        }(d.Observable);
    return e.FromObservable = y, r.define = s, t.exports;
  }), System.register("rxjs/scheduler/AsyncScheduler", ["rxjs/scheduler/FutureAction", "rxjs/scheduler/QueueScheduler"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        a = function(e) {
          ...
          return i(t, e), t.prototype.scheduleNow = function(e, t) {
            return new o.FutureAction(this, e).schedule(t, 0);
          }, t;
        }(n.QueueScheduler);
    return e.AsyncScheduler = a, r.define = s, t.exports;
      ...
      return o(t, e), t.prototype.call = function(e) {
        ...
        f = function(e) {
          ...
          return o(t, e), t.prototype._next = function(e) {
            ...
            var r = this.groups;
            r || (r = this.groups = "string" == typeof t ? new p.FastMap : new b.Map);
            var s = r.get(t);
            if (!s) {
    ...
    var l = function(e) {
      function t(t, r, s, i) {
        ...
        var n,
            a = this;
        o.isFunction(r) ? n = r : r && (a = r, n = r.next, s = r.error, i = r.complete, o.isFunction(a.unsubscribe) && this.add(a.unsubscribe.bind(a)), a.unsubscribe = this.unsubscribe.bind(this)), this._context = a, this._next = n, this._error = s, this._complete = i;
      }
  ...
  }), System.register("rxjs/scheduler/async", ["rxjs/scheduler/AsyncScheduler"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../scheduler/AsyncScheduler');
    return e.async = new i.AsyncScheduler, r.define = s, t.exports;
  ...
  }), System.register("rxjs/observable/IntervalObservable", ["rxjs/util/isNumeric", "rxjs/Observable", "rxjs/scheduler/async"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        u = function(e) {
          function t(t, r) {
            void 0 === t && (t = 0), void 0 === r && (r = a.async), e.call(this), this.period = t, this.scheduler = r, (!o.isNumeric(t) || 0 > t) && (this.period = 0), r && "function" == typeof r.schedule || (this.scheduler = a.async);
          }
          return i(t, e), t.create = function(e, r) {
  ...
  }), System.register("rxjs/Observable", ["rxjs/util/root", "rxjs/symbol/observable", "rxjs/util/toSubscriber"], !0, function(require, e, t) {
    var r = System.global,
        s = r.define;
    r.define = void 0;
    var i = require('../util/root'),
        o = require('../symbol/observable'),
        ...
        a = function() {
          ...
          return e.prototype.lift = function(t) {
            ...
            var s = this.operator,
                ...
                o = s && s.call(i) || i;
            o !== i && i.add(o);
            var a = this._subscribe(o);
            if (a !== i && i.add(a), i.syncErrorThrowable && (i.syncErrorThrowable = !1, i.syncErrorThrown))
              throw i.syncErrorValue;
            return i;
          }, e.prototype.forEach = function(e, t) {
            var r = this;
            if (t || (i.root.Rx && i.root.Rx.config && i.root.Rx.config.Promise ? t = i.root.Rx.config.Promise : i.root.Promise && (t = i.root.Promise)), !t)
              throw new Error("no Promise impl found");
            return new t(function(t, s) {
              var i = r.subscribe(function(t) {
                if (i)
                  try {
                    e(t);
                  } catch (r) {
    ...
    return e.Observable = a, r.define = s, t.exports;
    ...
    var i = this && this.__extends || function(e, t) {
      ...
      e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r);
        ...
        b = require('../util/ObjectUnsubscribedError'),
        p = function(e) {
          function t(t, r) {
            e.call(this), this.destination = t, this.source = r, this.observers = [], this.isUnsubscribed = !1, this.isStopped = !1, this.hasErrored = !1, this.dispatching = !1, this.hasCompleted = !1, this.source = r;
          }
          return i(t, e), t.prototype.lift = function(e) {
            var r = new t(this.destination || this, this);
            return r.operator = e, r;
          }, t.prototype.add = function(e) {
            return a.Subscription.prototype.add.call(this, e);
            ...
            this.isUnsubscribed && l.throwError(new b.ObjectUnsubscribedError);
    ...
    var b = require('../subject/BehaviorSubject');
    e.BehaviorSubject = b.BehaviorSubject;
    var p = require('../observable/ConnectableObservable');
    e.ConnectableObservable = p.ConnectableObservable;
    ...
    var x = require('../scheduler/asap'),
        y = require('../scheduler/async'),
        j = require('../scheduler/queue'),
        m = require('../symbol/rxSubscriber'),
        S = require('../symbol/observable'),
        O = require('../symbol/iterator'),
        g = {
          asap: x.asap,
          async: y.async,
          queue: j.queue
    ...
    e.Scheduler = g;
    var w = {
      rxSubscriber: m.$$rxSubscriber,
      observable: S.$$observable,
      iterator: O.$$iterator
    };
    return e.Symbol = w, r.define = s, t.exports;
  });
})(require('process'));
