...
(function(process) {
  ...
  (function(l) {
    function m(k, l) {
      return function(m, v) {
        return k[m] = l ? l(m, v) : v;
      };
    }
    var v = "object" === typeof global ? global : "object" === typeof self ? self : "object" === typeof this ? this : {};
    "function" === typeof define && define.amd ? define("tslib", ["exports"], function(k) {
      l(m(v, m(k)));
    }) : "object" === typeof module && "object" === typeof module.exports ? l(m(v, m(module.exports))) : l(m(v));
  })(function(l) {
    __extends = function(l, v) {
      function k() {
        this.constructor = l;
      }
      for (var m in v)
        v.hasOwnProperty(m) && (l[m] = v[m]);
      l.prototype = null === v ? Object.create(v) : (k.prototype = v.prototype, new k);
    };
    __assign = Object.assign || function(l) {
      for (var m,
          k = 1,
          E = arguments.length; k < E; k++) {
        m = arguments[k];
        for (var w in m)
    ...
    __rest = function(l, v) {
      var k = {},
          m;
      for (m in l)
        Object.prototype.hasOwnProperty.call(l, m) && 0 > v.indexOf(m) && (k[m] = l[m]);
      if (null != l && "function" === typeof Object.getOwnPropertySymbols) {
        var w = 0;
        for (m = Object.getOwnPropertySymbols(l); w < m.length; w++)
          0 > v.indexOf(m[w]) && (k[m[w]] = l[m[w]]);
      }
      return k;
    };
    __decorate = function(l, v, k, E) {
      var m = arguments.length,
          A = 3 > m ? v : null === E ? E = Object.getOwnPropertyDescriptor(v, k) : E,
          F;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate)
        A = Reflect.decorate(l, v, k, E);
      else
        for (var u = l.length - 1; 0 <= u; u--)
          if (F = l[u])
            A = (3 > m ? F(A) : 3 < m ? F(v, k, A) : F(v, k)) || A;
      return 3 < m && A && Object.defineProperty(v, k, A), A;
    };
    __param = function(l, v) {
      return function(k, m) {
        v(k, m, l);
      };
    };
    __metadata = function(l, v) {
      if ("object" === typeof Reflect && "function" === typeof Reflect.metadata)
        return Reflect.metadata(l, v);
    };
    __awaiter = function(l, v, k, E) {
      return new (k || (k = Promise))(function(m, A) {
        ...
        function G(l) {
          l.done ? m(l.value) : (new k(function(k) {
            k(l.value);
          })).then(w, u);
        }
        G((E = E.apply(l, v || [])).next());
      });
    };
    __generator = function(l, v) {
      function k(l) {
        return function(k) {
          return m([l, k]);
        };
      ...
      function m(k) {
        ...
        for (; w; )
          try {
            if (A = 1, F && (u = F[k[0] & 2 ? "return" : k[0] ? "throw" : "next"]) && !(u = u.call(F, k[1])).done)
              return u;
            if (F = 0, u)
              k = [0, u.value];
            switch (k[0]) {
              ...
              case 7:
                ...
                continue;
              default:
                if (!(u = w.trys, u = 0 < u.length && u[u.length - 1]) && (6 === k[0] || 2 === k[0])) {
                  w = 0;
                  continue;
                }
                if (3 === k[0] && (!u || k[1] > u[0] && k[1] < u[3]))
                  w.label = k[1];
                else if (6 === k[0] && w.label < u[1])
                  w.label = u[1], u = k;
                else if (u && w.label < u[2])
                  w.label = u[2], w.ops.push(k);
                else {
                  u[2] && w.ops.pop();
                  w.trys.pop();
                  continue;
  ...
  (function(l, m) {
    "object" === typeof exports && "undefined" !== typeof module ? m(exports) : "function" === typeof define && define.amd ? define(["exports"], m) : m(l.Rx = l.Rx || {});
  })(this, function(l) {
    function m(b) {
    ...
    function A(b) {
      ...
      if (!h) {
        var h = c.subject = new P,
            g = function J() {
              ...
              var f = J.source,
                  ...
                  f = f.subject,
                  d = c.shift();
              d ? f.error(d) : b ? (c = k(b).apply(this, c), c === n ? a.add(e.schedule(u, 0, {
                err: n.e,
                subject: f
              })) : a.add(e.schedule(F, 0, {
                value: c,
                subject: f
              }))) : a.add(e.schedule(F, 0, {
        ...
        g.source = c;
        k(f).apply(this, d.concat(g)) === n && h.error(n.e);
      }
      a.add(h.subscribe(b));
    }
    function F(b) {
    ...
    function S() {
      ...
      return null === a && 1 === b.length ? b[0] : (new K(b, a)).lift(new aa(1));
    }
    function sa(b) {
      var a = b.value;
      b = b.subscriber;
    ...
    function ta() {
      ...
      var a = Number.POSITIVE_INFINITY,
          c = null,
          f = b[b.length - 1];
      G(f) ? (c = b.pop(), 1 < b.length && "number" === typeof b[b.length - 1] && (a = b.pop())) : "number" === typeof f && (a = b.pop());
      return null === c && 1 === b.length ? b[0] : (new K(b, c)).lift(new aa(a));
    }
    function ua() {
      for (var b = [],
          a = 0; a < arguments.length; a++)
    ...
    var H = Array.isArray || function(b) {
      return b && "number" === typeof b.length;
        ...
        x = function() {
          ...
          b.prototype.unsubscribe = function() {
            ...
            if (!this.closed) {
              ...
              if (m(b)) {
                var e = k(b).call(this);
                e === n && (a = !0, (c = c || []).push(n.e));
              }
              if (H(d))
                for (var b = -1,
                    h = d.length; ++b < h; )
                  e = d[b], null != e && "object" === typeof e && (e = k(e.unsubscribe).call(e), e === n && (a = !0, c = c || [], e = n.e, e instanceof ia ? c = c.concat(e.errors) : c.push(e)));
              if (a)
                throw new ia(c);
            }
          };
        ...
        ka = r.Symbol,
        T = "function" === typeof ka && "function" === typeof ka.for ? ka.for("rxSubscriber") : "@@rxSubscriber",
        p = function(b) {
          function a(c, f, d) {
            b.call(this);
        ...
        y = function(b) {
          ...
          a.prototype._subscribe = function(c) {
            if (this.closed)
              throw new O;
            if (this.hasError)
              return c.error(this.thrownError), x.EMPTY;
            if (this.isStopped)
              return c.complete(), x.EMPTY;
        ...
        P = function(b) {
          ...
          __extends(a, b);
          a.prototype._subscribe = function(c) {
            return this.hasCompleted && this.hasNext ? (c.next(this.value), c.complete(), x.EMPTY) : this.hasError ? (c.error(this.thrownError), x.EMPTY) : b.prototype._subscribe.call(this, c);
          };
          a.prototype.next = function(c) {
        ...
        Qb = function(b) {
          ...
          a.prototype._subscribe = function(c) {
            ...
            h || (h = this.subject = new P, e = function B() {
              for (var c = [],
                  a = 0; a < arguments.length; a++)
                c[a - 0] = arguments[a];
              var b = B.source,
                  a = b.selector,
                  b = b.subject;
              a ? (c = k(a).apply(this, c), c === n ? b.error(n.e) : (b.next(c), b.complete())) : (b.next(1 === c.length ? c[0] : c), b.complete());
            }, e.source = this, k(b).apply(this, d.concat(e)) === n && h.error(n.e));
          ...
          a.dispatch = function(c) {
            ...
            if (!B) {
              var B = b.subject = new P,
                  l = function nb() {
                    ...
                    var f = nb.source,
                        b = f.selector,
                        f = f.subject;
                    b ? (c = k(b).apply(this, c), c === n ? a.add(g.schedule(w, 0, {
                      err: n.e,
                      subject: f
                    })) : a.add(g.schedule(E, 0, {
                      value: c,
                      subject: f
                    }))) : a.add(g.schedule(E, 0, {
                      value: 1 === c.length ? c[0] : c,
              ...
              l.source = b;
              k(e).apply(this, h.concat(l)) === n && B.error(n.e);
            }
            a.add(B.subscribe(c));
          };
          return a;
      ...
      a.prototype._subscribe = function(c) {
        ...
        h || (h = this.subject = new P, e = function B() {
          ...
          var b = B.source,
              ...
              b = b.subject,
              f = c.shift();
          f ? b.error(f) : a ? (c = k(a).apply(this, c), c === n ? b.error(n.e) : (b.next(c), b.complete())) : (b.next(1 === c.length ? c[0] : c), b.complete());
        }, e.source = this, k(a).apply(this, b.concat(e)) === n && h.error(n.e));
        return h.subscribe(c);
      };
      return a;
    }(g).create;
      ...
      a.prototype._subscribe = function(c) {
        ...
        if (null == e)
          ...
          b.then(function(b) {
            ...
            c.closed || c.add(e.schedule(ob, 0, {
              err: a,
              subscriber: c
            }));
          }).then(null, function(c) {
      ...
      return b;
        ...
        fc = function(b) {
          ...
          a.create = function(c, b, d, e, h) {
            return 1 == arguments.length ? new a(c.initialState, c.condition, c.iterate, c.resultSelector || Va, c.scheduler) : void 0 === e || G(e) ? new a(c, b, d, Va, e) : new a(c, b, d, e, h);
          };
          a.prototype._subscribe = function(c) {
 ...
 while (c = a.shift());
    ...
    var rc = function(b) {
      function a(c, a, d) {
        ...
        this.period = -1;
        this.dueTime = 0;
        ga(a) ? this.period = 1 > Number(a) && 1 || Number(a) : G(a) && (d = a);
        G(d) || (d = C);
        this.scheduler = d;
      ...
      return b;
        ...
        sc = function(b) {
          ...
          a.prototype._next = function(c) {
            ...
            H(c) ? a.push(new tc(c)) : "function" === typeof c[I] ? a.push(new uc(c[I]())) : a.push(new vc(this.destination, this, c));
          };
          a.prototype._complete = function() {
        ...
        xc = function(b) {
          ...
          a.prototype.send = function() {
            ...
            if (m === n)
              ...
              b = b ? k(m.open).call(m, e, h, g, b, l) : k(m.open).call(m, e, h, g);
              if (b === n)
          ...
          a.prototype.setupEvents = function(c, a) {
            ...
            function f(c) {
              ...
              if (4 === this.readyState) {
                ...
                0 === e && (e = h ? 200 : 0);
                200 <= e && 300 > e ? (b && b.complete(), a.next(c), a.complete()) : (b && b.error(c), a.error(new da("ajax error " + e, this, d)));
              }
            }
            ...
            if (c.upload && "withCredentials" in c) {
              ...
              k = function(c) {
                var a = k.progressSubscriber,
                    ...
                    f = k.request;
                a && a.error(c);
                b.error(new da("ajax error", this, f));
              };
              c.onerror = k;
              k.request = a;
              k.subscriber = this;
      ...
      return a;
        ...
        R = function(b) {
          ...
          a.prototype._subscribe = function(c) {
            ...
            if (this.closed)
              throw new O;
            this.hasError ? e = x.EMPTY : this.isStopped ? e = x.EMPTY : (this.observers.push(c), e = new Oa(this, c));
        ...
        Bc = function(b) {
          ...
          a.prototype._connectSocket = function() {
            ...
            e.onopen = function(a) {
              ...
              f && f.next(a);
              a = c.destination;
              c.destination = p.create(function(c) {
    ...
    var Fc = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Ec(a, this.bufferSize, this.startBufferEvery));
      };
      return b;
    }(),
        Ec = function(b) {
    ...
    var Hc = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Gc(a, this.bufferTimeSpan, this.bufferCreationInterval, this.maxBufferSize, this.scheduler));
      };
      return b;
    }(),
        Ic = function() {
    ...
    g.prototype.bufferTime = function(b) {
      var a = arguments.length,
          c = C;
      G(arguments[arguments.length - 1]) && (c = arguments[arguments.length - 1], a--);
      var f = null;
      2 <= a && (f = arguments[1]);
      var d = Number.POSITIVE_INFINITY;
      3 <= a && (d = arguments[2]);
      return this.lift(new Hc(b, f, d, c));
    };
    var Kc = function() {
      function b(a, c) {
        this.openings = a;
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Jc(a, this.openings, this.closingSelector));
      };
      return b;
    }(),
        Jc = function(b) {
      ...
      return b;
        ...
        Lc = function(b) {
          ...
          a.prototype.openBuffer = function() {
            ...
            b === n ? this.error(n.e) : (this.closingSubscription = a = new x, this.add(a), this.subscribing = !0, a.add(q(this, b)), this.subscribing = !1);
          };
          return a;
        }(t);
    ...
    var Da = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Oc(a, this.project, this.resultSelector, this.concurrent));
      };
      return b;
    }(),
        Oc = function(b) {
    ...
    var Fa = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Pc(a, this.ish, this.resultSelector, this.concurrent));
      };
      return b;
    }(),
        Pc = function(b) {
    ...
    var Cb = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new jd(a, this.nextOrObserver, this.error, this.complete));
      };
      return b;
    }(),
        jd = function(b) {
    ...
    var nd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new md(a, this.project, this.resultSelector));
      };
      return b;
    }(),
        md = function(b) {
    ...
    var pd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new od(a, this.project, this.concurrent, this.scheduler));
      };
      return b;
    }(),
        od = function(b) {
          ...
          a.prototype._next = function(c) {
            ...
            if (b.closed)
              ...
              if (this.active < this.concurrent) {
                b.next(c);
                var e = k(this.project)(c, d);
                e === n ? b.error(n.e) : this.scheduler ? this.add(this.scheduler.schedule(a.dispatch, 0, {
                  subscriber: this,
                  result: e,
                  value: c,
                  index: d
    ...
    var ab = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ud(a, this.predicate, this.source, this.yieldIndex, this.thisArg));
      };
      return b;
    }(),
        ud = function(b) {
    ...
    var ea = function(b) {
      ...
      return a;
        ...
        wd = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new vd(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
          };
          return b;
        }(),
        vd = function(b) {
          ...
          a.prototype._complete = function() {
            var a = this.destination;
            this.hasCompleted || "undefined" === typeof this.defaultValue ? this.hasCompleted || a.error(new ea) : (a.next(this.defaultValue), a.complete());
          };
          return a;
        }(p);
    ...
    var xd = function() {
      ...
      return b;
        ...
        Bd = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new Ad(a, this.keySelector, this.elementSelector, this.durationSelector, this.subjectSelector));
          };
          return b;
        }(),
        Ad = function(b) {
          ...
          a.prototype._group = function(a, b) {
            ...
            if (this.elementSelector)
              ...
              h = a;
            if (!f && (f = this.subjectSelector ? this.subjectSelector() : new y, c.set(b, f), a = new bb(b, f, this), this.destination.next(a), this.durationSelector)) {
              a = void 0;
              try {
              ...
              this.add(a.subscribe(new Cd(b, f, this)));
            }
            f.closed || f.next(h);
          };
          a.prototype._error = function(a) {
    ...
    g.prototype.groupBy = function(b, a, c, f) {
      return this.lift(new Bd(b, a, c, f));
    };
    var Fd = function() {
      function b() {}
      b.prototype.call = function(a, c) {
      ...
      return b;
        ...
        Id = function(b) {
          ...
          a.prototype._next = function(a) {
            this.value = a;
            this.hasValue = !0;
            this.throttled || (a = k(this.durationSelector)(a), a === n ? this.destination.error(n.e) : this.add(this.throttled = q(this, a)));
          };
    ...
    var Nd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Md(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
      };
      return b;
    }(),
        Md = function(b) {
          ...
          a.prototype._complete = function() {
            var a = this.destination;
            this.hasValue ? (a.next(this.lastValue), a.complete()) : a.error(new ea);
          };
          return a;
        }(p);
    ...
    var Pd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Od(a, this.predicate, this.thisArg, this.source));
      };
      return b;
    }(),
        Od = function(b) {
    ...
    var oa = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Ud(a, this.accumulator, this.seed, this.hasSeed));
      };
      return b;
    }(),
        Ud = function(b) {
    ...
    var Wd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Vd(a, this.project, this.seed, this.concurrent));
      };
      return b;
    }(),
        Vd = function(b) {
          ...
          a.prototype._next = function(a) {
            if (this.active < this.concurrent) {
              var c = this.index++,
                  ...
                  e = this.destination;
              b === n ? e.error(n.e) : (this.active++, this._innerSub(b, a, c));
            } else
              this.buffer.push(a);
          };
          a.prototype._innerSub = function(a, b, d) {
    ...
    var X = function(b) {
      ...
      a.prototype.connect = function() {
        ...
        a || (a = this._connection = new x, a.add(this.source.subscribe(new Xd(this.getSubject(), this))), a.closed ? (this._connection = null, a = x.EMPTY) : this._connection = a);
        return a;
      };
    ...
    var ne = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new me(a, this.accumulator, this.seed, this.hasSeed));
      };
      return b;
    }(),
        me = function(b) {
      ...
      return b;
        ...
        oe = function(b) {
          function a(a, f, d) {
            ...
            this._b = [];
            this._oneComplete = !1;
            this.add(f.subscribe(new qe(a, this)));
          }
          __extends(a, b);
          a.prototype._next = function(a) {
          ...
          a.prototype.checkValues = function() {
            for (var a = this._a,
              ...
              var e = a.shift(),
                  h = b.shift();
              d ? (e = k(d)(e, h), e === n && this.destination.error(n.e)) : e = e === h;
              e || this.emit(!1);
            }
          };
    ...
    var se = function() {
      ...
      return b;
        ...
        re = function(b) {
          ...
          a.prototype._complete = function() {
            var a = this.destination;
            0 < this.index ? (a.next(this.seenValue ? this.singleValue : void 0), a.complete()) : a.error(new ea);
          };
          return a;
        }(p);
    ...
    g.prototype.startWith = function() {
      ...
      G(a) ? b.pop() : a = null;
      var c = b.length;
      return 1 === c ? S(new la(b[0], a), this) : 1 < c ? S(new K(b, a), this) : S(new L(a), this);
    };
    var eb = new (function() {
      function b(a) {
        this.root = a;
 ...
 while (++e < g && (a = b.shift()));
        ...
        Ae = function(b) {
          function a(a, f, d) {
            ...
            if (!ga(f) || 0 > f)
              this.delayTime = 0;
            d && "function" === typeof d.schedule || (this.scheduler = fa);
          }
          __extends(a, b);
    ...
    var Ee = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new De(a, this.project, this.resultSelector));
      };
      return b;
    }(),
        De = function(b) {
    ...
    var Ge = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Fe(a, this.observable, this.resultSelector));
      };
      return b;
    }(),
        Fe = function(b) {
    ...
    var gb = function(b) {
      ...
      return a;
        ...
        We = function() {
          ...
          b.prototype.call = function(a, b) {
            return b.subscribe(new Ve(a, this.absoluteTimeout, this.waitFor, this.scheduler, this.errorInstance));
          };
          return b;
        }(),
        Ve = function(b) {
    ...
    var Ye = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Xe(a, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler));
      };
      return b;
    }(),
        Xe = function(b) {
    ...
    g.prototype.timeoutWith = function(b, a, c) {
      ...
      return this.lift(new Ye(b, f, a, c));
    };
    var hb = function() {
      return function(b, a) {
        this.value = b;
    ...
    var ff = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new ef(a, this.windowSize, this.startWindowEvery));
      };
      return b;
    }(),
        ef = function(b) {
          ...
          a.prototype._next = function(a) {
            ...
            0 !== ++this.count % b || this.closed || (b = new y, g.push(b), c.next(b));
          };
          a.prototype._error = function(a) {
            var b = this.windows;
            if (b)
    ...
    var hf = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new gf(a, this.windowTimeSpan, this.windowCreationInterval, this.scheduler));
      };
      return b;
    }(),
        gf = function(b) {
          function a(a, f, d, e) {
            ...
            if (null !== d && 0 <= d) {
              ...
              this.add(e.schedule(Pb, d, c));
            } else
              d = {
                subscriber: this,
                window: this.openWindow(),
                windowTimeSpan: f
              }, this.add(e.schedule(Ob, f, d));
          }
          __extends(a, b);
          a.prototype._next = function(a) {
      ...
      return b;
        ...
        lf = function(b) {
          ...
          a.prototype.openWindow = function(a) {
            ...
            a === n ? (a = n.e, this.destination.error(a), this.window.error(a)) : this.add(this.closingNotification = q(this, a));
          };
          return a;
        }(t);
