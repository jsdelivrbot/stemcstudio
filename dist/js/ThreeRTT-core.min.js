...
ThreeRTT.ScaleMaterial=function(a,b,c){var d={};a=ThreeRTT.toTarget(a);b=ThreeRTT.toTarget(b);d=_.extend(d,{sampleAlignment:{type:"v2",value:new THREE.Vector2},texture:{type:"t",value:a.read()}});b.on("render",function(){var e=a,g=b,k=g.height*c/e.height,l=d.sampleAlignment.value;l.x=g.width*c/e.width;l.y=k});var e=new THREE.ShaderMaterial({uniforms:d,vertexShader:ThreeRTT.getShader("rtt-vertex-downsample"),fragmentShader:ThreeRTT.getShader("generic-fragment-texture")});e.side=THREE.DoubleSide;e.depthTest=
...
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,c=this.gy,d=this.targets,e=(b-1)/2,f=(c-1)/2,g=new THREE.PlaneGeometry(1,1,1,1),k=0,l=0;k<a&&l<c;++l)for(var m=0;k<a&&m<b;++m,++k){var h=new THREE.MeshBasicMaterial({color:16777215,map:ThreeRTT.toTexture(d[k]),fog:!1});h.side=THREE.DoubleSide;h=new THREE.Mesh(g,h);h.renderDepth=1E4+Math.random();this.add(h);1<b&&(h.position.x=-e+m);1<c&&(h.position.y=f-l)}}});
