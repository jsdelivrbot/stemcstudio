...
d=Array(b),e=0;e<b;e++)d[e]=c.pluck(a,""+e);return d};c.indexOf=function(a,b,d){if(null==a)return-1;var e;if(d)return d=c.sortedIndex(a,b),a[d]===b?d:-1;if(v&&a.indexOf===v)return a.indexOf(b);d=0;for(e=a.length;d<e;d++)if(d in a&&a[d]===b)return d;return-1};c.lastIndexOf=function(a,c){if(null==a)return-1;if(J&&a.lastIndexOf===J)return a.lastIndexOf(c);for(var b=a.length;b--;)if(b in a&&a[b]===c)return b;return-1};c.range=function(a,c,b){1>=arguments.length&&(c=a||0,a=0);b=arguments[2]||1;for(var d=
Math.max(Math.ceil((c-a)/b),0),e=0,g=Array(d);e<d;)g[e++]=a,a+=b;return g};var L=function(){};c.bind=function(a,b){var d,e;if(a.bind===x&&x)return x.apply(a,k.call(arguments,1));if(!c.isFunction(a))throw new TypeError;e=k.call(arguments,2);return d=function(){if(!(this instanceof d))return a.apply(b,e.concat(k.call(arguments)));L.prototype=a.prototype;var c=new L,g=a.apply(c,e.concat(k.call(arguments)));return Object(g)===g?g:c}};c.bindAll=function(a){var b=k.call(arguments,1);0==b.length&&(b=c.functions(a));
n(b,function(b){a[b]=c.bind(a[b],a)});return a};c.memoize=function(a,b){var d={};b||(b=c.identity);return function(){var e=b.apply(this,arguments);return c.has(d,e)?d[e]:d[e]=a.apply(this,arguments)}};c.delay=function(a,c){var b=k.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(k.call(arguments,1)))};c.throttle=function(a,b){var d,e,g,h,k,m,p=c.debounce(function(){k=h=!1},b);return function(){d=this;e=arguments;g||
...
!0;b.lastHover=b.origin={x:d.pageX,y:d.pageY};d.preventDefault()};this._mouseUp=function(){b.drag=!1};this._mouseMove=function(d){if(b.drag){var e={x:d.pageX-b.origin.x,y:d.pageY-b.origin.y},h={x:d.pageX-b.lastHover.x,y:d.pageY-b.lastHover.y};b.lastHover={x:d.pageX,y:d.pageY};b.moved(b.origin,e,h)}};this.element&&(this.element.addEventListener("mousedown",this._mouseDown,!1),document.addEventListener("mouseup",this._mouseUp,!1),document.addEventListener("mousemove",this._mouseMove,!1))},stop:function(){this.element&&
(this.element.removeEventListener("mousedown",this._mouseDown),document.removeEventListener("mouseup",this._mouseUp),document.removeEventListener("mousemove",this._mouseMove))},moved:function(b,d,e){this.phi+=e.x*this.speed/this.width;this.theta=Math.min(\u03c0/2,Math.max(-\u03c0/2,this.theta+e.y*this.speed/this.height));this.emit("change")},update:function(){this.camera.position.x=Math.cos(this.phi)*Math.cos(this.theta)*this.orbit;this.camera.position.y=Math.sin(this.theta)*this.orbit;this.camera.position.z=
Math.sin(this.phi)*Math.cos(this.theta)*this.orbit;this.camera.position.addSelf?this.camera.position.addSelf(this.lookAt):this.camera.position.add(this.lookAt);this.camera.lookAt(this.lookAt)}};ThreeBox.OrbitControls.bind=function(b,d,e){return new ThreeBox.OrbitControls(b,d,e)};MicroEvent.mixin(ThreeBox.OrbitControls);
