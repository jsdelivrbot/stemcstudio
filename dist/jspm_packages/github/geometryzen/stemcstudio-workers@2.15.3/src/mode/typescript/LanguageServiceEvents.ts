...
export interface GetOutputFilesResponse {
    /**
     * The name of the file from which the output files were created.
     */
    fileName: string;
    /**
     * The output files, usually a JavaScript file and a source map file.
     */
    outputFiles: ts.OutputFile[];
    /**
     * The version of the file from which the output files were created.
     */
    version: number;
}
