        ...
        execute: function () {
            ...
            LanguageServiceWorker = (function () {
                function LanguageServiceWorker(sender) {
                    ...
                    this.documentRegistry_ = new DocumentRegistryInspector_1.DocumentRegistryInspector(ts.createDocumentRegistry(useCaseSensitiveFileNames));
                    ...
                    sender.on(LanguageServiceEvents_3.EVENT_ENSURE_MODULE_MAPPING, function (message) {
                        ...
                        try {
                            ...
                            var previousFileName = _this.lsHost.ensureModuleMapping(moduleName, fileName);
                    ...
                    sender.on(LanguageServiceEvents_8.EVENT_GET_OUTPUT_FILES, function (message) {
                        ...
                        try {
                            ...
                            var output = transpileModule_1.transpileModule(program, sourceFile, _this.lsHost.getCustomTransformers());
                            var outputFiles = [];
                    ...
                    sender.on(LanguageServiceEvents_7.EVENT_GET_LINT_ERRORS, function (message) {
                        ...
                        try {
                            ...
                            var linter = new linter_1.Linter({ fix: false }, _this.ensureLS());
