System.register(["./src/workers/ClojureWorker", "./src/workers/CssWorker", "./src/workers/CsvWorker", "./src/workers/ExampleWorker", "./src/workers/GlslWorker", "./src/workers/HtmlWorker", "./src/workers/JavaScriptWorker", "./src/workers/JsonWorker", "./src/workers/PythonWorker", "./src/workers/TypeScriptWorker", "./src/lib/Sender"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var ClojureWorker_1, CssWorker_1, CsvWorker_1, ExampleWorker_1, GlslWorker_1, HtmlWorker_1, JavaScriptWorker_1, JsonWorker_1, PythonWorker_1, TypeScriptWorker_1, Sender_1, main;
    return {
        setters: [
        ...
        execute: function () {
            main = {
                ...
                get CsvWorker() { return CsvWorker_1.CsvWorker; },
