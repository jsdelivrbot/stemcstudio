System.register(["./error", "./language/rule/abstractRule", "./utils", "./rules/commentFormatRule", "./rules/curlyRule", "./rules/eoflineRule", "./rules/forinRule", "./rules/jsdocFormatRule", "./rules/noConditionalAssignmentRule", "./rules/noForInArrayRule", "./rules/noMagicNumbersRule", "./rules/noShadowedVariableRule", "./rules/noTrailingWhitespaceRule", "./rules/noVarKeywordRule", "./rules/oneVariablePerDeclarationRule", "./rules/preferForOfRule", "./rules/preferFunctionOverMethodRule", "./rules/preferConstRule", "./rules/semicolonRule", "./rules/trailingCommaRule", "./rules/tripleEqualsRule"], function (exports_1, context_1) {
    "use strict";
    ...
    var error_1, abstractRule_1, utils_1, commentFormatRule_1, curlyRule_1, eoflineRule_1, forinRule_1, jsdocFormatRule_1, noConditionalAssignmentRule_1, noForInArrayRule_1, noMagicNumbersRule_1, noShadowedVariableRule_1, noTrailingWhitespaceRule_1, noVarKeywordRule_1, oneVariablePerDeclarationRule_1, preferForOfRule_1, preferFunctionOverMethodRule_1, preferConstRule_1, semicolonRule_1, trailingCommaRule_1, tripleEqualsRule_1, cachedRules;
    return {
        setters: [
            function (error_1_1) {
                error_1 = error_1_1;
