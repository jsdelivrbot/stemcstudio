System.register(["./Mirror", "stemcstudio-json"], function (exports_1, context_1) {
    "use strict";
    ...
    var Mirror_1, stemcstudio_json_1, JsonWorker;
    return {
        setters: [
            function (Mirror_1_1) {
                Mirror_1 = Mirror_1_1;
            },
            function (stemcstudio_json_1_1) {
                stemcstudio_json_1 = stemcstudio_json_1_1;
            }
        ],
        execute: function () {
            JsonWorker = (function (_super) {
                ...
                JsonWorker.prototype.onUpdate = function () {
                    ...
                    var annotations = [];
                    try {
                        stemcstudio_json_1.parse(value);
                    }
                    catch (e) {
                        var index = e.at - 1;
                        var text = e.message;
            ...
            exports_1("JsonWorker", JsonWorker);
        }
    };
});
