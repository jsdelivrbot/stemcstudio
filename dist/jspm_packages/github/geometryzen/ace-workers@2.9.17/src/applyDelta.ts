...
function throwDeltaError(delta: DocumentDelta, errorText: string) {
...
function validateDelta(docLines: string[], delta: DocumentDelta): void {
...
/**
 * The minimal representation for a document change.
 */
...
export function applyDelta(docLines: string[], delta: DocumentDelta, doNotValidate?: boolean): void {
