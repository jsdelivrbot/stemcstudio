...
import { ProgramAwareRuleWalker } from '../language/walker/programAwareRuleWalker';
...
export class Rule extends TypedRule {
    ...
    public applyWithProgram(sourceFile: ts.SourceFile, langSvc: ts.LanguageService): RuleFailure[] {
...
class NoForInArrayWalker extends ProgramAwareRuleWalker {
