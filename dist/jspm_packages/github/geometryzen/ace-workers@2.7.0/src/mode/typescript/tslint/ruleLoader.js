System.register(["./error", "./language/rule/abstractRule", "./utils", "./rules/arrayTypeRule", "./rules/classNameRule", "./rules/commentFormatRule", "./rules/curlyRule", "./rules/eoflineRule", "./rules/forinRule", "./rules/indentRule", "./rules/interfaceNameRule", "./rules/jsdocFormatRule", "./rules/labelPositionRule", "./rules/maxLineLengthRule", "./rules/memberAccessRule", "./rules/noAnyRule", "./rules/noArgRule", "./rules/noBitwiseRule", "./rules/noConditionalAssignmentRule", "./rules/noConsecutiveBlankLinesRule", "./rules/noConsoleRule", "./rules/noConstructRule", "./rules/noForInArrayRule", "./rules/noMagicNumbersRule", "./rules/noShadowedVariableRule", "./rules/noStringThrowRule", "./rules/noTrailingWhitespaceRule", "./rules/noVarKeywordRule", "./rules/oneVariablePerDeclarationRule", "./rules/preferForOfRule", "./rules/preferFunctionOverMethodRule", "./rules/preferConstRule", "./rules/radixRule", "./rules/semicolonRule", "./rules/trailingCommaRule", "./rules/tripleEqualsRule", "./rules/useIsnanRule"], function (exports_1, context_1) {
    ...
    var error_1, abstractRule_1, utils_1, arrayTypeRule_1, classNameRule_1, commentFormatRule_1, curlyRule_1, eoflineRule_1, forinRule_1, indentRule_1, interfaceNameRule_1, jsdocFormatRule_1, labelPositionRule_1, maxLineLengthRule_1, memberAccessRule_1, noAnyRule_1, noArgRule_1, noBitwiseRule_1, noConditionalAssignmentRule_1, noConsecutiveBlankLinesRule_1, noConsoleRule_1, noConstructRule_1, noForInArrayRule_1, noMagicNumbersRule_1, noShadowedVariableRule_1, noStringThrowRule_1, noTrailingWhitespaceRule_1, noVarKeywordRule_1, oneVariablePerDeclarationRule_1, preferForOfRule_1, preferFunctionOverMethodRule_1, preferConstRule_1, radixRule_1, semicolonRule_1, trailingCommaRule_1, tripleEqualsRule_1, useIsnanRule_1, cachedRules;
    return {
        setters: [
            function (error_1_1) {
                error_1 = error_1_1;
