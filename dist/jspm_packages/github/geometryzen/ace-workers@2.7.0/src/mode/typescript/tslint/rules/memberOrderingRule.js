System.register(["../language/rule/abstractRule", "../language/utils", "../utils", "../language/walker/ruleWalker"], function (exports_1, context_1) {
    ...
    function memberKindFromName(name) {
        var kind = MemberKind[utils_1.camelize(name)];
        return typeof kind === "number" ? [kind] : allAccess.map(addModifier);
        function addModifier(modifier) {
            var modifiedKind = MemberKind[utils_1.camelize(modifier + "-" + name)];
    ...
    function getMemberKind(member) {
        ...
        function hasModifier(kind) {
            return utils_2.hasModifier(member.modifiers, kind);
        }
    }
    ...
    var abstractRule_1, utils_2, utils_1, ruleWalker_1, OPTION_ORDER, OPTION_ALPHABETIZE, MemberKind, PRESETS, PRESET_NAMES, allMemberKindNames, optionsDescription, Rule, MemberOrderingWalker, allAccess, MemberCategory, _a, _b, _c;
    return {
        setters: [
        ...
        execute: function () {
            OPTION_ORDER = "order";
            OPTION_ALPHABETIZE = "alphabetize";
            (function (MemberKind) {
            ...
            exports_1("Rule", Rule);
            MemberOrderingWalker = (function (_super) {
            ...
            exports_1("MemberOrderingWalker", MemberOrderingWalker);
            allAccess = ["public", "protected", "private"];
            MemberCategory = (function () {
