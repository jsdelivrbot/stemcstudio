 ...
 *
 * Notice that to be isomorphic settings + operatorOverloading = compiler options.
 */
export function compilerOptionsFromTsConfig(settings: TsConfigSettings, operatorOverloading: boolean): ts.CompilerOptions {
    // Be careful here.
    // CompilerOptions has an index property that makes it easy to make errors.
...
/**
 * It should be noted that this function is "lossy" in that the compiler options
 * contain an operatorOverloading flag as well as other features.
 */
