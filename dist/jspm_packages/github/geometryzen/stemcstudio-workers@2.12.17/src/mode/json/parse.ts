 ...
 * Lookup table
 */
const escapee: { [ch: string]: string } = {
    '"': '"',
    '\\': '\\',
    '/': '/',
    b: '\b',
...
const error = function error(m: string): never {
...
const number = function number(): number {
...
const white = function skipWhitespace() {
...
const word = function word(): boolean | null | never {
