...
import { RuleArgumentType } from "./language/rule/rule";
...
export class EnableDisableRulesWalker {
    ...
    constructor(private sourceFile: ts.SourceFile, rules: { [name: string]: boolean | RuleArgumentType[] } | undefined) {
    ...
    private getStartOfLinePosition(position: number, lineOffset = 0): number | undefined {
