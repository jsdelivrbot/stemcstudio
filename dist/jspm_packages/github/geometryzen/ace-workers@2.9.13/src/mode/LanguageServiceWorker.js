System.register(["./typescript/DefaultLanguageServiceHost", "./typescript/DocumentRegistryInspector", "./typescript/tslint/linter", "./transpileModule", "./LanguageServiceEvents", "./LanguageServiceHelpers"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            ...
            LanguageServiceWorker = (function () {
                function LanguageServiceWorker(sender) {
                    ...
                    this.sender = sender;
                    this.trace = false;
                    this.lsHost = new DefaultLanguageServiceHost_1.DefaultLanguageServiceHost();
                    ...
                    sender.on(LanguageServiceEvents_3.EVENT_ENSURE_MODULE_MAPPING, function (message) {
                        ...
                        try {
                            ...
                            _this.lsHost.ensureModuleMapping(moduleName, fileName);
                            _this.resolve(LanguageServiceEvents_3.EVENT_ENSURE_MODULE_MAPPING, void 0, callbackId);
                        }
                        catch (reason) {
                    ...
                    sender.on(LanguageServiceEvents_4.EVENT_ENSURE_SCRIPT, function (message) {
                        ...
                        try {
                            ...
                            _this.resolve(LanguageServiceEvents_4.EVENT_ENSURE_SCRIPT, void 0, callbackId);
                        }
                        catch (reason) {
                    ...
                    sender.on(LanguageServiceEvents_12.EVENT_REMOVE_MODULE_MAPPING, function (message) {
                        ...
                        try {
                            ...
                            _this.lsHost.removeModuleMapping(moduleName);
                            _this.resolve(LanguageServiceEvents_12.EVENT_REMOVE_MODULE_MAPPING, void 0, callbackId);
                        }
                        catch (reason) {
                    ...
                    sender.on(LanguageServiceEvents_13.EVENT_REMOVE_SCRIPT, function (message) {
                        ...
                        try {
                            ...
                            _this.resolve(LanguageServiceEvents_13.EVENT_REMOVE_SCRIPT, void 0, callbackId);
                        }
                        catch (reason) {
                    ...
                    sender.on(LanguageServiceEvents_18.EVENT_SET_TS_CONFIG, function (message) {
                        ...
                        try {
                            ...
                            try {
                                var operatorOverloading = _this.lsHost.isOperatorOverloadingEnabled();
                                ...
                                var updatedSettings = LanguageServiceHelpers_2.tsConfigFromCompilerOptions(_this.lsHost.getCompilationSettings());
                ...
                LanguageServiceWorker.prototype.setOperatorOverloading = function (operatorOverloading) {
                    var oldValue = this.lsHost.isOperatorOverloadingEnabled();
