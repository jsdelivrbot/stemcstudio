import { EVENT_APPLY_DELTA } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_DEFAULT_LIB_CONTENT } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_ENSURE_MODULE_MAPPING } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_COMPLETIONS_AT_POSITION } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_DEFINITION_AT_POSITION } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_FORMATTING_EDITS_FOR_DOCUMENT } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_LINT_ERRORS } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_OUTPUT_FILES } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_QUICK_INFO_AT_POSITION } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_SCRIPT_CONTENT } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_SEMANTIC_ERRORS } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_GET_SYNTAX_ERRORS } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_REMOVE_MODULE_MAPPING } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_REMOVE_SCRIPT } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_MODULE_KIND } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_OPERATOR_OVERLOADING } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_SCRIPT_CONTENT } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_SCRIPT_TARGET } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_TRACE } from '../../src/mode/typescript/LanguageServiceEvents';
import { EVENT_SET_TS_CONFIG } from '../../src/mode/typescript/LanguageServiceEvents';

import { GetOutputFilesRequest } from '../../src/mode/typescript/LanguageServiceEvents';
import { GetOutputFilesResponse } from '../../src/mode/typescript/LanguageServiceEvents';
import { EnsureModuleMappingRequest, RemoveModuleMappingRequest } from '../../src/mode/typescript/LanguageServiceEvents';
import { GetScriptContentRequest, SetScriptContentRequest, RemoveScriptRequest } from '../../src/mode/typescript/LanguageServiceEvents';
import { SetOperatorOverloadingRequest } from '../../src/mode/typescript/LanguageServiceEvents';
import { SetTraceRequest } from '../../src/mode/typescript/LanguageServiceEvents';
...
describe("LanguageServiceWorker", function () {
    ...
    describe("getOutputFiles", function () {
        ...
        it("should acknowledge", function () {
            ...
            const outputFilesResponse = resolution2.value as GetOutputFilesResponse;
