System.register(["../../src/workers/TypeScriptWorker"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var TypeScriptWorker_1, MockWorkerCallback;
    return {
        setters: [
        ...
        execute: function () {
            ...
            describe("TypeScriptWorker", function () {
                describe("valid", function () {
                    var host = new MockWorkerCallback();
                    var worker = new TypeScriptWorker_1.TypeScriptWorker(host);
                    var sourceText = [
                        "1,2,3"
                    ].join('\n');
                    it("", function () {
