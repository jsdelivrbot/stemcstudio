...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            build: {
                src: 'dist/stemcstudio-worker-ts.js',
                dest: 'dist/stemcstudio-worker-ts.min.js'
            }
        }
    });
    ...
    function bundle() {
        ...
        return builder.bundle('stemcstudio-worker-ts.js', 'dist/stemcstudio-worker-ts.js', options);
    }
