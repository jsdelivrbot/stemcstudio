...
import { BlockScopeAwareRuleWalker } from '../language/walker/blockScopeAwareRuleWalker';
import { getBindingElementVariableDeclaration, isBlockScopedVariable } from '../language/utils';
...
class NoShadowedVariableWalker extends BlockScopeAwareRuleWalker<Set<string>, Set<string>> {
    public createScope() {
        return new Set();
    }
    ...
    public visitBindingElement(node: ts.BindingElement) {
        ...
        if (isSingleVariable) {
            ...
            const isBlockScopedVar = variableDeclaration !== null && isBlockScopedVariable(variableDeclaration);
    ...
    public visitVariableDeclaration(node: ts.VariableDeclaration) {
        ...
        if (isSingleVariable) {
            this.handleSingleVariableIdentifier(node.name as ts.Identifier, isBlockScopedVariable(node));
        }
