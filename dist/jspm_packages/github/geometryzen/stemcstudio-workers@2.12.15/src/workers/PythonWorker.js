System.register(["../fp/mixin", "./Mirror", "typhon-typescript"], function (exports_1, context_1) {
    "use strict";
    ...
    var mixin_1, Mirror_1, typhon_typescript_1, PythonWorker;
    return {
        setters: [
            function (mixin_1_1) {
                mixin_1 = mixin_1_1;
        ...
        execute: function () {
            PythonWorker = (function (_super) {
                ...
                PythonWorker.prototype.onUpdate = function () {
                    ...
                    try {
                        var result = typhon_typescript_1.transpileModule(sourceText);
