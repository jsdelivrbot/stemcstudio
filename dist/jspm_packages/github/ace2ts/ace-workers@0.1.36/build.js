...
requirejs.config({
  ...
  // files to include along with almond.
  include: [
    "ace-workers"
  ],

  // workers to wrap around the start / end of the resulting build file
  ...
  wrap: {
    start: "(function(global, define) {\n"+
    ...
    end:   "  var library = require('ace-workers');\n"+
           ...
           "  else {\n"+
                ...
                // This should match the name in the d.ts file.
           "    global['AceWorkers'] = library;\n"+
           "  }\n"+
           "}(this));\n"
  },
