System.register(['./constants', './CharacterBuffer', './ElementStack', './formatMessage', './getAttribute', './isWhitespace', './isAllWhitespace', './isAllWhitespaceOrReplacementCharacters', './messages', './StackItem', './Tokenizer'], function(exports_1) {
