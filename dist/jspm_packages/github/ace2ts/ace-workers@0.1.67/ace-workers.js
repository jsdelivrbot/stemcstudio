"use strict";
System.register(["./src/mode/ExampleWorker", "./src/mode/HtmlWorker", "./src/mode/JavaScriptWorker", "./src/mode/JsonWorker", "./src/mode/TypeScriptWorker", "./src/mode/LanguageServiceWorker", "./src/lib/Sender"], function(exports_1) {
    var ExampleWorker_1, HtmlWorker_1, JavaScriptWorker_1, JsonWorker_1, TypeScriptWorker_1, LanguageServiceWorker_1, Sender_1;
    var main;
    return {
        setters:[
