...
System.register("src/mode/json/parse.js", [], function(exports_1) {
  var at,
      ch,
      escapee,
      text,
...
System.register("src/mode/JsonWorker.js", ["../worker/Mirror", "./json/parse"], function(exports_1) {
  var __extends = (this && this.__extends) || function(d, b) {
    for (var p in b)
      if (b.hasOwnProperty(p))
        d[p] = b[p];
...
"use strict";
System.register("ace-workers.js", ["./src/mode/ExampleWorker", "./src/mode/HtmlWorker", "./src/mode/JavaScriptWorker", "./src/mode/JsonWorker", "./src/mode/TypeScriptWorker", "./src/mode/LanguageServiceWorker", "./src/lib/Sender"], function(exports_1) {
  var ExampleWorker_1,
      HtmlWorker_1,
      JavaScriptWorker_1,
      JsonWorker_1,
