System.register(["./expr", "./Scope"], function (exports_1, context_1) {
    "use strict";
    ...
    function parser() {
        ...
        function unexpected(str) {
            ...
            var e = new Error((str || 'unexpected ' + state) + ' at line ' + state[0].token.line);
            e['line'] = line;
            e['column'] = column;
            throw e;
        }
        ...
        function advance(op, t) {
            ...
            return function () {
                ...
                var children = state[0].children;
                var last_node = children[children.length - 1];
        ...
        var stmtlist = n(STMTLIST), stmt = n(STMT), decllist = n(DECLLIST), precision = n(PRECISION), ident = n(IDENT), fn = n(FUNCTION), fnargs = n(FUNCTIONARGS), forstmt = n(FORLOOP), ifstmt = n(IF), whilestmt = n(WHILELOOP), returnstmt = n(RETURN), dowhilestmt = n(DOWHILELOOP), quantifier = n(QUANTIFIER);
        var parse_struct;
        var parse_precision;
        var parse_quantifier;
        var parse_forloop;
        var parse_if;
        var parse_return;
        var parse_whileloop;
        var parse_dowhileloop;
        var parse_function;
        var parse_function_args;
        ...
        state.scope = new Scope_1.default(state);
    ...
    return {
        ...
        execute: function () {
            Advance = {};
            DEBUG = false;
            exports_1("IDENT", IDENT = 0);
            exports_1("STMT", STMT = 1);
            exports_1("STMTLIST", STMTLIST = 2);
            STRUCT = 3;
            FUNCTION = 4;
            FUNCTIONARGS = 5;
            DECL = 6;
