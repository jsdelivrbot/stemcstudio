System.register(["./configuration", "./enableDisableRules", "./error", "./language/languageServiceHost", "./language/rule/typedRule", "./ruleLoader", "./utils"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var configuration_1, enableDisableRules_1, error_1, languageServiceHost_1, typedRule_1, ruleLoader_1, utils_1, Linter;
    return {
        setters: [
