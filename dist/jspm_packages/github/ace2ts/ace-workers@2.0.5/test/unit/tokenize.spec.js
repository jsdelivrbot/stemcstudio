System.register(["src/mode/glsl/tokenizeString"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var tokenizeString_1;
    return {
        setters: [
        ...
        execute: function () {
            describe("glsl/tokenizeString", function () {
                it("main", function () {
                    var tokens = tokenizeString_1.default('void main(void) {}');
                ...
                it("attribute", function () {
                    var tokens = tokenizeString_1.default('attribute vec3 aVertexPosition;');
                ...
                it("gl_Position", function () {
                    var tokens = tokenizeString_1.default('void main(void) {gl_Position = aVertexPosition}');
