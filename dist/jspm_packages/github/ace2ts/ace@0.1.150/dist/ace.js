...
define('mode/XmlMode',["require", "exports", './TextMode', './XmlHighlightRules', './behaviour/XmlBehaviour', './folding/XmlFoldMode'], function (require, exports, TextMode_1, XmlHighlightRules_1, XmlBehaviour_1, XmlFoldMode_1) {
    "use strict";
...
define('ace',["require", "exports", "./createAnchor", "./createDocument", "./createEditor", "./createEditSession", "./createFold", "./createFoldLine", "./createRange", "./createRenderer", "./createTokenizer", "./createUndoManager", "./createWorkerClient", "./workspace/createWorkspace", "./mode/createCssMode", "./mode/createHtmlMode", "./mode/createJavaScriptMode", "./mode/createMarkdownMode", "./mode/createTextMode", "./mode/createTypeScriptMode", "./edit"], function (require, exports, createAnchor_1, createDocument_1, createEditor_1, createEditSession_1, createFold_1, createFoldLine_1, createRange_1, createRenderer_1, createTokenizer_1, createUndoManager_1, createWorkerClient_1, createWorkspace_1, createCssMode_1, createHtmlMode_1, createJavaScriptMode_1, createMarkdownMode_1, createTextMode_1, createTypeScriptMode_1, edit_1) {
    'use strict';
    var ace = {
        ...
        get createWorkspace() { return createWorkspace_1.default; },
