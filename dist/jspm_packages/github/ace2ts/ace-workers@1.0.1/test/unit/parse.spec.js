System.register(['src/mode/glsl/parse'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            describe("glsl/parse", function () {
                ...
                describe("syntax", function () {
                    it("", function () {
                        try {
                            var node = parse_1.default('vary ing highp vec4 vColor; void main(void) {gl_Position = aVertexPosition;}');
                        }
                        catch (e) {
