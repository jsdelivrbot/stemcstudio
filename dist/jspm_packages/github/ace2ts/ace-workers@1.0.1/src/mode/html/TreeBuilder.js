System.register(['./constants', './CharacterBuffer', './ElementStack', './formatMessage', './getAttribute', './isWhitespace', './isAllWhitespace', './isAllWhitespaceOrReplacementCharacters', './messages', './StackItem', './Tokenizer'], function(exports_1, context_1) {
    ...
    var constants_1, CharacterBuffer_1, ElementStack_1, formatMessage_1, getAttribute_1, isWhitespace_1, isAllWhitespace_1, isAllWhitespaceOrReplacementCharacters_1, messages_1, StackItem_1, Tokenizer_1;
    var Marker, TreeBuilder;
    return {
        setters:[
