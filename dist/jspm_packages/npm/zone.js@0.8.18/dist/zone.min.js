  ...
  !function(e, t) {
    ...
    function e(e, t) {
      for (var n = e.length - 1; n >= 0; n--)
        typeof e[n] === C && (e[n] = Zone.current.wrap(e[n], t + "_" + n));
      return e;
    }
    function t(t, r) {
      for (var o = t.constructor.name,
          a = function(a) {
            var i = r[a],
                s = t[i];
            if (s) {
              ...
              t[i] = function(t) {
                var n = function() {
                  return t.apply(this, e(arguments, o + "." + i));
                };
                return c(n, t), n;
              }(s);
            }
    ...
    function n(e) {
      return !e || e.writable !== !1 && (typeof e.get !== C || typeof e.set !== L);
    }
    function r(e, t, n) {
      ...
      if (r && r.configurable) {
        ...
        var a = r.get,
            i = t.substr(2),
            s = F[i];
        s || (s = F[i] = z("ON_PROPERTY" + i)), r.set = function(t) {
          var n = this;
          if (n || e !== j || (n = j), n) {
            var r = n[s];
            r && n.removeEventListener(i, q), "function" == typeof t ? (n[s] = t, n.addEventListener(i, q, !1)) : n[s] = null;
          }
        }, r.get = function() {
          var n = this;
          if (n || e !== j || (n = j), !n)
          ...
          if (a) {
            ...
            if (i)
              return r.set.apply(this, [i]), typeof n[M] === C && n.removeAttribute(t), i;
          }
          return null;
      ...
      if (n) {
        j[z(t)] = n, j[t] = function() {
          ...
          switch (r.length) {
            ...
            case 1:
              ...
              break;
            case 2:
              this[N] = new n(r[0], r[1]);
              break;
            case 3:
              this[N] = new n(r[0], r[1], r[2]);
              break;
            case 4:
              this[N] = new n(r[0], r[1], r[2], r[3]);
              break;
            default:
        ...
        for (r in o)
          "XMLHttpRequest" === t && "responseBlob" === r || !function(e) {
            "function" == typeof o[e] ? j[t].prototype[e] = function() {
              return this[N][e].apply(this[N], arguments);
            } : Object.defineProperty(j[t].prototype, e, {
              set: function(n) {
                "function" == typeof n ? (this[N][e] = Zone.current.wrap(n, t + "." + e), c(this[N][e], n)) : this[N][e] = n;
              },
              get: function() {
                return this[N][e];
              }
        ...
        for (r in n)
          "prototype" !== r && n.hasOwnProperty(r) && (j[t][r] = n[r]);
      }
    }
    function i(e, t, r) {
      for (var o = e; o && !o.hasOwnProperty(t); )
      ...
      if (o && !(a = o[i])) {
        a = o[i] = o[t];
        var s = o && Object.getOwnPropertyDescriptor(o, t);
        if (n(s)) {
          var u = r(a, i, t);
          o[t] = function() {
    ...
    function u() {
      ...
      try {
        ...
        e.indexOf("MSIE ");
        return e.indexOf("MSIE ") === -1 && e.indexOf("Trident/") === -1 && e.indexOf("Edge/") === -1 || (B = !0), B;
      } catch (t) {}
    }
    function l(e, t, n) {
      function r(t, n) {
        ...
        var _,
            ...
            E = m[z(i)] = m[i],
            D = m[z(s)] = m[s];
        n && n.prependEventListenerFnName && (_ = m[z(n.prependEventListenerFnName)] = m[n.prependEventListenerFnName]);
        var O = function(e) {
          if (!b.isExisting)
            return T.apply(b.target, [b.eventName, b.capture ? y : v, b.options]);
        },
            S = function(e) {
              if (!e.isRemoved) {
                var t = K[e.eventName],
              ...
              if (e.allRemoved)
                return w.apply(e.target, [e.eventName, e.capture ? y : v, e.options]);
            },
            Z = function(e) {
              ...
              return void 0 === i && (i = !1), void 0 === s && (s = !1), function() {
                ...
                if (!d || d(t, u, c, arguments)) {
                  var p,
                      ...
                      h = arguments[2],
                      v = !1;
                  void 0 === h ? p = !1 : h === !0 ? p = !0 : h === !1 ? p = !1 : (p = !!h && !!h.capture, v = !!h && !!h.once);
                  var y,
                      k = Zone.current,
                      m = K[f];
                  if (m)
                  ...
                  var Z,
                      P = c.constructor[J],
                      z = Y[P];
                  z && (Z = z[f]), Z || (Z = P + n + f), b.options = h, v && (b.options.once = !1), b.target = c, b.capture = p, b.eventName = f, b.isExisting = O;
                  var j = r ? V : null,
                      C = k.scheduleEventTask(Z, u, j, o, a);
                  return v && (h.once = !0), C.options = h, C.target = c, C.capture = p, C.eventName = f, l && (C.originalDelegate = u), s ? D.unshift(C) : D.push(C), i ? c : void 0;
                }
              };
            };
        return m[o] = R(T, l, C, L, k), _ && (m[f] = R(_, h, P, L, k, !0)), m[a] = function() {
          var t,
              n = this || e,
              r = arguments[0],
              o = arguments[2];
          ...
          if (n) {
            ...
            for (var d = Object.keys(t),
              ...
              var v = d[p],
                  y = te.exec(v),
                  g = y && y[1];
              g && "removeListener" !== g && this[s].apply(this, [g]);
            }
            this[s].apply(this, ["removeListener"]);
          }
        }, c(m[o], T), c(m[a], w), D && c(m[s], D), E && c(m[i], E), !0;
      }
    ...
    function h(e, t, n, r) {
      function o(t) {
        ...
        var r = t.data;
        return r.args[0] = n, r.handleId = s.apply(e, r.args), t;
      }
      function a(e) {
      ...
      s = i(e, t, function(n) {
        return function(i, s) {
          if (typeof s[0] === f) {
            ...
            if (!v)
              return v;
            var y = v.data.handleId;
            return typeof y === l ? u[y] = v : y && (y[re] = v), y && y.ref && y.unref && typeof y.ref === f && typeof y.unref === f && (v.ref = y.ref.bind(y), v.unref = y.unref.bind(y)), typeof y === l || y ? y : v;
          }
          return n.apply(e, s);
        };
      }), c = i(e, n, function(t) {
    ...
    function d() {
      Object.defineProperty = function(e, t, n) {
        ...
        return t !== ce && (n = g(e, t, n)), k(e, t, n, r);
    ...
    function g(e, t, n) {
      return n.configurable = !0, n.configurable || (e[se] || oe(e, se, {
        writable: !0,
        value: {}
      }), e[se][t] = !0), n;
    }
    ...
    function m(e, t) {
      ...
      t.EventTarget || l(t, [n.prototype]), t.WebSocket = function(e, t) {
        var r,
            a,
            i = arguments.length > 1 ? new n(e, t) : new n(e),
            s = Object.getOwnPropertyDescriptor(i, "onmessage");
        return s && s.configurable === !1 ? (r = Object.create(i), a = i, ["addEventListener", "removeEventListener", "send", "close"].forEach(function(e) {
          r[e] = function() {
    ...
    function T(e, t) {
      if (!R || x) {
        ...
        if (w()) {
          ...
          if (H) {
            b(window, Se.concat(["messageerror"]), r, Object.getPrototypeOf(window)), b(Document.prototype, Se, r), "undefined" != typeof window.SVGElement && b(window.SVGElement.prototype, Se, r), b(Element.prototype, Se, r), b(HTMLElement.prototype, Se, r), b(HTMLMediaElement.prototype, ve, r), b(HTMLFrameSetElement.prototype, he.concat(be), r), b(HTMLBodyElement.prototype, he.concat(be), r), b(HTMLFrameElement.prototype, _e, r), b(HTMLIFrameElement.prototype, _e, r);
            var o = window.HTMLMarqueeElement;
            o && b(o.prototype, Te, r);
            var i = window.Worker;
            i && b(i.prototype, Oe, r);
          }
          b(XMLHttpRequest.prototype, we, r);
          var s = t.XMLHttpRequestEventTarget;
          s && b(s && s.prototype, we, r), "undefined" != typeof IDBIndex && (b(IDBIndex.prototype, Ee, r), b(IDBRequest.prototype, Ee, r), b(IDBOpenDBRequest.prototype, Ee, r), b(IDBDatabase.prototype, Ee, r), b(IDBTransaction.prototype, Ee, r), b(IDBCursor.prototype, Ee, r)), n && b(WebSocket.prototype, De, r);
        } else
          E(), a("XMLHttpRequest"), n && m(e, t);
      }
    }
    function w() {
      if ((H || x) && !Object.getOwnPropertyDescriptor(HTMLElement.prototype, "onclick") && "undefined" != typeof Element) {
      ...
      var o = z("fakeonreadystatechange");
      Object.defineProperty(XMLHttpRequest.prototype, "onreadystatechange", {
        enumerable: !0,
        configurable: !0,
        get: function() {
    ...
    function D(e, t) {
      ...
      for (var c = e.__Zone_disable_IE_check || !1,
          p = e.__Zone_enable_cross_context_check || !1,
          f = u(),
          h = ".addEventListener:",
      ...
      return l(e, O, {validateHandler: D}), t.patchEventTarget = l, !0;
    }
    function O(e, t) {
      f(e, t);
    }
    function S(e) {
      if ((H || x) && "registerElement" in e.document) {
    ...
    var Z = (function(e) {
      ...
      function r(t) {
        0 === L && 0 === g.length && (l || e[v] && (l = e[v].resolve(0)), l ? l[y](o) : e[d](o, 0)), t && g.push(t);
      }
      function o() {
        if (!k) {
          for (k = !0; g.length; ) {
    ...
    }("undefined" != typeof window && window || "undefined" != typeof self && self || global), function(e, t) {
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function c(e, r, o) {
        ...
        if (e[k] === b) {
          var i = null;
          try {
            typeof o !== S && typeof o !== z || (i = o && o.then);
          } catch (p) {
            return a(function() {
              c(e, !1, p);
            })(), e;
          }
          if (r !== w && o instanceof M && o.hasOwnProperty(k) && o.hasOwnProperty(m) && o[k] !== b)
            u(o), c(e, o[k], o[m]);
          else if (r !== w && typeof i === z)
            try {
              i.apply(o, [a(s(e, r)), a(s(e, !1))]);
            } catch (p) {
              a(function() {
                c(e, !1, p);
              })();
            ...
            e[k] = r;
            var f = e[m];
            e[m] = o, r === w && o instanceof Error && (o[j] = t.currentTask);
            ...
            if (0 == f.length && r == w) {
              ...
              try {
                ...
                var v = p;
                v.rejection = o, v.promise = e, v.zone = t.current, v.task = t.currentTask, d.push(v), n.scheduleMicroTask();
              }
            }
          }
        }
      ...
      function u(e) {
        if (e[k] === E) {
          ...
          for (var o = 0; o < d.length; o++)
            e === d[o].promise && d.splice(o, 1);
        }
      }
      function l(e, t, n, r, o) {
        u(e);
        var s = e[k] ? typeof r === z ? r : a : typeof o === z ? o : i;
        t.scheduleMicroTask(_, function() {
          try {
            c(n, !0, t.run(s, void 0, [e[m]]));
          } catch (r) {
            c(n, !1, r);
          }
        });
      ...
      var g = h("unhandledPromiseRejectionHandler"),
          ...
          z = "function",
          j = h("currentTask"),
          C = h("rejectionHandledHandler"),
          L = "function ZoneAwarePromise() { [native code] }",
          M = function() {
            function e(t) {
              var n = this;
              if (!(n instanceof e))
            ...
            return e.toString = function() {
              ...
              try {
                for (var s = P(e),
                  ...
                  var u = c.value;
                  o(u) || (u = this.resolve(u)), u.then(t, n);
                }
              } catch (l) {
                p = {error: l};
              } finally {
              ...
              try {
                for (var s = P(e),
                    c = s.next(); !c.done; c = s.next()) {
                  var u = c.value;
                  o(u) || (u = this.resolve(u)), u.then(function(e) {
                    return function(n) {
                      i[e] = n, a--, a || t(i);
                    };
                  }(a), n), a++;
              ...
              var r = new this.constructor(null),
                  o = t.current;
              return this[k] == b ? this[m].push(o, r, e, n) : l(this, o, r, e, n), r;
      ...
      var I = e[v] = e.Promise,
          ...
          H = Object.getOwnPropertyDescriptor(e, "Promise");
      H && !H.configurable || (H && delete H.writable, H && delete H.value, H || (H = {
        ...
        t === M ? e[R] = t : (e[v] = t, t.prototype[y] || p(t), n.setNativePromise(t));
      }, Object.defineProperty(e, "Promise", H)), e.Promise = M;
      var x = h("thenPatched");
      if (I) {
        p(I);
        var F = e.fetch;
        typeof F == z && (e.fetch = f(F));
      }
      return Promise[t.__symbol__("uncaughtPromiseErrors")] = d, M;
    });
    var z = Zone.__symbol__,
        j = "object" == typeof window && window || "object" == typeof self && self || global,
        C = "function",
        L = "undefined",
        M = "removeAttribute",
        I = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
        R = !("nw" in j) && "undefined" != typeof j.process && "[object process]" === {}.toString.call(j.process),
        H = !R && !I && !("undefined" == typeof window || !window.HTMLElement),
        x = "undefined" != typeof j.process && "[object process]" === {}.toString.call(j.process) && !I && !("undefined" == typeof window || !window.HTMLElement),
        F = {},
        q = function(e) {
          if (e = e || j.event) {
            var t = F[e.type];
            t || (t = F[e.type] = z("ON_PROPERTY" + e.type));
            var n = this || e.target || j,
                r = n[t],
                o = r && r.apply(this, arguments);
            return void 0 == o || o || e.preventDefault(), o;
          }
        },
        N = z("originalInstance"),
        A = !1,
        B = !1;
    Zone.__load_patch("toString", function(e, t, n) {
      var r = t.__zone_symbol__originalToString = Function.prototype.toString,
          o = "function",
          a = z("OriginalDelegate"),
          i = z("Promise"),
          s = z("Error");
    ...
    var X = function(e, t) {
      ...
      return i;
        ...
        re = z("zoneTask"),
        oe = Object[z("defineProperty")] = Object.defineProperty,
        ae = Object[z("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        ie = Object.create,
        se = z("unconfigurables"),
        ce = "prototype",
        ue = "object",
        le = "undefined",
        ...
        Oe = ["error", "message"],
        Se = pe.concat(ge, ke, me, fe, he, de, ye),
        Ze = z("unbound");
    Zone.__load_patch("util", function(e, t, n) {
      ...
      "undefined" != typeof r && r.prototype && r.prototype.toBlob && s(r.prototype, "toBlob", function(e, t) {
        return {
      ...
      function r(e) {
        ...
        function r(e) {
          ...
          var t = e.data,
              n = t.target,
              r = n[s];
          d || (d = n[f], v = n[h]), r && v.apply(n, [g, r]);
          var a = n[s] = function() {
            n.readyState === n.DONE && !t.aborted && XMLHttpRequest[c] && e.state === k && e.invoke();
          };
          d.apply(n, [g, a]);
          var i = n[o];
          return i || (n[o] = e), b.apply(n, t.args), XMLHttpRequest[c] = !0, e;
        }
        function l() {}
        function p(e) {
          var t = e.data;
        ...
        var g = "readystatechange",
            ...
            b = i(e.XMLHttpRequest.prototype, "send", function() {
              return function(e, n) {
                var o = t.current;
                if (e[a])
                  return b.apply(e, n);
            ...
            T = "string",
            w = i(e.XMLHttpRequest.prototype, "abort", function(e) {
              return function(e, t) {
                var r = n(e);
      ...
      var o = z("xhrTask"),
          ...
          c = z("xhrScheduled"),
          u = z("xhrURL");
    }), Zone.__load_patch("geolocation", function(e, n, r) {
      e.navigator && e.navigator.geolocation && t(e.navigator.geolocation, ["getCurrentPosition", "watchPosition"]);
      ...
      e.PromiseRejectionEvent && (t[z("unhandledPromiseRejectionHandler")] = r("unhandledrejection"), t[z("rejectionHandledHandler")] = r("rejectionhandled"));
    });
  });
})(require('process'));
