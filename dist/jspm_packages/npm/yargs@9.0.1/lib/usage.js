...
(function(process) {
  ...
  module.exports = function usage(yargs, y18n) {
    ...
    self.help = function help() {
      ...
      let keys = Object.keys(Object.keys(descriptions).concat(Object.keys(demandedOptions)).concat(Object.keys(demandedCommands)).concat(Object.keys(options.default)).reduce((acc, key) => {
        if (key !== '_')
          acc[key] = true;
        return acc;
      }, {}));
      ...
      Object.keys(groups).forEach((groupName) => {
        ...
        const switches = normalizedKeys.reduce((acc, key) => {
          acc[key] = [key].concat(options.alias[key] || []).map((sw) => (sw.length > 1 ? '--' : '-') + sw).join(', ');
          return acc;
        }, {});
