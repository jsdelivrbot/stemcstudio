...
(function(process) {
  ...
  (function(l, k) {
    ...
    function Aa(b) {
      return b.reduce(function(a, c) {
        return a.concat(c instanceof R ? c.errors : c);
      }, []);
    }
    function id() {}
    function la() {
    ...
    function db() {
      for (var b = [],
        ...
        b[a - 0] = arguments[a];
      return function(c) {
        return c.lift.call(T.apply(void 0, [c].concat(b)));
      };
    }
    function pa(b, a) {
      return S(b, a, 1);
    ...
    function P(b, a) {
      return 2 <= arguments.length ? function(c) {
        return la(V(b, a), ea(1), qa(a))(c);
      } : function(c) {
        return la(V(function(c, a, f) {
          return b(c, a, f + 1);
        }), ea(1))(c);
      };
    }
    function Kb(b) {
      return P("function" === typeof b ? function(a, c) {
        return 0 < b(a, c) ? a : c;
      } : function(a, c) {
        return a > c ? a : c;
      });
    ...
    function oc() {
      ...
      return function(c) {
        ...
        A(a) ? b.pop() : a = null;
        var d = b.length;
        return 1 === d ? T(new ua(b[0], a), c) : 1 < d ? T(new G(b, a), c) : T(new F(a), c);
      };
    }
    function Ge(b, a) {
      void 0 === a && (a = 0);
    ...
    var E = Array.isArray || function(b) {
      return b && "number" === typeof b.length;
        ...
        v = function() {
          ...
          b.prototype.unsubscribe = function() {
            ...
            if (!this.closed) {
              ...
              x(f) && (b = q(f).call(this), b === n && (a = !0, c = c || (n.e instanceof R ? Aa(n.e.errors) : [n.e])));
              if (E(h))
                for (g = -1, k = h.length; ++g < k; )
                  b = h[g], null != b && "object" === typeof b && (b = q(b.unsubscribe).call(b), b === n && (a = !0, c = c || [], b = n.e, b instanceof R ? c = c.concat(Aa(b.errors)) : c.push(b)));
              if (a)
                throw new R(c);
            }
          };
        ...
        wa = p.Symbol,
        W = "function" === typeof wa && "function" === typeof wa.for ? wa.for("rxSubscriber") : "@@rxSubscriber",
        m = function(b) {
          function a(c, e, d) {
            b.call(this);
            ...
            switch (arguments.length) {
              ...
              case 1:
                ...
                if ("object" === typeof c) {
                  c instanceof a ? (this.syncErrorThrowable = c.syncErrorThrowable, this.destination = c, this.destination.add(this)) : (this.syncErrorThrowable = !0, this.destination = new Nc(this, c));
                  break;
                }
              default:
                this.syncErrorThrowable = !0, this.destination = new Nc(this, c, e, d);
            }
          }
          k(a, b);
        ...
        df = function(b) {
          ...
          a.prototype._subscribe = function(c) {
            ...
            h || (h = this.subject = new O, f = function D() {
              for (var c = [],
                  a = 0; a < arguments.length; a++)
                c[a - 0] = arguments[a];
              var b = D.source,
 ...
 while (c = a.shift());
            ...
            switch (b) {
              case "application/x-www-form-urlencoded":
                return Object.keys(a).map(function(c) {
                  return encodeURI(c) + "\x3d" + encodeURI(a[c]);
                }).join("\x26");
      ...
      return b;
        ...
        bg = function(b) {
          ...
          a.dispatch = function(a) {
            ...
            0 < b.length ? (c = Math.max(0, b[0].time - f.now()), this.schedule(a, c)) : c.active = !1;
          };
    ...
    var Q = function(b) {
      ...
      return a;
        ...
        mg = function(b) {
          ...
          a.prototype._complete = function() {
            var a = this.destination;
            0 <= this.index && ("undefined" !== typeof this.defaultValue ? a.next(this.defaultValue) : a.error(new Q));
            a.complete();
          };
          return a;
        }(m);
    ...
    g.prototype.reduce = function(b, a) {
      return 2 <= arguments.length ? P(b, a)(this) : P(b)(this);
    };
    var ac = function() {
      function b(a, b) {
        this.count = a;
    ...
    g.prototype.scan = function(b, a) {
      return 2 <= arguments.length ? V(b, a)(this) : V(b)(this);
    };
    var ye = function() {
      function b(a, b) {
        this.compareTo = a;
 ...
 while (++f < g && (a = b.shift()));
    ...
    l.Notification = y;
    l.EmptyError = ja;
    l.ArgumentOutOfRangeError = Q;
    l.ObjectUnsubscribedError = I;
    l.TimeoutError = zc;
    l.UnsubscriptionError = R;
    l.TimeInterval = bd;
    l.Timestamp = Cc;
    l.TestScheduler = qh;
