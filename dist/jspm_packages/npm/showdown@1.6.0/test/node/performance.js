...
function runTests() {
  ...
  new performance.Suite('Basic').setOption('cycles', 100).add('Simple "Hello World"', function() {
  ...
  new performance.Suite('subParsers').setOption('cycles', 1000).add('hashHTMLBlocks', function() {
