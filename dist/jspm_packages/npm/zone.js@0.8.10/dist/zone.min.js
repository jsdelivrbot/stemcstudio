...
(function(process) {
  !function(e, t) {
      ...
      if (n.configurable) {
        ...
        n.set = function(t) {
          ...
          if (o.hasOwnProperty(a))
            return o[a];
          if (r) {
            var i = r && r.apply(this);
            if (i)
              return n.set.apply(this, [i]), "function" == typeof o.removeAttribute && o.removeAttribute(t), i;
          }
          return null;
    ...
    function s(e, t, n, r, o, s) {
      ...
      void 0 === n && (n = !0), void 0 === r && (r = !1), void 0 === o && (o = !1), void 0 === s && (s = F);
      var l = D(e),
          h = D(t),
          p = !n && void 0;
      return function(t, n) {
        var o = s(t, n);
        o.options = o.options || p;
        var i = null;
        ...
        var v = Zone.current,
            y = o.target.constructor.name + "." + e + ":" + o.eventName;
        v.scheduleEventTask(y, i, o, c, u);
      };
    }
    function c(e, t, n) {
      void 0 === t && (t = !0), void 0 === n && (n = F);
      var r = D(e),
          o = !t && void 0;
      return function(e, t) {
        var i = n(e, t);
    ...
    function u(e, t, n, r) {
      return void 0 === t && (t = I), void 0 === n && (n = M), void 0 === r && (r = F), !(!e || !e[t]) && (h(e, t, function() {
        ...
        S[D(t)] = n, S[t] = function() {
          ...
          switch (r.length) {
            ...
            case 1:
              ...
              break;
            case 2:
              this[H] = new n(r[0], r[1]);
              break;
            case 3:
              this[H] = new n(r[0], r[1], r[2]);
              break;
            case 4:
              this[H] = new n(r[0], r[1], r[2], r[3]);
              break;
            default:
        ...
        for (r in o)
          "XMLHttpRequest" === t && "responseBlob" === r || !function(e) {
            "function" == typeof o[e] ? S[t].prototype[e] = function() {
              return this[H][e].apply(this[H], arguments);
            } : Object.defineProperty(S[t].prototype, e, {
              set: function(n) {
                "function" == typeof n ? (this[H][e] = Zone.current.wrap(n, t + "." + e), f(this[H][e], n)) : this[H][e] = n;
              },
              get: function() {
                return this[H][e];
              }
      ...
      i = h(e, t, function(n) {
        return function(i, s) {
          if ("function" == typeof s[0]) {
            ...
            return h && h.ref && h.unref && "function" == typeof h.ref && "function" == typeof h.unref && (l.ref = h.ref.bind(h), l.unref = h.unref.bind(h)), l;
          }
          return n.apply(e, s);
        };
      }), s = h(e, n, function(t) {
    ...
    function v() {
      Object.defineProperty = function(e, t, n) {
        ...
        return "prototype" !== t && (n = g(e, t, n)), _(e, t, n, r);
    ...
    function y(e, t, n) {
      var r = n.configurable;
      return n = g(e, t, n), _(e, t, n, r);
    }
    function k(e, t) {
      return e && e[x] && e[x][t];
    }
    function g(e, t, n) {
      return n.configurable = !0, n.configurable || (e[x] || L(e, x, {
        writable: !0,
        value: {}
      }), e[x][t] = !0), n;
    }
    ...
    function w() {
      ...
      Object.defineProperty(XMLHttpRequest.prototype, "onreadystatechange", {
        ...
        configurable: !0,
        get: function() {
          return this[D("fakeonreadystatechange")];
        },
        set: function(e) {
          this[D("fakeonreadystatechange")] = e;
        }
      });
      var n = new XMLHttpRequest,
          o = function() {};
      n.onreadystatechange = o;
      var r = n[D("fakeonreadystatechange")] === o;
      ...
      for (var e = function(e) {
        ...
        self.addEventListener(t, function(e) {
          ...
          for (r = o ? o.constructor.name + "." + n : "unknown." + n; o; )
            o[n] && !o[n][W] && (t = Zone.current.wrap(o[n], r), t[W] = o[n], o[n] = t), o = o.parentElement;
        }, !0);
      },
          t = 0; t < N.length; t++)
        e(t);
    ...
    function Z(e) {
      if ((O || j) && "registerElement" in e.document) {
    ...
    (function(e) {
      ...
      function r(t) {
        0 === j && 0 === v.length && (e[f] ? e[f].resolve(0)[d](o) : e[p](o, 0)), t && v.push(t);
      }
      function o() {
        if (!y) {
          for (y = !0; v.length; ) {
      ...
      var c = function() {
        ...
        return r.assertZonePatched = function() {
          ...
          var r = e.state != T;
          r && e._transitionTo(T, m), e.runCount++;
          var o = O;
          O = e, P = {
            parent: P,
            zone: this
          ...
          try {
            ...
            e.state !== g && e.state !== w && (e.type == D || e.data && e.data.isPeriodic ? r && e._transitionTo(m, T) : (e.runCount = 0, this._updateTaskCount(e, -1), r && e._transitionTo(g, T, g))), P = P.parent, O = o;
          }
          ...
          try {
            ...
            throw e._transitionTo(w, _, g), this._zoneDelegate.handleError(this, r), r;
          }
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function c(e, r, o) {
        ...
        if (e[k] === m) {
          ...
          if (r !== b && o instanceof Z && o.hasOwnProperty(k) && o.hasOwnProperty(g) && o[k] !== m)
            u(o), c(e, o[k], o[g]);
          else if (r !== b && "function" == typeof i)
            try {
            ...
            e[k] = r;
            var p = e[g];
            e[g] = o, r === b && o instanceof Error && (o[f("currentTask")] = t.currentTask);
            ...
            if (0 == p.length && r == b) {
              ...
              try {
                ...
                var y = h;
                y.rejection = o, y.promise = e, y.zone = t.current, y.task = t.currentTask, d.push(y), n.scheduleMicroTask();
              }
            }
          }
        }
      ...
      function l(e, t, n, r, o) {
        u(e);
        var s = e[k] ? "function" == typeof r ? r : a : "function" == typeof o ? o : i;
        t.scheduleMicroTask(_, function() {
          try {
            c(n, !0, t.run(s, void 0, [e[g]]));
          } catch (r) {
            c(n, !1, r);
          }
        });
          ...
          Z = function() {
            ...
            return e.toString = function() {
              ...
              var r = new this.constructor(null),
                  o = t.current;
              return this[k] == m ? this[g].push(o, r, e, n) : l(this, o, r, e, n), r;
    ...
    var D = function(e) {
      return "__zone_symbol__" + e;
        ...
        P = !("nw" in S) && "undefined" != typeof process && "[object process]" === {}.toString.call(process),
        O = !P && !z && !("undefined" == typeof window || !window.HTMLElement),
        j = "undefined" != typeof process && "[object process]" === {}.toString.call(process) && !z && !("undefined" == typeof window || !window.HTMLElement),
        C = D("eventTasks"),
        I = "addEventListener",
        ...
        H = D("originalInstance");
    Zone[D("patchEventTargetMethods")] = u, Zone[D("patchOnProperties")] = r, Zone.__load_patch("toString", function(e, t, n) {
      var r = Function.prototype.toString;
      Function.prototype.toString = function() {
        if ("function" == typeof this) {
          if (this[D("OriginalDelegate")])
            return r.apply(this[D("OriginalDelegate")], arguments);
          if (this === Promise) {
            var t = e[D("Promise")];
            if (t)
    ...
    var L = Object[D("defineProperty")] = Object.defineProperty,
        R = Object[D("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        q = Object.create,
        x = D("unconfigurables"),
        ...
        X = "EventTarget",
        N = "copy cut paste abort blur focus canplay canplaythrough change click contextmenu dblclick drag dragend dragenter dragleave dragover dragstart drop durationchange emptied ended input invalid keydown keypress keyup load loadeddata loadedmetadata loadstart message mousedown mouseenter mouseleave mousemove mouseout mouseover mouseup pause play playing progress ratechange reset scroll seeked seeking select show stalled submit suspend timeupdate volumechange waiting mozfullscreenchange mozfullscreenerror mozpointerlockchange mozpointerlockerror error webglcontextrestored webglcontextlost webglcontextcreationerror".split(" "),
        W = D("unbound");
    Zone.__load_patch("timers", function(e, t, n) {
      ...
      function r(e) {
        ...
        function r(e) {
          ...
          var a = t.target[o];
          return a || (t.target[o] = e), p.apply(t.target, t.args), XMLHttpRequest[s] = !0, e;
        }
        function c() {}
        function u(e) {
          var t = e.data;
        ...
        var l = h(e.XMLHttpRequest.prototype, "open", function() {
          return function(e, t) {
            return e[a] = 0 == t[2], l.apply(e, t);
          };
        }),
            p = h(e.XMLHttpRequest.prototype, "send", function() {
              return function(e, n) {
                var o = t.current;
                if (e[a])
                  return p.apply(e, n);
            ...
            f = h(e.XMLHttpRequest.prototype, "abort", function(e) {
              return function(e, t) {
                var r = n(e);
      ...
      e.PromiseRejectionEvent && (t[D("unhandledPromiseRejectionHandler")] = r("unhandledrejection"), t[D("rejectionHandledHandler")] = r("rejectionhandled"));
    });
  });
})(require('process'));
