...
(function(process) {
  ...
  (function(l, k) {
    ...
    function Ra() {
      for (var b = [],
        ...
        b[a - 0] = arguments[a];
      return function(c) {
        return c.lift.call(Sa.apply(void 0, [c].concat(b)));
      };
    }
    function Sa() {
      for (var b = [],
    ...
    function Ed(b) {
      var a = b.bufferCreationInterval,
          ...
          d = b.scheduler,
          f = e.openContext();
      e.closed || (e.add(f.closeAction = d.schedule(Za, c, {
        subscriber: e,
        context: f
      })), this.schedule(b, a));
    }
    ...
    function lb(b, a) {
      return a ? function(c) {
        return (new Pd(c, a)).lift(new mb(b));
      } : function(c) {
        return c.lift(new mb(b));
      };
    }
    function Qd() {
      return function() {
    ...
    function xb(b, a) {
      ...
      return function(c) {
        return c.lift(new yb(b, c, !1, a));
      };
    }
    function zb(b, a) {
      return function(c) {
        return c.lift(new yb(b, c, !0, a));
      };
    }
    function Ab(b, a, c) {
      return function(e) {
    ...
    function Zb() {
      ...
      return function(c) {
        1 === b.length && E(b[0]) && (b = b[0]);
        return c.lift.call(Oa.apply(void 0, [c].concat(b)));
      };
    }
    function $b(b) {
      void 0 === b && (b = -1);
      ...
      return b && "number" === typeof b.length;
          ...
          function a(c, e, d) {
            ...
            switch (arguments.length) {
              ...
              case 1:
                ...
                if ("object" === typeof c) {
                  c instanceof a ? (this.destination = c, this.destination.add(this)) : (this.syncErrorThrowable = !0, this.destination = new Nc(this, c));
                  break;
                }
              default:
        ...
        g = function() {
          ...
          b.prototype.subscribe = function(a, c, b) {
            ...
            e ? e.call(a, this.source) : a.add(this.source ? this._subscribe(a) : this._trySubscribe(a));
 ...
 while (c = a.shift());
    ...
    g.onErrorResumeNext = function() {
      ...
      1 === b.length && E(b[0]) && (b = b[0]);
      a = b.shift();
      return (new Tc(a, null)).lift(new Qa(b));
    };
    var Af = function(b) {
      function a(c, a) {
        b.call(this);
      ...
      return b;
        ...
        Wc = function() {
          return function(b, a, c) {
            ...
            this.response = Ua(this.responseType, a);
          };
        }(),
        ia = function(b) {
          function a(a, e, d) {
            ...
            this.response = Ua(this.responseType, e);
          }
          k(a, b);
          return a;
        }(Error),
      ...
      return b;
        ...
        Sf = function(b) {
          function a(a, e, d, f, h) {
            ...
            this.contexts = [];
            a = this.openContext();
            (this.timespanOnly = null == d || 0 > d) ? this.add(a.closeAction = h.schedule(Ya, e, {
              subscriber: this,
              context: a,
              bufferTimeSpan: e
            })) : (f = {
              ...
              subscriber: this,
              scheduler: h
            }, this.add(a.closeAction = h.schedule(Za, e, {
              subscriber: this,
              context: a
          ...
          a.prototype.onBufferFull = function(a) {
            ...
            if (!this.closed && this.timespanOnly) {
              ...
              this.add(a.closeAction = this.scheduler.schedule(Ya, c, {
                subscriber: this,
                context: a,
                bufferTimeSpan: c
              }));
    ...
    g.prototype.catch = cb;
    g.prototype._catch = cb;
    ...
    g.prototype.finally = wb;
    g.prototype._finally = wb;
    var yb = function() {
      function b(a, c, b, d) {
        this.predicate = a;
        this.source = c;
    ...
    g.prototype.last = function(b, a, c) {
      return Gb(b, a, c)(this);
    };
    g.prototype.let = Hb;
    g.prototype.letBind = Hb;
    var fe = function() {
      function b(a, c, b) {
        this.predicate = a;
        this.thisArg = c;
