...
(function(process) {
  (function() {
    var e,
        t = ["exports", "require", "vs/base/common/winjs.base", "vs/base/common/platform", "vs/base/common/errors", "vs/base/common/event", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/editor/common/core/uint", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/base/common/diff/diff", "vs/base/common/cancellation", "vs/base/common/map", "vs/base/common/functional", "vs/base/common/strings", "vs/base/common/types", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/callbackList", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/base/common/diff/diffChange", "vs/editor/common/core/characterClassifier", "vs/editor/common/diff/diffComputer", "vs/editor/common/model/wordHelper", "vs/editor/common/modes/linkComputer", "vs/editor/common/modes/supports/inplaceReplaceSupport", "vs/editor/common/standalone/standaloneBase", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/model/mirrorModel2", "vs/base/common/worker/simpleWorker", "vs/editor/common/services/editorSimpleWorker", "vs/base/common/winjs.base.raw"],
        n = function(e) {
          for (var n = [],
              r = 0,
              i = e.length; r < i; r++)
    ...
    !function(e) {
      ...
      var n = function() {
        ...
        return n.prototype._createIgnoreDuplicateModulesMap = function() {
          ...
          for (var e = 0,
              t = this.options.nodeModules; e < t.length; e++) {
            var n = t[e];
          ...
          for (var n,
              r = 0,
              i = this.sortedPathsRules.length; r < i; r++)
          ...
          if (e.Utilities.endsWith(r, ".js") || e.Utilities.isAbsolutePath(r))
            ...
            for (var i = 0,
                o = n.length; i < o; i++)
              this.isBuild() && "empty:" === n[i] || (e.Utilities.isAbsolutePath(n[i]) || (n[i] = this.options.baseUrl + n[i]), e.Utilities.endsWith(n[i], ".js") || e.Utilities.containsQueryString(n[i]) || (n[i] = n[i] + ".js"));
          }
          ...
          i = function() {
            ...
            return t.prototype._init = function(e) {
              ...
              var s = this,
                  ...
                  l = u.nodeInstrumenter || function(e) {
                    return e;
                  };
              this._init(a);
              var c = n.getRecorder();
              if (/^node\|/.test(r)) {
                ...
                r = e.Utilities.fileUriToFilePath(r), this._fs.readFile(r, {encoding: "utf8"}, function(a, f) {
                  if (a)
                    return void o(a);
    ...
    !function(e) {
      ...
      var s = function() {
        ...
        return s._findRelevantLocationInStack = function(e, t) {
          ...
          if (this._modules2[l])
            return void(this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'"));
          ...
          var n = this,
              r = this._moduleIdProvider.getStrModuleId(e),
              i = (this._inverseDependencies2[e] || []).map(function(e) {
          ...
          for (var n = this._createLoadError(e, t),
              r = [],
              i = 0,
              o = this._moduleIdProvider.getMaxModuleId(); i < o; i++)
            r[i] = !1;
          var s = !1,
              u = [];
                ...
                s = function(r) {
                  if (o++, o >= i.length)
                    ...
                    if (n._config.isBuild() && "empty:" === u)
                      return n._buildInfoPath[t] = u, n.defineModule(n._moduleIdProvider.getStrModuleId(t), [], null, null, null), void n._onLoad(t);
              ...
              if (a !== i.EXPORTS)
                if (a !== i.MODULE)
                  if (a !== i.REQUIRE) {
                    ...
                    o[s] = this._createRequire(e.moduleIdResolver);
                else
                  o[s] = {
                    id: e.strId,
                    config: function() {
        ...
        function t() {
          if (1 === arguments.length) {
            if (arguments[0] instanceof Object && !Array.isArray(arguments[0]))
              return void t.config(arguments[0]);
            if ("string" == typeof arguments[0])
              return n.synchronousRequire(arguments[0]);
          }
          if ((2 === arguments.length || 3 === arguments.length) && Array.isArray(arguments[0]))
            return void n.defineModule(e.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
      ...
      var u = 1447,
          ...
          c = function() {
            ...
            return e.prototype.ComputeUniqueIdentifiers = function() {
              ...
              do
                b = N + e, b === L || b < A && c[b - 1] < c[b + 1] ? (h = c[b + 1], m = h - N - i, h < P && S.MarkNextChange(), P = h, S.AddModifiedElement(h + 1, m), N = b + 1 - e) : (h = c[b - 1] + 1, m = h - N - i, h < P && S.MarkNextChange(), P = h - 1, S.AddOriginalElement(h, m + 1), N = b - 1 - e), M >= 0 && (c = this.m_forwardHistory[M], e = c[0], L = 1, A = c.length - 1);
 while (--M >= -1);
              if (E = S.getReverseChanges(), y[0]) {
                ...
                do
                  b = N + o, b === L || b < A && f[b - 1] >= f[b + 1] ? (h = f[b + 1] - 1, m = h - N - l, h > P && S.MarkNextChange(), P = h + 1, S.AddOriginalElement(h + 1, m + 1), N = b + 1 - o) : (h = f[b - 1], m = h - N - l, h > P && S.MarkNextChange(), P = h, S.AddModifiedElement(h + 1, m + 1), N = b - 1 - o), M >= 0 && (f = this.m_reverseHistory[M], o = f[0], L = 1, A = f.length - 1);
 while (--M >= -1);
                C = S.getChanges();
              }
              ...
              for (h = 1; h <= g / 2 + 1; h++) {
                ...
                for (d = this.ClipDiagonalBound(E - h, h, E, v), p = this.ClipDiagonalBound(E + h, h, E, v), P = d; P <= p; P += 2) {
                  for (c = P === d || P < p && y[P - 1] < y[P + 1] ? y[P + 1] : y[P - 1] + 1, f = c - (P - E) - S, M = c; c < t && f < i && this.ElementsAreEqual(c + 1, f + 1); )
                    c++, f++;
                  if (y[P] = c, c + f > w + D && (w = c, D = f), !N && Math.abs(P - C) <= h - 1 && c >= b[P])
                    return o[0] = c, a[0] = f, M <= b[P] && u > 0 && h <= u + 1 ? this.WALKTRACE(E, d, p, S, C, m, _, L, y, b, c, t, o, f, i, a, N, l) : null;
                }
                var I = (w - e + (D - r) - h) / 2;
                if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(w, this.OriginalSequence, I))
                  return l[0] = !0, o[0] = w, a[0] = D, I > 0 && u > 0 && h <= u + 1 ? this.WALKTRACE(E, d, p, S, C, m, _, L, y, b, c, t, o, f, i, a, N, l) : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)]);
                for (m = this.ClipDiagonalBound(C - h, h, C, v), _ = this.ClipDiagonalBound(C + h, h, C, v), P = m; P <= _; P += 2) {
                  for (c = P === m || P < _ && b[P - 1] >= b[P + 1] ? b[P + 1] - 1 : b[P - 1], f = c - (P - C) - L, M = c; c > e && f > r && this.ElementsAreEqual(c, f); )
                    c--, f--;
                  if (b[P] = c, N && Math.abs(P - E) <= h && c <= y[P])
                    return o[0] = c, a[0] = f, M >= y[P] && u > 0 && h <= u + 1 ? this.WALKTRACE(E, d, p, S, C, m, _, L, y, b, c, t, o, f, i, a, N, l) : null;
                }
                if (h <= u) {
      ...
      function n(e, t) {
        ...
        var u = {};
        for (var a in r)
          r.hasOwnProperty(a) && (u[a] = r[a], u[a.toLowerCase()] = r[a]);
        return new o(n, u);
      }
      function r(e, t) {
        var n = (65535 & t) << 16 >>> 0;
      ...
      t.USER_SETTINGS = n(function(e) {
        for (var t = 0,
            n = s._fromKeyCode.length; t < n; t++)
          e[t] = s._fromKeyCode[t];
    ...
    i(t[9], n([1, 0]), function(e, t) {
      ...
      t.empty = Object.freeze({dispose: function() {}}), t.dispose = n, t.combinedDisposable = r, t.toDisposable = i;
      var s = function() {
        function e() {
          this._toDispose = [];
        }
      ...
      var n = function() {
        ...
        return Object.defineProperty(e.prototype, "size", {
          ...
          for (var t in this.map)
            e.push(this.map[t].key);
          return e;
        }, e.prototype.values = function() {
          var e = [];
          for (var t in this.map)
            e.push(this.map[t].value);
          return e;
        ...
        return Object.defineProperty(e.prototype, "size", {
          ...
          if (this.tail)
            if (this.ratio < this.limit)
              ...
              this.map[this.tail.key] = void 0, this._size--, this.tail = this.tail.next, this.tail.prev = null;
        }, e;
      }();
        ...
        return e;
          ...
          u = function() {
            ...
            return e.prototype.insert = function(e, t) {
              for (var n = this._splitter(e),
                  r = 0,
                  i = this._root; r < n.length; r++) {
              ...
              for (var u; r < n.length; r++)
                u = new s, i.children[n[r]] = u, i = u;
              i.element = t;
            }, e.prototype.lookUp = function(e) {
              for (var t,
                  n = this._splitter(e),
                  r = this._root.children,
                  i = 0,
                  o = n; i < o.length; i++) {
                var s = o[i];
                if (t = r[s], !t)
      ...
      function c(e, t) {
        ...
        for (var i = r,
            o = -1; ; ) {
          if (o = e.lastIndexOf(t, i - 1), o === -1 || o + n !== i)
            break;
          if (0 === o)
            return "";
          i = o;
      ...
      function S(e, t) {
        for (var n = Math.min(e.length, t.length),
          ...
          if (i !== o) {
            var s = i - o;
            if (32 !== s && s !== -32 || !L(i) || !L(o))
              return C(e[r].toLowerCase(), t[r].toLowerCase());
          }
        }
        ...
        for (var i = 0; i < n; i++) {
          ...
          if (o !== s)
            if (L(o) && L(s)) {
              ...
              if (0 !== u && 32 !== u)
                return !1;
            } else if (String.fromCharCode(o).toLocaleLowerCase() !== String.fromCharCode(s).toLocaleLowerCase())
              return !1;
        }
        return !0;
      }
      ...
      function p(e, t) {
        if (r(t)) {
          ...
          if (e && e.constructor === t)
            return;
          if (1 === t.length && t.call(void 0, e) === !0)
            return;
      ...
      var r = function() {
        ...
        return e.prototype.add = function(e, t, n) {
          var r = this;
          void 0 === t && (t = null), this._callbacks || (this._callbacks = [], this._contexts = []), this._callbacks.push(e), this._contexts.push(t), Array.isArray(n) && n.push({dispose: function() {
              return r.remove(e, t);
            }});
          ...
          if (void 0 === t && (t = null), this._callbacks) {
            for (var n = !1,
                r = 0,
                i = this._callbacks.length; r < i; r++)
      ...
      var s = function() {
        ...
        return e.isUri = function(t) {
          ...
          var n = t.scheme,
              ...
              o = t.query,
              s = t.fragment;
          if (void 0 === n ? n = this.scheme : null === n && (n = ""), void 0 === r ? r = this.authority : null === r && (r = ""), void 0 === i ? i = this.path : null === i && (i = ""), void 0 === o ? o = this.query : null === o && (o = ""), void 0 === s ? s = this.fragment : null === s && (s = ""), n === this.scheme && r === this.authority && i === this.path && o === this.query && s === this.fragment)
            return this;
          var u = new e;
      ...
      t("WinJS/Core/_Global", [], function() {
          ...
          stopPropagation: function() {}
            ...
            o = {
              ...
              addEventListener: function(e, t, n) {
                ...
                for (var r = this._listeners[e] = this._listeners[e] || [],
                    i = 0,
                    o = r.length; i < o; i++) {
                  var s = r[i];
                  if (s.useCapture === n && s.listener === t)
                    return;
                }
                r.push({
                  listener: t,
              ...
              dispatchEvent: function(e, t) {
                ...
                if (n) {
                  ...
                  for (var o = 0,
                      s = n.length; o < s && !r._stopImmediatePropagationCalled; o++)
                    n[o].listener(r);
          ...
          if (i) {
            ...
            for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
              var a = 1 === u ? i : i[s],
                  c = a.e,
                  f = a.promise,
                  h = e.Debug && (r && r.name === w ? e.Debug.MS_ASYNC_OP_STATUS_CANCELED : e.Debug.MS_ASYNC_OP_STATUS_ERROR);
              if (o._traceAsyncOperationCompleted(a.asyncOpID, h), f) {
                ...
                H.prototype.done.call(t, null, c);
            }
          }
        }
        function g(e, t, n, r, i) {
          if (P._listeners[M]) {
            if (t instanceof Error && t.message === w)
              return;
        ...
        var N = n.Class.mix(n.Class.define(null, {}, {supportedForProcessing: !1}), i.eventMixin),
            P = new N;
        P._listeners = {};
        var M = "error",
            w = "Canceled",
        ...
        k = {
          ...
          enter: function(e) {
            var t = e._value;
            if (t instanceof V && t._state !== q && t._state !== K)
              y(t, {promise: e});
            else {
              var n = function(r) {
          ...
          enter: function(e) {
            if (e.done = J.prototype.done, e.then = J.prototype.then, e._listeners)
              for (var t,
                  n = [e]; n.length; )
                t = n.shift(), t._state._notify(t, n);
            e._setState(K);
          },
          cancel: s,
          done: null,
        ...
        var B,
            ...
            Q = n.Class.derive(j, function(e, t) {
      ...
      var h = function() {
        ...
        return e.prototype.setWorkerId = function(e) {
          ...
          var n = String(++this._lastSentReq),
              ...
              o = new i.TPromise(function(e, t, n) {
                r.c = e, r.e = t;
              }, function() {});
          ...
          var s = e,
              u = s.req,
              a = this._handler.handleMessage(s.method, s.args);
          a.then(function(e) {
            t._send({
          ...
          d = function(e) {
            function t(t, n) {
              ...
              "function" == typeof a.getConfig ? u = a.getConfig() : "undefined" != typeof self.requirejs && (u = self.requirejs.s.contexts._.config), r._lazyProxy = new i.TPromise(function(e, t, n) {
                o = e, s = t;
              }, function() {}), r._onModuleLoaded = r._protocol.sendMessage(c, [r._worker.getId(), n, u]), r._onModuleLoaded.then(function(e) {
                for (var t = {},
                    n = 0; n < e.length; n++)
                  t[e[n]] = f(e[n], l);
                o(t);
      ...
      var p = function() {
        ...
        return t.prototype.onmessage = function(e) {
          ...
          if (e === c)
            return this.initialize(t[0], t[1], t[2]);
      ...
      function s(e) {
        ...
        for (t = 1, n = e.length; t < n; t++)
          s = e[t], r = s.originalStart - (l.originalStart + l.originalLength), i = s.modifiedStart - (l.modifiedStart + l.modifiedLength), o = Math.min(r, i), o < a ? (l.originalLength = s.originalStart + s.originalLength - l.originalStart, l.modifiedLength = s.modifiedStart + s.modifiedLength - l.modifiedStart) : (u.push(s), l = s);
        return u;
      }
      var u = 5e3,
          a = 3,
          l = function() {
            ...
            return e.prototype.equals = function(t) {
              if (!(t instanceof e))
                return !1;
              var n = t;
              if (this.getLength() !== n.getLength())
                return !1;
              for (var r = 0,
                  i = this.getLength(); r < i; r++) {
          ...
          c = function(e) {
            function t(n, r) {
              var i,
                  ...
                  f = [],
                  h = [];
              for (s = 0, i = 0, o = n.length; i < o; i++)
                c += n[i], u = 1, a = n[i].length + 1, r && (u = t._getFirstNonBlankColumn(n[i], 1), a = t._getLastNonBlankColumn(n[i], 1)), f.push({
                  offset: s + u - 1,
                  lineNumber: i + 1,
                  column: u
                }), h.push({
            ...
            return o(t, e), t._getFirstNonBlankColumn = function(e, t) {
              ...
              var n,
                  ...
                  u = [];
              for (n = e; n <= t; n++)
                for (i = this.startMarkers[n], o = this.endMarkers[n], r = i.offset; r < o.offset; r++)
                  s.push({
                    offset: r,
          ...
          h = function() {
            function e(e, t, n, r, o) {
              if (0 === e.originalLength ? (this.originalStartLineNumber = t.getStartLineNumber(e.originalStart) - 1, this.originalEndLineNumber = 0) : (this.originalStartLineNumber = t.getStartLineNumber(e.originalStart), this.originalEndLineNumber = t.getEndLineNumber(e.originalStart + e.originalLength - 1)), 0 === e.modifiedLength ? (this.modifiedStartLineNumber = n.getStartLineNumber(e.modifiedStart) - 1, this.modifiedEndLineNumber = 0) : (this.modifiedStartLineNumber = n.getStartLineNumber(e.modifiedStart), this.modifiedEndLineNumber = n.getEndLineNumber(e.modifiedStart + e.modifiedLength - 1)), 0 !== e.originalLength && 0 !== e.modifiedLength && r()) {
                var u = t.getCharSequence(e.originalStart, e.originalStart + e.originalLength - 1),
                    a = n.getCharSequence(e.modifiedStart, e.modifiedStart + e.modifiedLength - 1),
                    l = i(u, a, r);
                o && (l = s(l)), this.charChanges = [];
                for (var c = 0,
                    h = l.length; c < h; c++)
                  this.charChanges.push(new f(l[c], u, a));
              }
            }
            return e;
          }(),
          d = function() {
            ...
            return e.prototype.computeDiff = function() {
              ...
              for (var e = i(this.original, this.modified, this._continueProcessingPredicate.bind(this)),
                  t = [],
                  n = 0,
                  r = e.length; n < r; n++)
                t.push(new h(e[n], this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldPostProcessCharChanges));
              return t;
      ...
      function n(e) {
        void 0 === e && (e = "");
        for (var n = t.USUAL_WORD_SEPARATORS,
            r = "(-?\\d*\\.\\d\\w*)|([^",
            i = 0; i < n.length; i++)
      ...
      function o() {
        if (null === f) {
          ...
          for (var e = " \t<>'\"、。｡､，．：；？！＠＃＄％＆＊‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…",
              t = 0; t < e.length; t++)
            f.set(e.charCodeAt(t), 1);
          for (var r = ".,;",
              t = 0; t < r.length; t++)
            f.set(r.charCodeAt(t), 2);
        }
        return f;
      }
      function s(e) {
      ...
      var a,
          l = function() {
            function e(e) {
              ...
              t++, n++;
              for (var c = new r.Uint8Matrix(n, t, 0),
                  i = 0,
                  o = e.length; i < o; i++) {
                var f = e[i],
                    u = f[0],
          ...
          h = function() {
            ...
            return e._createLink = function(e, t, n, r, i) {
              ...
              for (var n = i(),
                  ...
                  s = [],
                  u = 1,
                  a = t.getLineCount(); u <= a; u++) {
                for (var l = t.getLineContent(u),
                    c = l.length,
                    f = 0,
                    h = 0,
                    d = 0,
      ...
      var i = function() {
        ...
        return e.prototype.getCount = function() {
          ...
          if (e < 0)
            return 0;
          if (e = n.toUint32(e), e <= this.prefixSumValidIndex)
          ...
          for (var t,
              ...
              i,
              o = 0,
              s = this.values.length - 1; o <= s; )
            if (t = o + (s - o) / 2 | 0, n = this.getAccumulatedValue(t), i = n - this.values[t], e < i)
              s = t - 1;
            else {
              if (!(e >= n))
                break;
      ...
      var r = function() {
        ...
        return e.prototype.dispose = function() {
          ...
          if (0 !== t.length) {
            var n = t.split(/\r\n|\r|\n/);
            if (1 === n.length)
              return void this._setLineText(e.lineNumber - 1, this._lines[e.lineNumber - 1].substring(0, e.column - 1) + n[0] + this._lines[e.lineNumber - 1].substring(e.column - 1));
            ...
            for (var r = new Uint32Array(n.length - 1),
                i = 1; i < n.length; i++)
            ...
            return e.prototype.computeDiff = function(e, t, n) {
              ...
              for (var a = [],
                ...
                var f = c[l],
                    h = f.range,
                    d = f.text,
                    p = s.getValueInRange(h);
                if (d = d.replace(/\r\n|\n|\r/g, s.eol), p !== d)
                  if (Math.max(d.length, p.length) > e._diffLimit)
                    a.push({
                      range: h,
                      text: d
                    });
                  else
                    for (var m = u.stringDiff(p, d),
                        _ = s.offsetAt(i.Range.lift(h).getStartPosition()),
                        g = 0,
                        v = m; g < v.length; g++) {
                      var y = v[g],
                          b = s.positionAt(_ + y.originalStart),
                          E = s.positionAt(_ + y.originalStart + y.originalLength),
                          C = {
              ...
              if (o) {
                for (var s = [],
                    ...
                    l = 0,
                    c = o.getAllUniqueWords(u); l < c.length; l++) {
                  var f = c[l];
              ...
              return new r.TPromise(function(r, i) {
                self.require([e], function(e) {
                  var i = {getMirrorModels: function() {
                      return n._getModels();
                    }};
      ...
      var v = self,
          y = "function" == typeof v.importScripts;
