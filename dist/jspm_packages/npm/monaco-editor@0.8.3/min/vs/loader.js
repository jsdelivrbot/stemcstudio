  ...
  !function(e) {
    ...
    var r = function() {
      ...
      return r.prototype._createIgnoreDuplicateModulesMap = function() {
        ...
        for (var r,
            n = 0,
            o = this.sortedPathsRules.length; n < o; n++)
        ...
        if (e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n))
          e.Utilities.endsWith(n, ".js") || e.Utilities.containsQueryString(n) || (n += ".js"), r = [n];
        else {
          r = this._applyPaths(n);
          for (var o = 0,
              i = r.length; o < i; o++)
            this.isBuild() && "empty:" === r[o] || (e.Utilities.isAbsolutePath(r[o]) || (r[o] = this.options.baseUrl + r[o]), e.Utilities.endsWith(r[o], ".js") || e.Utilities.containsQueryString(r[o]) || (r[o] = r[o] + ".js"));
        }
        ...
        o = function() {
          ...
          return t.prototype._init = function(e) {
            ...
            if (/^node\|/.test(n)) {
              ...
              n = e.Utilities.fileUriToFilePath(n), this._fs.readFile(n, {encoding: "utf8"}, function(a, c) {
                if (a)
                  return void i(a);
                ...
                var h,
                    g = "(function (require, define, __filename, __dirname) { ",
                    v = "\n});";
                if (h = c.charCodeAt(0) === t._BOM ? g + c.substring(1) + v : g + c + v, h = u(h, f), d.nodeCachedDataDir) {
                  ...
                  s._loadAndEvalScript(n, f, h, {filename: f}, l), o();
              });
  ...
  !function(e) {
    ...
    var s = function() {
      ...
      return s._findRelevantLocationInStack = function(e, t) {
        ...
        for (var r = this._createLoadError(e, t),
            n = [],
            o = 0,
            i = this._moduleIdProvider.getMaxModuleId(); o < i; o++)
          n[o] = !1;
        var s = !1,
            d = [];
          ...
          var i = -1,
              s = function(n) {
                if (i++, i >= o.length)
                  ...
                  var d = o[i],
                      a = r.getRecorder();
                  if (r._config.isBuild() && "empty:" === d)
                    return r._buildInfoPath[t] = d, r.defineModule(r._moduleIdProvider.getStrModuleId(t), [], null, null, null), void r._onLoad(t);
        ...
        if (!e.isComplete()) {
          ...
          if (p) {
            ...
            for (var s = 0,
                d = p.length; s < d; s++)
              this._loadPluginDependency(e.exports, p[s]);
          }
        }
      }, s;
    }();
    ...
    var i = function() {
      function t() {
        ...
        if ((2 === arguments.length || 3 === arguments.length) && Array.isArray(arguments[0]))
          return void r.defineModule(e.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
