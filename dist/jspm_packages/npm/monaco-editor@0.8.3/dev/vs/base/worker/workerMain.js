...
(function(Buffer, process) {
  (function() {
    ...
    (function(AMDLoader) {
      ...
      var Configuration = (function() {
        ...
        Configuration.prototype._createNodeModulesMap = function() {
          ...
          for (var _i = 0,
              _a = this.options.nodeModules; _i < _a.length; _i++) {
        ...
        Configuration.prototype._applyPaths = function(moduleId) {
          var pathRule;
          for (var i = 0,
              len = this.sortedPathsRules.length; i < len; i++) {
            pathRule = this.sortedPathsRules[i];
            if (AMDLoader.Utilities.startsWith(moduleId, pathRule.from)) {
              var result = [];
              for (var j = 0,
                  lenJ = pathRule.to.length; j < lenJ; j++) {
    ...
    (function(AMDLoader) {
      var OnlyOnceScriptLoader = (function() {
        ...
        OnlyOnceScriptLoader.prototype.load = function(moduleManager, scriptSrc, callback, errorback) {
          ...
          this.actualScriptLoader.load(moduleManager, scriptSrc, function() {
      ...
      AMDLoader.scriptLoader = new OnlyOnceScriptLoader(AMDLoader.isWebWorker ? new WorkerScriptLoader() : AMDLoader.isNode ? new NodeScriptLoader() : new BrowserScriptLoader());
    })(AMDLoader || (AMDLoader = {}));
    var AMDLoader;
    (function(AMDLoader) {
      ...
      var ModuleManager = (function() {
        ...
        ModuleManager.prototype.getBuildInfo = function() {
          ...
          var result = [],
              resultLen = 0;
          for (var i = 0,
              len = this._modules2.length; i < len; i++) {
        ...
        ModuleManager.prototype._normalizeDependencies = function(dependencies, moduleIdResolver) {
          var result = [],
              resultLen = 0;
          for (var i = 0,
              len = dependencies.length; i < len; i++) {
        ...
        ModuleManager.prototype._onLoadError = function(moduleId, err) {
          ...
          var seenModuleId = [];
          for (var i = 0,
              len = this._moduleIdProvider.getMaxModuleId(); i < len; i++) {
          ...
          while (queue.length > 0) {
            ...
            if (inverseDeps) {
              for (var i = 0,
                  len = inverseDeps.length; i < len; i++) {
        ...
        ModuleManager.prototype._onModuleComplete = function(module) {
          ...
          if (inversePluginDeps) {
            ...
            for (var i = 0,
                len = inversePluginDeps.length; i < len; i++) {
    ...
    define(__m[11], __M([1, 0, 22]), function(require, exports, diffChange_1) {
      'use strict';
    ...
    define(__m[18], __M([1, 0]), function(require, exports) {
      ...
      var STRING = createMapping(function(TO_STRING_MAP) {
        TO_STRING_MAP[0] = 'unknown';
        TO_STRING_MAP[1] = 'Backspace';
        TO_STRING_MAP[2] = 'Tab';
        TO_STRING_MAP[3] = 'Enter';
        TO_STRING_MAP[4] = 'Shift';
        TO_STRING_MAP[5] = 'Ctrl';
        TO_STRING_MAP[6] = 'Alt';
        TO_STRING_MAP[7] = 'PauseBreak';
        TO_STRING_MAP[8] = 'CapsLock';
        TO_STRING_MAP[9] = 'Escape';
        TO_STRING_MAP[10] = 'Space';
        TO_STRING_MAP[11] = 'PageUp';
        TO_STRING_MAP[12] = 'PageDown';
        TO_STRING_MAP[13] = 'End';
        TO_STRING_MAP[14] = 'Home';
        TO_STRING_MAP[15] = 'LeftArrow';
        TO_STRING_MAP[16] = 'UpArrow';
        TO_STRING_MAP[17] = 'RightArrow';
        TO_STRING_MAP[18] = 'DownArrow';
        TO_STRING_MAP[19] = 'Insert';
        TO_STRING_MAP[20] = 'Delete';
        TO_STRING_MAP[21] = '0';
        TO_STRING_MAP[22] = '1';
        TO_STRING_MAP[23] = '2';
        TO_STRING_MAP[24] = '3';
        ...
        TO_STRING_MAP[66] = 'F8';
        TO_STRING_MAP[67] = 'F9';
        TO_STRING_MAP[68] = 'F10';
        TO_STRING_MAP[69] = 'F11';
        TO_STRING_MAP[70] = 'F12';
        TO_STRING_MAP[71] = 'F13';
        TO_STRING_MAP[72] = 'F14';
        TO_STRING_MAP[73] = 'F15';
        TO_STRING_MAP[74] = 'F16';
        TO_STRING_MAP[75] = 'F17';
        TO_STRING_MAP[76] = 'F18';
        TO_STRING_MAP[77] = 'F19';
        TO_STRING_MAP[78] = 'NumLock';
        TO_STRING_MAP[79] = 'ScrollLock';
        TO_STRING_MAP[80] = ';';
        TO_STRING_MAP[81] = '=';
        TO_STRING_MAP[82] = ',';
        TO_STRING_MAP[83] = '-';
        ...
        TO_STRING_MAP[89] = ']';
        TO_STRING_MAP[90] = '\'';
        TO_STRING_MAP[91] = 'OEM_8';
        TO_STRING_MAP[92] = 'OEM_102';
        TO_STRING_MAP[93] = 'NumPad0';
        TO_STRING_MAP[94] = 'NumPad1';
        TO_STRING_MAP[95] = 'NumPad2';
        TO_STRING_MAP[96] = 'NumPad3';
        TO_STRING_MAP[97] = 'NumPad4';
        TO_STRING_MAP[98] = 'NumPad5';
        TO_STRING_MAP[99] = 'NumPad6';
        TO_STRING_MAP[100] = 'NumPad7';
        TO_STRING_MAP[101] = 'NumPad8';
        TO_STRING_MAP[102] = 'NumPad9';
        TO_STRING_MAP[103] = 'NumPad_Multiply';
        TO_STRING_MAP[104] = 'NumPad_Add';
        TO_STRING_MAP[105] = 'NumPad_Separator';
        TO_STRING_MAP[106] = 'NumPad_Subtract';
        TO_STRING_MAP[107] = 'NumPad_Decimal';
        TO_STRING_MAP[108] = 'NumPad_Divide';
      }, function(FROM_STRING_MAP) {
        FROM_STRING_MAP['\r'] = 3;
      });
      exports.USER_SETTINGS = createMapping(function(TO_USER_SETTINGS_MAP) {
        for (var i = 0,
            len = STRING._fromKeyCode.length; i < len; i++) {
          TO_USER_SETTINGS_MAP[i] = STRING._fromKeyCode[i];
        }
        TO_USER_SETTINGS_MAP[15] = 'Left';
        TO_USER_SETTINGS_MAP[16] = 'Up';
        TO_USER_SETTINGS_MAP[17] = 'Right';
        TO_USER_SETTINGS_MAP[18] = 'Down';
      }, function(FROM_USER_SETTINGS_MAP) {
        FROM_USER_SETTINGS_MAP['OEM_1'] = 80;
        FROM_USER_SETTINGS_MAP['OEM_PLUS'] = 81;
        FROM_USER_SETTINGS_MAP['OEM_COMMA'] = 82;
        FROM_USER_SETTINGS_MAP['OEM_MINUS'] = 83;
        FROM_USER_SETTINGS_MAP['OEM_PERIOD'] = 84;
        FROM_USER_SETTINGS_MAP['OEM_2'] = 85;
        FROM_USER_SETTINGS_MAP['OEM_3'] = 86;
        FROM_USER_SETTINGS_MAP['OEM_4'] = 87;
        FROM_USER_SETTINGS_MAP['OEM_5'] = 88;
        FROM_USER_SETTINGS_MAP['OEM_6'] = 89;
        FROM_USER_SETTINGS_MAP['OEM_7'] = 90;
        FROM_USER_SETTINGS_MAP['OEM_8'] = 91;
        FROM_USER_SETTINGS_MAP['OEM_102'] = 92;
      });
      var KeyCodeUtils;
    ...
    define(__m[9], __M([1, 0]), function(require, exports) {
      'use strict';
      exports.empty = Object.freeze({dispose: function() {}});
    ...
    define(__m[13], __M([1, 0]), function(require, exports) {
      ...
      var TrieMap = (function() {
        ...
        TrieMap.prototype.findSubstr = function(path) {
          ...
          var children = this._root.children;
          for (var _i = 0,
              parts_2 = parts; _i < parts_2.length; _i++) {
            var part = parts_2[_i];
        ...
        TrieMap.prototype.findSuperstr = function(path) {
          ...
          var node;
          for (var _i = 0,
              parts_3 = parts; _i < parts_3.length; _i++) {
            var part = parts_3[_i];
            node = children[part];
            if (!node) {
              return;
    ...
    define(__m[15], __M([1, 0, 13]), function(require, exports, map_1) {
      'use strict';
      exports.empty = '';
      ...
      var normalizedCache = new map_1.BoundedLinkedMap(10000);
    ...
    define(__m[4], __M([1, 0, 3, 16]), function(require, exports, platform, types) {
      'use strict';
    ...
    define(__m[19], __M([1, 0, 4]), function(require, exports, errors_1) {
      'use strict';
      var CallbackList = (function() {
        ...
        CallbackList.prototype.remove = function(callback, context) {
          ...
          for (var i = 0,
              len = this._callbacks.length; i < len; i++) {
        ...
        CallbackList.prototype.entries = function() {
          ...
          return this._callbacks.map(function(fn, index) {
            return [fn, _this._contexts[index]];
          });
        };
    ...
    define(__m[5], __M([1, 0, 9, 19, 14]), function(require, exports, lifecycle_1, callbackList_1, functional_1) {
      'use strict';
      var Event;
      (function(Event) {
      ...
      function delayed(promise) {
        ...
        var emitter = new Emitter({
          onFirstListenerAdd: function() {
            toCancel = promise.then(function(event) {
              return listener = event(function(e) {
                return emitter.fire(e);
              });
            }, function() {
              return null;
      ...
      function any() {
        ...
        var emitter = new Emitter({
          onFirstListenerAdd: function() {
            listeners = events.map(function(e) {
              return e(function(r) {
                return emitter.fire(r);
              });
            });
          },
          onLastListenerRemove: function() {
    ...
    define(__m[12], __M([1, 0, 5]), function(require, exports, event_1) {
      'use strict';
    ...
    define(__m[10], __M([1, 0, 3]), function(require, exports, platform) {
      'use strict';
      function _encode(ch) {
      ...
      var URI = (function() {
        ...
        URI._asFormatted = function(uri, skipEncoding) {
          ...
          if (path) {
            ...
            if (m) {
              if (m[1]) {
                path = '/' + m[2].toLowerCase() + path.substr(3);
              } else {
                path = m[2].toLowerCase() + path.substr(2);
              }
            }
            var lastIdx = 0;
            while (true) {
    ...
    (function() {
        ...
        (function() {
          ...
          function createNamespace(parentNamespace, name) {
            ...
            if (name) {
              ...
              for (var i = 0,
                  len = namespaceFragments.length; i < len; i++) {
      ...
      _winjs("WinJS/Core/_ErrorFromName", ["WinJS/Core/_Base"], function errorsInit(_Base) {
        ...
        _Base.Namespace.define("WinJS", {ErrorFromName: ErrorFromName});
      ...
      _winjs("WinJS/Core/_Events", ["exports", "WinJS/Core/_Base"], function eventsInit(exports, _Base) {
        ...
        var eventMixin = {
          ...
          addEventListener: function(type, listener, useCapture) {
            ...
            for (var i = 0,
                len = eventListeners.length; i < len; i++) {
          ...
          dispatchEvent: function(type, details) {
            ...
            if (listeners) {
              ...
              for (var i = 0,
                  len = listeners.length; i < len && !eventValue._stopImmediatePropagationCalled; i++) {
      ...
      _winjs("WinJS/Promise", ["WinJS/Core/_Base", "WinJS/Promise/_StateMachine"], function promiseInit(_Base, _StateMachine) {
        "use strict";
        _Base.Namespace.define("WinJS", {Promise: _StateMachine.Promise});
    ...
    define(__m[2], __M([33, 4]), function(winjs, __Errors__) {
      'use strict';
    ...
    define(__m[17], __M([1, 0, 4, 3, 2, 12, 9, 5]), function(require, exports, errors, platform, winjs_base_1, cancellation_1, lifecycle_1, event_1) {
      'use strict';
        ...
        PeriodThrottledDelayer.prototype.trigger = function(promiseFactory, delay) {
          ...
          return _super.prototype.trigger.call(this, function() {
            return _this.periodThrottler.queue(function() {
              return winjs_base_1.Promise.join([winjs_base_1.TPromise.timeout(_this.minimumPeriod), promiseFactory()]).then(function(r) {
                return r[1];
              });
            });
          }, delay);
    ...
    define(__m[31], __M([1, 0, 4, 9, 2, 17, 3]), function(require, exports, errors_1, lifecycle_1, winjs_base_1, async_1, platform_1) {
      'use strict';
    ...
    define(__m[6], __M([1, 0, 7]), function(require, exports, position_1) {
      'use strict';
      var Range = (function() {
    ...
    define(__m[20], __M([1, 0, 6]), function(require, exports, range_1) {
      'use strict';
    ...
    define(__m[23], __M([1, 0, 8]), function(require, exports, uint_1) {
      'use strict';
    ...
    define(__m[24], __M([1, 0, 11, 15]), function(require, exports, diff_1, strings) {
      'use strict';
      ...
      var LineChange = (function() {
        function LineChange(diffChange, originalLineSequence, modifiedLineSequence, continueProcessingPredicate, shouldPostProcessCharChanges) {
          ...
          if (diffChange.originalLength !== 0 && diffChange.modifiedLength !== 0 && continueProcessingPredicate()) {
            ...
            this.charChanges = [];
            for (var i = 0,
                length = rawChanges.length; i < length; i++) {
    ...
    define(__m[26], __M([1, 0, 23, 8]), function(require, exports, characterClassifier_1, uint_1) {
      'use strict';
      var State;
      (function(State) {
      ...
      var StateMachine = (function() {
        function StateMachine(edges) {
          ...
          maxCharCode++;
          maxState++;
          var states = new uint_1.Uint8Matrix(maxState, maxCharCode, 0);
          for (var i = 0,
              len = edges.length; i < len; i++) {
            var _b = edges[i],
                from = _b[0],
      ...
      var LinkComputer = (function() {
        ...
        LinkComputer.computeLinks = function(model) {
          ...
          var result = [];
          for (var i = 1,
              lineCount = model.getLineCount(); i <= lineCount; i++) {
    ...
    define(__m[27], __M([1, 0]), function(require, exports) {
      ...
      var BasicInplaceReplace = (function() {
        ...
        BasicInplaceReplace.prototype.valueSetsReplace = function(valueSets, value, up) {
          var result = null;
          for (var i = 0,
              len = valueSets.length; result === null && i < len; i++) {
    ...
    define(__m[28], __M([1, 0, 5, 18, 7, 6, 20, 2, 12, 21, 10]), function(require, exports, event_1, keyCodes_1, position_1, range_1, selection_1, winjs_base_1, cancellation_1, token_1, uri_1) {
      'use strict';
      var Severity;
      (function(Severity) {
    ...
    define(__m[29], __M([1, 0, 8]), function(require, exports, uint_1) {
      'use strict';
    ...
    define(__m[30], __M([1, 0, 29]), function(require, exports, prefixSumComputer_1) {
      'use strict';
    ...
    define(__m[32], __M([1, 0, 10, 2, 6, 24, 11, 7, 30, 26, 27, 25, 28]), function(require, exports, uri_1, winjs_base_1, range_1, diffComputer_1, diff_1, position_1, mirrorModel2_1, linkComputer_1, inplaceReplaceSupport_1, wordHelper_1, standaloneBase_1) {
      'use strict';
      ...
      var BaseEditorSimpleWorker = (function() {
        ...
        BaseEditorSimpleWorker.prototype.computeMoreMinimalEdits = function(modelUrl, edits, ranges) {
          ...
          var result = [];
          for (var _i = 0,
              edits_1 = edits; _i < edits_1.length; _i++) {
            var _a = edits_1[_i],
                range = _a.range,
                text = _a.text;
            ...
            for (var _b = 0,
                changes_1 = changes; _b < changes_1.length; _b++) {
        ...
        BaseEditorSimpleWorker.prototype.textualSuggest = function(modelUrl, position, wordDef, wordDefFlags) {
          ...
          if (model) {
            ...
            for (var _i = 0,
                _a = model.getAllUniqueWords(wordDefRegExp); _i < _a.length; _i++) {
              var word = _a[_i];
        ...
        BaseEditorSimpleWorker.prototype.loadForeignModule = function(moduleId, createData) {
          ...
          return new winjs_base_1.TPromise(function(c, e) {
            self.require([moduleId], function(foreignModule) {
              var ctx = {getMirrorModels: function() {
