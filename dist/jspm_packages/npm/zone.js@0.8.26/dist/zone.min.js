...
(function(process) {
  !function(e, t) {
      ...
      for (var r = e.constructor.name,
          a = function(a) {
            ...
            if (s) {
              ...
              e[i] = function(e) {
                var t = function() {
                  return e.apply(this, n(arguments, r + "." + i));
                };
                return l(t, e), t;
              }(s);
            }
    ...
    function o(e) {
      return !e || e.writable !== !1 && !("function" == typeof e.get && "undefined" == typeof e.set);
    }
    function a(e, t, n) {
      var r = P(e, t);
      if (!r && n) {
      ...
      if (r && r.configurable) {
        ...
        var a = r.get,
            ...
            s = t.substr(2),
            c = Q[s];
        c || (c = Q[s] = B("ON_PROPERTY" + s)), r.set = function(t) {
          var n = this;
          if (n || e !== X || (n = X), n) {
            var r = n[c];
            r && n.removeEventListener(s, $), i && i.apply(n, U), "function" == typeof t ? (n[c] = t, n.addEventListener(s, $, !1)) : n[c] = null;
          }
        }, r.get = function() {
          var n = this;
          if (n || e !== X || (n = X), !n)
          ...
          if (a) {
            var i = a && a.call(this);
            if (i)
              return r.set.call(this, i), "function" == typeof n[G] && n.removeAttribute(t), i;
          }
          return null;
        }, j(e, t, r);
      }
      ...
      if (r) {
        X[B(t)] = r, X[t] = function() {
          ...
          switch (e.length) {
            ...
            case 1:
              ...
              break;
            case 2:
              this[ee] = new r(e[0], e[1]);
              break;
            case 3:
              this[ee] = new r(e[0], e[1], e[2]);
              break;
            case 4:
              this[ee] = new r(e[0], e[1], e[2], e[3]);
              break;
            default:
        ...
        for (o in a)
          "XMLHttpRequest" === t && "responseBlob" === o || !function(n) {
            "function" == typeof a[n] ? X[t].prototype[n] = function() {
              return this[ee][n].apply(this[ee], arguments);
            } : j(X[t].prototype, n, {
              set: function(r) {
                "function" == typeof r ? (this[ee][n] = e(r, t + "." + n), l(this[ee][n], r)) : this[ee][n] = r;
              },
              get: function() {
                return this[ee][n];
              }
        ...
        for (o in r)
          "prototype" !== o && r.hasOwnProperty(o) && (X[t][o] = r[o]);
      }
    }
    function c(e, t, n) {
    ...
    function u(e, n, r) {
      ...
      a = c(e, n, function(e) {
        return function(n, a) {
          var i = r(n, a);
          return i.cbIdx >= 0 && "function" == typeof a[i.cbIdx] ? t(i.name, a[i.cbIdx], i, o, null) : e.apply(n, a);
        };
      });
    }
    function l(e, t) {
      e[B("OriginalDelegate")] = t;
    }
    function f() {
      if (te)
        return ne;
      ...
      try {
        ...
        return e.indexOf("MSIE ") === -1 && e.indexOf("Trident/") === -1 && e.indexOf("Edge/") === -1 || (ne = !0), ne;
      } catch (t) {}
    }
    function p(e, t, n) {
      function r(t, n) {
        ...
        for (var k = t; k && !k.hasOwnProperty(o); )
          k = C(k);
        if (!k && t[o] && (k = t), !k)
          return !1;
        if (k[c])
        ...
        var _,
            ...
            E = k[B(i)] = k[i],
            S = k[B(s)] = k[s];
        n && n.prepend && (_ = k[B(n.prepend)] = k[n.prepend]);
        var D = function() {
          if (!b.isExisting)
            return T.call(b.target, b.eventName, b.capture ? g : v, b.options);
        },
            Z = function(e) {
              if (!e.isRemoved) {
                var t = oe[e.eventName],
                    n = void 0;
                t && (n = t[e.capture ? F : q]);
                var r = n && e.target[n];
                if (r)
              ...
              if (e.allRemoved)
                return w.call(e.target, e.eventName, e.capture ? g : v, e.options);
            },
            z = function(e) {
            ...
            H = function(t, n, o, a, i, s) {
              return void 0 === i && (i = !1), void 0 === s && (s = !1), function() {
                ...
                if (!d || d(t, u, c, arguments)) {
                  ...
                  var v,
                      g = !1;
                  void 0 === p ? v = !1 : p === !0 ? v = !0 : p === !1 ? v = !1 : (v = !!p && !!p.capture, g = !!p && !!p.once);
                  var m,
                      k = Zone.current,
                      _ = oe[f];
                  if (_)
                    ...
                    var T = f + q,
                        ...
                        E = A + T,
                        S = A + w;
                    oe[f] = {}, oe[f][q] = E, oe[f][F] = S, m = v ? S : E;
                  }
                  var D = c[m],
                      Z = !1;
                  if (D) {
                  ...
                  var z,
                      ...
                      P = ae[O];
                  P && (z = P[f]), z || (z = O + n + f), b.options = p, g && (b.options.once = !1), b.target = c, b.capture = v, b.eventName = f, b.isExisting = Z;
                  var j = r ? re : null;
                  j && (j.taskData = b);
                  var C = k.scheduleEventTask(z, u, j, o, a);
                  return b.target = null, j && (j.taskData = null), g && (p.once = !0), C.options = p, C.target = c, C.capture = v, C.eventName = f, l && (C.originalDelegate = u), s ? D.unshift(C) : D.push(C), i ? c : void 0;
                }
              };
            };
        return k[o] = H(T, u, j, I, m), _ && (k[f] = H(_, p, O, I, m, !0)), k[a] = function() {
          var t,
              n = this || e,
              r = arguments[0],
              o = arguments[2];
          ...
          if (!d || d(w, a, n, arguments)) {
            ...
            if (c)
              for (var u = 0; u < c.length; u++) {
                var l = c[u];
                if (M(l, a)) {
                  if (c.splice(u, 1), l.isRemoved = !0, 0 === c.length && (l.allRemoved = !0, n[i] = null), l.zone.cancelTask(l), m)
                    return n;
                  return;
                }
              }
            ...
            if (r) {
              ...
              if (c)
                for (var l = c.slice(),
                  ...
                  this[a].call(this, n, h, p.options);
                }
              if (u)
                for (var l = u.slice(),
                    f = 0; f < l.length; f++) {
          ...
          if (m)
            return this;
        }, l(k[o], T), l(k[a], w), S && l(k[s], S), E && l(k[i], E), !0;
      }
      for (var o = n && n.add || M,
          a = n && n.rm || R,
    ...
    function v(e, n, r, o) {
      function a(t) {
        function n() {
          try {
            ...
            t.data && t.data.isPeriodic || ("number" == typeof r.handleId ? delete l[r.handleId] : r.handleId && (r.handleId[ce] = null));
          }
        }
        var r = t.data;
      ...
      s = c(e, n, function(r) {
        return function(s, c) {
          if ("function" == typeof c[0]) {
            var u = {
              ...
              delay: "Timeout" === o || "Interval" === o ? c[1] || 0 : null,
              args: c
            },
                f = t(n, c[0], u, a, i);
            if (!f)
            ...
            return "number" == typeof p ? l[p] = f : p && (p[ce] = f), p && p.ref && p.unref && "function" == typeof p.ref && "function" == typeof p.unref && (f.ref = p.ref.bind(p), f.unref = p.unref.bind(p)), "number" == typeof p || p ? p : f;
          }
          return r.apply(e, c);
        };
      }), u = c(e, r, function(t) {
        return function(n, r) {
          var o,
              a = r[0];
          "number" == typeof a ? o = l[a] : (o = a && a[ce], o || (o = a)), o && "string" == typeof o.type ? "notScheduled" !== o.state && (o.cancelFn && o.data.isPeriodic || 0 === o.runCount) && ("number" == typeof a ? delete l[a] : a && (a[ce] = null), o.zone.cancelTask(o)) : t.apply(e, r);
        };
      });
    }
    function g() {
      Object.defineProperty = function(e, t, n) {
        ...
        return "prototype" !== t && (n = k(e, t, n)), _(e, t, n, r);
    ...
    function y(e, t, n) {
      var r = n.configurable;
      return n = k(e, t, n), _(e, t, n, r);
    }
    function m(e, t) {
      return e && e[pe] && e[pe][t];
    }
    function k(e, t, n) {
      return Object.isFrozen(n) || (n.configurable = !0), n.configurable || (e[pe] || Object.isFrozen(e) || ue(e, pe, {
        writable: !0,
        value: {}
      }), e[pe] && (e[pe][t] = !0)), n;
    }
    ...
    function b(e, t) {
      var n = t.WebSocket;
      t.EventTarget || p(t, [n.prototype]), t.WebSocket = function(e, t) {
        var r,
            o,
            a = arguments.length > 1 ? new n(e, t) : new n(e),
            s = P(a, "onmessage");
        return s && s.configurable === !1 ? (r = I(a), o = a, [M, R, "send", "close"].forEach(function(e) {
          r[e] = function() {
    ...
    function E(e, t) {
      if (!K || Y) {
        ...
        if (S()) {
          ...
          if (J) {
            var o = window;
            w(o, Oe.concat(["messageerror"]), r, C(o)), w(Document.prototype, Oe, r), "undefined" != typeof o.SVGElement && w(o.SVGElement.prototype, Oe, r), w(Element.prototype, Oe, r), w(HTMLElement.prototype, Oe, r), w(HTMLMediaElement.prototype, ye, r), w(HTMLFrameSetElement.prototype, ve.concat(we), r), w(HTMLBodyElement.prototype, ve.concat(we), r), w(HTMLFrameElement.prototype, Te, r), w(HTMLIFrameElement.prototype, Te, r);
            var a = o.HTMLMarqueeElement;
            a && w(a.prototype, Ee, r);
            var i = o.Worker;
            i && w(i.prototype, ze, r);
          }
          w(XMLHttpRequest.prototype, Se, r);
          var c = t.XMLHttpRequestEventTarget;
          c && w(c && c.prototype, Se, r), "undefined" != typeof IDBIndex && (w(IDBIndex.prototype, De, r), w(IDBRequest.prototype, De, r), w(IDBOpenDBRequest.prototype, De, r), w(IDBDatabase.prototype, De, r), w(IDBTransaction.prototype, De, r), w(IDBCursor.prototype, De, r)), n && w(WebSocket.prototype, Ze, r);
        } else
          D(), s("XMLHttpRequest"), n && b(e, t);
      }
    }
    function S() {
      if ((J || Y) && !P(HTMLElement.prototype, "onclick") && "undefined" != typeof Element) {
      ...
      var a = o[i] === s;
      return o.onreadystatechange = null, a;
    }
    function D() {
      for (var t = function(t) {
        ...
        self.addEventListener(n, function(t) {
          var n,
              o,
              a = t.target;
          for (o = a ? a.constructor.name + "." + r : "unknown." + r; a; )
            a[r] && !a[r][Pe] && (n = e(a[r], o), n[Pe] = a[r], a[r] = n), a = a.parentElement;
        }, !0);
      },
          n = 0; n < Oe.length; n++)
        t(n);
    ...
    function Z(e, t) {
      ...
      for (var S = function(e, t, n, r) {
        ...
        return !0;
          ...
          g = 0; g < a.length; g++) {
        var Z = e[a[g]];
        D.push(Z && Z.prototype);
      }
      return p(e, D, {vh: S}), t.patchEventTarget = p, !0;
    }
    function z(e, t) {
      d(e, t);
    }
    function O(t) {
      if ((J || Y) && "registerElement" in t.document) {
        ...
        document.registerElement = function(t, o) {
          return o && o.prototype && r.forEach(function(t) {
            ...
            if (r.hasOwnProperty(t)) {
              var a = P(r, t);
              a && a.value ? (a.value = e(a.value, n), y(o.prototype, t, a)) : r[t] = e(r[t], n);
            } else
              r[t] && (r[t] = e(r[t], n));
          }), n.call(document, t, o);
        }, l(document.registerElement, n);
      }
    }
    (function(e) {
      function t(e) {
      ...
      function r(t) {
        0 === I && 0 === y.length && (u || e[v] && (u = e[v].resolve(0)), u ? u[g](o) : e[d](o, 0)), t && y.push(t);
      }
      function o() {
        if (!m) {
          for (m = !0; y.length; ) {
      ...
      var u,
            ...
            return r.assertZonePatched = function() {
              ...
              if (!r || e.type !== z) {
                ...
                try {
                  ...
                  e.state !== _ && e.state !== S && (e.type == z || e.data && e.data.isPeriodic ? o && e._transitionTo(T, w) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(_, w, _))), j = j.parent, C = a;
                }
              }
              ...
              try {
                ...
                throw e._transitionTo(S, b, _), this._zoneDelegate.handleError(this, r), r;
              }
          ...
          p = function() {
            function e(e, t, n) {
              ...
              var r = n && n.onHasTask,
                  o = t && t._hasTaskZS;
              (r || o) && (this._hasTaskZS = r ? n : f, this._hasTaskDlgt = t, this._hasTaskDlgtOwner = this, this._hasTaskCurrZone = e, n.onScheduleTask || (this._scheduleTaskZS = f, this._scheduleTaskDlgt = t, this._scheduleTaskCurrZone = this.zone), n.onInvokeTask || (this._invokeTaskZS = f, this._invokeTaskDlgt = t, this._invokeTaskCurrZone = this.zone), n.onCancelTask || (this._cancelTaskZS = f, this._cancelTaskDlgt = t, this._cancelTaskCurrZone = this.zone));
            }
            return e.prototype.fork = function(e, t) {
              return this._forkZS ? this._forkZS.onFork(this._forkDlgt, this.zone, e, t) : new l(e, t);
          ...
          P = {
            ...
            showUncaughtError: function() {
              return !l[i("ignoreConsoleErrorUncaughtError")];
            },
            ...
            setNativePromise: function(e) {
              e && typeof e.resolve === s && (u = e.resolve(0));
            }
          },
          j = {
            parent: null,
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function u(e, o, a) {
        ...
        if (e[T] === z) {
          var s = null;
          try {
            "object" != typeof a && "function" != typeof a || (s = a && a.then);
          } catch (p) {
            return i(function() {
              u(e, !1, p);
            })(), e;
          }
          if (o !== P && a instanceof H && a.hasOwnProperty(T) && a.hasOwnProperty(w) && a[T] !== z)
            l(a), u(e, a[T], a[w]);
          else if (o !== P && "function" == typeof s)
            try {
              s.call(a, i(c(e, o)), i(c(e, !1)));
            } catch (p) {
              i(function() {
                u(e, !1, p);
              })();
            ...
            e[T] = o;
            var h = e[w];
            if (e[w] = a, e[E] === E && o === O && (e[T] = e[D], e[w] = e[S]), o === P && a instanceof Error) {
              var d = t.currentTask && t.currentTask.data && t.currentTask.data[_];
              d && v(a, L, {
                configurable: !0,
                enumerable: !1,
                writable: !0,
            ...
            if (0 == h.length && o == P) {
              ...
              try {
                ...
                var m = p;
                m.rejection = a, m.promise = e, m.zone = t.current, m.task = t.currentTask, y.push(m), n.scheduleMicroTask();
              }
            }
          }
        }
      ...
      function l(e) {
        if (e[T] === j) {
          ...
          for (var o = 0; o < y.length; o++)
            e === y[o].promise && y.splice(o, 1);
        }
      }
      function f(e, t, n, r, o) {
        l(e);
        var a = e[T],
            c = a ? "function" == typeof r ? r : i : "function" == typeof o ? o : s;
        t.scheduleMicroTask(Z, function() {
          try {
            var r = e[w],
                o = n && E === n[E];
            o && (n[S] = r, n[D] = a);
            var l = t.run(c, void 0, o && c !== s && c !== i ? [] : [r]);
            u(n, !0, l);
          } catch (f) {
            u(n, !1, f);
          }
      ...
      function p(e) {
        var t = e.prototype,
            n = d(t, "then");
        if (!n || n.writable !== !1 && n.configurable) {
          var r = t.then;
          t[k] = r, e.prototype.then = function(e, t) {
            var n = this,
      ...
      var b = g("unhandledPromiseRejectionHandler"),
          T = g("state"),
          w = g("value"),
          E = g("finally"),
          S = g("parentPromiseValue"),
          D = g("parentPromiseState"),
          Z = "Promise.then",
          z = null,
          O = !0,
          P = !1,
          ...
          L = g("currentTaskTrace"),
          M = g("rejectionHandledHandler"),
          R = "function ZoneAwarePromise() { [native code] }",
          H = function() {
            function e(t) {
              var n = this;
              if (!(n instanceof e))
            ...
            return e.toString = function() {
              ...
              return u(new this(null), O, e);
            }, e.reject = function(e) {
              return u(new this(null), P, e);
            }, e.race = function(e) {
              function t(e) {
                i && (i = r(e));
              }
              ...
              var r = new this.constructor(null),
                  o = t.current;
              return this[T] == z ? this[w].push(o, r, e, n) : f(this, o, r, e, n), r;
              ...
              n[E] = E;
              var r = t.current;
              return this[T] == z ? this[w].push(r, n, e, e) : f(this, r, n, e, e), n;
            }, e;
          }();
      ...
      var x = e[m] = e.Promise,
          ...
          q = d(e, "Promise");
      q && !q.configurable || (q && delete q.writable, q && delete q.value, q || (q = {
        configurable: !0,
        enumerable: !0
      }), q.get = function() {
        return e[F] ? e[F] : e[m];
      }, q.set = function(t) {
        t === H ? e[F] = t : (e[m] = t, t.prototype[k] || p(t), n.setNativePromise(t));
      }, v(e, "Promise", q)), e.Promise = H;
      var A = g("thenPatched");
      if (x) {
        p(x);
        var B = e.fetch;
        "function" == typeof B && (e.fetch = h(B));
      }
      return Promise[t.__symbol__("uncaughtPromiseErrors")] = y, H;
    });
    var P = Object.getOwnPropertyDescriptor,
        ...
        W = N ? window : void 0,
        X = N && W || "object" == typeof self && self || global,
        G = "removeAttribute",
        U = [null],
        V = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
        K = !("nw" in X) && "undefined" != typeof X.process && "[object process]" === {}.toString.call(X.process),
        J = !K && !V && !(!N || !W.HTMLElement),
        Y = "undefined" != typeof X.process && "[object process]" === {}.toString.call(X.process) && !V && !(!N || !W.HTMLElement),
        Q = {},
        $ = function(e) {
          if (e = e || X.event) {
            var t = Q[e.type];
            t || (t = Q[e.type] = B("ON_PROPERTY" + e.type));
            var n = this || e.target || X,
                r = n[t],
                o = r && r.apply(this, arguments);
            return void 0 == o || o || e.preventDefault(), o;
          }
        },
        ee = B("originalInstance"),
        te = !1,
        ne = !1;
    Zone.__load_patch("toString", function(e) {
      var t = Function.prototype.toString,
          n = B("OriginalDelegate"),
          r = B("Promise"),
          o = B("Error"),
          a = function() {
            if ("function" == typeof this) {
              var a = this[n];
              if (a)
                return "function" == typeof a ? t.apply(this[n], arguments) : Object.prototype.toString.call(a);
              if (this === Promise) {
                var i = e[r];
                if (i)
      ...
      Object.prototype.toString = function() {
        return this instanceof Promise ? s : i.apply(this, arguments);
      };
    });
    var re = {useG: !0},
        oe = {},
        ae = {},
        ie = /^__zone_symbol__(\w+)(true|false)$/,
        se = "__zone_symbol__propagationStopped",
        ce = B("zoneTask"),
        ue = Object[B("defineProperty")] = Object.defineProperty,
        le = Object[B("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        fe = Object.create,
        pe = B("unconfigurables"),
        ...
        de = ["afterscriptexecute", "beforescriptexecute", "DOMContentLoaded", "fullscreenchange", "mozfullscreenchange", "webkitfullscreenchange", "msfullscreenchange", "fullscreenerror", "mozfullscreenerror", "webkitfullscreenerror", "msfullscreenerror", "readystatechange", "visibilitychange"],
        ve = ["absolutedeviceorientation", "afterinput", "afterprint", "appinstalled", "beforeinstallprompt", "beforeprint", "beforeunload", "devicelight", "devicemotion", "deviceorientation", "deviceorientationabsolute", "deviceproximity", "hashchange", "languagechange", "message", "mozbeforepaint", "offline", "online", "paint", "pageshow", "pagehide", "popstate", "rejectionhandled", "storage", "unhandledrejection", "unload", "userproximity", "vrdisplyconnected", "vrdisplaydisconnected", "vrdisplaypresentchange"],
        ...
        ye = ["encrypted", "waitingforkey", "msneedkey", "mozinterruptbegin", "mozinterruptend"],
        ...
        _e = ["autocomplete", "autocompleteerror"],
        be = ["toggle"],
        Te = ["load"],
        we = ["blur", "error", "focus", "load", "resize", "scroll", "messageerror"],
        Ee = ["bounce", "finish", "start"],
        Se = ["loadstart", "progress", "abort", "error", "load", "progress", "timeout", "loadend", "readystatechange"],
        De = ["upgradeneeded", "complete", "abort", "success", "error", "blocked", "versionchange", "close"],
        Ze = ["close", "error", "open", "message"],
        ze = ["error", "message"],
        Oe = he.concat(ke, _e, be, de, ve, ge, me),
        Pe = B("unbound");
    Zone.__load_patch("util", function(e, t, r) {
      r.patchOnProperties = i, r.patchMethod = c, r.bindArguments = n;
    }), Zone.__load_patch("timers", function(e) {
      var t = "set",
          n = "clear";
      v(e, t, n, "Timeout"), v(e, t, n, "Interval"), v(e, t, n, "Immediate");
      ...
      for (var n = ["alert", "prompt", "confirm"],
          r = 0; r < n.length; r++) {
        var o = n[r];
        c(e, o, function(n, r, o) {
          return function(r, a) {
      ...
      "undefined" != typeof t && t.prototype && t.prototype.toBlob && u(t.prototype, "toBlob", function(e, t) {
        return {
      ...
      function r(e) {
        ...
        function r(e) {
          ...
          var t = e.data,
              n = t.target,
              r = n[i];
          h || (h = n[H], d = n[x]), r && d.call(n, y, r);
          var a = n[i] = function() {
            n.readyState === n.DONE && !t.aborted && XMLHttpRequest[s] && e.state === m && e.invoke();
          };
          h.call(n, y, a);
          var c = n[o];
        ...
        var y = "readystatechange",
            ...
            k = c(p, "open", function() {
              return function(e, t) {
                return e[a] = 0 == t[2], e[u] = t[1], k.apply(e, t);
              };
            }),
      ...
      e.PromiseRejectionEvent && (t[B("unhandledPromiseRejectionHandler")] = n("unhandledrejection"), t[B("rejectionHandledHandler")] = n("rejectionhandled"));
    });
  });
})(require('process'));
