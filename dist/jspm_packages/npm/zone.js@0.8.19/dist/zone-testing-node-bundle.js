    ...
    Zone.__load_patch('ZoneAwarePromise', function(global, Zone, api) {
        ...
        if (promise[symbolState] === UNRESOLVED) {
          ...
          if (state !== REJECTED && value instanceof ZoneAwarePromise && value.hasOwnProperty(symbolState) && value.hasOwnProperty(symbolValue) && value[symbolState] !== UNRESOLVED) {
            ...
            if (state === REJECTED && value instanceof Error) {
              ...
              if (trace) {
                Object.defineProperty(value, CURRENT_TASK_TRACE_SYMBOL, {
                  configurable: true,
                  enumerable: false,
                  writable: true,
                  value: trace
      ...
      var ZoneAwarePromise = (function() {
        ...
        ZoneAwarePromise.race = function(values) {
          ...
          try {
            for (var values_1 = __values(values),
                values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
        ...
        ZoneAwarePromise.all = function(values) {
          ...
          var resolvedValues = [];
          try {
            for (var values_2 = __values(values),
                values_2_1 = values_2.next(); !values_2_1.done; values_2_1 = values_2.next()) {
