...
!function(global, factory) {
  ...
  var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
    ...
    for (var p in b)
      ...
      BrowserAnimationFactory = function(_super) {
        ...
        return __extends(AnimationRenderer, _super), AnimationRenderer.prototype.setProperty = function(el, name, value) {
          ...
          if ("@" == eventName.charAt(0)) {
            var element = resolveElementFromTarget(target),
                name_1 = eventName.substr(1),
                phase = "";
            return "@" != name_1.charAt(0) && (_a = parseTriggerCallbackName(name_1), name_1 = _a[0], phase = _a[1]), this.engine.listen(this.namespaceId, element, name_1, phase, function(event) {
      ...
      InjectableAnimationEngine = function(_super) {
        ...
        return __extends(InjectableAnimationEngine, _super), InjectableAnimationEngine.decorators = [{type: _angular_core.Injectable}], InjectableAnimationEngine.ctorParameters = function() {
      ...
      BrowserAnimationsModule = function() {
        ...
        return BrowserAnimationsModule.decorators = [{
      ...
      NoopAnimationsModule = function() {
        function NoopAnimationsModule() {}
        return NoopAnimationsModule.decorators = [{
          type: _angular_core.NgModule,
          args: [{
            exports: [_angular_platformBrowser.BrowserModule],
