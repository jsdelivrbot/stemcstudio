  ...
  !function(global, factory) {
    ...
    var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
      ...
      for (var p in b)
        ...
        VERSION = new _angular_core.Version("4.3.0"),
        TextAst = function() {
        ...
        Xliff = function(_super) {
          ...
          return __extends(Xliff, _super), Xliff.prototype.write = function(messages, locale) {
            ...
            messages.forEach(function(message) {
              ...
              (_a = transUnit.children).push.apply(_a, [new CR(8), new Tag(_SOURCE_TAG, {}, visitor.serialize(message.nodes)), new CR(8), new Tag(_TARGET_TAG)].concat(contextTags)), message.description && transUnit.children.push(new CR(8), new Tag("note", {
                priority: "1",
                from: "description"
