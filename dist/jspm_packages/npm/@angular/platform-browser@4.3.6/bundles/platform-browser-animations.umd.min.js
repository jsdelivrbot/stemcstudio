...
!function(global, factory) {
  ...
  function parseTriggerCallbackName(triggerName) {
    var dotIndex = triggerName.indexOf("."),
        trigger = triggerName.substring(0, dotIndex),
        phase = triggerName.substr(dotIndex + 1);
    return [trigger, phase];
  }
  function instantiateSupportedAnimationDriver() {
    return _angular_animations_browser.ɵsupportsWebAnimations() ? new _angular_animations_browser.ɵWebAnimationsDriver : new _angular_animations_browser.ɵNoopAnimationDriver;
  }
  ...
  var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
    ...
    for (var p in b)
      ...
      BrowserAnimationBuilder = function(_super) {
        function BrowserAnimationBuilder(rootRenderer, doc) {
          ...
          return _this._renderer = rootRenderer.createRenderer(doc.body, typeData), _this;
        }
        return __extends(BrowserAnimationBuilder, _super), BrowserAnimationBuilder.prototype.build = function(animation) {
          ...
          return issueAnimationCommand(this._renderer, null, id, "register", [entry]), new BrowserAnimationFactory(id, this._renderer);
        }, BrowserAnimationBuilder;
      }(_angular_animations.AnimationBuilder);
  BrowserAnimationBuilder.decorators = [{type: _angular_core.Injectable}], BrowserAnimationBuilder.ctorParameters = function() {
  ...
  var BrowserAnimationFactory = function(_super) {
    ...
    return __extends(BrowserAnimationFactory, _super), BrowserAnimationFactory.prototype.create = function(element, options) {
      ...
      AnimationRendererFactory = function() {
        function AnimationRendererFactory(delegate, engine, _zone) {
          this.delegate = delegate, this.engine = engine, this._zone = _zone, this._currentId = 0, this._microtaskId = 1, this._animationCallbacksBuffer = [], this._rendererCache = new Map, this._cdRecurDepth = 0, engine.onRemovalComplete = function(element, delegate) {
        ...
        return AnimationRendererFactory.prototype.createRenderer = function(hostElement, type) {
          ...
          if (!(hostElement && type && type.data && type.data.animation)) {
            ...
            return renderer || (renderer = new BaseAnimationRenderer(EMPTY_NAMESPACE_ID, delegate, this.engine), this._rendererCache.set(delegate, renderer)), renderer;
          }
          ...
          return animationTriggers.forEach(function(trigger) {
          ...
          var _this = this;
          return count >= 0 && count < this._microtaskId ? void this._zone.run(function() {
            return fn(data);
          ...
          }), void this._animationCallbacksBuffer.push([fn, data]));
  ...
  AnimationRendererFactory.decorators = [{type: _angular_core.Injectable}], AnimationRendererFactory.ctorParameters = function() {
  ...
  var BaseAnimationRenderer = function() {
    ...
    return Object.defineProperty(BaseAnimationRenderer.prototype, "data", {
      ...
      AnimationRenderer = function(_super) {
        ...
        return __extends(AnimationRenderer, _super), AnimationRenderer.prototype.setProperty = function(el, name, value) {
          name.charAt(0) == ANIMATION_PREFIX ? "." == name.charAt(1) && name == DISABLE_ANIMATIONS_FLAG ? (value = void 0 === value || !!value, this.disableAnimations(el, value)) : this.engine.process(this.namespaceId, el, name.substr(1), value) : this.delegate.setProperty(el, name, value);
          ...
          if (eventName.charAt(0) == ANIMATION_PREFIX) {
            var element = resolveElementFromTarget(target),
                ...
                phase = "";
            return name.charAt(0) != ANIMATION_PREFIX && (_a = parseTriggerCallbackName(name), name = _a[0], phase = _a[1]), this.engine.listen(this.namespaceId, element, name, phase, function(event) {
      ...
      InjectableAnimationEngine = function(_super) {
  ...
  InjectableAnimationEngine.decorators = [{type: _angular_core.Injectable}], InjectableAnimationEngine.ctorParameters = function() {
  ...
  var SHARED_ANIMATION_PROVIDERS = [{
    ...
    deps: [_angular_platformBrowser.ɵDomRendererFactory2, _angular_animations_browser.ɵAnimationEngine, _angular_core.NgZone]
      ...
      BrowserAnimationsModule = function() {
