...
(function(process) {
  (function(global, factory) {
    ...
    function match$1(segmentGroup, route, segments) {
      ...
      var parameters = Object.assign({}, posParams, res.consumed[res.consumed.length - 1].parameters);
      return {
        consumedSegments: res.consumed,
        lastChild: res.consumed.length,
    ...
    RouterLink.ctorParameters = function() {
      ...
      }, {type: _angular_core.Renderer}, {type: _angular_core.ElementRef}];
    };
    ...
    var VERSION = new _angular_core.Version('0.0.0-ROUTERPLACEHOLDER');
