...
(function(process) {
  !function(global, factory) {
    ...
    function inheritedParamsDataResolve(route) {
      for (var pathToRoot = route.pathFromRoot,
          inhertingStartingFrom = pathToRoot.length - 1; inhertingStartingFrom >= 1; ) {
        var current = pathToRoot[inhertingStartingFrom],
            parent = pathToRoot[inhertingStartingFrom - 1];
    ...
    function createNode(routeReuseStrategy, curr, prevState) {
      ...
      if (routeReuseStrategy.retrieve(curr.value)) {
        ...
        return setFutureSnapshotsOfActivatedRoutes(curr, tree_1), tree_1;
      }
    ...
    var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
      ...
      for (var p in b)
        ...
        GuardsCheckStart = function() {
          function GuardsCheckStart(id, url, urlAfterRedirects, state) {
            this.id = id, this.url = url, this.urlAfterRedirects = urlAfterRedirects, this.state = state;
          }
          return GuardsCheckStart.prototype.toString = function() {
            return "GuardsCheckStart(id: " + this.id + ", url: '" + this.url + "', urlAfterRedirects: '" + this.urlAfterRedirects + "', state: " + this.state + ")";
          }, GuardsCheckStart;
        }(),
        GuardsCheckEnd = function() {
          function GuardsCheckEnd(id, url, urlAfterRedirects, state, shouldActivate) {
            this.id = id, this.url = url, this.urlAfterRedirects = urlAfterRedirects, this.state = state, this.shouldActivate = shouldActivate;
          }
          return GuardsCheckEnd.prototype.toString = function() {
        ...
        ResolveStart = function() {
          ...
          return ResolveStart.prototype.toString = function() {
        ...
        ResolveEnd = function() {
          ...
          return ResolveEnd.prototype.toString = function() {
        ...
        UrlSerializer = function() {
          ...
          return UrlSerializer.prototype.parse = function(url) {}, UrlSerializer.prototype.serialize = function(tree) {}, UrlSerializer;
        }(),
        ...
        Recognizer = function() {
          ...
          return Recognizer.prototype.recognize = function() {
            ...
            var _this = this,
                ...
                i = inheritedParamsDataResolve(route);
            ...
            if ("**" === route.path) {
              var params = segments.length > 0 ? last$1(segments).parameters : {},
                  snapshot_1 = new ActivatedRouteSnapshot(segments, params, Object.freeze(this.urlTree.queryParams), this.urlTree.fragment, getData(route), outlet, route.component, route, getSourceSegmentGroup(rawSegment), getPathIndexShift(rawSegment) + segments.length, getResolve(route));
            ...
            var _a = match$1(rawSegment, route, segments),
                ...
                snapshot = new ActivatedRouteSnapshot(consumedSegments, parameters, Object.freeze(this.urlTree.queryParams), this.urlTree.fragment, getData(route), outlet, route.component, route, getSourceSegmentGroup(rawSegment), getPathIndexShift(rawSegment) + consumedSegments.length, getResolve(route));
            if (0 === slicedSegments.length && segmentGroup.hasChildren()) {
        ...
        RouteReuseStrategy = function() {
          ...
          return RouteReuseStrategy.prototype.shouldDetach = function(route) {}, RouteReuseStrategy.prototype.store = function(route, handle) {}, RouteReuseStrategy.prototype.shouldAttach = function(route) {}, RouteReuseStrategy.prototype.retrieve = function(route) {}, RouteReuseStrategy.prototype.shouldReuseRoute = function(future, curr) {}, RouteReuseStrategy;
        }(),
        ...
        UrlHandlingStrategy = function() {
          ...
          return UrlHandlingStrategy.prototype.shouldProcessUrl = function(url) {}, UrlHandlingStrategy.prototype.extract = function(url) {}, UrlHandlingStrategy.prototype.merge = function(newUrlPart, rawUrl) {}, UrlHandlingStrategy;
        }(),
        ...
        Router = function() {
          ...
          return Router.prototype.resetRootComponentType = function(rootComponentType) {
            ...
            urlTransition && this.urlHandlingStrategy.shouldProcessUrl(rawUrl) ? (this.routerEvents.next(new NavigationStart(id, this.serializeUrl(url))), Promise.resolve().then(function(_) {
            ...
            var _this = this;
            return id !== this.navigationId ? (this.location.go(this.urlSerializer.serialize(this.currentUrlTree)), this.routerEvents.next(new NavigationCancel(id, this.serializeUrl(url), "Navigation ID " + id + " is not equal to the current navigation id " + this.navigationId)), Promise.resolve(!1)) : new Promise(function(resolvePromise, rejectPromise) {
              var urlAndSnapshot$;
              if (precreatedState)
                ...
                urlAndSnapshot$ = rxjs_operator_mergeMap.mergeMap.call(redirectsApplied$, function(appliedUrl) {
                  return rxjs_operator_map.map.call(recognize(_this.rootComponentType, _this.config, appliedUrl, _this.serializeUrl(appliedUrl)), function(snapshot) {
                    return _this.routerEvents.next(new RoutesRecognized(id, _this.serializeUrl(url), _this.serializeUrl(appliedUrl), snapshot)), {
              ...
              var preActivation,
                  ...
                  preactivationTraverse$ = rxjs_operator_map.map.call(beforePreactivationDone$, function(_a) {
                    ...
                    return preActivation = new PreActivation(snapshot, _this.currentRouterState.snapshot, moduleInjector), preActivation.traverse(_this.rootContexts), {
                      appliedUrl: appliedUrl,
                      snapshot: snapshot
                    };
                  }),
                  ...
                  preactivationResolveData$ = rxjs_operator_mergeMap.mergeMap.call(preactivationCheckGuards$, function(p) {
                    return _this.navigationId !== id ? rxjs_observable_of.of(!1) : p.shouldActivate && preActivation.isActivating() ? (_this.triggerEvent(new ResolveStart(id, _this.serializeUrl(url), p.appliedUrl, p.snapshot)), rxjs_operator_map.map.call(preActivation.resolveData(), function() {
                  ...
                  routerState$ = rxjs_operator_map.map.call(preactivationDone$, function(_a) {
                    ...
                    if (shouldActivate) {
                      return {
                        appliedUrl: appliedUrl,
                        state: createRouterState(_this.routeReuseStrategy, snapshot, _this.currentRouterState),
                        shouldActivate: shouldActivate
                      };
                    }
                    return {
              ...
              routerState$.forEach(function(_a) {
                ...
                if (_this.currentUrlTree = appliedUrl, _this.rawUrlTree = _this.urlHandlingStrategy.merge(_this.currentUrlTree, rawUrl), _this.currentRouterState = state, !shouldPreventPushState) {
                  var path = _this.urlSerializer.serialize(_this.rawUrlTree);
                  _this.location.isCurrentPathEqualTo(path) || shouldReplaceUrl ? _this.location.replaceState(path) : _this.location.go(path);
                }
                new ActivateRoutes(_this.routeReuseStrategy, state, storedState).activate(_this.rootContexts), navigationIsSuccessful = !0;
              }).then(function() {
                ...
                if (isNavigationCancelingError(e))
                  _this.resetUrlToCurrentUrlTree(), _this.navigated = !0, _this.routerEvents.next(new NavigationCancel(id, _this.serializeUrl(url), e.message)), resolvePromise(!1);
                else {
        ...
        CanActivate = function() {
          ...
          return Object.defineProperty(CanActivate.prototype, "route", {
            get: function() {
        ...
        PreActivation = function() {
          ...
          return PreActivation.prototype.traverse = function(parentContexts) {
            ...
            futureNode.children.forEach(function(c) {
              _this.traverseRoutes(c, prevChildren[c.value.outlet], contexts, futurePath.concat([c.value])), delete prevChildren[c.value.outlet];
            ...
            if (curr && future._routeConfig === curr._routeConfig) {
              ...
              if (shouldRunGuardsAndResolvers ? this.canActivateChecks.push(new CanActivate(futurePath)) : (future.data = curr.data, future._resolvedData = curr._resolvedData), future.component ? this.traverseChildRoutes(futureNode, currNode, context ? context.children : null, futurePath) : this.traverseChildRoutes(futureNode, currNode, parentContexts, futurePath), shouldRunGuardsAndResolvers) {
                var outlet = context.outlet;
                this.canDeactivateChecks.push(new CanDeactivate(outlet.component, curr));
              }
            } else
              curr && this.deactivateRouteAndItsChildren(currNode, context), this.canActivateChecks.push(new CanActivate(futurePath)), future.component ? this.traverseChildRoutes(futureNode, null, context ? context.children : null, futurePath) : this.traverseChildRoutes(futureNode, null, parentContexts, futurePath);
            ...
            var _this = this,
                canActivate = future._routeConfig ? future._routeConfig.canActivate : null;
            ...
            var _this = this,
                canDeactivate = curr && curr._routeConfig ? curr._routeConfig.canDeactivate : null;
            ...
            return rxjs_operator_map.map.call(this.resolveNode(resolve, future), function(resolvedData) {
              return future._resolvedData = resolvedData, future.data = Object.assign({}, future.data, inheritedParamsDataResolve(future).resolve), null;
            });
    ...
    var RouterLinkActive = function() {
      function RouterLinkActive(router, element, renderer, cdr) {
        var _this = this;
        this.router = router, this.element = element, this.renderer = renderer, this.cdr = cdr, this.classes = [], this.active = !1, this.routerLinkActiveOptions = {exact: !1}, this.subscription = router.events.subscribe(function(s) {
          s instanceof NavigationEnd && _this.update();
        });
      }
      return Object.defineProperty(RouterLinkActive.prototype, "isActive", {
        get: function() {
          return this.active;
        },
        enumerable: !0,
        ...
        this.links && this.linksWithHrefs && this.router.navigated && Promise.resolve().then(function() {
          ...
          _this.active !== hasActiveLinks && (_this.active = hasActiveLinks, _this.classes.forEach(function(c) {
    ...
    var OutletInjector = function() {
      ...
      return OutletInjector.prototype.get = function(token, notFoundValue) {
        ...
        PreloadingStrategy = function() {
          ...
          return PreloadingStrategy.prototype.preload = function(route, fn) {}, PreloadingStrategy;
        }(),
