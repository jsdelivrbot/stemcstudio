...
(function(process) {
  !function(global, factory) {
    ...
    function identifierModuleUrl(compileIdentifier) {
      var ref = compileIdentifier.reference;
      return ref instanceof StaticSymbol ? ref.filePath : _angular_core.ɵreflector.importUri(ref);
    }
    ...
    function isTemplate(el, enableLegacyTemplate, reportDeprecation) {
      ...
      return tagNoNs === NG_TEMPLATE_ELEMENT || (tagNoNs.toLowerCase() === TEMPLATE_ELEMENT ? !(!enableLegacyTemplate || tagNoNs.toLowerCase() !== TEMPLATE_ELEMENT) && (reportDeprecation(TEMPLATE_ELEMENT_DEPRECATION_WARNING, el.sourceSpan), !0) : void 0);
    }
    ...
    function variable(name, type, sourceSpan) {
      return void 0 === type && (type = null), new ReadVarExpr(name, type, sourceSpan);
    }
    function importExpr(id, typeParams, sourceSpan) {
      return void 0 === typeParams && (typeParams = null), new ExternalExpr(id, null, typeParams, sourceSpan);
    }
    function importType(id, typeParams, typeModifiers) {
      return void 0 === typeParams && (typeParams = null), void 0 === typeModifiers && (typeModifiers = null), null != id ? expressionType(importExpr(id, typeParams), typeModifiers) : null;
    }
    function expressionType(expr, typeModifiers) {
      return void 0 === typeModifiers && (typeModifiers = null), null != expr ? new ExpressionType(expr, typeModifiers) : null;
    }
    function literalArr(values, type, sourceSpan) {
      return void 0 === type && (type = null), new LiteralArrayExpr(values, type, sourceSpan);
    }
    ...
    function fn(params, body, type, sourceSpan) {
      return void 0 === type && (type = null), new FunctionExpr(params, body, type, sourceSpan);
    }
    function literal(value, type, sourceSpan) {
      return void 0 === type && (type = null), new LiteralExpr(value, type, sourceSpan);
    }
    function createClassStmt(config) {
      var parentArgs = config.parentArgs || [],
          ...
          ctor = new ClassMethod(null, config.ctorParams || [], superCtorStmts.concat(builder.ctorStmts));
    ...
    function multiProviderDef(providers) {
      function convertDeps(providerIndex, deps) {
        return deps.map(function(dep, depIndex) {
          ...
          return allParams.push(new FnParam(paramName, DYNAMIC_TYPE)), allDepDefs.push(depDef(dep)), variable(paramName);
        });
      }
      var allDepDefs = [],
          allParams = [],
    ...
    function singleProviderDef(providerType, providerMeta) {
      var providerExpr,
          flags,
          deps;
      providerType === ProviderAstType.Directive || providerType === ProviderAstType.Component ? (providerExpr = importExpr(providerMeta.useClass), flags = 8192, deps = providerMeta.deps || providerMeta.useClass.diDeps) : providerMeta.useClass ? (providerExpr = importExpr(providerMeta.useClass), flags = 256, deps = providerMeta.deps || providerMeta.useClass.diDeps) : providerMeta.useFactory ? (providerExpr = importExpr(providerMeta.useFactory), flags = 512, deps = providerMeta.deps || providerMeta.useFactory.diDeps) : providerMeta.useExisting ? (providerExpr = NULL_EXPR, flags = 1024, deps = [{token: providerMeta.useExisting}]) : (providerExpr = convertValueToOutputAst(providerMeta.useValue), flags = 128, deps = []);
    ...
    function needsAdditionalRootNode(astNodes) {
      ...
      return lastAstNode instanceof EmbeddedTemplateAst ? lastAstNode.hasViewContainer : lastAstNode instanceof ElementAst ? lastAstNode.name === NG_CONTAINER_TAG && lastAstNode.children.length ? needsAdditionalRootNode(lastAstNode.children) : lastAstNode.hasViewContainer : lastAstNode instanceof NgContentAst;
    }
    ...
    function createComponentFactoryResolver(directives) {
      ...
      if (componentDirMeta && componentDirMeta.directive.entryComponents.length) {
        ...
        return new ProviderAst(token, (!1), (!0), [{
          token: token,
          multi: !1,
          useClass: classMeta
    ...
    function calcStaticDynamicQueryFlags(queryIds, queryId, isFirst) {
      var flags = 0;
      return flags |= !isFirst || !queryIds.staticQueryIds.has(queryId) && queryIds.dynamicQueryIds.has(queryId) ? 268435456 : 134217728;
    }
    function serializeSummaries(summaryResolver, symbolResolver, symbols, types) {
      ...
      return types.forEach(function(typeSummary) {
        if (serializer.addOrMergeSummary({
          symbol: typeSummary.type.reference,
          metadata: null,
          type: typeSummary
        }), typeSummary.summaryKind === CompileSummaryKind.NgModule) {
    ...
    function createAotCompiler(compilerHost, options) {
      ...
      var console = new _angular_core.ɵConsole,
          ...
          compiler = new AotCompiler(config, compilerHost, resolver, tmplParser, new StyleCompiler(urlResolver), viewCompiler, new NgModuleCompiler, new TypeScriptEmitter(importResolver), summaryResolver, options.locale, options.i18nFormat, options.genFilePreamble, symbolResolver);
      return {
        compiler: compiler,
    ...
    var __extends = function(d, b) {
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        VERSION = new _angular_core.Version("4.0.3"),
        TextAst = function() {
      ...
      return CompileStylesheetMetadata;
        ...
        ProviderMeta = function() {
          function ProviderMeta(token, _a) {
            var useClass = _a.useClass,
                ...
                deps = _a.deps,
                multi = _a.multi;
            this.token = token, this.useClass = useClass, this.useValue = useValue, this.useExisting = useExisting, this.useFactory = useFactory, this.dependencies = deps, this.multi = !!multi;
          }
          return ProviderMeta;
        }(),
        CompilerConfig = function() {
          function CompilerConfig(_a) {
            ...
            this.defaultEncapsulation = defaultEncapsulation, this.useJit = useJit, this.missingTranslation = missingTranslation, this.enableLegacyTemplate = enableLegacyTemplate !== !1;
          }
 ...
 while (!this._isTextEnd());
        ...
        Message = function() {
          function Message(nodes, placeholders, placeholderToMessage, meaning, description, id) {
            this.nodes = nodes, this.placeholders = placeholders, this.placeholderToMessage = placeholderToMessage, this.meaning = meaning, this.description = description, this.id = id;
          }
          return Message;
        }(),
        Text$1 = function() {
      ...
      return Serializer.prototype.write = function(messages, locale) {}, Serializer.prototype.load = function(content, url) {}, Serializer.prototype.digest = function(message) {}, Serializer.prototype.createNameMapper = function(message) {
        ...
        Xliff = function(_super) {
          ...
          return __extends(Xliff, _super), Xliff.prototype.write = function(messages, locale) {
            ...
            messages.forEach(function(message) {
              ...
              transUnit.children.push(new CR(8), new Tag(_SOURCE_TAG, {}, visitor.serialize(message.nodes)), new CR(8), new Tag(_TARGET_TAG)), message.description && transUnit.children.push(new CR(8), new Tag("note", {
                priority: "1",
                from: "description"
            ...
            if (Object.keys(mlNodesByMsgId).forEach(function(msgId) {
        ...
        _WriteVisitor = function() {
          ...
          return _WriteVisitor.prototype.visitText = function(text, context) {
            ...
            var _this = this;
            return this._isInIcu = !1, [].concat.apply([], nodes.map(function(node) {
              return node.visit(_this);
            }));
          }, _WriteVisitor;
        }(),
        XliffParser = function() {
          ...
          return XliffParser.prototype.parse = function(xliff, url) {
            this._unitMlNodes = [], this._mlNodesByMsgId = {};
            ...
            switch (element.name) {
              case _UNIT_TAG:
                ...
                if (idAttr) {
                  var id = idAttr.value;
                  this._mlNodesByMsgId.hasOwnProperty(id) ? this._addError(element, "Duplicated translations for msg " + id) : (visitAll(this, element.children, null), this._unitMlNodes ? this._mlNodesByMsgId[id] = this._unitMlNodes : this._addError(element, "Message " + id + " misses a translation"));
                } else
        ...
        XmlToI18n = function() {
          function XmlToI18n() {}
          return XmlToI18n.prototype.convert = function(nodes) {
            return this._errors = [], {
          ...
          }, XmlToI18n.prototype.visitExpansion = function(icu, context) {}, XmlToI18n.prototype.visitExpansionCase = function(icuCase, context) {}, XmlToI18n.prototype.visitComment = function(comment, context) {}, XmlToI18n.prototype.visitAttribute = function(attribute, context) {}, XmlToI18n.prototype._addError = function(node, message) {
            this._errors.push(new I18nError(node.sourceSpan, message));
          }, XmlToI18n;
        }(),
        _VERSION$1 = "2.0",
          ...
          return __extends(Xliff2, _super), Xliff2.prototype.write = function(messages, locale) {
            ...
            messages.forEach(function(message) {
              ...
              if (message.description || message.meaning) {
                ...
                message.description && notes.children.push(new CR(8), new Tag("note", {category: "description"}, [new Text$2(message.description)])), message.meaning && notes.children.push(new CR(8), new Tag("note", {category: "meaning"}, [new Text$2(message.meaning)])), notes.children.push(new CR(6)), unit.children.push(new CR(6), notes);
              }
        ...
        Xmb = function(_super) {
          ...
          return __extends(Xmb, _super), Xmb.prototype.write = function(messages, locale) {
            ...
            return messages.forEach(function(message) {
              ...
              message.description && (attrs.desc = message.description), message.meaning && (attrs.meaning = message.meaning), rootNode.children.push(new CR(2), new Tag(_MESSAGE_TAG, attrs, visitor.serialize(message.nodes)));
    ...
    var PLURAL_CASES = ["zero", "one", "two", "few", "many", "other"],
        ...
        ProviderViewContext = function() {
          function ProviderViewContext(component) {
            var _this = this;
            this.component = component, this.errors = [], this.viewQueries = _getViewQueries(component), this.viewProviders = new Map, component.viewProviders.forEach(function(provider) {
            ...
            if (null != dep.token) {
              if (requestingProviderType === ProviderAstType.Directive || requestingProviderType === ProviderAstType.Component) {
                if (tokenReference(dep.token) === resolveIdentifier(Identifiers.Renderer) || tokenReference(dep.token) === resolveIdentifier(Identifiers.ElementRef) || tokenReference(dep.token) === resolveIdentifier(Identifiers.ChangeDetectorRef) || tokenReference(dep.token) === resolveIdentifier(Identifiers.TemplateRef))
                  return dep;
                tokenReference(dep.token) === resolveIdentifier(Identifiers.ViewContainerRef) && (this._hasViewContainer = !0);
              }
        ...
        NgModuleProviderAnalyzer = function() {
          function NgModuleProviderAnalyzer(ngModule, extraProviders, sourceSpan) {
            var _this = this;
            this._transformedProviders = new Map, this._seenProviders = new Map, this._errors = [], this._allProviders = new Map, ngModule.transitiveModule.modules.forEach(function(ngModuleType) {
          ...
          return NgModuleProviderAnalyzer.prototype.parse = function() {
            ...
            void 0 === eager && (eager = null);
            var foundLocal = !1;
            dep.isSkipSelf || null == dep.token || (tokenReference(dep.token) === resolveIdentifier(Identifiers.Injector) || tokenReference(dep.token) === resolveIdentifier(Identifiers.ComponentFactoryResolver) ? foundLocal = !0 : null != this._getOrCreateLocalProvider(dep.token, eager) && (foundLocal = !0));
            var result = dep;
    ...
    var PreparsedElement = function() {
      ...
      return PreparsedElement;
        ...
        IDENT_EVENT_IDX = 10,
        NG_TEMPLATE_ELEMENT = "ng-template",
          ...
          return TemplateParser.prototype.parse = function(component, template, directives, pipes, schemas, templateUrl) {
            ...
            if (htmlAstWithErrors.rootNodes.length > 0) {
              ...
              var bindingParser = new BindingParser(this._exprParser, interpolationConfig, this._schemaRegistry, uniqPipes, errors),
                  parseVisitor = new TemplateParseVisitor(this._config, providerViewContext, uniqDirectives, bindingParser, this._schemaRegistry, schemas, errors);
      ...
      return TemplateParseVisitor.prototype.visitExpansion = function(expansion, context) {
        ...
        return elementOrDirectiveRefs.forEach(function(elOrDirRef) {
          if (elOrDirRef.value.length > 0)
            ...
            var refToken = null;
            isTemplateElement && (refToken = createIdentifierToken(Identifiers.TemplateRef)), targetReferences.push(new ReferenceAst(elOrDirRef.name, refToken, elOrDirRef.sourceSpan));
          }
        }), directiveAsts;
    ...
    var DirectiveNormalizer = function() {
      ...
      return DirectiveNormalizer.prototype.clearCache = function() {
        ...
        var _this = this;
        normalizedDirective.isComponent && (this._resourceLoaderCache.delete(normalizedDirective.template.templateUrl), normalizedDirective.template.externalStylesheets.forEach(function(stylesheet) {
        ...
        if (null != prenormData.template) {
          if (null != prenormData.templateUrl)
          ...
          normalizedTemplateSync = this.normalizeTemplateSync(prenormData), normalizedTemplateAsync = Promise.resolve(normalizedTemplateSync);
        } else {
          if (!prenormData.templateUrl)
        ...
        CompileMetadataResolver = function() {
          ...
          return CompileMetadataResolver.prototype.clearCacheFor = function(type) {
            ...
            if (!typeSummary) {
              ...
              typeSummary = summary ? summary.type : null, this._summaryCache.set(type, typeSummary);
            }
            ...
            if (!this._directiveCache.has(directiveType)) {
              ...
              var _a = this.getNonNormalizedDirectiveMetadata(directiveType),
                  ...
                  createDirectiveMetadata = function(templateMetadata) {
                    ...
                    return templateMetadata && _this.initComponentFactory(metadata.componentFactory, templateMetadata.ngContentSelectors), _this._directiveCache.set(directiveType, normalizedDirMeta), _this._summaryCache.set(directiveType, normalizedDirMeta.toSummary()), normalizedDirMeta;
                  };
              if (metadata.isComponent) {
                ...
                return templateMeta.syncResult ? (createDirectiveMetadata(templateMeta.syncResult), null) : isSync ? (this._reportError(componentStillLoadingError(directiveType), directiveType), null) : templateMeta.asyncResult.then(createDirectiveMetadata);
              }
            ...
            var metadata = CompileDirectiveMetadata.create({
              ...
              componentViewType: nonNormalizedTemplateMetadata ? this.getComponentViewClass(directiveType) : void 0,
              rendererType: nonNormalizedTemplateMetadata ? this.getRendererType(directiveType) : void 0,
              componentFactory: void 0
            });
            ...
            meta.declarations && flattenAndDedupeArray(meta.declarations).forEach(function(declaredType) {
              ...
              if (_this._directiveResolver.isDirective(declaredType))
                ...
                if (!_this._pipeResolver.isPipe(declaredType))
            ...
            return pipeMeta || this._reportError(syntaxError("Illegal state: getPipeMetadata can only be called after loadNgModuleDirectiveAndPipeMetadata for a module that declares it. Pipe " + stringifyType(pipeType) + "."), pipeType), pipeMeta;
      ...
      return __extends(BuiltinType, _super), BuiltinType.prototype.visitType = function(visitor, context) {
        ...
        MapType = function(_super) {
          function MapType(valueType, modifiers) {
            void 0 === modifiers && (modifiers = null);
            var _this = _super.call(this, modifiers) || this;
            return _this.valueType = valueType, _this;
          }
    ...
    var Expression = function() {
      function Expression(type, sourceSpan) {
        this.type = type, this.sourceSpan = sourceSpan;
      }
      return Expression.prototype.visitExpression = function(visitor, context) {}, Expression.prototype.prop = function(name, sourceSpan) {
        ...
        return void 0 === type && (type = null), new ReadKeyExpr(this, index, type, sourceSpan);
      }, Expression.prototype.callMethod = function(name, params, sourceSpan) {
        return new InvokeMethodExpr(this, name, params, null, sourceSpan);
      }, Expression.prototype.callFn = function(params, sourceSpan) {
        return new InvokeFunctionExpr(this, params, null, sourceSpan);
      }, Expression.prototype.instantiate = function(params, type, sourceSpan) {
        return void 0 === type && (type = null), new InstantiateExpr(this, params, type, sourceSpan);
      ...
      return __extends(ReadVarExpr, _super), ReadVarExpr.prototype.visitExpression = function(visitor, context) {
        ...
        WriteVarExpr = function(_super) {
          ...
          return __extends(WriteVarExpr, _super), WriteVarExpr.prototype.visitExpression = function(visitor, context) {
            ...
            return void 0 === type && (type = null), void 0 === modifiers && (modifiers = null), new DeclareVarStmt(this.name, this.value, type, modifiers, this.sourceSpan);
          }, WriteVarExpr;
        }(Expression),
      ...
      return __extends(InvokeMethodExpr, _super), InvokeMethodExpr.prototype.visitExpression = function(visitor, context) {
        ...
        ExternalExpr = function(_super) {
          function ExternalExpr(value, type, typeParams, sourceSpan) {
            void 0 === type && (type = null), void 0 === typeParams && (typeParams = null);
            var _this = _super.call(this, type, sourceSpan) || this;
        ...
        ConditionalExpr = function(_super) {
          function ConditionalExpr(condition, trueCase, falseCase, type, sourceSpan) {
            void 0 === falseCase && (falseCase = null), void 0 === type && (type = null);
        ...
        TYPED_NULL_EXPR = new LiteralExpr(null, INFERRED_TYPE),
        StmtModifier = {};
    StmtModifier.Final = 0, StmtModifier.Private = 1, StmtModifier[StmtModifier.Final] = "Final", StmtModifier[StmtModifier.Private] = "Private";
    var Statement = function() {
      function Statement(modifiers, sourceSpan) {
        void 0 === modifiers && (modifiers = null), this.modifiers = modifiers, this.sourceSpan = sourceSpan, modifiers || (this.modifiers = []);
      }
      return Statement.prototype.visitStatement = function(visitor, context) {}, Statement.prototype.hasModifier = function(modifier) {
        ...
        DeclareVarStmt = function(_super) {
          function DeclareVarStmt(name, value, type, modifiers, sourceSpan) {
            void 0 === type && (type = null), void 0 === modifiers && (modifiers = null);
        ...
        DeclareFunctionStmt = function(_super) {
          function DeclareFunctionStmt(name, params, statements, type, modifiers, sourceSpan) {
            void 0 === type && (type = null), void 0 === modifiers && (modifiers = null);
            var _this = _super.call(this, modifiers, sourceSpan) || this;
            return _this.name = name, _this.params = params, _this.statements = statements, _this.type = type, _this;
          }
        ...
        AbstractClassPart = function() {
          function AbstractClassPart(type, modifiers) {
            void 0 === type && (type = null), this.type = type, this.modifiers = modifiers, modifiers || (this.modifiers = []);
          }
        ...
        AstTransformer$1 = function() {
          ...
          return AstTransformer$1.prototype.transformExpr = function(expr, context) {
            ...
            var _this = this,
                ...
                mapType = new MapType(ast.valueType);
        ...
        NgModuleCompiler = function() {
          ...
          return NgModuleCompiler.prototype.compile = function(ngModuleMeta, extraProviders) {
            ...
            var injectorClass = builder.build(),
                ...
                stmts = [injectorClass, ngModuleFactoryStmt];
            if (ngModuleMeta.id) {
    ...
    var _InjectorBuilder = function() {
      ...
      return _InjectorBuilder.prototype.addProvider = function(resolvedProvider) {
        ...
        if (resolvedProvider.lifecycleHooks.indexOf(_angular_core.ɵLifecycleHooks.OnDestroy) !== -1) {
          ...
          resolvedProvider.eager || (callNgOnDestroy = this._lazyProps.get(instance.name).and(callNgOnDestroy)), this._destroyStmts.push(callNgOnDestroy.toStmt());
        }
        ...
        var _this = this,
            ...
            injClassName = identifierName(this._ngModuleMeta.type) + "Injector";
        ...
        else if (null != provider.useFactory) {
          var deps = provider.deps || provider.useFactory.diDeps,
        ...
        var resolvedProviderValueExpr,
            type;
        if (isMulti ? (resolvedProviderValueExpr = literalArr(providerValueExpressions), type = new ArrayType(DYNAMIC_TYPE)) : (resolvedProviderValueExpr = providerValueExpressions[0], type = providerValueExpressions[0].type), type || (type = DYNAMIC_TYPE), isEager)
          this.fields.push(new ClassField(propName, type)), this._createStmts.push(THIS_EXPR.prop(propName).set(resolvedProviderValueExpr).toStmt());
        else {
    ...
    var VERSION$1 = 3,
        ...
        EmitterVisitorContext = function() {
          ...
          return EmitterVisitorContext.createRoot = function(exportedVars) {
            ...
            void 0 === lastPart && (lastPart = ""), this.print(from, lastPart, !0);
        ...
        AbstractEmitterVisitor = function() {
          ...
          return AbstractEmitterVisitor.prototype.visitExpressionStmt = function(stmt, ctx) {
            ...
            return ctx.print(ast, "[", useNewLine), ctx.incIndent(), this.visitAllExpressions(ast.entries, ctx, ",", useNewLine), ctx.decIndent(), ctx.print(ast, "]", useNewLine), null;
          }, AbstractEmitterVisitor.prototype.visitLiteralMapExpr = function(ast, ctx) {
            var _this = this,
                useNewLine = ast.entries.length > 1;
            return ctx.print(ast, "{", useNewLine), ctx.incIndent(), this.visitAllObjects(function(entry) {
            ...
            for (var i = 0; i < expressions.length; i++)
              i > 0 && ctx.print(null, separator, newLine), handler(expressions[i]);
            newLine && ctx.println();
        ...
        TypeScriptEmitter = function() {
          ...
          return TypeScriptEmitter.prototype.emitStatements = function(srcFilePath, genFilePath, stmts, exportedVars, preamble) {
            ...
            return sm && lines.push(""), lines.join("\n");
          }, TypeScriptEmitter;
        }(),
        _TsEmitterVisitor = function(_super) {
          function _TsEmitterVisitor(_genFilePath, _importResolver) {
            var _this = _super.call(this, !1) || this;
            return _this._genFilePath = _genFilePath, _this._importResolver = _importResolver, _this.typeExpression = 0, _this.importsWithPrefixes = new Map, _this.reexports = new Map, _this;
          }
          return __extends(_TsEmitterVisitor, _super), _TsEmitterVisitor.prototype.visitType = function(t, ctx, defaultType) {
            void 0 === defaultType && (defaultType = "any"), null != t ? (this.typeExpression++, t.visitType(this, ctx), this.typeExpression--) : ctx.print(null, defaultType);
            ...
            if (ctx.isExportedVar(stmt.name) && stmt.value instanceof ExternalExpr && !stmt.type) {
              var _a = this._resolveStaticSymbol(stmt.value.value),
                  ...
                  members = _a.members;
              if (0 === members.length && filePath !== this._genFilePath) {
                var reexports = this.reexports.get(filePath);
                return reexports || (reexports = [], this.reexports.set(filePath, reexports)), reexports.push({
                  name: name,
                  as: stmt.name
                }), null;
              }
            ...
            var _this = this;
            return ctx.pushClass(stmt), ctx.isExportedVar(stmt.name) && ctx.print(stmt, "export "), ctx.print(stmt, "class " + stmt.name), null != stmt.parent && (ctx.print(stmt, " extends "), this.typeExpression++, stmt.parent.visitExpression(this, ctx), this.typeExpression--), ctx.println(stmt, " {"), ctx.incIndent(), stmt.fields.forEach(function(field) {
            ...
            var arity = this._importResolver.getTypeArity(reference) || void 0,
                importReference = this._importResolver.getImportAs(reference) || reference;
            return {
            ...
            if (filePath != this._genFilePath) {
              ...
              null == prefix && (prefix = "import" + this.importsWithPrefixes.size, this.importsWithPrefixes.set(filePath, prefix)), ctx.print(null, prefix + ".");
            }
            if (members.length ? (ctx.print(null, name), ctx.print(null, "."), ctx.print(null, members.join("."))) : ctx.print(null, name), this.typeExpression > 0) {
              var suppliedParameters = typeParams && typeParams.length || 0,
                  additionalParameters = (arity || 0) - suppliedParameters;
              if (suppliedParameters > 0 || additionalParameters > 0) {
                ...
                }, typeParams, ctx, ","), additionalParameters > 0)
                  for (var i = 0; i < additionalParameters; i++)
                    (i > 0 || suppliedParameters > 0) && ctx.print(null, ","), ctx.print(null, "any");
                ctx.print(null, ">");
              }
            }
        ...
        StyleCompiler = function() {
          ...
          return StyleCompiler.prototype.compileComponent = function(comp) {
            ...
            for (var _this = this,
              ...
              dependencies.push(new StylesCompileDependency(getStylesVarName(null), stylesheet.styleUrls[i], shim, identifier)), styleExpressions.push(new ExternalExpr(identifier));
            }
      ...
      return __extends(_BuiltinAstConverter, _super), _BuiltinAstConverter.prototype.visitPipe = function(ast, context) {
        ...
        _AstToIrVisitor = function() {
          ...
          return _AstToIrVisitor.prototype.visitBinary = function(ast, mode) {
            ...
            return fnResult = ast instanceof BuiltinFunctionCall ? ast.converter(convertedArgs) : this.visit(ast.target, _Mode.Expression).callFn(convertedArgs), convertToStatementIfNeeded(mode, fnResult);
            ...
            return args.push(literal(ast.strings[ast.strings.length - 1])), ast.expressions.length <= 9 ? importExpr(createIdentifier(Identifiers.inlineInterpolate)).callFn(args) : importExpr(createIdentifier(Identifiers.interpolate)).callFn([args[0], literalArr(args.slice(1))]);
          }, _AstToIrVisitor.prototype.visitKeyedRead = function(ast, mode) {
            var leftMostSafe = this.leftMostSafeNode(ast);
            return leftMostSafe ? this.convertSafeAccess(ast, leftMostSafe, mode) : convertToStatementIfNeeded(mode, this.visit(ast.obj, _Mode.Expression).key(this.visit(ast.key, _Mode.Expression)));
            ...
            var temporary,
                guardedExpression = this.visit(leftMostSafe.receiver, _Mode.Expression);
        ...
        ViewCompiler = function() {
          ...
          return ViewCompiler.prototype.compileComponent = function(component, template, styles, usedPipes) {
            ...
            return visitor.visitAll([], template), statements.push.apply(statements, visitor.build()), new ViewCompileResult(statements, visitor.viewName, renderComponentVarName);
          }, ViewCompiler;
        }();
    ...
    var LOG_VAR = variable("l"),
        ...
        ViewBuilder = function() {
          ...
          return Object.defineProperty(ViewBuilder.prototype, "viewName", {
            ...
            if (this.variables = variables, this.parent || this.usedPipes.forEach(function(pipe) {
              ...
              this.component.viewQueries.forEach(function(query, queryIndex) {
                var queryId = queryIndex + 1,
                    ...
                    flags = 67108864 | calcStaticDynamicQueryFlags(queryIds_1, queryId, query.first);
            ...
            this.nodes.push(null);
            var elName = ast.name;
            ast.name === NG_CONTAINER_TAG && (elName = null);
            var _a = this._visitElementOrTemplate(nodeIndex, ast),
                flags = _a.flags,
            ...
            var childCount = this.nodes.length - nodeIndex - 1,
                ...
                compView = NULL_EXPR;
            compAst && (compView = importExpr({reference: compAst.directive.componentViewType}), compRendererType = importExpr({reference: compAst.directive.rendererType})), this.nodes[nodeIndex] = function() {
              return {
                sourceSpan: ast.sourceSpan,
                nodeFlags: 1 | flags,
            ...
            var _this = this,
                flags = 0;
            ast.hasViewContainer && (flags |= 8388608);
            ...
            var hostBindings = [],
                hostEvents = [],
                componentFactoryResolverProvider = createComponentFactoryResolver(ast.directives);
            componentFactoryResolverProvider && this._visitProvider(componentFactoryResolverProvider, ast.queryMatches), ast.providers.forEach(function(providerAst, providerIndex) {
              var dirAst,
                  dirIndex;
            ...
            return ast.queryMatches.forEach(function(match) {
              var valueType;
              tokenReference(match.value) === resolveIdentifier(Identifiers.ElementRef) ? valueType = 0 : tokenReference(match.value) === resolveIdentifier(Identifiers.ViewContainerRef) ? valueType = 3 : tokenReference(match.value) === resolveIdentifier(Identifiers.TemplateRef) && (valueType = 2), null != valueType && queryMatchExprs.push(literalArr([literal(match.queryId), literal(valueType)]));
            }), ast.references.forEach(function(ref) {
              var valueType;
              ref.value ? tokenReference(ref.value) === resolveIdentifier(Identifiers.TemplateRef) && (valueType = 2) : valueType = 1, null != valueType && (_this.refNodeIndices[ref.name] = nodeIndex, queryMatchExprs.push(literalArr([literal(ref.name), literal(valueType)])));
            ...
            this.nodes.push(null), dirAst.directive.queries.forEach(function(query, queryIndex) {
              var queryId = dirAst.contentQueryStartId + queryIndex,
                  flags = 33554432 | calcStaticDynamicQueryFlags(queryIds, queryId, query.first),
                  bindingType = query.first ? 0 : 1;
              _this.nodes.push(function() {
                return {
            ...
            }), dirAst.directive.isComponent && (flags |= 16384);
            ...
            (dirAst.inputs.length || (163840 & flags) > 0) && (updateDirectiveExpressions = dirAst.inputs.map(function(input, bindingIndex) {
              return _this._preprocessUpdateExpression({
                nodeIndex: nodeIndex,
                bindingIndex: bindingIndex,
            ...
            var flags = 0;
            providerAst.eager || (flags |= 2048), providerAst.providerType === ProviderAstType.PrivateService && (flags |= 4096), providerAst.lifecycleHooks.forEach(function(lifecycleHook) {
            ...
            if (pipe.pure) {
              ...
              var pipeNodeIndex = compBuilder.purePipeNodeIndices[name],
                  pipeValueExpr_1 = importExpr(createIdentifier(Identifiers.nodeValue)).callFn([compViewExpr, literal(pipeNodeIndex)]);
              return function(args) {
            ...
            var nodeIndex = this._createPipe(expression.sourceSpan, pipe),
                nodeValueExpr_1 = importExpr(createIdentifier(Identifiers.nodeValue)).callFn([VIEW_VAR, literal(nodeIndex)]);
            return function(args) {
            ...
            var self = this,
                ...
                nodeDefExprs = this.nodes.map(function(factory, nodeIndex) {
                  ...
                  updateRenderer && updateRendererStmts.push.apply(updateRendererStmts, createUpdateStatements(nodeIndex, sourceSpan, updateRenderer, !1)), updateDirectives && updateDirectivesStmts.push.apply(updateDirectivesStmts, createUpdateStatements(nodeIndex, sourceSpan, updateDirectives, (163840 & nodeFlags) > 0));
                  var logWithNodeDef = 3 & nodeFlags ? new CommaExpr([LOG_VAR.callFn([]).callFn([]), nodeDef]) : nodeDef;
        ...
        AotCompiler = function() {
          ...
          return AotCompiler.prototype.clearCache = function() {
            ...
            var _this = this,
                ...
                exportedVars = [],
                generatedFiles = [];
            if (generatedFiles.push(this._createSummary(srcFileUrl, directives, pipes, ngModules, injectables, statements, exportedVars)), exportedVars.push.apply(exportedVars, ngModules.map(function(ngModuleType) {
            ...
            return targetStatements.push.apply(targetStatements, appCompileResult.statements), appCompileResult.ngModuleFactoryVar;
            ...
            var _this = this,
                ...
                viewResult = this._viewCompiler.compileComponent(compMeta, parsedTemplate, stylesExpr, usedPipes);
            return componentStyles && targetStatements.push.apply(targetStatements, _resolveStyleStatements(this._symbolResolver, componentStyles, fileSuffix)), targetStatements.push.apply(targetStatements, viewResult.statements), {
        ...
        StaticReflector = function() {
          ...
          return StaticReflector.prototype.importUri = function(typeOrFunc) {
            ...
            var importSymbol = this.getStaticSymbol(moduleUrl, name),
                rootSymbol = this.findDeclaration(moduleUrl, name);
            return importSymbol != rootSymbol && this.symbolResolver.recordImportAs(rootSymbol, importSymbol), members && members.length ? this.getStaticSymbol(rootSymbol.filePath, rootSymbol.name, members) : rootSymbol;
            ...
            var staticSymbol = enumIdentifier,
                members = (staticSymbol.members || []).concat(name);
            ...
            try {
              ...
              if (!parameters_1) {
                ...
                if (ctorData) {
                  ...
                  parameters_1 = [], parameterTypes.forEach(function(paramType, index) {
                    var nestedResult = [];
      ...
      return __extends(PopulatedScope, _super), PopulatedScope.prototype.resolve = function(name) {
              ...
              if (metadata.metadata) {
                ...
                Object.keys(metadata.metadata).forEach(function(metadataKey) {
                  var symbolMeta = metadata.metadata[metadataKey],
                      ...
                      importSymbol = void 0;
                  metadata.importAs && (importSymbol = _this.getStaticSymbol(metadata.importAs, name), _this.recordImportAs(symbol, importSymbol));
                  var origin = origins_1.hasOwnProperty(metadataKey) && origins_1[metadataKey];
                  if (origin) {
                    var originFilePath = _this.resolveModule(origin, filePath);
                    originFilePath ? _this.symbolResourcePaths.set(symbol, originFilePath) : _this.reportError(new Error("Couldn't resolve original symbol for " + origin + " from " + filePath), null);
                  }
        ...
        JitEmitterVisitor = function(_super) {
          function JitEmitterVisitor() {
            var _this = _super.apply(this, arguments) || this;
            return _this._evalArgNames = [], _this._evalArgValues = [], _this;
          }
        ...
        JitCompiler = function() {
          ...
          return Object.defineProperty(JitCompiler.prototype, "injector", {
            ...
            return ngModule.transitiveModule.modules.forEach(function(localModuleMeta) {
        ...
        MessageBundle = function() {
          ...
          return MessageBundle.prototype.updateFromTemplate = function(html, url, interpolationConfig) {
            ...
            this._messages.forEach(function(message) {
              ...
              messages.hasOwnProperty(id) || (messages[id] = message);
            });
