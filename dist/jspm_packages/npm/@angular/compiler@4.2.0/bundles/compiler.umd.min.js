  ...
  !function(global, factory) {
    ...
    function createAotCompiler(compilerHost, options) {
      var translations = options.translations || "",
          ...
          compiler = new AotCompiler(config, compilerHost, staticReflector, resolver, tmplParser, new StyleCompiler(urlResolver), viewCompiler, new NgModuleCompiler(staticReflector), new TypeScriptEmitter, summaryResolver, options.locale || null, options.i18nFormat || null, symbolResolver);
      return {
        compiler: compiler,
    ...
    var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
      ...
      for (var p in b)
        ...
        VERSION = new _angular_core.Version("4.2.0"),
        TextAst = function() {
      ...
      return TranslationBundle.load = function(content, url, serializer, missingTranslationStrategy, console) {
        ...
        I18NHtmlParser = function() {
          ...
          return I18NHtmlParser.prototype.parse = function(source, url, parseExpansionForms, interpolationConfig) {
            ...
            return this._translationBundle ? parseResult.errors.length ? new ParseTreeResult(parseResult.rootNodes, parseResult.errors) : mergeTranslations(parseResult.rootNodes, this._translationBundle, interpolationConfig, [], {}) : parseResult;
          }, I18NHtmlParser;
        }(),
        CORE = "@angular/core",
        ...
        AotCompiler = function() {
          ...
          return AotCompiler.prototype.clearCache = function() {
            ...
            var _this = this,
                ...
                json = _a.json,
                exportAs = _a.exportAs;
            return exportAs.forEach(function(entry) {
            ...
            }), [new GeneratedFile(srcFileUrl, summaryFileName(srcFileUrl), json), this._codegenSourceModule(srcFileUrl, forJitOutputCtx)];
            ...
            var _this = this,
                importExpr$$1 = function(symbol, typeParams) {
                  ...
                  var arity = _this._symbolResolver.getTypeArity(symbol) || 0,
                      ...
                      name = _a.name,
                      members = _a.members,
                      moduleName = _this._symbolResolver.fileNameToModuleName(filePath, genFilePath),
      ...
      return __extends(PopulatedScope, _super), PopulatedScope.prototype.resolve = function(name) {
        ...
        StaticSymbolResolver = function() {
          ...
          return StaticSymbolResolver.prototype.resolveSymbol = function(staticSymbol) {
            ...
            return importedFilePath === containingFilePath ? null : this.knownFileNameToModuleNames.get(importedFilePath) || this.host.fileNameToModuleName(importedFilePath, containingFilePath);
