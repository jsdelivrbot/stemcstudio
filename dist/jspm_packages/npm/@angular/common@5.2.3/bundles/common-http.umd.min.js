...
!function(global, factory) {
  ...
  function paramParser(rawParams, codec) {
    ...
    if (rawParams.length > 0) {
      rawParams.split("&").forEach(function(param) {
        var eqIdx = param.indexOf("="),
            _a = -1 == eqIdx ? [codec.decodeKey(param), ""] : [codec.decodeKey(param.slice(0, eqIdx)), codec.decodeValue(param.slice(eqIdx + 1))],
            key = _a[0],
            val = _a[1],
            list = map$$1.get(key) || [];
    ...
    return HttpHandler;
      ...
      HttpParams = function() {
        function HttpParams(options) {
          ...
          var _this = this;
          if (this.updates = null, this.cloneFrom = null, this.encoder = options.encoder || new HttpUrlEncodingCodec, options.fromString) {
            if (options.fromObject)
              throw new Error("Cannot specify both fromString and fromObject.");
            this.map = paramParser(options.fromString, this.encoder);
          } else
            options.fromObject ? (this.map = new Map, Object.keys(options.fromObject).forEach(function(key) {
  ...
  HttpEventType[HttpEventType.Sent] = "Sent", HttpEventType[HttpEventType.UploadProgress] = "UploadProgress", HttpEventType[HttpEventType.ResponseHeader] = "ResponseHeader", HttpEventType[HttpEventType.DownloadProgress] = "DownloadProgress", HttpEventType[HttpEventType.Response] = "Response", HttpEventType[HttpEventType.User] = "User";
  var HttpResponseBase = function() {
    ...
    return HttpResponseBase;
      ...
      HttpHeaderResponse = function(_super) {
        ...
        return tslib.__extends(HttpHeaderResponse, _super), HttpHeaderResponse.prototype.clone = function(update) {
      ...
      HttpResponse = function(_super) {
        function HttpResponse(init) {
          void 0 === init && (init = {});
          var _this = _super.call(this, init) || this;
          return _this.type = HttpEventType.Response, _this.body = void 0 !== init.body ? init.body : null, _this;
        }
        return tslib.__extends(HttpResponse, _super), HttpResponse.prototype.clone = function(update) {
      ...
      HttpErrorResponse = function(_super) {
        ...
        return tslib.__extends(HttpErrorResponse, _super), HttpErrorResponse;
      }(HttpResponseBase),
      HttpClient = function() {
        ...
        return HttpClient.prototype.request = function(first, url, options) {
          ...
          if (first instanceof HttpRequest)
            ...
            var params = void 0;
            options.params && (params = options.params instanceof HttpParams ? options.params : new HttpParams({fromObject: options.params})), req = new HttpRequest(first, url, void 0 !== options.body ? options.body : null, {
              headers: headers,
              params: params,
              reportProgress: options.reportProgress,
      ...
      XSRF_COOKIE_NAME = new _angular_core.InjectionToken("XSRF_COOKIE_NAME"),
      ...
      HttpInterceptingHandler = function() {
        ...
        }, HttpInterceptingHandler.decorators = [{type: _angular_core.Injectable}], HttpInterceptingHandler.ctorParameters = function() {
      ...
      HttpClientModule = function() {
        ...
        return HttpClientModule.decorators = [{
          type: _angular_core.NgModule,
          args: [{
      ...
      HttpClientJsonpModule = function() {
        function HttpClientJsonpModule() {}
        return HttpClientJsonpModule.decorators = [{
          type: _angular_core.NgModule,
