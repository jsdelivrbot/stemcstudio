  ...
  (function(global, factory) {
    ...
    var DirectiveNormalizer = (function() {
      ...
      DirectiveNormalizer.prototype.normalizeTemplate = function(prenormData) {
        ...
        if (isDefined(prenormData.preserveWhitespaces) && typeof prenormData.preserveWhitespaces !== 'boolean') {
          throw syntaxError("The preserveWhitespaces option for component " + _angular_core.ɵstringify(prenormData.componentType) + " must be a boolean");
        }
    ...
    var AotCompiler = (function() {
      ...
      AotCompiler.prototype._compileComponent = function(outputCtx, compMeta, ngModule, directiveIdentifiers, componentStyles, fileSuffix) {
        ...
        var _a = this._templateParser.parse(compMeta, ((((compMeta.template)).template)), directives, pipes, ngModule.schemas, templateSourceUrl(ngModule.type, compMeta, ((compMeta.template))), preserveWhitespaces),
        ...
        function simplifyInContext(context, value, depth, references) {
          ...
          function simplify(expression) {
            ...
            if (expression instanceof StaticSymbol) {
              if (expression === self.injectionToken || expression === self.opaqueToken || self.conversionMap.has(expression) || (references > 0 && !expression.members.length)) {
                return expression;
              } else {
    ...
    var JitCompiler = (function() {
      ...
      JitCompiler.prototype._compileTemplate = function(template) {
        ...
        var _a = this._templateParser.parse(compMeta, ((((compMeta.template)).template)), directives, pipes, template.ngModule.schemas, templateSourceUrl(template.ngModule.type, template.compMeta, ((template.compMeta.template))), preserveWhitespaces),
            parsedTemplate = _a.template,
            usedPipes = _a.pipes;
