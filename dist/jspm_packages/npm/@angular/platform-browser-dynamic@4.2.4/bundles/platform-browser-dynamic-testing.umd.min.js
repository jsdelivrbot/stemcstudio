...
!function(global, factory) {
  ...
  var extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d, b) {
    ...
    for (var p in b)
      ...
      DOMTestComponentRenderer = function(_super) {
        function DOMTestComponentRenderer(_doc) {
          var _this = _super.call(this) || this;
          return _this._doc = _doc, _this;
        }
        return __extends(DOMTestComponentRenderer, _super), DOMTestComponentRenderer.prototype.insertRootElement = function(rootElId) {
          for (var rootEl = _angular_platformBrowser.ɵgetDOM().firstChild(_angular_platformBrowser.ɵgetDOM().content(_angular_platformBrowser.ɵgetDOM().createTemplate('<div id="' + rootElId + '"></div>'))),
              oldRoots = _angular_platformBrowser.ɵgetDOM().querySelectorAll(this._doc, "[id^=root]"),
              i = 0; i < oldRoots.length; i++)
  ...
  DOMTestComponentRenderer.decorators = [{type: _angular_core.Injectable}], DOMTestComponentRenderer.ctorParameters = function() {
    return [{
      type: void 0,
      decorators: [{
  ...
  var platformBrowserDynamicTesting = _angular_core.createPlatformFactory(_angular_compiler_testing.platformCoreDynamicTesting, "browserDynamicTesting", _angular_platformBrowserDynamic.ɵINTERNAL_BROWSER_DYNAMIC_PLATFORM_PROVIDERS),
      BrowserDynamicTestingModule = function() {
  ...
  BrowserDynamicTestingModule.decorators = [{
    ...
    return [];
  }, exports.platformBrowserDynamicTesting = platformBrowserDynamicTesting, exports.BrowserDynamicTestingModule = BrowserDynamicTestingModule, exports.ɵDOMTestComponentRenderer = DOMTestComponentRenderer, Object.defineProperty(exports, "__esModule", {value: !0});
});
