...
(function(process) {
  (function(t, k) {
    ...
    var mb = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(b, a) {
      ...
      for (var c in a)
        ...
        n;
    if ("object" == typeof window && window.window === window)
      n = window;
    else if ("object" == typeof self && self.self === self)
      n = self;
    else if ("object" == typeof global && global.global === global)
      n = global;
    else
      ...
      return a;
        ...
        ha = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new Xb(a, this.project));
          };
          return b;
        }(),
        Xb = function(b) {
    ...
    var W = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Yb(a, this.concurrent));
      };
      return b;
    }(),
        Yb = function(b) {
    ...
    var $b = function(b) {
      ...
      a.prototype._subscribe = function(c) {
        return new Zb(c, this.observableFactory);
      };
      return a;
    }(g),
        Zb = function(b) {
    ...
    var bc = function(b) {
      ...
      a.prototype._subscribe = function(c) {
        return new ac(c, this.sources, this.resultSelector);
      };
      return a;
    }(g),
        ac = function(b) {
      ...
      return a;
        ...
        ia = function(b) {
          ...
          a.prototype.scheduleMessage = function(c) {
            this.add(this.scheduler.schedule(a.dispatch, this.delay, new hc(c, this.destination)));
          };
          a.prototype._next = function(c) {
    ...
    var mc = function(b) {
      ...
      a.prototype._subscribe = function(c) {
        return new lc(c, this.condition, this.thenSource, this.elseSource);
      };
      return a;
    }(g),
        lc = function(b) {
 ...
 while (c = a.shift());
    ...
    var Va = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new qc(a, this.nextSources));
      };
      return b;
    }(),
        qc = function(b) {
    ...
    var va = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new xc(a, this.project));
      };
      return b;
    }(),
        xc = function(b) {
          ...
          a.prototype._next = function(c) {
            ...
            D(c) ? a.push(new yc(c)) : "function" === typeof c[A] ? a.push(new zc(c[A]())) : a.push(new Ac(this.destination, this, c));
          };
          a.prototype._complete = function() {
    ...
    var xa = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Bc(a, this.project, this.thisArg));
      };
      return b;
    }(),
        Bc = function(b) {
        ...
        Gc = function(b) {
          function a(c, a) {
            if (c instanceof g)
              ...
              this._output = new v;
              "string" === typeof c ? this.url = c : Fc(this, c);
    ...
    var Ic = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Hc(a, this.closingNotifier));
      };
      return b;
    }(),
        Hc = function(b) {
    ...
    g.prototype.buffer = function(b) {
      return this.lift(new Ic(b));
    };
    var Lc = function() {
      function b(a, c) {
        this.bufferSize = a;
        this.subscriberClass = (this.startBufferEvery = c) && a !== c ? Jc : Kc;
      }
      b.prototype.call = function(a, c) {
    ...
    var Nc = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Mc(a, this.bufferTimeSpan, this.bufferCreationInterval, this.maxBufferSize, this.scheduler));
      };
      return b;
    }(),
        Oc = function() {
    ...
    g.prototype.bufferTime = function(b) {
      ...
      3 <= a && (d = arguments[2]);
      return this.lift(new Nc(b, e, d, c));
    };
    var Qc = function() {
      function b(a, c) {
        this.openings = a;
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Pc(a, this.openings, this.closingSelector));
      };
      return b;
    }(),
        Pc = function(b) {
    ...
    var Sc = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Rc(a, this.closingSelector));
      };
      return b;
    }(),
        Rc = function(b) {
    ...
    var Db = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Tc(a, this.selector, this.caught));
      };
      return b;
    }(),
        Tc = function(b) {
    ...
    var Ca = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Uc(a, this.project, this.resultSelector, this.concurrent));
      };
      return b;
    }(),
        Uc = function(b) {
    ...
    var Ea = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Vc(a, this.ish, this.resultSelector, this.concurrent));
      };
      return b;
    }(),
        Vc = function(b) {
    ...
    var Xc = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Wc(a, this.predicate, this.source));
      };
      return b;
    }(),
        Wc = function(b) {
    ...
    g.prototype.count = function(b) {
      return this.lift(new Xc(b, this));
    };
    var Zc = function() {
      function b() {}
      b.prototype.call = function(a, c) {
        return c.subscribe(new Yc(a));
      };
      return b;
    }(),
        Yc = function(b) {
    ...
    var ad = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new $c(a, this.durationSelector));
      };
      return b;
    }(),
        $c = function(b) {
    ...
    var cd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new bd(a, this.dueTime, this.scheduler));
      };
      return b;
    }(),
        bd = function(b) {
    ...
    var ed = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new dd(a, this.defaultValue));
      };
      return b;
    }(),
        dd = function(b) {
    ...
    var gd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new fd(a, this.delay, this.scheduler));
      };
      return b;
    }(),
        fd = function(b) {
    ...
    var Za = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new id(a, this.delayDurationSelector));
      };
      return b;
    }(),
        id = function(b) {
        ...
        kd = function(b) {
          ...
          a.prototype._subscribe = function(a) {
            this.subscriptionDelay.subscribe(new jd(a, this.source));
          };
          return a;
        }(g),
        jd = function(b) {
    ...
    g.prototype.delayWhen = function(b, a) {
      return a ? (new kd(this, a)).lift(new Za(b)) : this.lift(new Za(b));
    };
    var ld = n.Set || Fb(),
        nd = function() {
          function b(a, c) {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new md(a, this.keySelector, this.flushes));
          };
          return b;
        }(),
        md = function(b) {
    ...
    var Gb = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new od(a, this.compare, this.keySelector));
      };
      return b;
    }(),
        od = function(b) {
    ...
    var Hb = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new pd(a, this.nextOrObserver, this.error, this.complete));
      };
      return b;
    }(),
        pd = function(b) {
    ...
    var td = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new sd(a, this.project, this.resultSelector));
      };
      return b;
    }(),
        sd = function(b) {
    ...
    var vd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ud(a, this.project, this.concurrent, this.scheduler));
      };
      return b;
    }(),
        ud = function(b) {
    ...
    var T = function(b) {
      ...
      return a;
        ...
        xd = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new wd(a, this.index, this.defaultValue));
          };
          return b;
        }(),
        wd = function(b) {
    ...
    var Ib = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new yd(a, this.predicate, this.thisArg));
      };
      return b;
    }(),
        yd = function(b) {
    ...
    var Jb = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new zd(a, this.callback));
      };
      return b;
    }(),
        zd = function(b) {
    ...
    var $a = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Ad(a, this.predicate, this.source, this.yieldIndex, this.thisArg));
      };
      return b;
    }(),
        Ad = function(b) {
    ...
    var ba = function(b) {
      ...
      return a;
        ...
        Cd = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new Bd(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
          };
          return b;
        }(),
        Bd = function(b) {
    ...
    g.prototype.first = function(b, a, c) {
      return this.lift(new Cd(b, a, c, this));
    };
    var Dd = function() {
      function b() {
        this.size = 0;
      ...
      return b;
        ...
        Hd = function() {
          ...
          b.prototype.call = function(a, c) {
            return c.subscribe(new Gd(a, this.keySelector, this.elementSelector, this.durationSelector, this.subjectSelector));
          };
          return b;
        }(),
        Gd = function(b) {
          ...
          a.prototype._group = function(a, b) {
            var c = this.groups;
            c || (c = this.groups = "string" === typeof b ? new Fd : new Ed);
            var e = c.get(b),
                h;
            ...
            if (!e && (e = this.subjectSelector ? this.subjectSelector() : new v, c.set(b, e), a = new ab(b, e, this), this.destination.next(a), this.durationSelector)) {
              ...
              this.add(a.subscribe(new Id(b, e, this)));
            }
            e.closed || e.next(h);
          };
          a.prototype._error = function(a) {
    ...
    g.prototype.groupBy = function(b, a, c, e) {
      return this.lift(new Hd(b, a, c, e));
    };
    var Ld = function() {
      function b() {}
      b.prototype.call = function(a, c) {
    ...
    var Pd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Od(a, this.durationSelector));
      };
      return b;
    }(),
        Od = function(b) {
    ...
    var Rd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Qd(a, this.duration, this.scheduler));
      };
      return b;
    }(),
        Qd = function(b) {
    ...
    var Td = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Sd(a, this.predicate, this.resultSelector, this.defaultValue, this.source));
      };
      return b;
    }(),
        Sd = function(b) {
    ...
    g.prototype.last = function(b, a, c) {
      return this.lift(new Td(b, a, c, this));
    };
    g.prototype.let = Ia;
    ...
    var Vd = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Ud(a, this.predicate, this.thisArg, this.source));
      };
      return b;
    }(),
        Ud = function(b) {
    ...
    g.prototype.every = function(b, a) {
      return this.lift(new Vd(b, a, this));
    };
    g.prototype.map = wa;
    var Xd = function() {
      function b(a) {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Wd(a, this.value));
      };
      return b;
    }(),
        Wd = function(b) {
    ...
    g.prototype.mapTo = function(b) {
      return this.lift(new Xd(b));
    };
    var Zd = function() {
      function b() {}
      b.prototype.call = function(a, c) {
        return c.subscribe(new Yd(a));
      };
      return b;
    }(),
        Yd = function(b) {
    ...
    var ja = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new $d(a, this.accumulator, this.seed, this.hasSeed));
      };
      return b;
    }(),
        $d = function(b) {
    ...
    var be = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ae(a, this.accumulator, this.seed, this.concurrent));
      };
      return b;
    }(),
        ae = function(b) {
    ...
    var U = function(b) {
      ...
      a.prototype.connect = function() {
        ...
        a || (a = this._connection = new u, a.add(this.source.subscribe(new ce(this.getSubject(), this))), a.closed ? (this._connection = null, a = u.EMPTY) : this._connection = a);
        return a;
      };
      a.prototype.refCount = function() {
        return this.lift(new de(this));
      };
      return a;
    }(g),
        Mb = {
    ...
    var cb = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new he(a, this.count, this.source));
      };
      return b;
    }(),
        he = function(b) {
    ...
    var je = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ie(a, this.notifier, c));
      };
      return b;
    }(),
        ie = function(b) {
    ...
    var le = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ke(a, this.count, this.source));
      };
      return b;
    }(),
        ke = function(b) {
    ...
    var ne = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new me(a, this.notifier, this.source));
      };
      return b;
    }(),
        me = function(b) {
    ...
    var re = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new qe(a, this.period, this.scheduler));
      };
      return b;
    }(),
        qe = function(b) {
    ...
    var te = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new se(a, this.accumulator, this.seed, this.hasSeed));
      };
      return b;
    }(),
        se = function(b) {
    ...
    var ve = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ue(a, this.compareTo, this.comparor));
      };
      return b;
    }(),
        ue = function(b) {
          function a(a, e, d) {
            ...
            this._b = [];
            this._oneComplete = !1;
            this.add(e.subscribe(new we(a, this)));
          }
          k(a, b);
          a.prototype._next = function(a) {
    ...
    var ye = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new xe(a, this.predicate, this.source));
      };
      return b;
    }(),
        xe = function(b) {
    ...
    g.prototype.single = function(b) {
      return this.lift(new ye(b, this));
    };
    var Ae = function() {
      function b(a) {
        this.total = a;
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new ze(a, this.total));
      };
      return b;
    }(),
        ze = function(b) {
    ...
    var Ce = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new Be(a, this.notifier));
      };
      return b;
    }(),
        Be = function(b) {
    ...
    var Ee = function() {
      ...
      b.prototype.call = function(a, c) {
        return c.subscribe(new De(a, this.predicate));
      };
      return b;
    }(),
        De = function(b) {
 ...
 while (++f < h && (a = b.shift()));
        ...
        He = function() {
          ...
          b.prototype.call = function(a, b) {
            return (new Ge(b, this.delay, this.scheduler)).subscribe(a);
          };
          return b;
        }();
    g.prototype.subscribeOn = function(b, a) {
      void 0 === a && (a = 0);
      return this.lift(new He(b, a));
    };
    var Rb = function() {
      function b() {}
      b.prototype.call = function(a, b) {
        return b.subscribe(new Ie(a));
      };
      return b;
    }(),
        Ie = function(b) {
    ...
    var Ke = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Je(a, this.project, this.resultSelector));
      };
      return b;
    }(),
        Je = function(b) {
    ...
    var Me = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Le(a, this.observable, this.resultSelector));
      };
      return b;
    }(),
        Le = function(b) {
    ...
    var Se = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Re(a, this.notifier));
      };
      return b;
    }(),
        Re = function(b) {
    ...
    var Ue = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Te(a, this.predicate));
      };
      return b;
    }(),
        Te = function(b) {
    ...
    var We = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Ve(a, this.durationSelector));
      };
      return b;
    }(),
        Ve = function(b) {
    ...
    var Ye = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new Xe(a, this.duration, this.scheduler));
      };
      return b;
    }(),
        Xe = function(b) {
    ...
    var fb = function(b) {
      ...
      return a;
        ...
        bf = function() {
          ...
          b.prototype.call = function(a, b) {
            return b.subscribe(new af(a, this.absoluteTimeout, this.waitFor, this.scheduler, this.errorInstance));
          };
          return b;
        }(),
        af = function(b) {
    ...
    g.prototype.timeout = function(b, a) {
      ...
      return this.lift(new bf(b, c, a, new fb));
    };
    var df = function() {
      function b(a, b, e, d) {
        this.waitFor = a;
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new cf(a, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler));
      };
      return b;
    }(),
        cf = function(b) {
    ...
    g.prototype.timeoutWith = function(b, a, c) {
      ...
      return this.lift(new df(b, e, a, c));
    };
    var gb = function() {
      return function(b, a) {
        this.value = b;
    ...
    var mf = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new lf(a, this.windowSize, this.startWindowEvery));
      };
      return b;
    }(),
        lf = function(b) {
    ...
    var of = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new nf(a, this.windowTimeSpan, this.windowCreationInterval, this.maxWindowSize, this.scheduler));
      };
      return b;
    }(),
        pf = function(b) {
    ...
    g.prototype.windowTime = function(b, a, c, e) {
      ...
      z(c) ? d = c : P(c) && (h = c);
      z(a) ? d = a : P(a) && (f = a);
      return this.lift(new of(b, f, h, d));
    };
    var rf = function() {
      function b(a, b) {
        this.openings = a;
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new qf(a, this.openings, this.closingSelector));
      };
      return b;
    }(),
        qf = function(b) {
    ...
    var tf = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new sf(a, this.closingSelector));
      };
      return b;
    }(),
        sf = function(b) {
    ...
    var vf = function() {
      ...
      b.prototype.call = function(a, b) {
        return b.subscribe(new uf(a, this.observables, this.project));
      };
      return b;
    }(),
        uf = function(b) {
