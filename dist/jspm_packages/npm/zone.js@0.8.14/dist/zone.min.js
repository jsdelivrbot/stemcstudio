    ...
    function u(e, t, n) {
      function r(t, n) {
        ...
        var _,
            ...
            D = m[w(i)] = m[i],
            Z = m[w(c)] = m[c];
        n && n.prependEventListenerFnName && (_ = m[w(n.prependEventListenerFnName)] = m[n.prependEventListenerFnName]);
        var S = function(e) {
          if (!b.isExisting)
              ...
              return void 0 === i && (i = !1), void 0 === s && (s = !1), function() {
                ...
                if (!d || d(t, u, c, arguments)) {
                  ...
                  var O,
                      z = c.constructor[F],
                      P = H[z];
                  P && (O = P[f]), O || (O = z + n + f), b.options = h, v && (b.options.once = !1), b.target = c, b.capture = p, b.eventName = f, b.isExisting = Z;
                  var j = r ? M : null,
                      x = k.scheduleEventTask(O, u, j, o, a);
        ...
        return m[o] = U(T, p, N, A, k), _ && (m[f] = U(_, h, P, A, k, !0)), m[a] = function() {
          var t,
              n = this || e,
              r = arguments[0],
              o = arguments[2];
    ...
    (function(e) {
      ...
      var c = function() {
        ...
        return r.assertZonePatched = function() {
          ...
          if (!r || e.type !== Z) {
            var o = e.state != b;
            o && e._transitionTo(b, _), e.runCount++;
            var a = P;
            P = e, z = {
              parent: z,
              zone: this
            ...
            try {
              ...
              e.state !== k && e.state !== w && (e.type == Z || e.data && e.data.isPeriodic ? o && e._transitionTo(_, b) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(k, b, k))), z = z.parent, P = a;
            }
          }
