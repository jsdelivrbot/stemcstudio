...
export class AxesHelper extends Line {
...
export class GridHelper extends Line {
     ...
     * @param step The size of the step between neighboring lines.
     * @param colorCenterLine The color of the centerline.
     * @param colorGrid The color of the lines of the grid.
     */
    constructor(size: number, step: number, colorCenterLine?: (Color | number | string), colorGrid?: (Color | number | string));
