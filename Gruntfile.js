...
function copies(target) {
    return [
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/davinci-eight@3.3.2/dist/davinci-eight.d.ts')
        },
        {
            src: "../davinci-eight/dist/davinci-eight.js",
            dest: prepend(target, 'vendor/davinci-eight@3.3.2/dist/davinci-eight.js')
        },
        {
            src: "../davinci-eight/dist/davinci-eight.css",
            dest: prepend(target, 'vendor/davinci-eight@3.3.2/dist/davinci-eight.css')
        },
        {
