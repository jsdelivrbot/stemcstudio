...
function copies(target) {
    return [
        ...
        {
            src: "museum/plotly@1.21.3/plotly.d.ts",
            dest: prepend(target, 'vendor/plotly@1.21.3/plotly.d.ts')
        },
        {
            src: "museum/plotly@1.21.3/plotly.js",
            dest: prepend(target, 'vendor/plotly@1.21.3/plotly.js')
        },
        {
            src: "museum/plotly@1.21.3/plotly.min.js",
            dest: prepend(target, 'vendor/plotly@1.21.3/plotly.min.js')
        },
        {
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/davinci-eight@6.0.0/dist/davinci-eight.d.ts')
        },
        {
            src: "bower_components/davinci-eight/dist/davinci-eight.js",
            dest: prepend(target, 'vendor/davinci-eight@6.0.0/dist/davinci-eight.js')
        },
        {
            src: "bower_components/davinci-eight/dist/davinci-eight.css",
            dest: prepend(target, 'vendor/davinci-eight@6.0.0/dist/davinci-eight.css')
        },
        {
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/davinci-newton@0.0.1/dist/davinci-newton.d.ts')
        },
        {
            src: "bower_components/davinci-newton/dist/davinci-newton.js",
            dest: prepend(target, 'vendor/davinci-newton@0.0.1/dist/davinci-newton.js')
        },
        {
            src: "bower_components/davinci-newton/dist/davinci-newton.css",
            dest: prepend(target, 'vendor/davinci-newton@0.0.1/dist/davinci-newton.css')
        },
        {
