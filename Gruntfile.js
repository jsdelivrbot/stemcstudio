...
function copies(target) {
    return [
        ...
        {
            src: 'jspm_packages/github/geometryzen/ace-workers@2.7.0/src/worker.js',
            dest: prepend(target, 'js/worker.js')
        },
        {
            src: 'jspm_packages/github/geometryzen/ace-workers@2.7.0/dist/ace-workers.js',
            dest: prepend(target, 'js/ace-workers@2.7.0/ace-workers.js')
        },
        {
