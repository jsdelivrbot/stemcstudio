    ...
    grunt.initConfig({
        ...
        copy: {
            dev: {
                files: [
                    ...
                    {
                        src: 'jspm_packages/github/ace2ts/ace-workers@0.1.69/src/worker.js',
                    ...
                    {
                        src: 'jspm_packages/github/ace2ts/ace-workers@0.1.69/dist/ace-workers.js',
        ...
        tslint: {
            src: [
                ...
                "app/ts/templates/**/*.ts",
                "app/ts/utils/**/*.ts",
                "app/ts/widgets/editor/Document.ts",
                "app/ts/widgets/editor/Fold.ts",
                "app/ts/widgets/editor/FoldLine.ts",
                "app/ts/widgets/editor/Position.ts",
