...
function copies(target) {
    return [
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/davinci-eight@5.0.16/dist/davinci-eight.d.ts')
        },
        {
            src: "bower_components/davinci-eight/dist/davinci-eight.js",
            dest: prepend(target, 'vendor/davinci-eight@5.0.16/dist/davinci-eight.js')
        },
        {
            src: "bower_components/davinci-eight/dist/davinci-eight.css",
            dest: prepend(target, 'vendor/davinci-eight@5.0.16/dist/davinci-eight.css')
        },
        {
