...
function copies(target) {
    return [
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/plotly@1.19.2/plotly.d.ts')
        },
        {
            src: "museum/plotly@1.19.2/plotly.js",
            dest: prepend(target, 'vendor/plotly@1.19.2/plotly.js')
        },
        {
            src: "museum/plotly@1.19.2/plotly.min.js",
            dest: prepend(target, 'vendor/plotly@1.19.2/plotly.min.js')
        },
        {
        ...
        },
        {
            ...
            dest: prepend(target, 'vendor/davinci-eight@3.3.0/dist/davinci-eight.d.ts')
        },
        {
            src: "../davinci-eight/dist/davinci-eight.js",
            dest: prepend(target, 'vendor/davinci-eight@3.3.0/dist/davinci-eight.js')
        },
        {
            src: "../davinci-eight/dist/davinci-eight.css",
            dest: prepend(target, 'vendor/davinci-eight@3.3.0/dist/davinci-eight.css')
        },
        {
