...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/fab683ca77d0286b9d51aba6375deaceb41b22f5/socket.io/socket.io.d.ts
...
declare module SocketIO {
	...
	interface Namespace extends NodeJS.EventEmitter {
		 ...
		 */
		use( fn: ( socket:Socket, fn: ( err?: any ) => void ) =>void ): this;
