...
ace.define("ace/mode/typescript",["require","exports","module","ace/lib/oop","ace/mode/javascript","ace/mode/typescript_highlight_rules","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/mode/matching_brace_outdent","ace/worker/worker_client"], function(require, exports, module) {
"use strict";
...
(function() {
    this.createWorker = function(session) {
        ...
        worker.on("getFileNames", function(event) {
            console.log("TypeScript Mode/Session receiving getFileNames "+ JSON.stringify(event));
